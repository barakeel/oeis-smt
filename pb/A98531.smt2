;; sequence(s): A98531
;; terms: 0 1 2 34 277 3402 36170 407463 4491564 49926988 553211363 6137270812 68054635036 754774491429 8370420537086 92830050637086 1029498223070793 11417322172518550 126619992693837974 1404237451180502875
;; small program: loop(loop((((x * x) * x) * x) * x, 1, loop2(x + y, x, y, 0, 1)) + x, x, 0)
;; fast program: loop(loop(loop((((x * x) * x) * x) * x, 1, loop2(x + y, x, x - 2, 1, 1)), 1, y) + x, x, 0)
(set-logic UFNIA)
