;; sequence(s): A180039
;; terms: 1 112 111223 1111222334 111112222333445 111111222223333444556 1111111222222333334444555667 111111112222222333333444445555666778 111111111222222223333333444444555556666777889
;; small program: loop(loop(loop(1 + (2 * ((2 * (x + x)) + x)), y + 1, x), y, 1) + x, x, 1)
;; fast program: loop(loop(loop2(1 + (x * y), y, loop(x + y, x, x), 1, 2 + (2 * (2 + 2))), 1, y) + x, x, 1)
(set-logic UFNIA)
