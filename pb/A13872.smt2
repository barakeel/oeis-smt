;; sequence(s): A13872
;; terms: 2744 1475789056 793714773254144 426878854210636742656 229585692886981495482220544 123476695691247935826229781856256 66408730383449729837806206197059026944 35716209009748467500288285041727074107129856
;; small program: loop((loop(x * x, 2, 2) - 2) * x, loop(1 + (x + x), 2, x) + x, 1)
