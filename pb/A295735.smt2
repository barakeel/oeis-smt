;; sequence(s): A295735
;; terms: 0 ~1 0 1 3 8 15 31 54 101 171 304 507 875 1446 2449 4023 6728 11007 18247
;; small program: loop2(x + y, 2 + x, x, 1, 0) - loop2(2 + y, x + x, x, 1, 0)
;; fast program: loop2(x + y, x, x, 1 + 2, 0) - loop2(y + y, x, x, 1 + 2, 2)
(set-logic UFNIA)
