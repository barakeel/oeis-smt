;; sequence(s): A272068
;; terms: 0 59049 9509900499 995009990004999 99950009999000049999 9999500009999900000499999 999995000009999990000004999999 99999950000009999999000000049999999 9999999500000009999999900000000499999999 999999995000000009999999990000000004999999999 99999999950000000009999999999000000000049999999999
;; small program: loop2(loop(2 * ((2 * (x + x)) + x), y, x) - x, y, 1 + (2 + 2), 1, x)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))) - 1) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))) - 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h4 x) (- (w5 x) 1))))
