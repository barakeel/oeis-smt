;; sequence(s): A91804
;; terms: 1 2 32 9216 84934656 39137889484800 1298501242170900480000 4221953171600428240994304000000 1757091687362157576297527910177177600000000
;; small program: loop(loop(2 * ((x * y) * y), y, x), x, 1)
;; fast program: loop(x * x, 1, loop(loop(x * y, y, x), x, 1)) * loop2(x * y, y + y, x, 1, 2)
(set-logic UFNIA)
