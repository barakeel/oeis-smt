;; sequence(s): A106514
;; terms: 1 3 9 25 67 175 449 1137 2851 7095 17553 43225 106051 259423 633089 1541985 3749827 9107175 22095249 53559817
;; small program: loop((x + x) + loop2(y, (x + y) + y, y, 1, 1), x, 1)
;; fast program: loop2((x + x) + y, x, x, 1 + 2, 1) - loop(x + x, x, 2)
(set-logic UFNIA)
