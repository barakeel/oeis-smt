;; sequence(s): A5968
;; terms: 0 1 2 10 37 162 674 2871 12132 51436 217811 922780 3908764 16558101 70140734 297121734 1258626537 5331629710 22585142414 95672204155
;; small program: loop(loop((x * x) * x, 1, loop2(x + y, x, y, 0, 1)) + x, x, 0)
;; fast program: loop(loop((x * x) * x, 1, loop2(x + y, x, y - 2, 1, 1)) + x, x, 1) - 1
(set-logic UFNIA)
