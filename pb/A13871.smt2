;; sequence(s): A13871
;; terms: 196 105413504 56693912375296 30491346729331195904 16398978063355821105872896 8819763977946281130444984418304 4743480741674980702700443299789930496 2551157786410604821449163217266219579080704 1372073885318497127491074758162987278899500548096
;; small program: loop((loop(x * x, 2, 2) - 2) * x, 2 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 + 2))))) * loop2(x * y, y, 2 + x, 1, 2 + (2 * (2 + (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 + 2)))))
(set-logic UFNIA)
