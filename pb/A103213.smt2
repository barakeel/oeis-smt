;; sequence(s): A103213
;; terms: 1 5 29 206 1774 18204 218868 3036144 47928816 850514400 16783812000 364865040000 8666747625600 223351748524800 6206847295622400 185007996436838400 5887506932836300800 199216094254423142400
;; small program: loop((loop((2 * (x * y)) + loop(x * y, y, 1), y, 1) + (x * y)) + x, x, 1)
;; fast program: loop(loop(loop(x * y, x, loop(x + x, x, 2) - 1), 1, y) + ((1 + y) * x), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h5 x) (- (v6 x) 1))))
