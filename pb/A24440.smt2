;; sequence(s): A24440
;; terms: 1 28 521 8132 115425 1547436 20005177 252510484 3136438289 38534838524 469928249193 5701527366756 68933583580993 831438081590092 10011928868278169 120426060354676148 1447414807491149937
;; small program: loop((loop(loop(1 + (2 * (2 * (x + x))), y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
