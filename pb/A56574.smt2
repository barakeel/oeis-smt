;; sequence(s): A56574
;; terms: 0 1 1 128 2187 78125 2097152 62748517 1801088541 52523350144 1522435234375 44231334895529 1283918464548864 37281334283719577 1082404156823183753 31427428360210000000 912473096871571914483
;; small program: loop2(loop2(x + y, x, y, 0, x) * x, y, 1 + 2, 1, x)
;; fast program: loop(loop((x * x) * x, 1, x * x) * x, 1, if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (ite (<= x 0) 0 (w4 x)))))
