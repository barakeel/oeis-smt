;; sequence(s): A20972
;; terms: 1 28 529 8428 122257 1673980 22067473 283450636 3574941073 44501447452 548719235857 6718924954924 81849587868049 993294339107644 12020103854584081 145151139884150092 1750035954202640785
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((((y * y) + x) + x) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
