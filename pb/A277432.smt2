;; sequence(s): A277432
;; terms: 0 1 2 8 32 164 984 6896 55168 496528 4965280 54618112 655417344 8520425536 119285957504 1789289362688 28628629803008 486686706651392 8760360719725056 166446853674776576
;; small program: loop((x * y) + loop2(x + y, x - y, y, 0, 1), x, 0)
;; fast program: loop(loop2(y + y, x, y - 1, 1, 0) + (x * y), x, 0)
(set-logic UFNIA)
