;; sequence(s): A21279
;; terms: 1 23 371 5227 68955 877371 10927867 134329979 1637524859 19854820219 239894019963 2891817662331 34806527338363 418516051199867 5028894399547259 60400347075823483 725233079160063867
;; small program: loop(loop2((2 * ((2 * (x + x)) + y)) - 1, y + y, y, 1, 2) + loop((2 + y) * x, 2, x), x, 1)
