;; sequence(s): A22396
;; terms: 1 26 27 53 80 133 213 346 559 905 1464 2369 3833 6202 10035 16237 26272 42509 68781 111290
;; small program: loop2(y, x + y, x, 1, loop(1 + (x * x), 2, 2))
;; fast program: loop2(x + y, x, x, 1, loop(x * x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
