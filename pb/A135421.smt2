;; sequence(s): A135421
;; terms: 1 30 32400 1259712000 1763193692160000 88844650093530316800000 161162887476414617908936704000000 10524495800322448706290880214277816320000000 24742299477723936603969643338598393206990805401600000000
;; small program: loop(loop2((2 + (2 + y)) * x, 2, y + y, x, 1), x, 1)
;; fast program: (loop2(x * y, (y + y) + y, x, 1, 1 + 2) * loop2(x * y, (y + y) + y, x, 1, 1 + (2 + 2))) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))
(set-logic UFNIA)
