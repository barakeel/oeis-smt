;; sequence(s): A46882
;; terms: 1 1 4 46656 1333735776850284124449081472843776
;; small program: loop(loop2(x * y, y, x, 1, x), 1, loop(x * y, x, 1))
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 1, loop(x * y, x, 1))
(set-logic UFNIA)
