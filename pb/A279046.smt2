;; sequence(s): A279046
;; terms: 1 0 1 4 108 12672 9158400 46133452800 1860226228224000 675033837113180160000 2449564623049780415692800000 97778774486746890792389836800000000 46836189690981206780971946461888512000000000 291649927271171583734813938085106400257638400000000000
;; small program: loop((x * y) + loop(0 - x, y, 1), x, 1) * loop(loop(x * y, y - 1, x), x, 1)
;; fast program: loop(loop(x * y, y - 1, y) * x, x - 1, 1) * loop((x * y) + loop(0 - x, y, 1), x, 1)
(set-logic UFNIA)
