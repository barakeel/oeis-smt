;; sequence(s): A265688
;; terms: 1 111 11101 1110111 111011101 11101110111 1110111011101 111011101110111 11101110111011101 1110111011101110111 111011101110111011101 11101110111011101110111 1110111011101110111011101 111011101110111011101110111 11101110111011101110111011101
;; small program: loop(loop(loop(loop((2 * ((2 * (x + x)) + x)) + y, 2, x), x, 1), 1, y) - x, x, 1)
;; fast program: loop(loop(loop(loop(((2 + (2 * (2 + 2))) * x) + y, 2, x), x, 1), 1, y) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (+ (* (+ 2 (* 2 (+ 2 2))) x) y))))
(assert (= g7 2))
