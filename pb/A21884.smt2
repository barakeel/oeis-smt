;; sequence(s): A21884
;; terms: 1 23 358 4758 58419 686541 7864936 88727036 991573957 11016698979 121950785034 1346833901634 14852822151415 163644677778137 1801937252261452 19834231783445352 218267009404507593
;; small program: loop((loop((loop(1 + (2 * (x + x)), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((x + x) + x)) + x) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
