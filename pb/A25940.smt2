;; sequence(s): A25940
;; terms: 1 21 295 3525 38911 411741 4255255 43385925 438878671 4418961261 44370835015 444796211925 4454490876031 44584086067581 446075938835575 4462169900295525 44630162203602991 446352401627074701
;; small program: loop(((loop(loop2((2 * ((x + x) + x)) + y, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(((loop(loop2(((2 * (x + x)) + x) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + x) + x) + x, x, 1)
(set-logic UFNIA)
