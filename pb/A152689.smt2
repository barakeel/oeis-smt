;; sequence(s): A152689
;; terms: 0 0 0 1 4 11 28 79 284 1363 8356 61583 523924 5024179 53479148 624890431 7946278828 109195935539 1612048228564 25439293045903
;; small program: loop(loop(loop(loop(x * y, y - 1, 1) + x, y - 2, x), y, x), x, 0)
;; fast program: loop(loop(loop(loop(x * y, y - 1, y) + x, y - 1, 1) + x, y - 2, x), x, 0)
(set-logic UFNIA)
