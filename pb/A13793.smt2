;; sequence(s): A13793
;; terms: 1000 10000000 100000000000 1000000000000000 10000000000000000000 100000000000000000000000 1000000000000000000000000000 10000000000000000000000000000000 100000000000000000000000000000000000
;; small program: loop(2 * ((2 * (x + x)) + x), loop(1 + (x + x), 2, x), 1)
;; fast program: ((2 + (2 * (2 + 2))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (+ 2 (* 2 (+ 2 2))) (v2 x)) (v4 x)))))
