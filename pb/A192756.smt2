;; sequence(s): A192756
;; terms: 0 1 6 17 38 75 138 243 416 699 1160 1909 3124 5093 8282 13445 21802 35327 57214 92631
;; small program: loop(loop(loop2(x + y, x, y, 2, 0) + x, y, x), x, 0) - x
;; fast program: (((loop2(x + y, x, x, 1 + (2 + 2), 1 + 2) - (2 * (2 + x))) * 2) - 2) - x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (* (- (w3 x) (* 2 (+ 2 x))) 2) 2) x))))
