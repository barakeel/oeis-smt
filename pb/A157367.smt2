;; sequence(s): A157367
;; terms: 4999 19601 43807 77617 121031 174049 236671 308897 390727 482161 583199 693841 814087 943937 1083391 1232449 1391111 1559377 1737247 1924721
;; small program: 1 + (2 * loop((2 + x) * x, 1, loop((2 * ((x + x) + x)) + x, 2, 1 + x)))
;; fast program: 1 + (2 * loop((2 + x) * x, 1, (1 + x) * loop(x * x, 1, 1 + (2 + (2 + 2)))))
(set-logic UFNIA)
