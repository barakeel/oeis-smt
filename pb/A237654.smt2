;; sequence(s): A237654
;; terms: 1 0 5 5 25 49 150 365 990 2550 6726 17550 46015 120390 315275 825299 2160775 5656855 14809980 38772875
;; small program: loop(loop(loop(loop2(x + y, x, y + y, 1, 1) - x, y, 1) - x, y, 1) - x, x, 1)
;; fast program: loop(loop(loop(loop2(x + y, x, x - 1, 2, 1) * loop2(x + y, x, x - 1, 1, 1), 1, y) - x, y, 1) - x, x, 1)
(set-logic UFNIA)
