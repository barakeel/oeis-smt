;; sequence(s): A97422
;; terms: 0 1 4 15 65 339 2103 15171 124755 1151331 11779971 132323811 1618766691 21421525731 304887173091 4644050174691 75378332568291 1298783923147491 23675771981669091 455240918799307491
;; small program: loop(loop((x * y) + loop(x * y, y - 1, 1), y, 0) + x, x, 0)
;; fast program: loop((loop((x * y) + loop(x * y, y - 1, 1), y - 1, 1) * y) + x, x, 1) - loop(x * y, x, 1)
(set-logic UFNIA)
