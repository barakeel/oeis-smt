;; sequence(s): A25955
;; terms: 1 26 455 6760 92121 1191606 14892475 181671620 2176950941 25732149586 300910712895 3488589043680 40160193084961 459619264745966 5234383334635715 59363930948274940 670860383232854181
;; small program: loop(((loop(loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((x + x) + x) + y, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
