;; sequence(s): A28118
;; terms: 1 27 470 6750 87411 1065177 12504280 143383500 1619764421 18123947127 201553821690 2232652225050 24669249375031 272138102501877 2998983086992700 33027209966147400 363568827451799241
;; small program: loop((loop((loop2((loop((2 + y) * x, 2, x) - x) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop((loop2(((2 * (x + x)) + (y * y)) + x, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
