;; sequence(s): A35038
;; terms: 0 0 0 0 0 0 1 8 37 130 386 1024 2510 5812 12911 27824 58651 121670 249528 507624
;; small program: loop(loop(loop(loop(loop(x + y, y, x) - y, y - 2, x), y - 2, x), y, x) + x, x, 0)
;; fast program: loop(loop(loop(loop(loop(x + y, y, x), y, x), y - 2, x), y - 2, x) + x, x - 1, 0)
(set-logic UFNIA)
