;; sequence(s): A259109
;; terms: 0 2 130 1588 9780 41030 134342 369640 893928 1956810 3956810 7499932 13471900 23125518 38184590 60965840 94520272 142795410 210819858 304911620
;; small program: loop(loop2((x * x) * y, 2, 2, y, y) + x, x, 0)
;; fast program: 2 * loop(loop((x * x) * x, 1, y * y) + x, x, 0)
(set-logic UFNIA)
