;; sequence(s): A13788
;; terms: 8 32768 134217728 549755813888 2251799813685248 9223372036854775808 37778931862957161709568 154742504910672534362390528 633825300114114700748351602688 2596148429267413814265248164610048 10633823966279326983230456482242756608
;; small program: loop(x + x, 2 + loop((2 + y) * x, 2, x), 2)
;; fast program: loop((x * x) * x, 1, loop((x + x) * x, 1, loop(x + x, x, 1))) * loop((x * x) * x, 1, loop(x * x, 1, loop(x + x, x, 1)))
(set-logic UFNIA)
