;; sequence(s): A21704
;; terms: 1 25 430 6370 87451 1148875 14682760 184262740 2283789301 28059228925 342594651490 4164091223110 50445694121551 609637726848175 7354257305858620 88598528944951480 1066309318875820201
;; small program: loop(((loop(loop(1 + loop((x + x) + x, 2, x), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + x, x, 1)
(set-logic UFNIA)
