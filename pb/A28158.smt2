;; sequence(s): A28158
;; terms: 1 33 695 11925 181911 2572893 34540735 446515125 5610825671 68978848653 833511432975 9933242415525 117049255275031 1366477139586813 15829397675656415 182175233504671125 2085009104934341991 23750419100554859373 269443828297173915055
;; small program: loop(loop(loop2(((2 * (((y * y) + x) + x)) - y) + x, y + y, x, 1, 2) * loop(x + x, x, 1), 1, y) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop(loop2(((2 * (((y * y) + x) + x)) - y) + x, y + y, x, 1, 2) * loop(x + x, x, 1), 1, y) + x) + ((((x * 2) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
