;; sequence(s): A81076
;; terms: 5 10 50 325 2210 15130 103685 710650 4870850 33385285 228826130 1568397610 10749957125 73681302250 505019158610 3461452808005 23725150497410 162614600673850 1114577054219525 7639424778862810
;; small program: 1 + (2 + loop2(y - x, x, 2 * (x + x), 2, 1))
;; fast program: 1 + loop(x * x, 1, loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2))
(set-logic UFNIA)
