;; sequence(s): A35274
;; terms: 1 15 375 13125 590625 32484375 2111484375 158361328125 13460712890625 1278767724609375 134270611083984375 15441120274658203125 1930140034332275390625 260568904634857177734375
;; small program: loop(loop2((2 * (x * y)) + x, 2, 2, x, y), x, 1)
;; fast program: loop2(x * y, 2 + y, x, 1, 1 + 2) * loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
