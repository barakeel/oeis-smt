;; sequence(s): A13885
;; terms: 83521 118587876497 168377826559400929 239072435685151324847153 339448671314611904643504117121 481968572106750915091411825223071697 684326450885775034048946719925754910487329 971645701575323882519635342913622589939807491953
;; small program: loop((loop(x * x, 2, 2) * x) + x, (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, 1 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
