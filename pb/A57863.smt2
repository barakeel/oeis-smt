;; sequence(s): A57863
;; terms: 1 1 3 45 4725 4465125 46414974375 6272287562165625 12714083695698776015625 438120013555654794702228515625 286849911214281324754704976473779296875 3943988517696329309474874414036059896739501953125
;; small program: loop(loop((2 * (x * y)) - x, y, x), x, 1)
;; fast program: loop(loop((2 * (x * y)) + x, y, 1) * x, x - 2, 1) * loop2(x * y, 2 + y, x - 1, 1, 1 + 2)
(set-logic UFNIA)
