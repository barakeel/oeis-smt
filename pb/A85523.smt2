;; sequence(s): A85523
;; terms: 1 5 325 333125 5458253125 1430853765453125 6001437102708869453125 402749632331680654432389453125 432449125237897791207428190509189453125 7429419400754766057344059513229133345069189453125 2042183254696046247075864924725939712088925233082669189453125 8981616938352999804189736540441162599045265812868432152715194669189453125
;; small program: loop2(((x * y) * y) + x, 2 * (y + y), x, 1, 2)
;; fast program: loop2((1 + (y * y)) * x, 2 * (y + y), x, 1, 2)
(set-logic UFNIA)
