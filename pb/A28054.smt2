;; sequence(s): A28054
;; terms: 1 22 309 3542 36197 344190 3119173 27339334 233997093 1968524558 16351808837 134557949526 1099534023589 8937744119326 72366036152901 584189060834918 4705458521506085 37837251535931694
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (2 * (x + x))), y, 1) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
