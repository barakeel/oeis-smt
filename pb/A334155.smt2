;; sequence(s): A334155
;; terms: 1 2 5 15 57 273 1593 10953 86553 771993 7666713 83871513 1001957913 12976997913 181106559513 2709277004313 43247182412313 733699248716313 13182759232076313 250070586344012313
;; small program: loop2((x * y) + y, y - 1, x, 1, x)
;; fast program: loop2(1 + (x * y), y - 1, x - 1, if x <= 0 then 1 else 2, x)
(set-logic UFNIA)
