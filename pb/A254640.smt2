;; sequence(s): A254640
;; terms: 1 67 927 6677 32942 126378 404634 1129854 2833479 6515509 13947505 28115451 53846156 98669156 173975076 296541132 490504893 789878583 1241708083 1909993393
;; small program: loop(loop(loop(((loop(x * x, 2, y) * y) * y) + x, y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop((x * x) * x, 1, y * y) + x, y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
