;; sequence(s): A21454
;; terms: 1 18 220 2310 22561 212268 1957600 17857620 161924521 1463379918 13200803980 118959425130 1071396569881 9646380238968 86836484875360 781623699024840 7035090031526641 63318194178965418
;; small program: loop(((loop((loop(1 + loop((x + x) + x, 2, x), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
