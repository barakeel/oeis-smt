;; sequence(s): A157337
;; terms: 161 577 1249 2177 3361 4801 6497 8449 10657 13121 15841 18817 22049 25537 29281 33281 37537 42049 46817 51841
;; small program: 1 + loop2(2 * ((x + y) * x), x, 2, 2, x + x)
;; fast program: 1 + (2 * loop((2 + x) * x, 1, 2 * (2 * (2 + (x + x)))))
(set-logic UFNIA)
