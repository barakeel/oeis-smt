;; sequence(s): A28017
;; terms: 1 31 627 10499 158219 2232387 30141979 394679923 5055314187 63715123043 793475307131 9793201406547 120053522334955 1464191224876099 17788099372232283 215464347026366771
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * (2 * (x + x))), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x, x, 1)
