;; sequence(s): A14928
;; terms: 1 27 534 9322 152127 2379885 36167548 538155684 7879732173 113924725903 1630368136242 23136292864686 326011399456939 4566262891748481 63626908677237816 882601196902689928
;; small program: loop(loop(loop((2 + y) * x, 2, x) + x, y, 1 + y) + x, x, 1)
;; fast program: loop2(((2 * (2 * ((x + x) + x))) + x) + y, y - 1, x, 1 + x, x)
(set-logic UFNIA)
