;; sequence(s): A346395
;; terms: 0 1 7 38 192 969 5115 29322 187992 1370745 11392839 107043606 1122823944 12989320785 164040593067 2243143392138 32994768719376 519229765892241 8701862242296807 154700700117472422
;; small program: loop(((loop((x * y) + loop((x + x) + x, y, 1), y - 1, 1) + x) + x) + x, x, 0)
;; fast program: loop(loop(loop2(x * y, y, y, 1, 1 + 2) + (x * y), y - 1, 1) + ((x + x) + x), x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (w5 x y) (* x y)))))
