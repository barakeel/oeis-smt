;; sequence(s): A74531
;; terms: 3 14 94 764 6658 59324 532234 4785284 43053538 387440684 3486844474 31381238804 282430072018 2541867430844 22876797254314 205891146476324 1853020231964098 16677181828937804 150094635684681754
;; small program: loop((x * x) + x, 1, loop((x + x) + x, x, 1)) + loop(x + x, x, 1)
;; fast program: loop((x * x) + x, 1, loop2(x * y, y, x, 1, 1 + 2)) + loop(x + x, x, 1)
(set-logic UFNIA)
