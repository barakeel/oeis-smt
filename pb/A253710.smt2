;; sequence(s): A253710
;; terms: 1 1026 61100 1169750 12044025 83384476 437200176 1864757700 6779099625 21693441550 62545208076 165314338826 405941961425 935824239000 2042356907200 4248401203176 8470439399601 16262944822650 30186516503500 54350088184350
;; small program: loop(loop((loop((x * x) * x, 2, y) * y) + x, 1 + y, x), x, 1)
;; fast program: loop(loop((loop((x * x) * x, 1, (y * y) * y) * y) + x, y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (= g5 1))
(assert (forall ((x Int) (y Int)) (= (h5 x y) (* (* y y) y))))
