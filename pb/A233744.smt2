;; sequence(s): A233744
;; terms: 1 2 8 36 200 1300 9720 82180 775520 8082180 92205800 1143084580 15302486160 220019440420 3381685263320 55333244924100 960361672886720 17622501030879940 340893902373527880 6933456765092580580
;; small program: loop((loop(loop(x * y, y, 1) - x, y, 1) + (x * y)) + x, x, 1)
;; fast program: loop(loop(loop(x * y, y - 1, y) - x, y, 1) + ((1 + y) * x), x, 1)
(set-logic UFNIA)
