...
(assert (forall ((x Int)) (= (small x) (divf x (ite (<= (modf (+ 1 x) (+ 2 (* 2 (+ 2 2)))) 0) (+ 2 (* 2 (+ 2 2))) 1)))))
(assert (forall ((x Int)) (= (f0 x) (divf x (+ 2 (* 2 (+ 2 2)))))))
(assert (forall ((x Int)) (= (g0 x) (- (modf x (+ 2 (* 2 (+ 2 2)))) (* 2 (+ 2 2))))))
