;; sequence(s): A3773
;; terms: 16 3456 686000 135834624 26894628304 5325000912000 1054323287943536 208750686023540736 41331581509440922000 8183444388183674181504 1620280657278860350213424 320807386696826179092096000
;; small program: 2 * loop((x * x) * x, 1, loop2((x + x) + y, x, x + x, 2, 1))
;; fast program: loop((2 * (x * x)) * x, 1, loop2((2 * ((x + x) + x)) - y, x, x, 2, 0))
(set-logic UFNIA)
