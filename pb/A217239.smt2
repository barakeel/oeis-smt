;; sequence(s): A217239
;; terms: 0 0 2 18 216 3960 110160 4399920 238412160 16777031040 1484589254400 161180565638400 21054377854540800 3256459838542310400 588451470350449305600 122827588903536701184000 29325437466043778002944000
;; small program: loop((x * y) + loop((x * y) * y, y, 1), x - 1, 0) * x
;; fast program: loop2(1 + (x * y), y - 1, x - 1, 0, x) * loop(x * y, x - 1, x)
(set-logic UFNIA)
