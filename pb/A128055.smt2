;; sequence(s): A128055
;; terms: 1 1 2 4 8 32 64 64 128 256 512 2048 4096 4096 8192 16384 32768 131072 262144 262144
...
(assert (= f2 1))
(assert (forall ((x Int)) (= (g2 x) (- 2 (modf (- 0 x) (+ 2 (+ 2 2)))))))
(assert (= h2 2))
(assert (forall ((x Int) (y Int)) (= (u2 x y) (ite (<= x 0) y f2))))
(assert (forall ((x Int)) (= (v2 x) (u2 (g2 x) h2))))
(assert (forall ((x Int)) (= (fast x) (divf (v1 x) (v2 x)))))
