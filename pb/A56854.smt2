;; sequence(s): A56854
;; terms: 2 7 47 322 2207 15127 103682 710647 4870847 33385282 228826127 1568397607 10749957122 73681302247 505019158607 3461452808002 23725150497407 162614600673847 1114577054219522 7639424778862807
;; small program: loop2(y - x, x, 2 * (x + x), 2, 1)
;; fast program: loop(x * x, 1, loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2)) - 2
(set-logic UFNIA)
