;; sequence(s): A13814
;; terms: 21 4084101 794280046581 154472377739119461 30041942495081691894741 5842587018385982521381124421 1136272165922724266740722458520501 220983347100817338120002444455525554981 42977062327514056734916195400155065458259861
;; small program: loop((loop(2 * (2 + x), 2, 2) * x) + x, 1 + (2 * (x + x)), 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))) * loop2(x * y, y, 1 + x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
