;; sequence(s): A13801
;; terms: 2744 105413504 4049565169664 155568095557812224 5976303958948914397184 229585692886981495482220544 8819763977946281130444984418304 338820052976784335907174521413566464 13016111155156147048210016414623569281024
;; small program: loop((loop(x * x, 2, 2) - 2) * x, loop(1 + (x + x), 2, x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + (2 + 2))))) * loop2(x * y, y, 1 + (x + x), 1, 2 + (2 * (2 + (2 + 2))))
(set-logic UFNIA)
