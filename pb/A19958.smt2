;; sequence(s): A19958
;; terms: 1 22 329 4178 48621 537222 5744929 60136378 620564021 6341995022 64384199529 650640568578 6554239839421 65878458172822 661143103694129 6627971208280778 66395645870074821 664768758151070622
;; small program: loop((loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + (2 + 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
