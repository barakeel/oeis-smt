;; sequence(s): A101091
;; terms: 1 20 155 760 2814 8592 22770 54120 117975 239668 459173 837200 1463020 2464320 4019412 6372144 9849885 14884980 22040095 32037896
;; small program: loop(loop(loop(loop(loop(x * x, 2, y) + x, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop((((y * y) * y) * y) + x, y, x), y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f8 x y) (+ (* (* (* y y) y) y) x))))
