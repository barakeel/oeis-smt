;; sequence(s): A253826
;; terms: 1 18 595 20196 686053 23305590 791703991 26894630088 913625718985 31036379815386 1054323288004123 35815955412324780 1216688160731038381 41331581509442980158 1404057083160330286975 47696609245941786776976 1620280657278860420130193
;; small program: loop(loop2((y - x) - x, x, 2 * (y + y), 1, 1) + x, x, 1)
;; fast program: loop2((2 * ((x + x) + x)) - y, x, x - 1, (if x <= 0 then 0 else 2) + 1, 1) * loop2((2 * ((x + x) + x)) - y, x, x, 1, 0)
(set-logic UFNIA)
