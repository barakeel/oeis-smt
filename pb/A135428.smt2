;; sequence(s): A135428
;; terms: 1 90 810000 729000000000 65610000000000000000 590490000000000000000000000000 531441000000000000000000000000000000000000
;; small program: loop(loop2(((2 * (2 + 2)) + y) * x, 2, y + y, x, 1), x, 1)
;; fast program: loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, 1 + (2 + 2))) * loop2(x * y, y, x, 1, loop((x + x) + x, 2, loop(x + x, x, 1)))
(set-logic UFNIA)
