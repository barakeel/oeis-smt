;; sequence(s): A20499
;; terms: 1 25 426 6170 81851 1029315 12498676 148149460 1726010901 19855374605 226242178526 2559210312750 28786474721551 322368894171895 3597522989519976 40035969784960040 444564772324613801
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + (y * y)) + x, (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
