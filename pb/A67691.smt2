;; sequence(s): A67691
;; terms: 0 1 2 9 1000 1004006004001 1020191144865623440455270145683555422808365843606721760320032
;; small program: loop(loop2((x * y) + x, y, y - 1, 1, x), x, 0)
;; fast program: loop(loop2(x * y, y, y - 1, 1, 1 + x) * (1 + x), x - 1, if x <= 0 then 0 else 1)
(set-logic UFNIA)
