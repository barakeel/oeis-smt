;; sequence(s): A95930
;; terms: 1 4 15 57 220 859 3381 13380 53143 211585 843756 3368259 13455325 53774932 214978335 859595529 3437550076 13748021995 54986385093 219930610020
;; small program: loop((x + loop2(y - x, x, y, 1, 0)) + x, x + x, 1)
;; fast program: loop((((loop2(((x - y) + x) + x, x, y - 1, 0, 1) + x) + x) + x) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (+ (+ (w3 x y) x) x) x) x))))
