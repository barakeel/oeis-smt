;; sequence(s): A192882
;; terms: 0 1 3 14 51 205 792 3107 12117 47362 184965 722591 2822544 11025793 43069611 168242270 657200859 2567211037 10028243016 39173122739
;; small program: loop2(x + y, x, x, 0, 1) * loop2(y, (x + y) + y, x, 1, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else (1 + 2), 1) * loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
