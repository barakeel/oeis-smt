;; sequence(s): A130471
;; terms: 0 2 5 21 106 640 4527 36539 331508 3338358 36946489 445724977 5821580670 81839381996 1232102291651 19778348559015 337223021210632 6086161135368034 115915940643233613 2323409451689985053
;; small program: loop(loop(loop(loop((x * y) + x, y, 1) + x, y, 1) - x, y, 1) - x, x, 0)
;; fast program: loop(loop(loop(loop2(1 + (x * y), y - 1, x, 1, 1 + x), 1, y) - x, y, 1) - x, x, 0)
(set-logic UFNIA)
