;; sequence(s): A132074
;; terms: 1 4 9 16 27 46 81 148 279 538 1053 2080 4131 8230 16425 32812 65583 131122 262197 524344
;; small program: loop(x + x, x, 1) + loop2(x + y, 1, x, x, x)
;; fast program: (((loop(x + x, x - 1, 2) - 1) + x) + x) + x
(set-logic UFNIA)
