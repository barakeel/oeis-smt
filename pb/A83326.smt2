;; sequence(s): A83326
;; terms: 1 5 27 155 927 5675 35127 218195 1354527 8386715 51749127 318163235 1949418927 11907099755 72529083927 440741148275 2672816984127 16180899860795 97813978879527 590561131589315
;; small program: loop2(((2 * (x + x)) + x) + y, 2 * ((y + y) + y), x, 0, 1) + loop(x + x, x + x, 1)
