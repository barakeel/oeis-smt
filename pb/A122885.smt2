;; sequence(s): A122885
;; terms: 1 13 61 385 2185 12853 74677 435721 2538625 14798077 86245741 502684561 2929845241 17076419653 99528607141 580095354265 3381043256305 19706164707853 114855943942237 669429501042721
;; small program: loop((loop2((x + x) + y, x, y + y, 1 + 2, 0) - x) - x, x, 1)
;; fast program: loop(((1 + 2) * (loop2((2 * ((x + x) + x)) - y, x, y, 1, 1) - x)) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (* (+ 1 2) (- (w3 x y) x)) x))))
