;; sequence(s): A61404
;; terms: 3840 92160 5160960 495452160 71345111040 14269022208000 3767021862912000 1265719345938432000 526539247910387712000 265375780946835406848000 159225468568101244108800000
;; small program: loop2(loop(2 * (x * y), y, x), 2 + (2 + (y + x)), 2, 1, x)
;; fast program: loop2(loop(2 * (x * y), y, 1) * x, 1 + (2 + (2 + y)), 2, 1, x)
(set-logic UFNIA)
