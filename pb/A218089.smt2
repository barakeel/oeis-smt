;; sequence(s): A218089
;; terms: 1 14 165 2244 35755 659238 13856521 327596552 8612579511 249374246010 7887780406957 270660921021516 10015416945711619 397588957529910734 16855928678721845265 760132325936960344080 36333256253671504279279
;; small program: loop(loop2((x * y) + x, y, x, x, x) - loop2(x * y, y, x, 1, x), 1, 1 + x)
;; fast program: ((loop2(x * y, y, x, 1, 2 + x) * (2 + x)) - loop2(x * y, y, x, 1, 1 + x)) * (1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (- (* (w3 x) (+ 2 x)) (w4 x)) (+ 1 x)))))
