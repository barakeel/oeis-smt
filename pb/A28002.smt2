;; sequence(s): A28002
;; terms: 1 29 551 8701 124047 1659525 21274807 264643037 3219794303 38520062581 454834639623 5314864742733 61583614410319 708640371952997 8107367772115799 92304987577062589 1046598515850404895 11825045589370719573 133200272973175444135 1496451631645514927405
;; small program: loop(loop(loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + x) + ((((x * 2) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
