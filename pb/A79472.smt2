;; sequence(s): A79472
;; terms: 0 2 4 12 30 80 208 546 1428 3740 9790 25632 67104 175682 459940 1204140 3152478 8253296 21607408 56568930
;; small program: loop(loop2(x + y, x, y + y, 0, 2) - x, x, 0)
;; fast program: loop2(x + y, x, x - 2, 2, 2) * loop2(x + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1)
(set-logic UFNIA)
