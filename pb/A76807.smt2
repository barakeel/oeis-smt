;; sequence(s): A76807
;; terms: 1 12 20736 5159780352 184884258895036416 953962166440690129601298432 708801874985091845381344307009569161216 75836984583351248111063210627854719374392938360471552
;; small program: loop(loop((2 + y) * x, 2, x), x * x, 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))) * loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, 1 + 2))
(set-logic UFNIA)
