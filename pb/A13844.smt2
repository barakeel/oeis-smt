;; sequence(s): A13844
;; terms: 343 5764801 96889010407 1628413597910449 27368747340080916343 459986536544739960976801 7730993719707444524137094407 129934811447123020117172145698449 2183814375991796599109312252753832343
;; small program: loop((2 * ((x + x) + x)) + x, loop(1 + (x + x), 2, x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 + 2))))
(set-logic UFNIA)
