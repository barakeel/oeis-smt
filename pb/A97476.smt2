;; sequence(s): A97476
;; terms: 1 4 2304 1194393600 1941728542064640000 25569049282962188245401600000000 5866627428836325123819714259080708096000000000000
;; small program: loop(loop((x * y) * y, y + y, x), x, 1)
;; fast program: loop(loop(x * x, 1, loop(x * y, y + y, 1)) * x, x, 1)
(set-logic UFNIA)
