;; sequence(s): A34662
;; terms: 6 42 546 9198 170898 3304182 65019786 1290094638 25700456418 513002215782 10250010815226 204900053024478 4097000260921938 81930001287820182 1638500006371967466 32769000031591352718 655370000156882923458
;; small program: loop2(1 + loop(x + x, y, x), y, 2, 1, x) * (1 + loop((2 * (x + x)) + x, x, 1))
;; fast program: (1 + loop((x * x) + x, 1, loop(x + x, x, 1))) * (1 + loop2(x * y, y, x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
