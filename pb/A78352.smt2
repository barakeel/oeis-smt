;; sequence(s): A78352
;; terms: 1 18 104976 198359290368 121439531096594251776 24088659210943104643915283693568 1548139828427760582529495524831238344488779776
;; small program: loop(2 * loop((x + x) + x, 2, x), x * x, 1)
;; fast program: (loop2(x * y, y, x, 1, loop((x + x) + x, x - 1, 1 + 2)) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))) * loop2(x * y, y, x, 1, loop((x + x) + x, x, 1))
(set-logic UFNIA)
