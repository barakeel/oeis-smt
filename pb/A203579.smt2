;; sequence(s): A203579
;; terms: 2 2 7 17 57 177 577 1857 6017 19457 62977 203777 659457 2134017 6905857 22347777 72318977 234029057 757334017 2450784257
;; small program: 1 + loop2(y, 2 * ((x + x) + y), x, 1, 1)
;; fast program: 1 + loop(x + x, x - 1, loop2(x + y, x, x - 1, 1, 2))
(set-logic UFNIA)
