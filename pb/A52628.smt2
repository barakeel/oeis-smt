;; sequence(s): A52628
;; terms: 2 2 4 18 48 240 1440 10080 80640 725760 7257600 79833600 958003200 12454041600 174356582400 2615348736000 41845579776000 711374856192000 12804747411456000 243290200817664000
;; small program: loop(x * y, x, loop2(y, 2, x - 2, 2, x))
;; fast program: loop(x * y, x, loop2(y, 2, 2 + (2 - x), 2, x))
(set-logic UFNIA)
