;; sequence(s): A10800
;; terms: 1 5040 101606400 6145155072000 929147446886400000 309071606732292096000000 205619158526859285626880000000 254046582743105184577722777600000000 549289359343832305886569080815616000000000 1979419135331434097492840339627153817600000000000
;; small program: loop(loop2((x * y) + x, 1 + y, 2 + (2 + 2), x, y), x, 1)
;; fast program: loop(loop(loop2(x * y, 1 + y, 2 + (2 + 2), 1, 1 + x), 1, y) * x, x, 1)
(set-logic UFNIA)
