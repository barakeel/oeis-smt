;; sequence(s): A145442
;; terms: 10 100 1000 1000000 1000000000 1000000000000 1000000000000000 1000000000000000000 1000000000000000000000 1000000000000000000000000
;; small program: loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2))) * loop2((x * y) * y, y, x - 2, 1, 2 + (2 * (2 + 2)))
;; fast program: loop(x * x, 1, loop2(x * y, y, x - 2, 1, 2 + (2 * (2 + 2)))) * loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
