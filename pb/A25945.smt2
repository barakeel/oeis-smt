;; sequence(s): A25945
;; terms: 1 22 323 4016 45873 499386 5280511 54817972 562288925 5721711710 57909049419 583934547768 5873255438857 58969928883394 591360924613847 5925240739579004 59333827978882869 593908224257636838
;; small program: loop(((loop((loop2((2 * ((2 * (x + x)) + x)) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
