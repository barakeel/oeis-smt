;; sequence(s): A62814
;; terms: 0 1 6 38 326 3739 53808 927420 18578248 423649565 10828720882 306545462810 9518362652994 321605286435431 11745699035775884 461063683165975712 19357125741005727156 865493449685182242777
;; small program: loop(loop(x + loop2(x * y, y, y, 1, y), y, x), x, 0)
;; fast program: loop(loop(loop2(x * y, y, y - 1, y, y) + x, y, x), x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (w2 x y) (u2 (h2 x y) i2 (j2 x y)))))
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ x (w2 x y)))))
