;; sequence(s): A13759
;; terms: 256 1048576 4294967296 17592186044416 72057594037927936 295147905179352825856 1208925819614629174706176 4951760157141521099596496896
;; small program: loop(x + x, 2 * (2 * (2 + ((x + x) + x))), 1)
;; fast program: loop(x * x, 2, loop(x + x, x, 2)) * loop(x * x, 2, loop2(x * y, y, x, 2, 2 + 2))
(set-logic UFNIA)
