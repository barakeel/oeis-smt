;; sequence(s): A20978
;; terms: 1 29 565 9245 137221 1915949 25677205 334395965 4265954341 53604494669 666045061045 8206250792285 100467119521861 1224084180206189 14859716922480085 179888148281902205
;; small program: loop(loop(loop((x + x) + x, y + y, 1) + (2 * (2 * (x + x))), y, 1) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(loop2(((x + x) + x) + y, y + y, x, 1, 2) * loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
