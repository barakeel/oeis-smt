;; sequence(s): A93967
;; terms: 0 1 4 15 48 145 420 1183 3264 8865 23780 63151 166320 434993 1130948 2925375 7533312 19323713 49395780 125877071
;; small program: loop2((x + x) + y, x, x, 0, x)
;; fast program: loop2((x + x) + y, x, x - 1, x, 0)
(set-logic UFNIA)
