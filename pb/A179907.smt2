;; sequence(s): A179907
;; terms: 1 1 3 7 41 577 47321 54608393 5168247530883 564459384575477049359
;; small program: loop2(y, (x + y) + y, loop2(x + y, x, x, 1, 0), 1, 1)
;; fast program: loop2((2 * x) + y, x, loop2(x + y, x, x, 1, 0) - 1, 1, 1)
(set-logic UFNIA)
