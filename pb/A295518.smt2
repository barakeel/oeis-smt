;; sequence(s): A295518
;; terms: 0 1 4 14 52 220 1092 6388 43588 341444 3022660 29835844 324782916 3864151876 49875956548 694041238340 10356520497988 164956188717892 2793150548587332 50100649026499396
;; small program: loop(loop((x * y) + loop(x + x, y, 1), y - 1, 1) + x, x, 0)
;; fast program: loop(loop(loop(x + x, y - 1, 2) + (x * y), y - 1, 1) + x, x, 0)
(set-logic UFNIA)
