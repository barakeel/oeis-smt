;; sequence(s): A5714
;; terms: 1 10 45 141 357 784 1554 2850 4917 8074 12727 19383 28665 41328 58276 80580 109497 146490 193249 251713
;; small program: loop(loop(loop(loop(loop(2 + (x + y), y, x), y, x) - y, y, x) - y, y, x), 1 + x, 0)
;; fast program: loop(loop(loop(loop((loop(x + y, 1 + y, x) + y) + y, y, x) + y, y, x) + y, y, x) + y, x, 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f8 x y) (+ (+ (v9 x y) y) y))))
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (+ (v8 x y) y))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (v6 x y) y))))
