;; sequence(s): A281199
;; terms: 0 2 10 38 130 420 1308 3970 11822 34690 100610 289032 823800 2332418 6566290 18394910 51310978 142587180 394905492 1090444930
;; small program: loop(loop2(x + y, x, y + y, 0, y) - x, x, 0) * 2
;; fast program: loop((loop2(((x - y) + x) + x, x, y - 1, 1, 0) * y) - x, x, 0) * 2
(set-logic UFNIA)
