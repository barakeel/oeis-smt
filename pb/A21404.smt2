;; sequence(s): A21404
;; terms: 1 20 285 3640 44681 540540 6505045 78138080 937976961 11257033060 135089723405 1621098253320 19453266126841 233439544261580 2801275941271365 33615316957309360 403383826200494321
;; small program: loop(((loop(loop(1 + (2 * (x + x)), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
