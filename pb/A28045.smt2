;; sequence(s): A28045
;; terms: 1 26 443 6304 81573 998502 11807311 136529708 1555263545 17536382578 196332094179 2187124368312 24278204224717 268819199510654 2971083878320247 32794508383067716 361640295036833889 3985248936321941130 43895384100591144715
;; small program: loop(loop2((((((y - 1) + y) * (y * y)) + x) + x) + x, y + y, y, 1, 2) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop2((((((y - 1) + y) * (y * y)) + x) + x) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
