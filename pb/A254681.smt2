;; sequence(s): A254681
;; terms: 1 21 176 936 3750 12342 35112 89232 207207 446875 906048 1743248 3206268 5670588 9690000 16062144 25912029 40797009 62837104 94875000
;; small program: loop(loop(loop(loop(loop(loop(x * x, 2, y) + x, y, x), y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop(loop((((y * y) * y) * y) + x, y, x), y, x), y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f10 x y) (+ (* (* (* y y) y) y) x))))
