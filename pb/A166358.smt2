;; sequence(s): A166358
;; terms: 1 1 3 7 21 61 295 1331 10409 65017 694411 5454879 73145149 689074101 11090013103 121652191051 2282132463953 28550033871857 611369381873683 8587415858721079
;; small program: (loop(loop(loop(1 - (x * y), y, 1) + (x * y), y - 1, 1) + x, x - 1, 0) * x) + 1
;; fast program: ((loop(loop(loop2(1 + (((y * y) - y) * x), y - 2, x, 1, x), 1, y) + x, x - 1, 1) * x) + 1) - x
(set-logic UFNIA)
