;; sequence(s): A13828
;; terms: 27 6561 1594323 387420489 94143178827 22876792454961 5559060566555523 1350851717672992089 328256967394537077627 79766443076872509863361 19383245667680019896796723 4710128697246244834921603689
;; small program: loop((x + x) + x, loop(1 + (x + x), 2, x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1 + 2, 1 + 2)) * loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))
(set-logic UFNIA)
