;; sequence(s): A192879
;; terms: 0 1 4 10 27 70 184 481 1260 3298 8635 22606 59184 154945 405652 1062010 2780379 7279126 19057000 49891873
;; small program: loop2(x + y, x, x, 0, 1) * loop2(y, x + y, x, 1 + 2, 1)
;; fast program: (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(x + y, x, x - 1, 1, 1 + 2)
(set-logic UFNIA)
