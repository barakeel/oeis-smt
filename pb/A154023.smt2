;; sequence(s): A154023
;; terms: 0 6 216 7770 279504 10054374 361677960 13010352186 468011000736 16835385674310 605605873274424 21784976052204954 783653532006103920 28189742176167536166 1014047064810025198056 36477504590984739593850
;; small program: (loop2(loop(2 * ((x + x) + x), 2, x) - y, x, x, 0, 1 - 2) * (1 + 2)) * 2
;; fast program: loop2((loop(x * x, 1, 2 + (2 + 2)) * x) - y, x, x - 1, if x <= 0 then 0 else (2 + (2 + 2)), 0)
(set-logic UFNIA)
