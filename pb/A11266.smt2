;; sequence(s): A11266
;; terms: 1 1 4 48 1536 122880 23592960 10569646080 10823317585920 24936923717959680 127677049435953561600 1438154284846580917862400 35344079704389572637386342400 1882001556099335963795547960115200 215842994465920643015783804449692057600
;; small program: loop(loop2(x * y, 2, y, x, y), x, 1)
;; fast program: (loop(2 * (x * y), x - 1, 1) * (if x <= 0 then 1 else x)) * loop2(x * y, y + y, x - 2, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (v2 x) (ite (<= x 0) 1 x)) (w3 x)))))
