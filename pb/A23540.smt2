;; sequence(s): A23540
;; terms: 1 26 452 6622 88473 1117788 13616464 161765924 1887776825 21743151430 247985329956 2807195642706 31593670364257 353962564536152 3951485554056128 43987455339016168 488552227663629969
;; small program: loop((loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + loop((x + x) + x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
