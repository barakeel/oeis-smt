;; sequence(s): A135138
;; terms: 0 0 1 0 5 2 25 20 129 150 685 1008 3725 6410 20641 39500 116025 238782 659125 1425960
;; small program: loop((loop2(y, (x + y) + y, y, 1, 0) - x) - x, x, 0)
;; fast program: loop((loop2((x + x) + y, x, y - 1, 1, 0) - x) - x, x - 1, 0)
(set-logic UFNIA)
