;; sequence(s): A207836
;; terms: 0 3 16 75 336 1463 6240 26199 108640 445995 1815792 7341347 29505840 117982815 469672384 1862393775 7359403968 28991540051 113892526800 446305331451
;; small program: loop2(y, (2 * (y + y)) - x, x, 0, 2 + x)
;; fast program: loop2((2 * (x + x)) - y, x, x - 2, if (x - 1) <= 0 then x else (2 + 2), 1) * (2 + x)
(set-logic UFNIA)
