;; sequence(s): A1582
;; terms: 1 2 10 36 145 560 2197 8568 33490 130790 510949 1995840 7796413 30454814 118965250 464711184 1815292333 7091038640 27699580729 108202305420
;; small program: loop2((x + x) + y, x, x, loop2(x + y, x, x, 1, 0), 0)
;; fast program: loop2((x + x) + y, x, x, loop2(x + y, x, x - 1, 1, 1), 0)
(set-logic UFNIA)
