;; sequence(s): A206641
;; terms: 14 9 23 32 55 87 142 229 371 600 971 1571 2542 4113 6655 10768 17423 28191 45614 73805
;; small program: loop2(y, x + y, x, loop(2 + (x + x), 2, 2), 1 + (2 * (2 + 2)))
;; fast program: loop2(x + y, x, x, 2 + (2 * (2 + (2 + 2))), 0 - (1 + (2 + 2)))
(set-logic UFNIA)
