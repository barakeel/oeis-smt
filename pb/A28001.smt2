;; sequence(s): A28001
;; terms: 1 29 553 8801 127033 1728833 22655881 289479377 3634751065 45081115937 554241018409 6770845059953 82332981442297 997760934850241 12061135182324937 145526363142458129 1753455257965355929
;; small program: loop((loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + x) + x, x, 1)
(set-logic UFNIA)
