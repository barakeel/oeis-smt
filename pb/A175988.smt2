;; sequence(s): A175988
;; terms: 1 0 ~1 16 759375 191749544167774320464809980317709376
;; small program: loop(loop2(x * y, y, y, x, x) - 1, x, 0) + 1
;; fast program: loop((loop2(x * y, y, y - 2, 1, x) * ((x * x) * x)) - 1, x, 0) + 1
(set-logic UFNIA)
