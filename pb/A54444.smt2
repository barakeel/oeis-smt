;; sequence(s): A54444
;; terms: 1 5 20 71 235 744 2285 6865 20284 59155 170711 488400 1387225 3916061 10996580 30737759 85573315 237387960 656451269 1810142185
;; small program: loop(loop((1 + (x + x)) * loop2(x + y, x, x + x, 1, 0), 1, y) - x, x, 1)
;; fast program: loop(loop(loop2(((x - y) + x) + x, x, x - 1, 2, 1) * (1 + (x + x)), 1, y) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (* (w5 x) (+ 1 (+ x x))))))
(assert (= g4 1))
