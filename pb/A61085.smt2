;; sequence(s): A61085
;; terms: 4 8 12 16 170 204 238 272 306 340 374 408 442 476 510 544 578 612 646 680
;; small program: (loop(2, 2 + (2 - x), 1 + loop(x * x, 2, 2)) * 2) * (1 + x)
;; fast program: (loop(2, 2 + (2 - x), 1 + (2 * (2 * (2 + 2)))) * 2) * (1 + x)
(set-logic UFNIA)
(declare-fun f0 () Int)
