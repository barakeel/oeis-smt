;; sequence(s): A215502
;; terms: 4 1 13 13 73 121 481 1009 3361 7969 24193 61249 177025 464257 1307137 3493633 9699841 26190337 72173569 195941377
;; small program: (loop((loop2(2 * (x + y), x, y, 0, 1) - x) - x, x, 1) * (1 + 2)) + 1
;; fast program: loop2(y - x, x + x, x, 2, 1) + (2 * loop2(2 * (x + y), x, x - 1, 1, 1))
(set-logic UFNIA)
