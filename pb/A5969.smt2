;; sequence(s): A5969
;; terms: 1 2 18 99 724 4820 33381 227862 1564198 10714823 73457064 503438760 3450734281 23651386922 162109796922 1111115037483 7615701104764 52198777931900 357775783071021 2452231602371646
;; small program: loop(loop(x * x, 2, loop2(x + y, x, y, 1, 0)) + x, x, 1)
;; fast program: loop(loop(x * x, 2, loop2(x + y, x, y - 1, 1, 1)) + x, x, 1)
(set-logic UFNIA)
