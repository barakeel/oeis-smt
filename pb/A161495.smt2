;; sequence(s): A161495
;; terms: 3 35 432 5405 67773 850080 10663107 133755235 1677792528 21045816925 263993558397 3311470367040 41538271098243 521045872287395 6535871471114352 81984366749625245 1028391763981932093
;; small program: loop2(((2 * (x + x)) - y) + x, x, x, 1, 0) * loop2(x + y, x, 1 + (x + x), 1, 2)
;; fast program: loop2(((2 * (x + x)) - y) + x, x, x - 1, (if x <= 0 then 0 else (2 + 2)) + 1, 1) * loop2(x + y, x, x + x, 1 + 2, 1)
(set-logic UFNIA)
