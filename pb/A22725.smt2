;; sequence(s): A22725
;; terms: 1 26 455 6760 92301 1200966 15177955 188364020 2310685001 28133195506 340850357055 4116281407680 49604299052101 596924491783646 7176484756065755 86224982057057740 1035557295293705601
;; small program: loop((loop(loop(1 + (2 * (2 * (x + x))), y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop(loop(loop2((2 * (2 * (x + x))) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * (2 * ((x + x) + x))), x, 1)
(set-logic UFNIA)
