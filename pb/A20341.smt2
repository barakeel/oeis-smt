;; sequence(s): A20341
;; terms: 1 24 397 5652 74665 946992 11736613 143526444 1741517569 21034565640 253379036989 3047347017156 36615998359513 439728040092768 5279095003079125 63365680208288988 760504096286734897
;; small program: loop((loop((loop(loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * ((x + x) + x))) + y, (2 * (y + y)) + y, x, 1, 1 + (2 + 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
