;; sequence(s): A17999
;; terms: 1 20 279 3370 37841 407640 4281739 44256950 452652981 4597133860 46465625999 468116448930 4705386343321 47223418005680 473421066847059 4742518890351310 47483346499724861 475240568299871100 4755255406504488919 47572502130747596090
;; small program: loop(((loop((loop(2 * ((2 * (x + x)) + x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2(((1 + 2) * ((x + x) + y)) + x, (y + y) + y, x, 1, 1), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (* (+ 1 2) (+ (+ x x) y)) x))))
