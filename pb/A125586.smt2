;; sequence(s): A125586
;; terms: 1 4 17 74 323 1400 6005 25478 107015 445556 1841273 7561922 30897227 125714672 509767421 2061390206 8317305359 33498803948 134727010049 541232563130
;; small program: loop(((loop2(((x + x) + x) + y, 2 * (y + y), y - 1, 1, 2) + x) + x) + x, x, 1)
;; fast program: (((loop(x + x, x + x, 2) - 1) - loop2(x * y, y, x - 1, x, 1 + 2)) + 1) - loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (+ (- (- (v2 x) 1) (w3 x)) 1) (w4 x)))))
