;; sequence(s): A22452
;; terms: 1 21 290 3330 34491 334791 3109900 27997860 246301781 2129087961 18155626710 153166509990 1281087729871 10640517267531 87874475534720 722286313011720 5913514800094761 48255642147081501
;; small program: loop((loop((loop(1 + (2 * (2 * (x + x))), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
