;; sequence(s): A351409
;; terms: 1 8 3888 764411904 214990848000000000 224634374557469245440000000000 1880461634768804771224006806208512000000000000 240091793104790737576620139562796649430329798636339200000000000000 813675117804798213250391541747787241264315446434692481270971279693253181440000000000000000
;; small program: loop2(loop((x * y) + x, y, x), y, x + x, 1 + x, x)
;; fast program: (loop(x * x, 1, loop2((x * y) + x, y, x, 1, x)) * (1 + x)) * loop(x * x, 1, loop2(x * y, y, x, 1, loop(x * y, x, 1)))
(set-logic UFNIA)
