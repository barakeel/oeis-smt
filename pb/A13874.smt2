;; sequence(s): A13874
;; terms: 15 11390625 8649755859375 6568408355712890625 4987885095119476318359375 3787675244106352329254150390625 2876265888493261300027370452880859375 2184164409074570299708284437656402587890625 1658599848141001821340978494845330715179443359375
;; small program: loop((loop(x * x, 2, 2) * x) - x, 1 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1)) * loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + 2))) - 1)) * loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1))
(set-logic UFNIA)
