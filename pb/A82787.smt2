;; sequence(s): A82787
;; terms: 2 60 6720 1663200 726485760 494010316800 482718652416000 641171050071552000 1111363153457356800000 2436552577639909048320000 6591982246414881207091200000 21572261901392698750205952000000 83992431415453295380032651264000000 383725422380885198036206312488960000000
;; small program: loop2((2 + y) * x, 1 + y, 1 + (x + x), 1, x)
;; fast program: loop2((2 + y) * x, 1 + y, 1 + x, 1, x + x) * loop2(x * y, 1 + y, x, 1, 2 + x)
(set-logic UFNIA)
