;; sequence(s): A20726
;; terms: 1 27 493 7599 106645 1411431 17955757 222093423 2690508229 32080473975 377794514461 4405195463487 50953884924853 585473143132359 6690087028209805 76090252032830991 861988540696279717
;; small program: loop(loop(loop(loop((2 + y) * x, 2, x) - x, y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, (y + y) + y, x, 1, 1 + 2) * loop(x + x, x, 1), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
