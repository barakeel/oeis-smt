...
(assert (forall ((x Int)) (= (f2 x) (+ (+ (modf (- 2 (v3 x)) (+ 2 2)) 1) x))))
...
(assert (forall ((x Int)) (= (f5 x) (modf (- (modf (modf (- (modf (modf (- (v6 x) 1) (+ 1 x)) (+ 1 2)) 1) (+ 1 x)) (+ 1 2)) 1) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (fast x) (- (divf (+ (* (v5 x) 2) 1) (+ 1 2)) x))))
