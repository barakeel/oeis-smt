;; sequence(s): A52608
;; terms: 1 1 6 42 408 4920 71280 1204560 23264640 505491840 12203654400 324084499200 9388910361600 294668851276800 9959509521561600 360665744414976000 13931586106454016000 571775010100310016000
;; small program: loop(x * y, x, loop2(y, (x + y) + y, x, 1, 1))
;; fast program: loop(x * y, x, 1) * loop2((x + x) + y, x, x - 1, 1, 1)
(set-logic UFNIA)
