;; sequence(s): A176343
;; terms: 0 1 2 5 16 81 649 8438 177199 6024767 331362186 29491234555 4246737775921 989489901789594 373037692974676939 227552992714552932791 224594803809263744664718 358677901683394200229554647
;; small program: loop(1 + loop2(x + y, x, y, 0, x), x, 0)
;; fast program: loop(1 + (loop2(x + y, x, y - 1, 1, 1) * x), x - 1, if x <= 0 then 0 else 1)
(set-logic UFNIA)
