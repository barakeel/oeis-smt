;; sequence(s): A52712
;; terms: 0 1 2 24 480 13440 483840 21288960 1107025920 66421555200 4516665753600 343266597273600 28834394170982400 2652764263730380800 265276426373038080000 28649854048288112640000
;; small program: loop2(2 * ((x * y) + x), 1 + y, x - 2, x, x)
;; fast program: loop2(x * y, 1 + y, x - 2, 1, 1 + x) * loop(x + x, x - 2, x)
(set-logic UFNIA)
