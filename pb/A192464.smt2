;; sequence(s): A192464
;; terms: 2 4 7 16 38 95 242 624 1619 4216 11002 28747 75170 196652 514607 1346880 3525566 9229063 24160402 63250168
;; small program: loop2(loop2(x + y, x, y, 0, 1) + x, (1 + y) + y, 2, 1, x)
;; fast program: ((if x <= 0 then 0 else loop2(((x - y) + x) + x, x, x - 1, 2, 1)) + loop2(x + y, x, x - 2, 1, 1)) + 1
(set-logic UFNIA)
