;; sequence(s): A22370
;; terms: 2 16 18 34 52 86 138 224 362 586 948 1534 2482 4016 6498 10514 17012 27526 44538 72064
;; small program: loop2(y, x + y, x, 2, loop(x * x, 2, 2))
;; fast program: 2 * loop2(y, x + y, x, 1, 2 * (2 + 2))
(set-logic UFNIA)
