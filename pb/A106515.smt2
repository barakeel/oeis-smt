;; sequence(s): A106515
;; terms: 1 2 6 15 38 94 231 564 1372 3329 8064 19512 47177 114010 275430 665247 1606534 3879302 9366735 22615356
;; small program: loop2((x + x) + y, x, x, 1, 1) - loop2(x + y, x, x, 0, 1)
;; fast program: loop2((x + x) + y, x, x - 1, (if x <= 0 then 0 else 1) + 2, 1) - loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
