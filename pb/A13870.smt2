;; sequence(s): A13870
;; terms: 14 7529536 4049565169664 2177953337809371136 1171355575953987221848064 629983141281877223603213172736 338820052976784335907174521413566464 182225556172186058674940229804729969934336 98005277522749794820791054154499091349964324864
;; small program: loop((loop(x * x, 2, 2) - 2) * x, 1 + ((2 * (x + x)) + x), 1)
