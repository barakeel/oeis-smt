;; sequence(s): A121801
;; terms: 0 6 10 32 78 210 544 1430 3738 9792 25630 67106 175680 459942 1204138 3152480 8253294 21607410 56568928 148099382
;; small program: loop(loop2(x + y, x, y + y, 2, 2) - x, x, 0)
;; fast program: (if x <= 0 then 0 else loop2(x + y, x, x - 2, 2, 2)) * loop2(x + y, x, x, 2, 1)
(set-logic UFNIA)
