;; sequence(s): A13866
;; terms: 13 4826809 1792160394037 665416609183179841 247064529073450392704413 91733330193268616658399616009 34059943367449284484947168626829637 12646218552730347184269489080961456410641 4695452425098908797088971409337422035076128813
;; small program: loop(loop((2 + y) * x, 2, x) + x, 1 + ((2 * (x + x)) + x), 1)
