;; sequence(s): A328352
;; terms: 0 1 56 2831 141706 7086081 354307956 17715417331 885770964206 44288548698581 2214427437370456 110721371880729831 5536068594097526706 276803429705181511081 13840171485260601432956 692008574263037701042331 34600428713151923199089206 1730021435657596350689323581
;; small program: loop(loop(loop(1 + (2 * ((2 * (x + x)) + x)), x, 0) * loop2(x * y, y, x - 1, 1, 1 + (2 + 2)), 1, y) + x, x, 0)
;; fast program: loop(loop(loop2(1 + (x * y), y, x - 1, 1, 2 + (2 * (2 + 2))) * loop2(x * y, y, x - 1, 1, 1 + (2 + 2)), 1, y) + x, x, 0)
(set-logic UFNIA)
