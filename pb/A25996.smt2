;; sequence(s): A25996
;; terms: 1 26 449 6550 87765 1122522 13981657 171489758 2084497085 25203559810 303786156609 3654919330374 43925837020261 527579714133290 6334254431345705 76034189070980398 912572474428695693
;; small program: loop((loop((loop2(loop((2 + y) * x, 2, x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop((loop(loop(x + x, x, loop2(1 + (x * y), y, x, 1, 2 + (2 + 2))), 1, y) + (2 * (x + x))) + x, x, 1), 1, y) + (((x + x) + x) * 2)) + x, x, 1)
(set-logic UFNIA)
