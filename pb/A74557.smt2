;; sequence(s): A74557
;; terms: 3 18 126 972 7938 67068 578826 5065092 44732898 397517868 3547309626 31744033812 284606850258 2554928116668 22955161402026 206361331428132 1855841341806018 16694108488251468 150196195641088026
;; small program: loop((x + x) + x, x, 1 + (loop((x + x) + x, x, 1) + loop(x + x, x, 1)))
;; fast program: loop((x * x) + x, 1, loop2(x * y, y, x, 1, 1 + 2)) + loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
