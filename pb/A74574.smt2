;; sequence(s): A74574
;; terms: 3 20 138 980 7122 52700 395418 2998820 22932642 176524460 1365982698 10616089460 82804904562 647865527420 5082373099578 39962451176900 314860495170882 2485193267125580 19646626804658058 155533156747557140
;; small program: loop2(((2 * ((x + x) + x)) + ((y * y) * y)) + x, y + y, x, 2, 1) + loop((2 * (x + x)) + x, x, 1)
;; fast program: (loop((x * x) * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + 2))) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
