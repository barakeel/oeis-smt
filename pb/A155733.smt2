;; sequence(s): A155733
;; terms: 1 2 10 10003 100150090027004050247
;; small program: loop(y + loop2(x * y, y, y, x, x), x, 1)
;; fast program: loop((loop2(x * y, y, y - 2, x, x) * (x * x)) + y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ y (w1 x y)))))
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (* (w3 x y) (* x x)) y))))
