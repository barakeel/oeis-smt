;; sequence(s): A66259
;; terms: 1 4 18 75 320 1352 5733 24276 102850 435655 1845504 7817616 33116057 140281700 594243090 2517253683 10663258432 45170286424 191344405725 810547906740
;; small program: loop(x * x, 1, loop2(x + y, x, x, 1, 1)) * loop2(x + y, x, x, 1, 0)
;; fast program: loop(x * x, 1, loop2(x + y, x, x, 1, 1)) * loop2(x + y, x, x - 1, 1, 1)
(set-logic UFNIA)
