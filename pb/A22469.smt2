;; sequence(s): A22469
;; terms: 1 23 350 4450 51231 554433 5756260 58034900 572630861 5558653243 53279890170 505596134550 4759287370891 44506489496453 413949260130080 3832708325439400 35351885537967321 325028008388124063 2980145152236043990 27260474825925725450
;; small program: loop((loop(loop(1 + (2 * (2 * (x + x))), y, 1) + loop((x + x) + x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + x) + (((x * 2) * 2) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (* 2 (* 2 (+ x x))) y))))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (v5 x y) x) (* (* (* x 2) 2) 2)))))
