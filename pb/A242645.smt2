;; sequence(s): A242645
;; terms: 1 111 121111 1331121111 146411331121111 161051146411331121111 1771561161051146411331121111 194871711771561161051146411331121111 214358881194871711771561161051146411331121111 2357947691214358881194871711771561161051146411331121111
;; small program: loop(loop(loop(loop2(x * y, y, x, 1 + (2 + (2 * (2 + 2))), 2 + (2 * (2 + 2))), 1, y) * x, y, 1) + x, x, 1)
;; fast program: loop(loop(loop(loop2(x * y, y, y, 1, 2 + (2 * (2 + 2))) * x, x, 1) * loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (* (w7 x y) x))))
