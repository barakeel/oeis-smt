;; sequence(s): A232998
;; terms: 2 144 373248 34828517376 116997070082015232 14148730862126934905585664 61597414834991926584601402260062208 9654059848037384195421778226918440269760167936 54470327768942860701549299585257673594965942082487957061632
;; small program: loop(2 * loop(2 * ((x + x) + x), y + y, x), x, 2)
;; fast program: ((loop2(x * y, y + y, x, 2, 1 + 2) * loop2(x * y, y + y, x, 1, 2)) * loop2(x * y, (y + y) + y, x, 1, 1 + 2)) * loop2(x * y, (y + y) + y, x, 1, 2 + 2)
(set-logic UFNIA)
