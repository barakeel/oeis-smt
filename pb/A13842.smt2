;; sequence(s): A13842
;; terms: 7 117649 1977326743 33232930569601 558545864083284007 9387480337647754305649 157775382034845806615042743 2651730845859653471779023381601 44567640326363195900190045974568007 749048330965186233494494102694564493649
;; small program: loop((2 * ((x + x) + x)) + x, 1 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) * loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 + 2))))
(set-logic UFNIA)
