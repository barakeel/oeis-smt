;; sequence(s): A16301
;; terms: 1 18 237 2810 31941 356538 3947917 43557210 479780181 5280836858 58105480797 639241667610 7032065242021 77354752161978 850912446296877 9360087771874010 102961219803721461 1132574689406603898
;; small program: loop((loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop2(((2 * (x + x)) + x) + y, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
