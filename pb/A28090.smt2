;; sequence(s): A28090
;; terms: 1 28 503 7394 96993 1183584 13750411 154260238 1686734885 18091012940 191193729519 1997666285082 20686716623977 212717150997496 2175158274827027 22143785088967526 224633627211465069
;; small program: loop(((loop((loop2((2 * ((2 * (x + x)) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((((y * y) * y) + x) + x) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
