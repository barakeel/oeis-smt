;; sequence(s): A105576
;; terms: 3 4 0 ~6 ~4 10 20 2 ~36 ~38 36 114 44 ~182 ~268 98 636 442 ~828 ~1710
;; small program: 1 + loop2(1 + (y + y), y - x, x, 2, 1)
;; fast program: 1 + loop2((x - y) - y, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2)
(set-logic UFNIA)
