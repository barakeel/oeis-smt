;; sequence(s): A25937
;; terms: 1 18 211 2052 18025 148806 1179487 9089784 68647909 510709914 3756191803 27381204396 198197187553 1426557620142 10220981500759 72957382445088 519164877763357 3684933735388290 26099214855723955
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + x) + x, y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
