;; sequence(s): A26561
;; terms: 1 25 405 5405 64661 721725 7683685 79078285 793624821 7813101725 75772440965 726132366765 6891899656981 64900354798525 607206802510245 5650395374640845 52342063252985141 483011998315708125
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
