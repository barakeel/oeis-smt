;; sequence(s): A13799
;; terms: 2197 62748517 1792160394037 51185893014090757 1461920290375446110677 41753905413413116367045797 1192533292512492016559195008117 34059943367449284484947168626829637 972786042517719014174576083150881262357
;; small program: loop(loop((2 + y) * x, 2, x) + x, loop(1 + (x + x), 2, x), 1)
