;; sequence(s): A21824
;; terms: 1 20 267 3010 31073 304920 2901319 27075950 249555405 2281579300 20749095731 188036746170 1700122392697 15347941075760 138412864844703 1247405586235270 11236794818538149 101192043527859900
;; small program: loop(loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) + loop((x + x) + x, 2, x), x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
