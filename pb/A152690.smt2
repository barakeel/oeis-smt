;; sequence(s): A152690
;; terms: 1 2 4 16 304 34864 24918064 125436246064 5056710181206064 1834938528961266006064 6658608419043265483506006064 265790273955000365854215115506006064
;; small program: loop(loop(loop(x * y, y, x), y, 1) + x, x, 1)
;; fast program: loop(loop(loop(x * y, y, y) * x, y - 1, y) + x, x, 1)
(set-logic UFNIA)
