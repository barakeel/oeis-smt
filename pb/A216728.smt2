;; sequence(s): A216728
;; terms: 1 1 30 4410 1837080 1660289400 2778905329200 7757931431250000 33536835305077104000 212373276256391153904000 1887114765997607482496160000 22736049196010108202227823840000 361148501823912048339843750000000000 7389146090843722060953495522716592000000 190939093198813987007780146685866111584000000
;; small program: loop(((y - 1) + y) * (x * y), x, 1) * loop2(x * y, y, x - 1, 1, 1 + (x + x))
;; fast program: (loop(x * y, x, 1) * loop2(x * y, 2 + y, x - 1, 1, 1 + 2)) * loop2(x * y, y, x - 1, 1, 1 + (x + x))
(set-logic UFNIA)
