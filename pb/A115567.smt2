;; sequence(s): A115567
;; terms: 0 1 3 7 15 31 63 126 246 465 847 1485 2509 4095 6475 9948 14892 21777 31179 43795
;; small program: loop(loop(loop(loop(loop(x + y, y - 2, x), y, x) + y, y - 2, x), y, x) + y, x, 0)
;; fast program: loop(loop(loop(loop(loop(x + y, y, x), y - 1, x) + y, y - 2, x) + y, y, x), x - 1, x)
(set-logic UFNIA)
