;; sequence(s): A5443
;; terms: 0 1 2 12 72 600 5760 65520 846720 12337920 199584000 3552595200 68976230400 1450895846400 32866215782400 797681364480000 20650793619456000 568032822669312000 16543733655601152000 508598164809326592000
;; small program: loop(x * y, x, loop2(x + y, x, x, 0, 1))
;; fast program: loop(x * y, x - 1, 1) * loop2(x + y, x, x - 2, x, x)
(set-logic UFNIA)
