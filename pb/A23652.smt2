;; sequence(s): A23652
;; terms: 1 5 14 31 61 112 197 337 566 939 1545 2528 4121 6701 10878 17639 28581 46288 74941 121305
;; small program: loop(loop2(2 + (x + y), 2 + x, y, 1, 1) + x, x, 1)
;; fast program: ((loop2(x + y, x, x, 1 + (2 * (2 + (2 + 2))), 2 * (2 + 2)) - 2) - 2) - (2 * (2 * (2 + x)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (- (w2 x) 2) 2) (* 2 (* 2 (+ 2 x)))))))
