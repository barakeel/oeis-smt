;; sequence(s): A28113
;; terms: 1 26 437 6082 76653 913218 10527349 119017634 1330185725 14766710530 163286454981 1801494203106 19849649018317 218551250986562 2405323875398933 26466271609592098 291175987346320029
;; small program: loop((loop(loop2((loop((2 + y) * x, 2, x) - x) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
