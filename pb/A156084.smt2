;; sequence(s): A156084
;; terms: 0 4 68 1224 21960 394060 7071116 126886032 2276877456 40856908180 733147469780 13155797547864 236071208391768 4236125953503964 76014195954679580 1364019401230728480 24476335026198433056 439210011070341066532
;; small program: loop(loop2((2 * (x + x)) + y, x, y + y, 0, 1) - x, x, 0)
;; fast program: loop2((2 * (x + x)) + y, x, x, 1, 0) * loop2((2 * (x + x)) + y, x, x - 2, if (x - 1) <= 0 then x else (2 + 2), 1)
(set-logic UFNIA)
