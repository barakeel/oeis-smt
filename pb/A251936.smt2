;; sequence(s): A251936
;; terms: 10 43 120 265 506 875 1408 2145 3130 4411 6040 8073 10570 13595 17216 21505 26538 32395 39160 46921
;; small program: (((loop(loop(loop(2 + (x + y), y - 1, x) + y, y, x) + y, 1 + x, 0) * 2) * 2) + 2) + x
;; fast program: (((((((((((((loop(loop(2 + (x + y), y, x) + y, 2 + x, 0) - 2) * x) + 2) + 2) + 2) + x) + 2) + x) + 2) + x) + x) + x) + x) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* (- (v3 x) 2) x) 2) 2) 2) x) 2) x) 2) x) x) x) x) x))))
