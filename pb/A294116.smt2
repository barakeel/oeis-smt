;; sequence(s): A294116
;; terms: 2 21 23 44 67 111 178 289 467 756 1223 1979 3202 5181 8383 13564 21947 35511 57458 92969
;; small program: loop2(1 + y, x + y, x, 2, loop(2 * (2 + x), 2, 2))
;; fast program: loop2(x + y, x, x, 2, 1 + (2 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
