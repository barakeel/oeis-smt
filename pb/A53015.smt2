;; sequence(s): A53015
;; terms: 0 1 4 19683 340282366920938463463374607431768211456
;; small program: loop2(x * y, y, loop2(x * y, x, x, 1, x), 1, x)
;; fast program: loop2(loop2(x * y, y, y - 2, 1, x) * (x * x), y, x - 1, x, x)
(set-logic UFNIA)
