;; sequence(s): A129905
;; terms: 1 3 6 17 43 114 297 779 2038 5337 13971 36578 95761 250707 656358 1718369 4498747 11777874 30834873 80726747
;; small program: loop(loop2(y - x, x, y + y, 1 + 2, 2) - x, x, 1)
;; fast program: (2 * loop(x * x, 1, loop2(x + y, x, x, 0, 1))) + loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1))
(set-logic UFNIA)
