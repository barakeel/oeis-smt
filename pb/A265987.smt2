;; sequence(s): A265987
;; terms: 2 2 6 10 30 66 182 442 1166 2930 7590 19306 49662 126882 325526 833050 2135150 5467346 14007942 35877322
;; small program: 1 + loop2((x + y) + y, x + x, x, 1, 0)
;; fast program: 1 + loop2((x + y) + y, x + x, x - 1, 1, 2)
(set-logic UFNIA)
