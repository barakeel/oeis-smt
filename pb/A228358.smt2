...
(assert (forall ((x Int)) (= (f5 x) (modf (- (modf (modf (- (modf (- (modf (+ (modf (+ (ite (<= (- (modf (+ 1 (v6 x)) (+ 1 x)) 2) 0) 1 x) x) 2) 1) (+ 1 2)) 1) (+ 1 2)) 1) (+ 1 x)) (+ 1 2)) 1) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (fast x) (+ (divf (+ (v5 x) 1) (+ 1 2)) (ite (<= x 0) 1 2)))))
