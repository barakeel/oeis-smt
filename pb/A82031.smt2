;; sequence(s): A82031
;; terms: 1 5 28 176 1240 9752 85120 819296 8639872 99209600 1233416704 16517058560 237137769472 3634932675584 59263206154240 1024222802014208 18706559855656960 360062627304341504 7285354765603176448
;; small program: loop(loop(loop((x * y) + loop(x + x, y, 1), y, 1) + (x * y), y, 1) + (x * y), x, 1)
;; fast program: loop(loop(loop(loop(x + x, y - 1, 2) + (x * y), y, 1) + (x * y), y, 1) + (x * y), x, 1)
(set-logic UFNIA)
