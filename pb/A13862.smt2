;; sequence(s): A13862
;; terms: 12 2985984 743008370688 184884258895036416 46005119909369701466112 11447545997288281555215581184 2848515765597237675947403497177088 708801874985091845381344307009569161216 176372588156290374069930666601805113523699712
;; small program: loop(loop((2 + y) * x, 2, x), 1 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2)))) * loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2))))
(set-logic UFNIA)
