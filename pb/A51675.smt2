;; sequence(s): A51675
;; terms: 1 16 314928 1352605460594688 403107840000000000000000000000000 4157825501361955044460594652554199040000000000000000000000000
;; small program: loop(loop2(x * y, y, y * y, x, y), 1 + x, 1)
;; fast program: loop(loop(loop2(loop2(x * y, y, y - 1, 1, x) * (x * x), y, 2, 1 + x, x), 1, y) * x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (w5 x y) (u5 (h5 x y) i5 (j5 x)))))
