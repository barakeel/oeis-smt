;; sequence(s): A28149
;; terms: 1 30 573 8902 122829 1570422 19052461 222558534 2527254477 28081375894 306750949869 3305552387046 35230183832845 372099762869046 3900761112145197 40636558684412038 421103652688800333
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((2 * (x + x)) + x)) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
