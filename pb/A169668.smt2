;; sequence(s): A169668
;; terms: 6 720 3628800 1316818944000 52563198423859200000 327312129899898454671360000000 428017682605583614976547335700480000000000
;; small program: loop(loop((x * y) + x, y + y, x), 1 + x, 1)
;; fast program: loop2(loop(x * y, y, 1 + y) * x, 2 + y, 1 + x, 1, 2)
(set-logic UFNIA)
