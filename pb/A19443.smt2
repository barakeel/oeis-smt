;; sequence(s): A19443
;; terms: 1 19 247 2743 28063 273847 2596399 24174631 222479455 2032023895 18467516431 167287650439 1512085646527 13647818683063 123064923768943 1108992721390567 9989389232302879 89955248709321751
;; small program: loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), x, 1)
;; fast program: loop((loop(loop2(((x + x) + x) + y, y + y, x, 1, 2) * loop(x + x, x - 1, 2), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
