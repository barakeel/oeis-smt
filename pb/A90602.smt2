;; sequence(s): A90602
;; terms: 0 1 4 243 1048576 762939453125 170581728179578208256 18562115921017574302453163671207 1427247692705959881058285969449495136382746624 106111661199647248543687855752712667991103904330482569981872649
;; small program: x * loop2(x * y, y, (x - 2) * x, x, x)
;; fast program: (x * loop2(x * y, y, x - 2, x, x)) * loop2(x * y, y, x - 2, 1, loop2(x * y, y, x - 2, x, x))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* x (w1 x)) (w2 x)))))
