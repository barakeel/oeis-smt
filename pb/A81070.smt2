;; sequence(s): A81070
;; terms: 0 5 45 320 2205 15125 103680 710645 4870845 33385280 228826125 1568397605 10749957120 73681302245 505019158605 3461452808000 23725150497405 162614600673845 1114577054219520 7639424778862805
;; small program: loop2(y - x, x, 2 * (x + x), 2, 1) - 2
;; fast program: (loop(x * x, 1, loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2)) - 2) - 2
(set-logic UFNIA)
