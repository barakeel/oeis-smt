;; sequence(s): A25949
;; terms: 1 23 353 4579 54393 613419 6692161 71391683 749696585 7783261915 80123162769 819556503987 8342165636377 84594465902411 855327149649377 8628331464477091 86883794517646569 873641784546629307
;; small program: loop(((loop((loop2((2 * ((2 * (x + x)) + x)) + ((y * y) * y), y + y, y, 1, 2) + x) + x, y, 1) + x) + x) + x, x, 1)
