;; sequence(s): A13811
;; terms: 6859 893871739 116490258898219 15181127029874798299 1978419655660313589123979 257829627945307727248226067259 33600614943460448322716069311260139 4378865740046709085864680868712732574619 570658162108627174778971075491512021856922699
;; small program: loop((2 * loop((x + x) + x, 2, x)) + x, loop(1 + (x + x), 2, x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 * (2 + 2)))))) * loop2(x * y, y, 1 + (x + x), 1, 1 + (2 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
