;; sequence(s): A181745
;; terms: 23 719 479001599 265252859812191058636308479999999
;; small program: loop((x * y) + x, 2 + loop((x + x) + x, x, 1), 1) - 1
;; fast program: loop(loop2(x * y, 1 + y, 2 + 2, 1, x) * loop(x * y, x - 1, 1), 1, loop((x + x) + x, x, 1)) - 1
(set-logic UFNIA)
