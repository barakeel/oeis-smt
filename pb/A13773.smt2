;; sequence(s): A13773
;; terms: 529 6436343 78310985281 952809757913927 11592836324538749809 141050039560662968926103 1716155831334586342923895201 20880467999847912034355032910567 254052654154149545721997685422868689
;; small program: loop(loop(x * y, 2 + 2, x) - x, 2 + ((x + x) + x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1)) * loop2(x * y, y, 2 + x, 1, (2 * (2 * (2 + (2 + 2)))) - 1)
(set-logic UFNIA)
