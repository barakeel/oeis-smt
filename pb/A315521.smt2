...
(assert (= v0 (u0 g0 h0)))
(assert (forall ((x Int)) (= (small x) (+ (divf (+ (+ (* (+ (divf (+ (+ (* (* (divf (+ (* (* (+ (+ (divf (+ (+ (divf (+ (* 2 (+ x x)) x) v0) 1) x) (ite (<= x 0) 1 2)) x) x) 2) 2) 1) (+ 1 2)) (ite (<= x 0) 1 2)) 2) 1) x) (+ 1 2)) x) 2) 1) x) (+ 1 2)) x))))
(assert (forall ((x Int)) (= (fast x) (+ (divf (+ (+ (* (+ (divf (+ (+ (* (* (divf (+ (* (* (+ (+ (divf (+ (+ (divf (+ (* 2 (+ x x)) x) (+ 1 (+ 2 (* 2 (+ 2 2))))) 1) x) (ite (<= x 0) 1 2)) x) x) 2) 2) 1) (+ 1 2)) (ite (<= x 0) 1 2)) 2) 1) x) (+ 1 2)) x) 2) 1) x) (+ 1 2)) x))))
