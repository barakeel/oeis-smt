;; sequence(s): A192955
;; terms: 0 1 2 7 18 41 84 161 294 519 894 1513 2528 4185 6882 11263 18370 29889 48548 78761
;; small program: loop(loop(loop2(2 + (x + y), x, y, 0, 2) + x, y - 2, x), x, x)
;; fast program: ((loop2(x + y, x, x, 2 + 2, 1 + 2) - (2 * (2 + x))) * 2) - (x * x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (- (w3 x) (* 2 (+ 2 x))) 2) (* x x)))))
