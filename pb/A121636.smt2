;; sequence(s): A121636
;; terms: 0 1 5 23 122 754 5364 43308 391824 3929616 43287840 519711840 6755460480 94527008640 1416783432960 22646604153600 384576130713600 6914404440115200 131217341055897600 2621176954176614400
;; small program: loop(((x * y) + loop(x * y, y, 1)) + x, x - 1, x)
;; fast program: loop(((x * y) + loop(x * y, y - 1, y)) + x, x - 1, x)
(set-logic UFNIA)
