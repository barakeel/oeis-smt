;; sequence(s): A28212
;; terms: 1 35 775 13895 220591 3239495 45114175 605081015 7896440431 100983137255 1271943884575 15837914099735 195494604120271 2397051804927815 29242027752046975 355340314794184055 4305125050033912111 52039828472216683175 627954645427055761375
;; small program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + (2 * (2 * (x + x))), x, 1)
;; fast program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
