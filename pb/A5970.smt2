;; sequence(s): A5970
;; terms: 1 10 26 75 196 520 1361 3570 9346 24475 64076 167760 439201 1149850 3010346 7881195 20633236 54018520 141422321 370248450
;; small program: loop(loop(x * x, 1, loop2(x + y, x, y, 1, 2)) + x, x, 1)
;; fast program: (loop2(x + y, x, x, 1, 2) * loop2(x + y, x, x, 1 + 2, 1)) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (w3 x) (w4 x)) 2))))
