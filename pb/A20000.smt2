;; sequence(s): A20000
;; terms: 1 23 362 4870 60411 715533 8243572 93366380 1046230421 11644889443 129058033182 1426436938290 15738640474831 173461105001753 1910430676985192 21031277618176600 231459987587209641
;; small program: loop((loop((loop(loop((2 + y) * x, 2, x) - x, y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((x + x) + x)) + x) + y, (2 * (y + y)) + y, x, 1, 1 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
