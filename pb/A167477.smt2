;; sequence(s): A167477
;; terms: 1 3 12 44 149 479 1487 4503 13386 39226 113641 326173 928957 2628459 7395624 20708264 57739517 160391483 444068171 1225831551
;; small program: loop2(y - x, x, x + x, 1 + x, 1)
;; fast program: loop2((x + x) + y, x + y, x - 1, 1 + (x + x), x)
(set-logic UFNIA)
