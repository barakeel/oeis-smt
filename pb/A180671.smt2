;; sequence(s): A180671
;; terms: 0 5 13 26 47 81 136 225 369 602 979 1589 2576 4173 6757 10938 17703 28649 46360 75017
;; small program: loop(x + loop2(1 + (x + y), x, y, 2, 1), x, x)
;; fast program: loop2(x + y, x, x, 2 * (2 + 2), 1 + (2 + 2)) - (2 * (2 + 2))
(set-logic UFNIA)
