;; sequence(s): A27005
;; terms: 1 19 101 370 1148 3278 8967 23993 63483 167040 438346 1148844 3009181 7879855 20631713 54016798 141420392 370246298 969320643 2537718005
;; small program: loop(loop(loop(loop2(y, x + y, y, 2, 1) + x, y, x), 1 + y, x), x + x, 1)
;; fast program: loop((loop(loop((((loop2(x + y, x, x, 2 + 2, 1 + 2) - 2) - x) - x) - x, 1, 2 + y) + x, x, 1) - x) - x, 1, x + x)
(set-logic UFNIA)
