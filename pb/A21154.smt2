;; sequence(s): A21154
;; terms: 1 19 256 3066 35007 391545 4339462 47896672 527676853 5808513711 63913994508 703155662118 7735220904139 85089973066117 936002419362994 10296090191237004 113257309994958465 1245831999401562363
;; small program: loop((loop2(((2 * ((x + x) + y)) - 1) + x, y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop2(((2 * ((x + x) + y)) - 1) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
