;; sequence(s): A195390
;; terms: 1 720 479001600 6402373705728000 620448401733239439360000 265252859812191058636308480000000 371993326789901217467999448150835200000000 1405006117752879898543142606244511569936384000000000 12413915592536072670862289047373375038521486354677760000000000
;; small program: loop(x * y, 2 * ((x + x) + x), 1)
;; fast program: loop2((loop2(x * y, 1 + y, x, 1, 1 + x) * loop(x * y, x, 1)) * loop2(x * y, 1 + y, x, 1, 1 + (x + x)), x * x, 1, x + x, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (* (* (w2 x) (v3 x)) (w4 x)))))
