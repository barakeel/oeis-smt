;; sequence(s): A13886
;; terms: 18 34012224 64268410079232 121439531096594251776 229468251895129407139872768 433595865796975883590475106484224 819308872942260126404286866009182175232 1548139828427760582529495524831238344488779776 2925315479322586708409093799864313376118974623776768
;; small program: loop(2 * loop((x + x) + x, 2, x), 1 + ((2 * (x + x)) + x), 1)
