;; sequence(s): A292465
;; terms: 0 1 4 18 60 200 624 1911 5712 16830 48950 140976 402624 1141933 3219580 9031050 25219824 70153016 194466672 537404835
;; small program: loop2(x + y, x, x, loop2(x + y, x, x, 0, x), 0)
;; fast program: loop2(x + y, x, x, loop2(x + y, x, x - 2, x, x), 0)
(set-logic UFNIA)
