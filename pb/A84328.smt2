;; sequence(s): A84328
;; terms: 0 1 13 158 1911 23105 279344 3377317 40832337 493669894 5968552915 72160819061 872436565728 10547906344793 127525980259301 1541810773578190 18640754273664159 225369887048273977
;; small program: loop2(loop((2 + y) * x, 2, x) + y, x + y, x, 0, 1)
;; fast program: loop2((2 * (2 * ((x + x) + x))) + y, x + y, x - 1, if x <= 0 then 0 else 1, 1)
(set-logic UFNIA)
