;; sequence(s): A135427
;; terms: 1 72 419904 198359290368 7589970693537140736 23524081260686625628823519232 5905684770308534937017423724484399202304 120091666484242114100641836801136909254418910442160128
;; small program: loop(loop2(((2 * (2 + 2)) + y) * x, 1, y + y, x, 0), x, 1)
;; fast program: ((loop2(x * y, (y + y) + y, x, 1, 1 + 2) * loop2(x * y, (y + y) + y, x - 1, 1, 1 + 2)) * loop2(x * y, (y + y) + y, x, 1, 2 + (2 + 2))) * loop2(x * y, (y + y) + y, x, 1, 2 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (* (w2 x) (w3 x)) (w4 x)) (w5 x)))))
