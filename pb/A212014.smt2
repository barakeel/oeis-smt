;; sequence(s): A212014
;; terms: 2 6 8 14 18 20 28 34 38 40 50 58 64 68 70 82 92 100 106 110
;; small program: loop((1 - loop(x - (if x <= 0 then 0 else (1 + y)), x, y)) + x, x, 1) * 2
;; fast program: loop(loop(1 - loop(x - (if x <= 0 then 0 else (1 + y)), x, x), 1, y) + x, x, 1) * 2
(set-logic UFNIA)
