;; sequence(s): A259451
;; terms: 0 1 4 18 48 125 288 637 1344 2754 5500 10769 20736 39377 73892 137250 252672 461533 837216 1509341
;; small program: x * loop2(x + y, x, x, 0, x)
;; fast program: x * loop2(x + y, x, x - 2, x, x)
(set-logic UFNIA)
