;; sequence(s): A99365
;; terms: 0 1 25 676 18225 491401 13249600 357247801 9632441025 259718659876 7002771375625 188815108482001 5091005157638400 137268324147754801 3701153746831741225 99793882840309258276 2690733682941518232225
;; small program: loop(x * x, 1, loop2(((2 * (x + x)) + x) + y, x, x, 0, 1))
;; fast program: loop(x * x, 1, loop2(((2 * (x + x)) + x) + y, x, x - 1, if x <= 0 then 0 else 1, 0))
(set-logic UFNIA)
