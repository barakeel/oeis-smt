;; sequence(s): A95807
;; terms: 1 10 181 2620 33571 402130 4619161 51572440 564151951 6077367550 64696307941 682266771460 7140400943131 74263608488170 768372476393521 7915352287541680 81238170587875111
;; small program: loop(loop2(x * y, y, y, 1, 2 + (2 * (2 + 2))) + loop((x + x) + x, 2, x - 1), x, 1)
;; fast program: loop(loop2(x * y, y, x - 1, 1, 2 + (2 * (2 + 2))) + loop2((x - 1) * y, y, x, 1, 1 + (2 * (2 + 2))), 1, 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (* (- x 1) y))))
