;; sequence(s): A177265
;; terms: 1 1 4 12 57 321 2176 17008 150505 1485465 16170036 192384876 2483177809 34554278857 515620794592 8212685046336 139062777326001 2494364438359953 47245095998005060 942259727190907180
;; small program: loop(loop((1 + y) * (loop(0 - x, y, 1) + x), y, 1) + x, x, 1)
;; fast program: loop(loop(loop(1 - (x * y), x, 1) * (1 + x), 1, y) - x, x, 1) * loop(0 - x, x, 1)
(set-logic UFNIA)
