;; sequence(s): A13817
;; terms: 10648 2494357888 584318301411328 136880068015412051968 32064977213018365645815808 7511413302012830262726227918848 1759593634476317566025195247357657088 412195366437884247746798137865015318806528
;; small program: loop((loop(x * y, 2 + 2, x) - x) - x, loop(1 + (x + x), 2, x), 1)
;; fast program: (loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + (2 * (2 + 2))))) * loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 * (2 + 2)))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (w3 x) (w4 x)) (v5 x)))))
