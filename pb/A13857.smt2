;; sequence(s): A13857
;; terms: 10000 1000000000 100000000000000 10000000000000000000 1000000000000000000000000 100000000000000000000000000000 10000000000000000000000000000000000 1000000000000000000000000000000000000000
;; small program: loop(2 * ((2 * (x + x)) + x), (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
