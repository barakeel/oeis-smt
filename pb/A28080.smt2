;; sequence(s): A28080
;; terms: 1 27 469 6687 85357 1016775 11565973 127403199 1371332413 14511863223 151627818277 1569077088111 16117515157069 164615225572071 1673829571276981 16960654592840223 171391059145733725
;; small program: loop(((loop(loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (2 * (x + x))), y, 1) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
