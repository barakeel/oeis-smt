;; sequence(s): A51285
;; terms: 1 2 2 4 16 65536 115792089237316195423570985008687907853269984665640564039457584007913129639936
;; small program: loop2(loop(x + x, y, 1), x * y, x, 1, 1)
;; fast program: loop2(loop2(x * y, y, y - 2, 1, x) * (x * x), x, x - 2, if x <= 0 then 1 else 2, 0)
(set-logic UFNIA)
