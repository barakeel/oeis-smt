;; sequence(s): A167478
;; terms: 1 4 19 75 264 869 2741 8396 25175 74271 216336 623689 1782889 5060500 14277019 40070259 111954456 311555501 863978525 2388417116
;; small program: loop2(y - x, x, x + x, 1 + (x + x), 2)
;; fast program: loop2((x - y) + x, y - x, x, 1 + (x + x), 2)
(set-logic UFNIA)
