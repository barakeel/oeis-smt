;; sequence(s): A24435
;; terms: 1 29 561 9121 134897 1882545 25284337 330685937 4242985713 53675466481 671774536433 8338419180273 102834889732849 1261772945322737 15418912066155249 187803876238668529
;; small program: loop(loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + loop((2 + y) * x, 2, x), x, 1)
