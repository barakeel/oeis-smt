;; sequence(s): A152686
;; terms: 1 1 1 2 12 360 86400 269568000 17662095360000 39345496591564800000 4820704671590339051520000000 52567343238846954009129910272000000000 82543717140049422917575408530662149324800000000000
;; small program: loop(loop(loop2(x + y, x, y, 0, x), y, x), x, 1)
;; fast program: loop(loop(loop(loop2(x + y, x, y, 2, 1) * x, x - 1, 2), 1, y) * x, x - 2, 1)
(set-logic UFNIA)
