;; sequence(s): A343698
;; terms: 1 2 384 40310784 7608405715845120 6419592322744320000000000000 50709051409862934701619019776000000000000000 6988904507653043786857875068352862005134308147200000000000000000
;; small program: loop2(loop(x * y, y, x), y, (1 + 2) + (2 * x), 1 + x, x)
;; fast program: ((loop2(x * y, y, x - 2, 1, loop(x * y, x - 1, x)) * loop((x * x) * x, 1, loop(x * y, x, 1))) * loop2(x * y, y, x, 1, loop(x * y, x, 1))) * loop(((1 + y) * y) * x, x, 1)
(set-logic UFNIA)
