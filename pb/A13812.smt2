;; sequence(s): A13812
;; terms: 20 3200000 512000000000 81920000000000000 13107200000000000000000 2097152000000000000000000000 335544320000000000000000000000000 53687091200000000000000000000000000000 8589934592000000000000000000000000000000000
;; small program: loop(loop(2 * (2 + x), 2, 2) * x, 1 + (2 * (x + x)), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) * loop2(x * y, y, 1 + (x + x), 1, 2 + (2 * (2 + 2)))) * loop2(x * y, y, x, 2, 2 * (2 * (2 + 2)))
(set-logic UFNIA)
