;; sequence(s): A293004
;; terms: 0 0 2 6 16 40 98 238 576 1392 3362 8118 19600 47320 114242 275806 665856 1607520 3880898 9369318
;; small program: loop2(y, (x + y) + y, x, 1, 1) - 1
;; fast program: loop2((x + x) + y, x, x - 1, 1, 1) - 1
(set-logic UFNIA)
