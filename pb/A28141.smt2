;; sequence(s): A28141
;; terms: 1 31 619 10171 150115 2075227 27499123 354164107 4472448739 55701408763 686884421587 8409900709483 102430894160323 1242818548606939 15036887507052211 181551642806017099
;; small program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + (2 * (x + x)), x, 1)
;; fast program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
