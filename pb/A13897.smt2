;; sequence(s): A13897
;; terms: 160000 512000000000 1638400000000000000 5242880000000000000000000 16777216000000000000000000000000 53687091200000000000000000000000000000 171798691840000000000000000000000000000000000 549755813888000000000000000000000000000000000000000
;; small program: loop(loop(2 * (2 + x), 2, 2) * x, (2 * (2 + (x + x))) + x, 1)
