;; sequence(s): A15261
;; terms: 1 91 9191 918191 91828191 9182728191 918273728191 91827363728191 9182736463728191 918273645463728191 91827364555463728191 9182736455455463728191 918273645546455463728191
;; small program: loop(loop(loop(loop(2 * ((2 * (x + x)) + x), y, 1) - x, x, 1) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(y - x, 2 * ((2 * (y + y)) + y), x, 1, 2 + (2 * (2 + 2))) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (- y x))))
(assert (forall ((x Int) (y Int)) (= (g7 x y) (* 2 (+ (* 2 (+ y y)) y)))))
