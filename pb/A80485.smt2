;; sequence(s): A80485
;; terms: 1 1 2 10 10010 100501001000500110010 1030439087548102432463831259335600084552960956356206758209687466939207907583986354899341984694140259859223116066501110010
;; small program: loop(x + loop2(x * y, y, y, x, x), x - 1, 1)
;; fast program: loop(((loop2(x * y, y, y - 2, 1, x) * (x * x)) + 1) * x, x - 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* (+ (* (w3 x y) (* x x)) 1) x))))
