;; sequence(s): A260231
;; terms: 2 10 280 71960 224946960 10495350312720 8643382777938679680 145011908479540041684850560 56180584638978557924165229531974400 561805846445966163880630853243909229531974400 160289764609087349005207761687490741791453382934816332800
;; small program: loop(loop2(x * y, y, y, x, y) + x, 1 + x, 1)
;; fast program: loop(loop(1 + loop2(x * y, y, x, 1 + x, 1 + x), 1, y) * x, x, 1) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (+ 1 (w4 x)))))
(assert (= g3 1))
