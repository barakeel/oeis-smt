;; sequence(s): A99924
;; terms: 4 4 13 22 45 82 152 274 491 870 1531 2676 4652 8048 13865 23798 40713 69446 118144 200510
;; small program: loop2(1 + (2 + y), x + y, x, ((x + x) + 2) + 2, x)
;; fast program: loop2(1 + y, x + y, x, 2 + ((2 + x) + x), 2 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i0 x) (+ (+ (+ x x) 2) 2))))
