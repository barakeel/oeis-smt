;; sequence(s): A260005
;; terms: 19 10228 15569256417 5742397643169488579854258 36681813266165915713665394441869800619098139628586701684547
;; small program: loop(loop((x + x) + y, x + y, x), 2, x)
;; fast program: loop(loop((2 * x) + y, x + y, x), 2, x)
(set-logic UFNIA)
