;; sequence(s): A20766
;; terms: 1 29 571 9521 144907 2083865 28847827 388709777 5134091323 66784487561 858403625443 10928093824193 138039056180299 1732402968047417 21624191213455219 268679676312195569
;; small program: loop(loop(loop(2 * ((x + x) + x), x, loop(x + x, x, 2) - 1), 1, y) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 2 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
