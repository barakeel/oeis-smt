;; sequence(s): A21984
;; terms: 1 26 457 6822 93333 1210938 15168529 185357774 2224062445 26316305730 307996949481 3573147901206 41156463852037 471239561238602 5368820120200513 60908872219620318 688516109116593309
;; small program: loop((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), y, 1) - x) + loop((2 + y) * x, 2, x), x, 1)
