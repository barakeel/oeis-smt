;; sequence(s): A195615
;; terms: 15 273 4895 87841 1576239 28284465 507544127 9107509825 163427632719 2932589879121 52623190191455 944284833567073 16944503814015855 304056783818718321 5456077604922913919 97905340104793732225 1756840044281364266127
;; small program: loop(loop2(((x - y) + x) + x, x, y, 1, 0) - x, (1 + 2) * (1 + x), 1)
;; fast program: loop2(x + y, x, 2 + ((x + x) + x), 2, 1) * loop2((2 * (x + x)) + y, x, x, 1 + 2, 1)
(set-logic UFNIA)
