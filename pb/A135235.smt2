;; sequence(s): A135235
;; terms: 1 2 34012224
;; small program: loop((x * y) * loop2(x * y, y, x - 2, x, 1 + 2), x + x, 1)
;; fast program: loop(loop2(x * y, y, x - 1, 1, loop2(x * y, y, x, 1, loop(x * y, x, x))), x - 1, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (* (* x y) (w1 x)))))
