;; sequence(s): A134068
;; terms: 0 3 3 6 18 24 60 120 216 480 912 1824 3744 7296 14784 29568 58752 118272 235776 471552
;; small program: loop((loop2(0 - (x + y), x - y, y - 1, 1 + 2, 0) + x) + x, x, 0)
;; fast program: loop((loop2(0 - (x + y), x - y, y - 1, 1, 0) + x) + x, x, 0) * (1 + 2)
(set-logic UFNIA)
