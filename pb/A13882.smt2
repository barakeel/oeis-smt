;; sequence(s): A13882
;; terms: 17 24137569 34271896307633 48661191875666868481 69091933913008732880827217 98100666009922840441972689847969 139288917338851014461418017489467720433 197770344305988984840145602058543169130838081 280805607755268602048174614102036928492604365174417
;; small program: loop((loop(x * x, 2, 2) * x) + x, 1 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 * (2 + 2))))) * loop2(x * y, y, 1 + x, 1, 1 + (2 * (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
