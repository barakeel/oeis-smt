;; sequence(s): A6172
;; terms: 4 2 9 10 42 79 252 582 1645 4106 11070 28459 75348 195898 515073 1344906 3526786 9223895 24163596 63236638
;; small program: (1 + loop2(x + y, x, x + x, 1, 0)) + loop2(y - x, x, x, 2, 1)
;; fast program: (1 + loop2(((x - y) + x) + x, x, x - 1, if x <= 0 then 1 else 2, 1)) + loop2(y - x, x, x, 2, 1)
(set-logic UFNIA)
