;; sequence(s): A352
;; terms: 5 29 118 418 1383 4407 13736 42236 128761 390385 1179354 3554454 10696139 32153963 96592972 290041072 870647517 2612991141 7841070590 23527406090
;; small program: loop(loop(loop2(((x + x) + x) + y, y + y, y, 1, 2) + x, y, x), 1 + x, 0)
;; fast program: (loop(loop(loop2((((x - 1) + x) + x) + y, y + y, x, 1, 2 + 2), 1, y) + x, 1 + x, 0) - 1) - x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (+ (+ (- x 1) x) x) y))))
