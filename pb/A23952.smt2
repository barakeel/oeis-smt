;; sequence(s): A23952
;; terms: 1 25 416 5822 74319 898779 10511446 120335968 1358681621 15202492877 169098946380 1873624439778 20707233183547 228476788273759 2518219270791458 27735798399148292 305344872665615937
;; small program: loop((loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + ((2 * ((y + y) + y)) + y), x, 1, 2 * (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
