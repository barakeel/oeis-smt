;; sequence(s): A218149
;; terms: 1 3 9 81 6561 14348907 2541865828329 109418989131512359209 3433683820292512484657849089281 235655016338368235499067731945871638181119123 106111661199647248543687855752712667991103904330482569981872649
;; small program: loop((x + x) + x, loop(loop(x + y, y - 2, x), x, x), 1)
;; fast program: loop(loop(loop2(x * y, (y + y) + y, x - 1, 1, 1 + 2), 1, y) * x, x - 1, 1) * loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
