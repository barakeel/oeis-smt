;; sequence(s): A16312
;; terms: 1 18 229 2538 26197 259290 2498293 23637546 220808533 2043771642 18789409717 171872944074 1566234297109 14231753285274 129035291862901 1167964212866922 10558204018573525 95349518886691386
;; small program: loop((loop((loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((y * y) + x) + x, (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (+ (* y y) x) x))))
