...
(assert (forall ((x Int)) (= (f2 x) (ite (<= (modf (divf x 2) 2) 0) 2 (divf x 2)))))
...
(assert (forall ((x Int)) (= (f5 x) (- (+ (modf (+ (v6 x) x) 2) x) 2))))
(assert (= g5 2))
