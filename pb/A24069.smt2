;; sequence(s): A24069
;; terms: 1 5 ~92 ~1971 ~15088 ~70349 ~233280 ~543607 ~417536 5294727 50466176 343309885 2140950528 12997945499 78258750592 470014125201 2820841472000 16926249106063 101559344448384 609358846138757
;; small program: loop(2 * ((x + x) + x), x, 1) - loop2((x * x) * y, x, 2, x, x)
;; fast program: loop2(x * y, y, x, 1, 2 + (2 + 2)) - (loop((x * x) * x, 1, x * x) * x)
(set-logic UFNIA)
