;; sequence(s): A78354
;; terms: 1 20 160000 512000000000 655360000000000000000 335544320000000000000000000000000 68719476736000000000000000000000000000000000000
;; small program: loop(loop(2 * (2 + x), 2, 2) * x, x * x, 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))) * loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
