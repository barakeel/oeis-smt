;; sequence(s): A140961
;; terms: 1 17 205 2129 20341 184457 1615405 13808609 116015461 962575097 7913168605 64610052689 524855128981 4247421698537 34274519697805 275985344786369 2218709434248901 17815093293410777 142915542082163005 1145704555158361649
;; small program: loop((loop(loop2(2 * ((2 * (x + x)) + y), 2 * ((y + y) + y), x, 1, 2), 1, y) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + y, (y + y) + y, x, 1, 2) * loop(x + x, x, 1), 1, y) + x) + ((x + x) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g2 x y) (* 2 (+ (+ y y) y)))))
