;; sequence(s): A19613
;; terms: 1 20 273 3172 33809 342132 3348241 32033924 301669137 2808831124 25937190929 238042888356 2174659962385 19797924540596 179763483454737 1628947562960068 14738065844679953 133185374228264148
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + (2 * (x + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + (y * y), (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
