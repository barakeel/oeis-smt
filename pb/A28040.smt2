;; sequence(s): A28040
;; terms: 1 24 375 4870 57321 636924 6829435 71574690 738951741 7552940824 76677389295 774826006110 7804690367761 78442179476724 787189784753955 7891278029367130 79048458617193381 791434402768644624
;; small program: loop(((loop((loop2((2 * ((2 * (x + x)) + x)) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((((y * y) + x) + x) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (w5 x y) (* 2 (+ (* 2 (+ x x)) x))))))
