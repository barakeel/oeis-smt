;; sequence(s): A219012
;; terms: 4 724 198924689265124 311489521560905211009923410118036749078665998068304623331823899816643124
;; small program: loop(loop2((x * y) + x, 1 + y, 2 + 2, x, x) + x, x, 2) + 2
;; fast program: loop((loop((2 + x) * (((x * x) * x) - x), 1, 2 + x) * x) + x, x, 2) + 2
(set-logic UFNIA)
