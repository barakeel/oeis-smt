;; sequence(s): A67961
;; terms: 1 9 64 2401 161051 34012224 17249876309 23811286661761 84590643846578176 792594609605189126649 19381341794579313317802199 1242425797286480951825250390016 208396491430277954192889648311785961 91534759488004239323168528670973468727049
;; small program: loop2(x * y, y, 1 + x, 1, loop2(x + y, x, x, 1, 2))
;; fast program: loop2(loop2(x * y, y, y - 1, 1, x) * (x * x), x, 1, loop2(x + y, x, x, 1, 2), x)
(set-logic UFNIA)
