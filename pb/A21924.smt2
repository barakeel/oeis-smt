;; sequence(s): A21924
;; terms: 1 24 389 5364 68025 821808 9633613 110741388 1256415809 14127007752 157849954197 1755978039972 19472809159753 215457395996256 2380083675784541 26261340423891516 289518110311522257
;; small program: loop(loop2((((y - 1) + y) * (y * y)) + x, y + y, y, 1, 2) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop2((((y - 1) + y) * (y * y)) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
