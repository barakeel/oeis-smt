;; sequence(s): A16302
;; terms: 1 19 267 3407 41915 508167 6124003 73618159 884068779 10612080215 127361237939 1528416234111 18341401707643 220098854991463 2641196432412675 31694408051560463 380333150931832907
;; small program: loop((loop2(loop((2 + y) * x, 2, x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop(x + x, x, loop2(1 + (x * y), y, x, 1, 2 + (2 + 2))), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
