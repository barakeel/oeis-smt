;; sequence(s): A203516
;; terms: 1 4 192 184320 4954521600 4794391461888000 204135216112950312960000 451965950843675288237663846400000 60040562704967329457107799785403842560000000 542366306792798635131534558788357929673196306432000000000
;; small program: loop(loop2(2 * (x * y), 1 + y, y, 2, y) * x, x, 1)
;; fast program: (loop(loop((2 * (x * y)) + x, y, 1) * x, x - 1, 1) * loop2(x * y, y + y, x - 1, 1, 2)) * loop2(x * y, y + y, x, 1, 2 + 2)
(set-logic UFNIA)
