;; sequence(s): A271938
;; terms: 1 3 3 27 19683 87189642485960958202911070585860771696964072404731750085525219437990967093723439943475549906831683116791055225665627
;; small program: loop2(loop((x + x) + x, y, 1), x * y, x, 1, 1)
;; fast program: loop2(x * loop2(x * y, y, y - 1, 1, x), x, x - 1, if x <= 0 then 1 else (1 + 2), 1)
(set-logic UFNIA)
