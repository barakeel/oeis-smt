;; sequence(s): A22111
;; terms: 1 20 263 2878 28449 264048 2350651 20332466 172311557 1438844836 11885079999 97387603014 793247778025 6432389826584 51985193621507 419076145997722 3371967484999053 27092843456412492
;; small program: loop((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop(loop(loop2((2 * ((x + x) + x)) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
