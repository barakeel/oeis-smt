;; sequence(s): A20975
;; terms: 1 30 607 10344 160189 2335746 32694859 444486828 5913240457 77372622822 999305059831 12772807490352 161880145667605 2037329650638858 25491080959642723 317372095748963316 3934768748483886433 48606797206780217454 598568489369669902735
;; small program: loop((loop(loop(loop((2 + y) * x, 2, x) - x, y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * ((x + x) + x))) + y, (2 * ((y + y) + y)) + y, x, 1, 1 + (2 + (2 + 2))), 1, y) + x) + ((((x * 2) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g7 x y) (+ (* 2 (+ (+ y y) y)) y))))
