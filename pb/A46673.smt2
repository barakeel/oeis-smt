;; sequence(s): A46673
;; terms: 2 36 1320 84000 8285760 1173553920 226040855040 56865153945600 18112111963545600 7125892746964992000 3394344333441245184000 1925382105537337294848000 1282520788685931213619200000 991363455147400701817651200000 880169729965718014490443776000000
;; small program: loop(((x * y) + loop(x * y, y, 1)) + x, x, 1) * loop2(x * y, 1 + y, 1 + x, 1, 2 + x)
;; fast program: loop(((loop(x * y, y - 1, 1) + x) * y) + x, x, 1) * loop2(x * y, 1 + y, 1 + x, 1, 2 + x)
(set-logic UFNIA)
