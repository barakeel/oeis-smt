;; sequence(s): A24441
;; terms: 1 27 480 7090 94311 1173417 13944190 160292880 1797313221 19769671207 214195117500 2292743705070 24300717989731 255479745527397 2667841806196410 27701356042027660 286258773993179841
;; small program: loop((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + loop((x + x) + x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
