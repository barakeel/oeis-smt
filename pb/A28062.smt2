;; sequence(s): A28062
;; terms: 1 26 440 6190 78981 952476 11101000 126669380 1426238561 15923605126 176828848560 1956923483970 21609410926741 238289337781976 2625298690331120 28907173689169960 318181508654719521
;; small program: loop(((loop((loop((loop(loop((2 + y) * x, 2, x) - x, y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop((loop(loop2(((2 * (x + x)) + x) + y, (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1), 1, y) + ((((x + x) * 2) + x) * 2)) + x, x, 1)
(set-logic UFNIA)
