;; sequence(s): A72110
;; terms: 1 2 5 16 57 210 781 2912 10865 40546 151317 564720 2107561 7865522 29354525 109552576 408855777 1525870530 5694626341 21252634832
;; small program: 1 + loop2(y, (2 * (y + y)) - x, x, 0, 1)
;; fast program: 1 + loop2((2 * (x + x)) - y, x, x - 2, if (x - 1) <= 0 then x else (2 + 2), 1)
(set-logic UFNIA)
