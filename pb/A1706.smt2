;; sequence(s): A1706
;; terms: 1 9 71 580 5104 48860 509004 5753736 70290936 924118272 13020978816 195869441664 3134328981120 53180752331520 953884282141440 18037635241029120 358689683932346880 7483713725055744000 163478034254755584000 3731670622213083648000
;; small program: loop(loop(loop(((x * y) + loop(x * y, y, 1)) + x, y, 1) + ((2 + y) * x), y, 1) + ((2 + y) * x), x, 1)
;; fast program: loop(loop(loop(((x * y) + loop(x * y, y - 1, y)) + x, y, 1) + ((2 + y) * x), y, 1) + ((2 + y) * x), x, 1)
(set-logic UFNIA)
