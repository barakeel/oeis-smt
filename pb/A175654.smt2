;; sequence(s): A175654
;; terms: 1 2 6 14 36 86 210 500 1194 2822 6660 15638 36642 85604 199626 464630 1079892 2506550 5811762 13462484
;; small program: loop2((x + x) + y, x - y, x, 2, 0) - loop(x + x, x, 1)
;; fast program: loop2(((x + y) + y) + y, x, x - 1, (if x <= 0 then 1 else 2) + 2, 2) - loop(x + x, x - 1, 2)
(set-logic UFNIA)
