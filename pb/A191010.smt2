;; sequence(s): A191010
;; terms: 1 7 41 215 1065 5079 23593 107479 482345 2139095 9395241 40936407 177167401 762356695 3264175145 13915694039 59098749993 250138895319 1055531162665 4442026976215
;; small program: loop(loop(x + x, y + y, 1 + y) - x, x, 1)
;; fast program: loop(loop((1 + x) * loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) - x, x, 1)
(set-logic UFNIA)
