;; sequence(s): A24446
;; terms: 1 31 638 10982 171171 2506917 35201776 479688604 6392929061 83765551883 1083070611714 13855878102066 175736023769671 2213065674408529 27704146634051252 345076242383014568 4279844990866901001 52886642197647118455 651455131567317021190
;; small program: loop((loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * ((x + x) + x))) + y, 1 + ((2 * ((y + y) + y)) + y), x, 1, 2 * (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
