;; sequence(s): A26391
;; terms: 1 25 407 5489 66759 762321 8356279 89114113 932519687 9629963057 98523692631 1001349555297 10129549127335 102127457330833 1027215881948663 10314453257429441 103444825304722503
;; small program: loop((loop(loop2((2 * ((x + x) + x)) + y, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
