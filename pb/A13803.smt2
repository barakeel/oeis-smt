;; sequence(s): A13803
;; terms: 3375 170859375 8649755859375 437893890380859375 22168378200531005859375 1122274146401882171630859375 56815128661595284938812255859375 2876265888493261300027370452880859375 145610960604971353313885629177093505859375
;; small program: loop((loop(x * x, 2, 2) * x) - x, loop(1 + (x + x), 2, x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + 2))) - 1)) * loop2(x * y, y, 1 + (x + x), 1, (2 * (2 * (2 + 2))) - 1)
(set-logic UFNIA)
