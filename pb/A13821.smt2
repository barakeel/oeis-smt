;; sequence(s): A13821
;; terms: 13824 4586471424 1521681143169024 504857282956046106624 167499529910025153071284224 55572324035428505185378394701824 18437563379178327736384102280592359424 6117141027690268863066571918245810640257024
;; small program: loop(loop(x * y, 2 + 2, x), loop(1 + (x + x), 2, x), 1)
