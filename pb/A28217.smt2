;; sequence(s): A28217
;; terms: 1 37 865 16345 272881 4203577 61233985 856507465 11620866961 154020283417 2004281620705 25705179230185 325843083624241 4091525808208057 50980871394705025 631212806724858505 7774530598929024721 95344134061235633497 1165077358261678630945
;; small program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
