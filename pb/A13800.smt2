;; sequence(s): A13800
;; terms: 14 537824 20661046784 793714773254144 30491346729331195904 1171355575953987221848064 44998795805848373114515226624 1728673739677471101567216945987584 66408730383449729837806206197059026944
;; small program: loop((loop(x * x, 2, 2) - 2) * x, 1 + (2 * (x + x)), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 + 2))))) * loop2(x * y, y, 1 + (x + x), 1, 2 + (2 * (2 + (2 + 2))))
(set-logic UFNIA)
