;; sequence(s): A175985
;; terms: 1 1 3 63 16777215 1329227995784915872903807060280344575
;; small program: loop(x + x, loop(x * y, x, 1), 1) - 1
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 2, loop(x + x, x - 1, 2)) - 1
(set-logic UFNIA)
