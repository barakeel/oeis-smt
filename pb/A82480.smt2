;; sequence(s): A82480
;; terms: 1 2 4 12 48 288 2592 36288 798336 27941760 1564738560 140826470400 20419838208000 4778242140672000 1806175529174016000 1103573248325323776000 1090330369345419890688000
;; small program: loop(x + loop2(x + y, x, y, 0, x), x, 1)
;; fast program: loop((1 + loop2(x + y, x, y - 2, 1, 1)) * x, x, 1)
(set-logic UFNIA)
