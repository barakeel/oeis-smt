;; sequence(s): A95931
;; terms: 1 7 36 165 715 3004 12393 50559 204820 826045 3321891 13333932 53457121 214146295 857417220 3431847189 13733091643 54947296924 219828275865 879415437615
;; small program: loop(loop2(x + y, x, y + y, 1, 1) + (2 * (x + x)), x, 1)
;; fast program: loop(loop2(((x - y) + x) + x, x, y - 1, 1 + 2, 1) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (w3 x y) (* 2 (+ x x))))))
