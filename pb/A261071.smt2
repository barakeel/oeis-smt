;; sequence(s): A261071
;; terms: 3 5 65 16777217 1329227995784915872903807060280344577
;; small program: 1 + loop(loop2(x * y, y, y, x, x), x, 2)
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 1, loop(x + x, x, 2)) + 1
(set-logic UFNIA)
