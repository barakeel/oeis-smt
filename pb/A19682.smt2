;; sequence(s): A19682
;; terms: 1 23 363 4891 60515 710619 8059507 89191307 969344739 10390594555 110181318611 1158295737963 12091317123523 125488476039131 1296062772061875 13331230899395659 136647741897916067 1396496332294665147 14235133611505668499 144782868986965745195
;; small program: loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), x, 1)
;; fast program: loop(loop(loop2((2 * (x + x)) + (y * y), (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (* 2 (+ x x)) (* y y)))))
