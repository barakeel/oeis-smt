;; sequence(s): A175984
;; terms: 1 3 17 5833 1158419072229137 2086068166214649286321811524278555292919121929640327670690020838966185723169
;; small program: 1 + loop(loop2(x * y, y, y, 1, 2 + x), x, 0)
;; fast program: loop(loop2(x * y, y, y - 1, 1, 2 + x) * (2 + x), x, 0) + 1
(set-logic UFNIA)
