;; sequence(s): A166384
;; terms: 1 60 151200 1816214400 60339831552000 4274473667143680000 553761949463615692800000 118528911546113729396736000000 38996486014317601426443730944000000
;; small program: loop2((x * y) + x, 1 + y, (x + x) + x, 1, x + x)
;; fast program: loop2(((y * y) + y) * x, 2 + y, x, 1, 1 + ((x + x) + x)) * loop2(x * y, 1 + y, x, 1, 1 + (x + x))
(set-logic UFNIA)
