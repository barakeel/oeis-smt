;; sequence(s): A23947
;; terms: 1 28 527 8390 122121 1683768 22407907 291019450 3713967341 46787388908 583658682087 7226065372110 88934701511761 1089437114484448 13295459966641067 161767703674942370
;; small program: loop((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
