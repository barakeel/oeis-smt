;; sequence(s): A256817
;; terms: 8 16 32 64 124 229 402 673 1080 1670 2500 3638 5164 7171 9766 13071 17224 22380 28712 36412
;; small program: (((((loop(loop(loop(2 + loop(x + y, y, x), y, x), y, 2) + x, x, 2) + 2) + 2) + x) + 2) + x) + x
;; fast program: (((((((loop(loop((loop(loop(x + y, y, x), y, x) + y) + y, y, x), x, 2) + 2) + 2) + x) + 2) + x) + x) + x) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (+ (+ (+ (+ (+ (v0 x) 2) 2) x) 2) x) x))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (+ (v6 x y) y) y))))
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (+ (+ (+ (+ (+ (+ (v4 x) 2) 2) x) 2) x) x) x) x))))
