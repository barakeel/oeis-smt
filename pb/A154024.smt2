;; sequence(s): A154024
;; terms: 0 7 343 16800 822857 40303193 1974033600 96687343207 4735705783543 231952896050400 11360956200686057 556454900937566393 27254929189740067200 1334935075396325726407
;; small program: loop2(((1 + loop((x + y) * x, 2, 2)) * x) - y, x, x - 1, if x <= 0 then 0 else 1, 0) * (1 + (2 + (2 + 2)))
;; fast program: loop2((loop(x * x, 1, 1 + (2 + (2 + 2))) * x) - y, x, x - 1, if x <= 0 then 0 else 1, 0) * (1 + (2 + (2 + 2)))
(set-logic UFNIA)
