;; sequence(s): A159950
;; terms: 240 122522400 137932073613734400 342696507457909818131702784000 1879127177606120717127879344567470740879360000 22740756589119797763590969093409514524935686067027158720512000000
;; small program: loop(loop2(x + y, x, y, x, x), 2 * (2 + (x + x)), 1)
;; fast program: loop(loop2(x + y, x, y, 2, 1) * x, loop(1 + (x + x), 2, x), 2)
(set-logic UFNIA)
