;; sequence(s): A6262
;; terms: 1 2 18 4608 1800000000 5077997833420800000000 5608281336980602120684110607059901336780800000000
;; small program: loop2((1 + y) * (x * x), y - 1, x, 1, x)
;; fast program: loop2((x * y) * x, y - 1, x - 1, 1 + x, x)
(set-logic UFNIA)
