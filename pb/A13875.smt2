;; sequence(s): A13875
;; terms: 225 170859375 129746337890625 98526125335693359375 74818276426792144775390625 56815128661595284938812255859375 43143988327398919500410556793212890625 32762466136118554495624266564846038818359375 24878997722115027320114677422679960727691650390625
;; small program: loop((loop(x * x, 2, 2) * x) - x, 2 + ((2 * (x + x)) + x), 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1)) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + 2))) - 1))
(set-logic UFNIA)
