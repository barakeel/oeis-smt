;; sequence(s): A16299
;; terms: 1 17 209 2293 23961 244797 2473969 24869813 249349001 2496744877 24983724129 249918620133 2499593099641 24997965496157 249989827476689 2499949137375253 24999745686859881 249998728434266637
;; small program: loop((loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + x) + x, x, 1)
;; fast program: loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + (2 + 2)), 1, y) + x) + x, x, 1)
(set-logic UFNIA)
