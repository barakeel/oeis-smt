;; sequence(s): A28679
;; terms: 1 272 22639104 546341708980224 3811101610741578352558080 7683152190027081335646892427952783360 4476375132477699824408564935442752007430598683525120
;; small program: loop(loop((x * x) - x, 1, loop((2 * (2 * (2 * (x + x)))) + x, y, 1)) * x, x, 1)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, 1 + (2 * (2 * (2 + 2))))) * x, x, 1)
(set-logic UFNIA)
