;; sequence(s): A28142
;; terms: 1 31 617 10067 146913 1999083 25952089 325901779 3994115345 48056935355 570022255881 6685284487011 77695022872897 896253234623947 10275099966705593 117190651899653363 1330751148294893169
;; small program: loop(loop(loop2((loop((2 + y) * x, 2, x) - x) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: loop((loop(loop((loop2(((x + x) + x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
