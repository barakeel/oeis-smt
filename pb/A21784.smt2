;; sequence(s): A21784
;; terms: 1 21 302 3762 43923 497223 5545264 61398804 677478725 7463074905 82149266706 903924739926 9944608539607 109397965416267 1203414334895828 13237742692094328 145616100380861769
;; small program: loop((loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, x, 1)
