;; sequence(s): A84594
;; terms: 1 4 28 1552 4817152 46409906716672 4307758882900393634270543872 37113573186414494550922197215584520229965687291643953152
;; small program: loop2(y, 2 * (x + y), loop(x + x, x, 1), 1, 1)
;; fast program: loop2((2 * (x * x)) - y, y * y, x, 1, 0 - 2)
(set-logic UFNIA)
