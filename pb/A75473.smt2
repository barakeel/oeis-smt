;; sequence(s): A75473
;; terms: 0 0 0 1 30 653 13762 304295 7251598 187783369 5287733418 161516858963 5332258661782 189493508862461 7219703867130466 293780009979371503 12721918893479808030 584361555380576356625 28385640762100638931546
;; small program: (loop(x * y, x, 1) - loop2(x * y, y, x - 1, 2, 1 + x)) + loop2(x * y, y, x, 1, x)
;; fast program: ((loop2(x * y, y, x - 2, 1, x) * (if x <= 0 then 1 else (x * x))) - loop2(x * y, y, x - 1, 2, 1 + x)) + loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (* (w3 x) (ite (<= x 0) 1 (* x x))) (w4 x)) (v5 x)))))
