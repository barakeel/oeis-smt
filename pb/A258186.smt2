...
(assert (forall ((x Int)) (= (f0 x) (* (modf (+ (v1 x) 1) (+ 1 (+ x x))) (+ 1 x)))))
(assert (= g0 1))
(assert (forall ((x Int)) (= (h0 x) (divf x 2))))
(assert (forall ((x Int) (y Int)) (= (u0 x y) (ite (<= x 0) y (f0 (u0 (- x 1) y))))))
(assert (forall ((x Int)) (= (v0 x) (u0 g0 (h0 x)))))
(assert (forall ((x Int)) (= (small x) (divf (divf (divf (+ (divf (v0 x) 2) 1) 2) 2) 2))))
...
(assert (forall ((x Int)) (= (f3 x) (* (modf (+ (* (v4 x) 2) 1) (+ 1 (+ x x))) (+ 1 x)))))
(assert (= g3 1))
(assert (forall ((x Int)) (= (h3 x) (divf x 2))))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y))))))
(assert (forall ((x Int)) (= (v3 x) (u3 g3 (h3 x)))))
(assert (forall ((x Int)) (= (fast x) (divf (divf (divf (+ (divf (v3 x) 2) 1) 2) 2) 2))))
