;; sequence(s): A73940
;; terms: 1 14 38416 20661046784 2177953337809371136 44998795805848373114515226624 182225556172186058674940229804729969934336
;; small program: loop((loop(x * x, 2, 2) - 2) * x, x * x, 1)
;; fast program: (loop2(x * y, y, x - 1, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) * loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))
(set-logic UFNIA)
