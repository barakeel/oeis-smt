;; sequence(s): A188538
;; terms: 1 2 2 4 6 12 23 46 90 174 330 616 1133 2058 3698 6584 11630 20404 35587 61750
;; small program: x + loop2(y, ((x + y) - 2) - 1, x, 1, x)
;; fast program: loop(((loop2(x + y, x, x, 2, 1 - x) - 2) - x) - 1, 2, x) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g0 x y) (- (- (+ x y) 2) 1))))
...
(assert (forall ((x Int)) (= (f1 x) (- (- (- (w2 x) 2) x) 1))))
(assert (= g1 2))
