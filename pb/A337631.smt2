;; sequence(s): A337631
;; terms: 0 1 10 55 228 801 2526 7387 20440 54229 139218 348111 851916 2047945 4849606 11337667 26214336 60030909 136314810 307232695
;; small program: loop(loop(loop2(x * y, 2, y, y, y) + x, y, x), x, 0)
;; fast program: loop(loop(loop2(((y * y) + x) + x, y - 1, x, 0, x), 1, y) + x, x, 0)
(set-logic UFNIA)
(declare-fun f2 (Int Int) Int)
(declare-fun g2 () Int)
(declare-fun h2 (Int Int) Int)
(declare-fun i2 (Int Int) Int)
