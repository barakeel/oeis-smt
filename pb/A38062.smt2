;; sequence(s): A38062
;; terms: 1 3 9 81 1296 30375 944784 36756909 1719926784 94143178827 5904900000000 417703359617577 32905425960566784 2857282535902251951 271165225379757133824 27925772039747314453125
;; small program: loop((x + x) + x, x, loop2(x * y, y, x - 2, 1, x))
;; fast program: loop2(x * y, y, x - 2, 1, x) * loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
