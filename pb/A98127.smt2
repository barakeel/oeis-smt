;; sequence(s): A98127
;; terms: 7 26 33 59 92 151 243 394 637 1031 1668 2699 4367 7066 11433 18499 29932 48431 78363 126794
;; small program: loop2(y, x + y, x, 1 + (2 + (2 + 2)), loop(1 + (x * x), 2, 2))
;; fast program: loop2(x + y, x, x, 1 + (2 + (2 + 2)), 1 + (2 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
