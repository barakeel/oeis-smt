;; sequence(s): A5522
;; terms: 4 3 6 10 21 46 108 263 658 1674 4305 11146 28980 75547 197262 515594 1348477 3528150 9233244 24167167
;; small program: (1 + loop2(y - x, x, x + x, 1, 1)) + loop2(y, x + y, x, 2, 1)
;; fast program: (loop2(((x - y) + x) + x, x, x - 2, if (x - 1) <= 0 then 1 else 2, 1) + loop2(y, x + y, x, 2, 1)) + 1
(set-logic UFNIA)
