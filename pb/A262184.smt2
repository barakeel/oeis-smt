;; sequence(s): A262184
;; terms: 1 1 1 3 7 21 57 157 421 1123 2971 7833 20593 54057 141753 371491 973183 2548813 6674473 17476581
;; small program: 1 + loop((x * x) - x, 1, loop2(x + y, x, x, 0, 1))
;; fast program: 1 + loop((x * x) - x, 1, loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
