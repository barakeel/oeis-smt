;; sequence(s): A298679
;; terms: 0 3 6 33 102 423 1494 5745 21102 79431 295086 1103985 4114710 15367143 57329286 213999153 798569022 2980473543 11122931934 41512040625
;; small program: loop((loop2(y, (2 * (y + y)) - x, y, 0, 1 + 2) - x) - x, x, 0)
;; fast program: loop((loop2((2 * (x + x)) - y, x, y - 1, 1, 0) - x) - x, x, 0) * (1 + 2)
(set-logic UFNIA)
