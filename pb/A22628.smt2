;; sequence(s): A22628
;; terms: 1 25 418 5898 76059 930003 10996396 127188916 1449394837 16348318701 183083516694 2039995806654 22648876033135 250810539522919 2772306789414112 30602539667823912 337485446955075753 3719200955052251457 40966103582317693450 451066307861295957490
;; small program: loop((loop((loop(1 + (2 * (2 * (x + x))), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + x) + ((((x * 2) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (- (v2 x y) x) (v3 x)))))
