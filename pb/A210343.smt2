;; sequence(s): A210343
;; terms: 1 1 4 27 625 32768 4826809 1801088541 1785793904896 4605366583984375 31181719929966183601 552061438912436417593344 25601832525455335435322705761 3107689015140868348741078056241817 987683253336131809511244100000000000000
;; small program: loop2(loop2(x + y, x, y, x, 0), y, x, 1, x)
;; fast program: loop2(x * y, y, x - 2, 1, loop2(x + y, x, x - 1, 1, 1)) * loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1))
(set-logic UFNIA)
