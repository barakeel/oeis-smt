;; sequence(s): A95344
;; terms: 1 1 9 9 49 81 281 601 1729 4129 11049 27561 71761 182001 469049 1197049 3073249 7861441 20154441 51600201
;; small program: loop(loop2((x + y) + y, x + x, y, 2, 0) - x, x, 1)
;; fast program: loop2(y - x, 2 * (x + y), x, 1 + 2, 2) - loop(0 - x, x, 2)
(set-logic UFNIA)
