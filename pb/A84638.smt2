;; sequence(s): A84638
;; terms: 1 1 2 4 8 16 32 64 129 265 558 1200 2610 5682 12288 26292 55587 116179 240366 493108
;; small program: loop(loop(loop(loop(loop(loop(x + y, (y - 2) - 2, x), y, x), y, x), y - 2, x), y, x) + x, x - 1, 1)
;; fast program: loop(loop(loop(loop(loop(loop(x + y, y, x), y, x), y - 2, x), y - 2, x), y - 2, x) + x, x - 1, 1)
(set-logic UFNIA)
