;; sequence(s): A13906
;; terms: 23 148035889 952809757913927 6132610415680998648961 39471584120695485887249589623 254052654154149545721997685422868689 1635170022196481349560959748587682926364327 10524515126174167358877236351104092889324551536161 67739389260745218861137988047774370539553852007909099223
;; small program: loop(loop(x * y, 2 + 2, x) - x, 1 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1)) * loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + (2 + 2)))) - 1)) * loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1))
(set-logic UFNIA)
