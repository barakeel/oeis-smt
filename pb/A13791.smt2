;; sequence(s): A13791
;; terms: 729 4782969 31381059609 205891132094649 1350851717672992089 8862938119652501095929 58149737003040059690390169 381520424476945831628649898809 2503155504993241601315571986085849 16423203268260658146231467800709255289
;; small program: loop((x + x) + x, 2 * loop(1 + (x + x), 2, x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1 + 2, 1 + (2 * (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 * (2 + 2))))
(set-logic UFNIA)
