;; sequence(s): A80250
;; terms: 1 35 871 19215 402591 8236095 166570111 3349906175 67183250431 1345516627455 26928850135551 538762184167935 10777095520297471 215560428864815615 4311393762242888191 86229727095755178495
;; small program: loop(loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), y, 1) + loop(((2 + y) * x) + x, 2, x), x, 1)
;; fast program: loop(loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)), 1, y) + (2 * (2 * ((2 * (x + x)) + x))), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g6 x y) (+ 1 (* 2 (+ y y))))))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (v5 x y) (* 2 (* 2 (+ (* 2 (+ x x)) x)))))))
