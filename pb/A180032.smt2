;; sequence(s): A180032
;; terms: 1 6 37 227 1394 8559 52553 322678 1981261 12165051 74694082 458625767 2815987409 17290317414 106163498933 651849716563 4002393075346 24574913392671 150891318490777 926480986202582
;; small program: loop2((2 * ((x + x) + x)) + y, x - y, x, 1, 0)
;; fast program: loop2((2 * ((x + x) + x)) + y, x - y, x - 1, if x <= 0 then 1 else (2 + (2 + 2)), 1)
(set-logic UFNIA)
