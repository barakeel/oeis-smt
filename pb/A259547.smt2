;; sequence(s): A259547
;; terms: 0 1 16 162 768 3125 10368 31213 86016 223074 550000 1303049 2985984 6654713 14482832 30881250 64684032 133383037 271257984 544872101
;; small program: loop2(x + y, x, x, 0, loop(x * x, 2, x))
;; fast program: ((x * x) * x) * loop2(x + y, x, x - 2, x, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (* x x) x) (w2 x)))))
