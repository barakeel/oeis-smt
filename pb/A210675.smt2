;; sequence(s): A210675
;; terms: 0 1 7 15 30 54 94 159 265 437 716 1168 1900 3085 5003 8107 13130 21258 34410 55691
;; small program: loop(x + loop2(y, 1 + (x + y), y, 2 + 2, 1), x, 0)
;; fast program: ((loop2(x + y, x, x, 1 + (2 + (2 + 2)), 2) - (2 * (2 + 2))) - x) + 1
(set-logic UFNIA)
