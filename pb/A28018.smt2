;; sequence(s): A28018
;; terms: 1 31 625 10395 155001 2155251 28559665 365471515 4555708201 55646962371 668889963105 7936976609835 93190238832601 1084660596151891 12532810309612945 143923263421271355
;; small program: loop((loop((loop2((2 * ((2 * (x + x)) + x)) + ((y * y) * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x, x, 1)
