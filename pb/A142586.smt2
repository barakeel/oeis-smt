;; sequence(s): A142586
;; terms: 1 2 5 14 39 107 290 779 2079 5522 14615 38579 101634 267347 702455 1844114 4838079 12686507 33254210 87141659
;; small program: loop2(y - x, x, x + x, 2, 1) - loop(x + x, x - 1, 1)
;; fast program: loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2) - loop(x + x, x - 1, 1)
(set-logic UFNIA)
