;; sequence(s): A22378
;; terms: 2 32 34 66 100 166 266 432 698 1130 1828 2958 4786 7744 12530 20274 32804 53078 85882 138960
;; small program: 2 * loop2(y, x + y, x, 1, loop(x * x, 2, 2))
;; fast program: 2 * loop2(y, x + y, x, 1, 2 * (2 * (2 + 2)))
(set-logic UFNIA)
