;; sequence(s): A220888
;; terms: 0 0 0 0 2 11 37 98 225 470 919 1713 3082 5400 9274 15688 26236 43499 71655 117466
;; small program: loop(loop(loop(loop(loop2(x + y, x, y, 1, 1) + x, (y - 1) - 2, x), y, x), y, x), x, 0)
;; fast program: loop(loop(loop(loop(loop2(x + y, x, y, 1, 1) + x, y, x), y, x), y, x), (x - 1) - 2, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g5 x) (- (- x 1) 2))))
(assert (= h5 0))
