;; sequence(s): A74580
;; terms: 3 24 194 1584 13058 108624 911234 7703664 65588738 561991824 4843001474 41948320944 364990300418 3188510652624 27953062038914 245823065693424 2167728096132098 19161612027339024 169737447404391554
;; small program: loop2((2 * ((((y * y) + x) + x) + x)) + x, (y + y) + y, x, 2, 1) + loop(x + x, (x + x) + x, 1)
;; fast program: (loop((x * x) * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))
(set-logic UFNIA)
