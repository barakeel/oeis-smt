;; sequence(s): A98694-A137592
;; terms: 1 2 48 34560 1393459200 5056584744960000 2422112183371431936000000 211155601241022491077587763200000000 4417964278440225627098723475313498521600000000000
;; small program: loop(loop(x * y, y + y, x), x, 1)
;; fast program: (loop(loop((2 * (x * y)) + x, y, 1) * x, x - 1, 1) * loop2(x * y, y + y, x, 1, 2)) * loop(loop(x * y, y, x), x, 1)
(set-logic UFNIA)
