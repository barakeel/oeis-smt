;; sequence(s): A21829
;; terms: 1 21 297 3577 39753 422793 4384969 44813769 454009545 4575676105 45971643081 461011315401 4617904831177 46225887853257 462540273695433 4627092539587273 46281069938293449 462871589543951049
;; small program: loop(loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), x, 1)
...
(assert (forall ((x Int) (y Int)) (= (g5 x y) (+ 1 (* 2 (+ y y))))))
