;; sequence(s): A23954
;; terms: 1 24 379 4974 58825 651228 6891463 70602378 706070629 6931922712 67078160227 641665645062 6081300568513 57197856053076 534603948966271 4970585718586626 46011858222290077 424339730032027920
;; small program: loop(loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + loop((x + x) + x, 2, x), x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + (2 * (2 * (y + y))), x, 1, 1 + (2 * (2 + 2))), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
