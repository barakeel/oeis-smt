;; sequence(s): A88852
;; terms: 1 20 5376 22282240 1464583847936 1536853372840181760 25788843362951132511993856 6922956840496417818923870380359680 29734213503918523875893136571995338085236736 2043325439152335369940571764620635289780959288334745600
;; small program: loop(x + x, 2 * (x * x), loop(1 + (2 * (x + x)), x, 1))
;; fast program: (((loop2(1 + (x * y), y, x, 1, 2 + 2) * loop2(x * y, y + y, x - 1, 1, 2)) * loop2(x * y, y + y, x - 1, 1, 2)) * loop2(x * y, y + y, x, 1, 2)) * loop2(x * y, y + y, x, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (* (* (w2 x) (w3 x)) (w4 x)) (w5 x)) (w6 x)))))
