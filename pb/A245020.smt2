;; sequence(s): A245020
;; terms: 0 2 30 302 2550 19502 140070 963902 6433590 41983502 269335110 1705278302 10686396630 66425568302 410223570150 2520229093502 15417960407670 93999281613902 571487645261190 3466523088409502
;; small program: loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 0, 1) + (2 * (x + x))) + x, x, 0) * 2
;; fast program: loop(((((loop(loop2(x * y, y, x, 1, 2 + (2 + 2)) - loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) + x) + x) + x) + x) + x, x, 0)
(set-logic UFNIA)
