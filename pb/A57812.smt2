...
(assert (forall ((x Int)) (= (f2 x) (ite (<= (modf (+ 1 (v3 x)) (+ 1 x)) 0) (modf 1 x) 0))))
(assert (= g2 1))
...
(assert (forall ((x Int)) (= (f6 x) (modf (+ (+ (ite (<= (- (modf (+ 1 (v7 x)) (+ 1 (+ x x))) 2) 0) 1 2) x) x) (ite (<= x 0) 1 2)))))
(assert (= g6 1))
...
(assert (forall ((x Int)) (= (f4 x) (modf (+ (v5 x) (ite (<= x 0) 0 1)) 2))))
