;; sequence(s): A76811
;; terms: 1 13 28561 10604499373 665416609183179841 7056410014866816666030739693 12646218552730347184269489080961456410641 3830224792147131369362629348887201408953937846517364173
;; small program: loop(loop((2 + y) * x, 2, x) + x, x * x, 1)
;; fast program: loop2(loop2(x * y, y, y, 1, 1 + (2 * (2 + (2 + 2)))) * x, 2 + y, x, 1, 1)
(set-logic UFNIA)
