;; sequence(s): A108078
;; terms: 1 2 12 576 414720 7166361600 4334215495680000 125824009525788672000000 230121443546659694208614400000000 33669808475874225917238947767910400000000000 487707458060712424140716248549520230160793600000000000000
;; small program: loop(loop((x * y) * y, y, x), x, 1 + x)
;; fast program: loop((x * y) * y, x, 1 + x) * loop(loop(x * x, 1, loop(x * y, y - 1, 1)) * x, x, 1)
(set-logic UFNIA)
