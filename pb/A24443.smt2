;; sequence(s): A24443
;; terms: 1 29 558 8986 131243 1805223 23872696 307323332 3882264405 48383711857 597102947714 7316027902638 89165615770687 1082459954878331 13102563809462412 158253703693612504
;; small program: loop((loop(loop(1 + loop((x + x) + x, 2, x), y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
...
(assert (forall ((x Int) (y Int)) (= (g7 x y) (+ 1 (+ (* 2 (+ (+ y y) y)) y)))))
