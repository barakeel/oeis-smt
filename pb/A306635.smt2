;; sequence(s): A306635
;; terms: 1 2 576 14332723200 72474629486854275072000000 482580045081719158086051946616717605601280000000000000
;; small program: loop(loop(loop(x * y, y, x), y + y, x), x, 1)
;; fast program: loop(loop(loop2(loop((x * y) * y, y, 1 + y) * x, 2 + y, x, 1, 1), 1, y) * x, x, 1)
(set-logic UFNIA)
