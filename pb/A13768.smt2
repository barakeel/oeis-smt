;; sequence(s): A13768
;; terms: 21 194481 1801088541 16679880978201 154472377739119461 1430568690241985328321 13248496640331026125580781 122694327386105632949003612841 1136272165922724266740722458520501 10523016528610349434285830688358359761
;; small program: loop((loop(2 * (2 + x), 2, 2) * x) + x, 1 + ((x + x) + x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))) * loop2(x * y, y, 1 + x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
