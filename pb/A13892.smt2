;; sequence(s): A13892
;; terms: 6859 16983563041 42052983462257059 104127350297911241532841 257829627945307727248226067259 638411683925748518131605316913942641 1580770532156861979997149793605296459437459 3914144333903073791808962606796280957916632792441
;; small program: loop((2 * loop((x + x) + x, 2, x)) + x, loop(1 + (x + x), 2, x) + x, 1)
