;; sequence(s): A244309
;; terms: 0 0 0 4 18 100 448 2028 8820 38148 163350 697048 2965248 12595048 53440504 226608900 960530634 4070452764 17246835648 73069580980
;; small program: loop(((x * x) - x) * x, 1, loop2(x + y, x, x, 0, 1))
;; fast program: loop(((x * x) - x) * x, 1, loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
