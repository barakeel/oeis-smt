;; sequence(s): A121913
;; terms: 1 32 16384 134217728 17592186044416 36893488147419103232 1237940039285380274899124224 664613997892457936451903530140172288 5708990770823839524233143877797980545530986496
;; small program: loop(2 * loop(x + x, y, x), x + x, 1)
;; fast program: loop(x * x, 2, loop2(x * y, y + y, x - 1, 1, 2)) * loop((((x * x) * x) * x) * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
