;; sequence(s): A328791
;; terms: 3 28 903 30628 1040403 35343028 1200622503 40785822028 1385517326403 47066803275628 1598885794044903 54315050194251028 1845112820810490003 62679520857362409028 2129258596329511416903 72332112754346025765628 2457162575051435364614403
;; small program: (1 + loop(x * x, 1, loop2((2 * ((x + x) + x)) - y, x, x, 0, 1 + (2 + 2)))) + 2
;; fast program: loop(x * x, 1, loop2((2 * ((x + x) + x)) - y, x, x - 1, if x <= 0 then 0 else (1 + (2 + 2)), 0)) + (1 + 2)
(set-logic UFNIA)
