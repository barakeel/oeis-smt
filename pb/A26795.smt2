;; sequence(s): A26795
;; terms: 1 27 475 6915 90571 1110147 13011355 147722355 1638222091 17846324067 191730867835 2037261517395 21455455896811 224319716510787 2331201129229915 24104752246858035 248186422724438731
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
