;; sequence(s): A254381
;; terms: 1 18 540 22680 1224720 80831520 6304858560 567437270400 57878601580800 6598160580211200 831368233106611200 114728816168712345600 17209322425306851840000 2787910232899709998080000
;; small program: loop(loop(((2 + y) * x) + y, 2, y) * x, x, 1)
;; fast program: loop2(x * y, 1 + y, x, 1, 2 + x) * loop2(x * y, y, x, 1 + x, 1 + 2)
(set-logic UFNIA)
