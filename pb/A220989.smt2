;; sequence(s): A220989
;; terms: 7 1657 247969 35821441 5159655937 743006877697 106993187463169 15407021359595521 2218611104160546817 319479999339664244737 46005119908998197280769 6624737266944778960896001 953962166440636632998608897
;; small program: (loop((x - 1) * x, 1, loop(loop((2 + y) * x, 2, x), x, 2)) * (1 + 2)) + 1
;; fast program: (loop((x - 1) * x, 1, loop2(x * y, y, x, 2, 2 * (2 + (2 + 2)))) * (1 + 2)) + 1
(set-logic UFNIA)
