;; sequence(s): A24437
;; terms: 1 25 410 5570 67971 774075 8402620 88071940 898959941 8988218525 88404153630 858025759110 8237487011911 78372461725375 740024044725440 6943130337867080 64790256275839881 601800374629166625
;; small program: loop((loop(loop(1 + (2 * (2 * (x + x))), y, 1) + loop((x + x) + x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((2 * ((y + y) + y)) + y), x, 1, 2 * (2 + 2)), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
