;; sequence(s): A13751
;; terms: 144 248832 429981696 743008370688 1283918464548864 2218611106740436992 3833759992447475122176 6624737266949237011120128 11447545997288281555215581184
;; small program: loop(loop((2 + y) * x, 2, x), 2 + ((x + x) + x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 2, 2 * (2 + (2 + 2)))) * loop2(x * y, y, 1 + x, 1 + 2, 2 * (2 + (2 + 2)))
(set-logic UFNIA)
