;; sequence(s): A174515
;; terms: 1 25 397 5125 58813 626725 6356749 62315125 596370205 5610245125 52128987181 480061573525 4392455087677 40002549209125 363080219023693 3287474035532725 29714233445499229 268240649382317125
;; small program: loop(loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), x, 1)
;; fast program: loop(loop(loop((loop2(((x + x) + x) + y, y + y, y, 1, 2) + x) + x, x, 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
