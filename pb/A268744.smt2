;; sequence(s): A268744
;; terms: 4 11 32 89 244 659 1760 4657 12228 31899 82752 213641 549236 1406755 3591232 9140833 23204612 58765099 148496608 374496953
;; small program: loop2((x + x) + y, x, 1 + x, 1, 2 + x)
;; fast program: loop2((x + x) + y, x, x, 2 + (2 + x), 1)
(set-logic UFNIA)
