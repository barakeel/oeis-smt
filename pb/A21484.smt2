;; sequence(s): A21484
;; terms: 1 21 310 4050 50371 613671 7411240 89174100 1071295141 12861600921 154369595770 1852587338550 22231809806311 266785528785771 3201445408153900 38417440232993400 461009759536223881
;; small program: loop(((loop((loop(1 + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
