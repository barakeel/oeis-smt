;; sequence(s): A291945
;; terms: 1 1111 1234321 1371330631 1523548331041 1692662195786551 1880547699518858161 2089288494165451416871 2321199517017816524143681 2578852663406794158323629591 2865105309044948309897552475601 3183131998348937572296180800392711 3536459650165669642821056869236301921 3929006671334058973174194181721531434231
;; small program: loop(loop((2 + loop((x + x) + x, 2, x)) * x, 2, 1) * x, x, 1)
;; fast program: loop2(x * y, y, x, 1, 1 + loop(x * x, 1, 2 + (2 * (2 + 2)))) * loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (w3 x) (w5 x)))))
