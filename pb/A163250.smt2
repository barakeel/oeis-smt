;; sequence(s): A163250
;; terms: 0 0 1 5 15 36 76 148 273 485 839 1424 2384 3952 6505 10653 17383 28292 45964 74580
;; small program: loop(loop((loop2(x + y, x, y, 1, 1) - 2) + x, y, x), x, 0)
;; fast program: ((loop2(x + y, x, x, 2 * (2 + 2), 1 + (2 + 2)) - 2) - ((2 + x) * (2 + x))) - 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (- (w3 x) 2) (* (+ 2 x) (+ 2 x))) 2))))
