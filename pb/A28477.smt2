;; sequence(s): A28477
;; terms: 1 2 20 108 725 4480 28561 179928 1138660 7193450 45474461 287400960 1816564229 11481464878 72568802500 458669938608 2899021855801 18323243845760 115811947027949 731988596166300
;; small program: loop(x * x, 1, loop2(x + y, x, x, 1, 0)) * loop2((x + x) + y, x, x, 1, 0)
;; fast program: (if x <= 0 then 1 else loop2((x + x) + y, x, x - 1, 2, 1)) * loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (ite (<= x 0) 1 (w3 x)) (v4 x)))))
