;; sequence(s): A78185
;; terms: 1 15 50625 38443359375 6568408355712890625 252511682940423488616943359375 2184164409074570299708284437656402587890625
;; small program: loop((loop(x * x, 2, 2) * x) - x, x * x, 1)
;; fast program: loop2(x * y, y, x, 1, loop((x + x) + x, x - 1, 1 + 2)) * loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
