;; sequence(s): A190535
;; terms: 56 672 13440 443520 23950080 2107607040 301387806720 69921971159040 26290661155799040 16011012643881615360 15786858466867272744960 25195826113120167300956160 65080818850189392138369761280
;; small program: loop(loop2(x + y, x, 2 + y, x, x) - x, 2 + x, 2)
;; fast program: loop(loop2(1 + (x + y), x, y, 2, 1) * x, 2 + x, 2)
(set-logic UFNIA)
