;; sequence(s): A84963
;; terms: 7 13 233 2211236406303914545699412969744873993387956988653
;; small program: loop(loop2(x + y, x, x, 0, 1), x, 1 + (2 + (2 + 2)))
;; fast program: loop(loop2(x + y, x, x - 2, 1, 1), x, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
