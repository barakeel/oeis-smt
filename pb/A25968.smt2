;; sequence(s): A25968
;; terms: 1 22 320 3920 44016 471072 4904320 50237440 509670656 5141007872 51677982720 518395637760 5193684791296 51995352604672 520305091051520 5205162447994880 52064302294695936 520719124195049472
;; small program: loop(((loop2(((2 * ((x + x) + y)) - 1) + x, y + y, y, 1, 2) + x) + x) + x, x, 1) * loop(x + x, x, 1)
