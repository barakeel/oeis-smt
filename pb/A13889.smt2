;; sequence(s): A13889
;; terms: 104976 198359290368 374813367582081024 708235345355337676357632 1338258845052394702439737982976 2528731089327963353099650821015994368 4778209346999261057189801002565550445953024 9028751479390699717312017900815782025058563653632
;; small program: loop(2 * loop((x + x) + x, 2, x), (2 * (2 + (x + x))) + x, 1)
