;; sequence(s): A25934
;; terms: 1 20 269 3100 33261 344580 3507709 35392940 355527821 3563328340 35673709149 356939747580 3570412342381 35709202523300 357117435046589 3571301442515020 35713650014404941 357139678477481460
;; small program: loop(((loop((loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + x) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop((loop2(((x + x) + x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + ((((x + x) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (v6 x y) (* (+ (* (+ x x) 2) x) 2)))))
