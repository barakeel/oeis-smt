;; sequence(s): A111108
;; terms: 0 5 3 25 25 131 175 705 1137 3875 7095 21649 43225 122435 259423 698625 1541985 4011971 9107175 23143825
;; small program: loop2((x + x) + y, x, x, 1, 1) - loop(0 - (x + x), x, 1)
;; fast program: loop2((x + x) + y, x, x, 1, 1) - loop2(x * y, y, x, 1, 0 - 2)
(set-logic UFNIA)
