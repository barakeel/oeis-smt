;; sequence(s): A25995
;; terms: 1 25 412 5694 71799 859131 9961834 113290048 1272810517 14190510477 157439054136 1741315046562 19221270567955 211903646137663 2334237969260518 25699753556697636 282859494700604913
;; small program: loop((loop((loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop((loop2(((2 * (x + x)) + x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
