;; sequence(s): A179823
;; terms: 1 1 2 5 29 408 33461 38613965 3654502875938 399133058537705128729 4125636888562548868221559797461449 4657508918199804645965719872781284840798220312648198320
;; small program: loop2((x + x) + y, x, loop2(x + y, x, x, 1, 0), 0, 1)
;; fast program: loop2((2 * x) + y, x, loop2(x + y, x, x, 1, 0) - 1, 1, 0)
(set-logic UFNIA)
