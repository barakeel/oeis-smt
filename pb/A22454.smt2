;; sequence(s): A22454
;; terms: 1 23 352 4530 53151 590373 6335302 66471680 687035701 7029030723 71413230252 722053798830 7276293638251 73154751811073 734297855505202 7362269063785980 73757914933860801 738526673084931423
;; small program: loop((loop((loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (* 2 (+ (* 2 (+ x x)) x)) y))))
