;; sequence(s): A208354
;; terms: 1 1 2 4 7 13 23 41 72 126 219 379 653 1121 1918 3272 5567 9449 16003 27049
;; small program: loop((loop2(2 + y, x + y, y - 1, 1 + 2, y) - x) - x, x, 1)
;; fast program: loop((loop2(y, x + y, y - 1, 1 + 2, 2 + y) - x) - x, x, 1)
(set-logic UFNIA)
