;; sequence(s): A200562
;; terms: 1 ~1 3 3 ~5 35 ~21 51 187 ~253 1035 ~45 91 8099 ~8277 25203 23035 ~38845 286539 ~179949
;; small program: loop2(loop2((x - y) - y, x, y, 1, 0) * x, 1 + y, 2, 1, x)
;; fast program: loop2(loop2((x - y) - y, x, y, 1, 1) * x, y - 1, 2, 1, x)
(set-logic UFNIA)
