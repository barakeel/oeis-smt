;; sequence(s): A6355
;; terms: 1 0 2 2 4 6 10 16 26 42 68 110 178 288 466 754 1220 1974 3194 5168
;; small program: if x <= 0 then 1 else loop2(y, x + y, x, 2, 0)
;; fast program: if x <= 0 then 1 else loop2(x + y, x, x - 1, 0, 2)
(set-logic UFNIA)
