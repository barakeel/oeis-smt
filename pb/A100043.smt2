;; sequence(s): A100043
;; terms: 2 120 40320 39916800 87178291200 355687428096000 2432902008176640000 25852016738884976640000 403291461126605635584000000 8841761993739701954543616000000 263130836933693530167218012160000000
;; small program: loop((2 + y) * x, (x + x) + x, 2)
;; fast program: loop2((x * y) + x, 1 + y, 2 + x, 1, x + x) * loop(x * y, x + x, 1)
(set-logic UFNIA)
