;; sequence(s): A13856
;; terms: 1000 100000000 10000000000000 1000000000000000000 100000000000000000000000 10000000000000000000000000000 1000000000000000000000000000000000 100000000000000000000000000000000000000 10000000000000000000000000000000000000000000
;; small program: loop(2 * ((2 * (x + x)) + x), loop(1 + (x + x), 2, x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
