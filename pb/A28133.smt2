;; sequence(s): A28133
;; terms: 1 28 503 7418 98169 1217136 14481211 167749366 1909343117 21481183724 239821188399 2663810246994 29488849731745 325724954017192 3592642298586467 39588148322702702 435961667557278453
;; small program: loop((loop(loop2((loop((2 + y) * x, 2, x) - x) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
