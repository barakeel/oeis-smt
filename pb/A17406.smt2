;; sequence(s): A17406
;; terms: 1 2985984 148035889 1544804416 8303765625 30840979456 90458382169 225199600704 496981290961 1000000000000 1870414552161 3297303959104 5534900853769 8916100448256 13867245015625
;; small program: loop(loop2(x * y, x, y, x, x), 2, 1 + (loop((2 + y) * x, 2, x) - x))
