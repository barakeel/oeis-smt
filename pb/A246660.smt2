...
(assert (forall ((x Int) (y Int)) (= (g2 x y) (divf y (- 2 (modf x 2))))))
...
(assert (forall ((x Int)) (= (f1 x) (modf (- (* (+ (divf (w2 x) 2) 1) (- 2 (modf x 2))) 2) (+ 1 x)))))
(assert (= g1 1))
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (modf y 2) x))))
(assert (forall ((x Int) (y Int)) (= (g6 x y) (divf y (- 2 (modf x 2))))))
(assert (= h6 (* 2 (+ 2 (+ 2 2)))))
(assert (= i6 1))
