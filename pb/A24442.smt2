;; sequence(s): A24442
;; terms: 1 28 518 7988 111279 1454376 18208156 221140696 2626932077 30692791844 354119115714 4046102802924 45880411771195 517157095113232 5801772397167992 64842434348911472 722511991410929433
;; small program: loop((loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + loop((x + x) + x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
