;; sequence(s): A139743
;; terms: 0 6 96 1206 14016 157926 1755936 19409046 213968256 2355994566 25927658976 285262842486 3138184236096 34521491440806 379743730067616 4177217651837526 45949577275681536 505446265559840646 5559913498794965856 61159071374928218166
;; small program: loop(loop((2 + y) * x, 2, x) - x, x, 1) - loop((2 * (x + x)) + x, x, 1)
;; fast program: loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))) - loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
