;; sequence(s): A3266
;; terms: 1 1 1 2 6 30 240 3120 65520 2227680 122522400 10904493600 1570247078400 365867569267200 137932073613734400 84138564904377984000 83044763560621070208000 132622487406311849122176000 342696507457909818131702784000
;; small program: loop(loop2(x + y, x, y, 0, x), x, 1)
;; fast program: loop(x * loop2(x + y, x, y - 1, 2, 1), x - 2, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* x (w3 x y)))))
