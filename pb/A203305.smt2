;; sequence(s): A203305
;; terms: 1 2 48 64512 20808990720 6658450862270054400 8590449816558320728896700416000 180165778137909187135292776823951671626301440000 246665746050863452218796304775365273357060390005370386894553088000000
;; small program: loop(loop2(((x * y) - x) * y, y + y, y, 1, 2) * x, x, 1)
;; fast program: loop(loop2(((y - 1) + y) * (x * y), y + y, y, 1, 2) * x, x - 1, 1) * loop2(x * y, y + y, x, 1, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (* (+ (- y 1) y) (* x y)))))
