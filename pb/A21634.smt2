;; sequence(s): A21634
;; terms: 1 21 298 3594 39763 417567 4236796 41963988 408348325 3920543913 37248255694 350941450782 3284131050487 30562445793459 283104150028192 2612274474873576 24025167335391049 220344082704460605
;; small program: loop(((loop(loop(1 + (2 * (2 * (x + x))), y, 1) + loop((x + x) + x, 2, x), y, 1) + x) + x) + x, x, 1)
