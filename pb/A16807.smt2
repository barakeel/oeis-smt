;; sequence(s): A16807
;; terms: 0 16384 2097152 35831808 268435456 1280000000 4586471424 13492928512 34359738368 78364164096 163840000000 319277809664 587068342272 1028071702528 1727094849536 2799360000000
;; small program: loop(loop2(x * y, x, 2 + y, 2, x), 2, x) * x
;; fast program: loop(loop((x * x) * x, 1, x * x) * x, 1, 2 * (x + x))
(set-logic UFNIA)
