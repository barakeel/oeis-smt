;; sequence(s): A99425
;; terms: 1 2 6 14 34 82 198 478 1154 2786 6726 16238 39202 94642 228486 551614 1331714 3215042 7761798 18738638
;; small program: if x <= 0 then 1 else loop2(y, (x + y) + y, x, 2, 2)
;; fast program: if x <= 0 then 1 else loop2((x + x) + y, x, x - 1, 2, 2)
(set-logic UFNIA)
