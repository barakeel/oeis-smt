;; sequence(s): A8860
;; terms: 1 2 4 8 16 32 64 128 255 502 968 1816 3302 5812 9908 16384 26333 41226 63004 94184
;; small program: loop(loop(loop(loop(loop(loop(x + y, y - 2, x), y, x) + y, y - 2, x), y, x) + y, y - 1, x), x, 1) + x
;; fast program: loop(loop(loop(loop(loop(loop(x + y, y, x), y - 1, x) + y, y - 2, x) + y, y, x), y - 2, x) + y, x, 1)
(set-logic UFNIA)
