;; sequence(s): A111262
;; terms: 3 12 65 403 2652 17889 121859 833260 5706081 39096531 267936188 1836369217 12586419075 86267964108 591287758337 4052742230419 27777897084444 190392509164065 1304969593244291 8944394450283436
;; small program: loop2(x + y, x, x + x, 2, 0) + loop2(x + y, x, 2 * (x + x), 1, 1)
;; fast program: loop2(((x - y) + x) + x, x, x - 1, if x <= 0 then 1 else 2, 1) * (2 + loop2(x + y, x, x + x, 1, 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (w2 x) (+ 2 (w3 x))))))
