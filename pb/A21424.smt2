;; sequence(s): A21424
;; terms: 1 16 170 1520 12411 96096 719860 5278240 38153621 273134576 1942326750 13748476560 97001079631 682818667456 4798793396840 33686888924480 236284962774441 1656378634646736 11606570499786130
;; small program: loop(((loop((loop(1 + ((2 * ((x + x) + x)) + x), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
