;; sequence(s): A74572
;; terms: 3 19 125 853 6017 43669 324425 2455213 18847457 146248549 1143973625 9001559773 71140399697 564037211029 4482514190825 35685074651533 284448674508737 2269489412583109 18119773163416025 144743621302194493
;; small program: loop2(((2 * (x + x)) + x) + y, 2 * ((y + y) + y), x, 2, 1) + loop(x + x, (x + x) + x, 1)
;; fast program: (loop((x * x) * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + 2))) + loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
