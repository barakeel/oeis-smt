;; sequence(s): A155625
;; terms: 1 14 136 1394 14896 162074 1775656 19503554 214424416 2358209834 25938473176 285315864914 3138445153936 34522779252794 379750102018696 4177249243157474 45949734158539456 505447045679162954
;; small program: (loop(x + x, x + x, 1) - 1) + loop(loop((2 + y) * x, 2, x) - x, x, 1)
;; fast program: (loop(x * x, 1, loop(x + x, x, 1)) - 1) + loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))
(set-logic UFNIA)
