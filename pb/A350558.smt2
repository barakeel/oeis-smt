;; sequence(s): A350558
;; terms: 1 1 64 1679616 63403380965376 8916100448256000000000000 10061319724179153710638694400000000000000 173335925289013982808975076100021379095592960000000000000000 79317573895713454077105543742169655162315106629579798748776628224000000000000000000
;; small program: loop2(loop((x * y) * y, y, x), y, 1 + x, 1, x)
;; fast program: (loop2(x * y, y, x - 2, 1, loop(x * y, x - 1, x)) * loop(x * x, 2, loop(x * y, x, 1))) * loop2(x * y, y, x, 1, loop(x * y, x - 1, x))
(set-logic UFNIA)
