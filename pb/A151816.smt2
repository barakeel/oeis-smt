;; sequence(s): A151816
;; terms: 0 1 15 495 29295 2735775 370945575 68916822975 16813959537375 5214921734397375 2004231846526284375 934957186489800849375 520444368391989625959375 340788940288324502208609375 259324006920606914270844234375 226933251813970116856323617109375 226305693647403205116652558922109375
;; small program: loop2(loop(x * y, y, 1) + ((y * y) * x), 2 + y, x, 0, 1)
;; fast program: (loop2(x * y, 1 + y, x, 1, 1 + x) * loop(x * y, x, 1)) - loop(x * x, 1, loop2(x * y, 2 + y, x - 1, 1, 1 + 2))
(set-logic UFNIA)
