;; sequence(s): A282464
;; terms: 0 1 3 15 51 176 560 1743 5271 15675 45925 133056 381888 1087645 3077451 8658951 24245655 67602608 187789616 519924075
;; small program: loop((loop(x * x, 1, loop2(x + y, x, y, 0, 1)) * y) + x, x, 0)
;; fast program: loop((loop(loop(x * x, 1, loop2(x + y, x, x - 2, 1, 1)), 1, y) * y) + x, x, 0)
(set-logic UFNIA)
