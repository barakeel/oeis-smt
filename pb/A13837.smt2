;; sequence(s): A13837
;; terms: 625 1953125 6103515625 19073486328125 59604644775390625 186264514923095703125 582076609134674072265625 1818989403545856475830078125 5684341886080801486968994140625 17763568394002504646778106689453125
;; small program: loop((2 * (x + x)) + x, (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 1 + (2 + 2))) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
