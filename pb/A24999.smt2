;; sequence(s): A24999
;; terms: 1 30 593 9738 143949 1989198 26238361 334590546 4159355717 50694901686 608290940049 7207487623674 84523773236605 982803891723294 11346293009032457 130203935811077922 1486512106726735413
;; small program: loop(loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (2 * (x + x))), x, 1)
;; fast program: loop((loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + (2 * (2 * (y + y))), x, 1, 1 + (2 * (2 + 2))), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
