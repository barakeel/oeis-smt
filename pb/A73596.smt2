;; sequence(s): A73596
;; terms: 0 1 5 23 116 669 4429 33375 283072 2673321 27845293 317274407 3926774180 52469606981 752922837861 11549166072847 188596608142560 3266826328953745 59830416584102325 1155208913864163511
;; small program: loop(loop(loop(1 + (x * y), y - 1, 1) + x, y, 0) + (x * y), x, 0)
;; fast program: loop(loop(loop(1 + (x * y), y, 1) + x, y - 1, 1) + (x * y), x, 0)
(set-logic UFNIA)
