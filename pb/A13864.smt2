;; sequence(s): A13864
;; terms: 1728 429981696 106993205379072 26623333280885243904 6624737266949237011120128 1648446623609512543951043690496 410186270246002225336426103593500672 102067469997853225734913580209377959215104 25397652694505813866070015990659936347412758528
;; small program: loop(loop((2 + y) * x, 2, x), loop(1 + (x + x), 2, x) + x, 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2)))) * loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 + 2))))
(set-logic UFNIA)
