;; sequence(s): A90599
;; terms: 1 4 81 16384 48828125 2821109907456 3909821048582988049 154742504910672534362390528 202755595904452569706561330872953769 10000000000000000000000000000000000000000000000
;; small program: loop2((x * y) + x, y, loop(x + y, x, 1), 1, x)
;; fast program: loop2(x * y, y, x, 1, 1 + x) * loop2(x * y, y, loop(x + y, x - 1, 1), 1, 1 + x)
(set-logic UFNIA)
