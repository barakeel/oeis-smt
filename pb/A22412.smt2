;; sequence(s): A22412
;; terms: 1 23 356 4690 57015 663621 7538098 84446336 938561525 10384529155 114604142016 1262952525198 13906624731091 153059279644385 1684178151097070 18529154259093436 203840055167045073
;; small program: loop((loop((loop(1 + (2 * ((x + x) + x)), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
