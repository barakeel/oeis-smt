;; sequence(s): A25983
;; terms: 1 27 485 7335 101181 1319967 16597525 203384295 2445473261 28983189807 339647023365 3944444998455 45472205947741 521027509282047 5939635577526005 67419323254471815 762445883405916621
;; small program: loop((loop((loop2((2 * ((2 * (x + x)) + x)) + (y * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((x + x) + y)) - 1) + x, y + y, x, 1, 2) * loop(x + x, x, 1), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (- (* 2 (+ (+ x x) y)) 1) x))))
