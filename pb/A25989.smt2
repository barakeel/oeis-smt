;; sequence(s): A25989
;; terms: 1 23 347 4375 50211 546063 5750347 59371895 605580371 6130227103 61765086747 620509140615 6222647943331 62333853156143 623992946413547 6243906815856535 62463186581999091 624777847926261183
;; small program: loop((loop(loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * ((x + x) + x)), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
