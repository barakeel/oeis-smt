;; sequence(s): A13767
;; terms: 400 3200000 25600000000 204800000000000 1638400000000000000 13107200000000000000000 104857600000000000000000000 838860800000000000000000000000 6710886400000000000000000000000000 53687091200000000000000000000000000000
;; small program: loop(loop(2 * (2 + x), 2, 2) * x, 2 + ((x + x) + x), 1)
;; fast program: (loop2(x * y, y, 2 + x, 1, 2 + (2 * (2 + 2))) * loop((x * x) * x, 1, loop(x + x, x, 1))) * loop(x * x, 1, loop2(x * y, y, x, 2, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
