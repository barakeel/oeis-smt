;; sequence(s): A13901
;; terms: 194481 794280046581 3243919932521508681 13248496640331026125580781 54108198377272584130510593262881 220983347100817338120002444455525554981 902518308877795191433240103403256374623457081 3685975927806112219127687339549342762856035687969181
;; small program: loop((loop(2 * (2 + x), 2, 2) * x) + x, (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, 1 + (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
