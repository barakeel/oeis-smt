;; sequence(s): A57527
;; terms: 1 1 2 48 331776 79254226206720 471092427871945743012986880000 351177419973413722592573060611594181593855426560000000000
;; small program: loop(loop(loop(loop(x * y, y, x), y, x), y, x), x, 1)
;; fast program: loop(loop(loop(loop(x * y, y, y) * x, y, 1 + y) * x, y, 1) * x, x - 1, 1)
(set-logic UFNIA)
