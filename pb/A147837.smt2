;; sequence(s): A147837
;; terms: 1 5 30 185 1145 7090 43905 271885 1683670 10426265 64565505 399827210 2475962945 15332604565 94948417230 587975897785 3641089198345 22547744899490 139628768304705 864662653635485
;; small program: loop2((2 * ((x + x) + x)) - y, y - x, x, 1, 1)
;; fast program: loop2((2 * ((x + x) + x)) + y, x + y, x - 1, (if x <= 0 then 0 else (2 + 2)) + 1, 0)
(set-logic UFNIA)
