;; sequence(s): A318197
;; terms: 1 144 629856 69657034752 178523361331200000 10072680467275913619308544 12094526244510115670028303294529536 301689370251168256106930569591201258430005248 153543958878683931150976515367278080485732740052794998784 1572290138917723454985999517360927544173903258140620787548160000000000
;; small program: (loop2((x * y) + x, y, 1 + x, 1, x) * loop2(x * y, y, x, 1, loop((x + x) + x, 1 + x, 2))) * loop2(x * y, y + y, x, 1, 2)
;; fast program: ((loop2(x * y, y + y, x, 1, 1 + 2) * loop2(x * y, (y + y) + y, x, 1, 1 + 2)) * loop2(x * y, y, x, 1 + x, 1 + x)) * loop2(x * y, (y + y) + y, x, 1, 2 + 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (* (* (w0 x) (w1 x)) (w3 x)))))
...
(assert (forall ((x Int)) (= (fast x) (* (* (* (w4 x) (w5 x)) (w6 x)) (w7 x)))))
