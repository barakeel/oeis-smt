...
(assert (forall ((x Int)) (= (f3 x) (ite (<= (modf x 2) 0) (divf x 2) 2))))
...
(assert (forall ((x Int)) (= (small x) (+ (modf (* (divf (+ (+ (v0 x) 1) x) 2) 2) (+ 1 x)) 1))))
(assert (= f10 1))
(assert (forall ((x Int)) (= (g10 x) (modf x (+ 2 2)))))
(assert (= h10 (+ 2 2)))
(assert (forall ((x Int) (y Int)) (= (u10 x y) (ite (<= x 0) y f10))))
(assert (forall ((x Int)) (= (v10 x) (u10 (g10 x) h10))))
(assert (forall ((x Int)) (= (f9 x) (divf x (v10 x)))))
(assert (= g9 2))
...
(assert (forall ((x Int)) (= (f5 x) (modf (v6 x) 2))))
(assert (= g5 1))
...
(assert (forall ((x Int)) (= (fast x) (divf (- (* (+ (+ (* (modf (+ (+ (v4 x) 1) x) 2) 2) 1) (modf x 2)) (ite (<= x 0) 1 2)) 1) 2))))
