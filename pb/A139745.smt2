;; sequence(s): A139745
;; terms: 0 4 72 988 12240 144244 1653912 18663628 208594080 2317594084 25654949352 283334343868 3124587089520 34425823133524 379071610510392 4172500607905708 45916496933002560 505214397985306564 5558288899894321032 61147691553229173148
;; small program: loop(loop((2 + y) * x, 2, x) - x, x, 1) - loop((2 * ((x + x) + x)) + x, x, 1)
;; fast program: loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))) - loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
