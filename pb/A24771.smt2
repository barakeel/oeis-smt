;; sequence(s): A24771
;; terms: 1 28 515 7850 107481 1373088 16714975 196403350 2246489861 25160397548 277090599435 3010102678050 32332333478641 344033387428408 3631750686931895 38080468894107950 396993032851849821
;; small program: loop(loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + loop((x + x) + x, 2, x), x, 1)
;; fast program: loop((loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + (2 * (2 * (y + y))), x, 1, 1 + (2 * (2 + 2))), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g6 x y) (+ 1 (* 2 (* 2 (+ y y)))))))
