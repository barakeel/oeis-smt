;; sequence(s): A25984
;; terms: 1 28 524 8288 119952 1646400 21834688 282827776 3602179328 45309135872 564541565952 6982826532864 85877229359104 1051359996166144 12824652929417216 155979167054692352
;; small program: loop((loop2((2 * (((x + x) + x) + y)) - 1, y + y, y, 1, 2) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
;; fast program: loop((loop(loop((2 * ((x + x) + x)) - 1, x, 2) - loop(x + x, x, 1), 1, y) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
