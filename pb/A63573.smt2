;; sequence(s): A63573
;; terms: 1 2 10 170 33490 1133870930 1285739648704587610 1653126447166808568966775665261637370
;; small program: loop2(((x * y) * y) + x, x + y, x, 1, 1)
;; fast program: loop2((1 + (y * y)) * x, x + y, x, 1, 1)
(set-logic UFNIA)
