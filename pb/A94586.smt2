;; sequence(s): A94586
;; terms: 1 5 16 47 131 356 953 2529 6676 17567 46135 121016 317201 831053 2176712 5700303 14926171 39081404 102323209 267896585
;; small program: loop2(loop2(x + y, x, y, 1, 1) + x, 1 + y, 1 + x, 0, x)
;; fast program: loop2(((x - y) + x) + x, x, x, 1 + 2, 1) - loop2(x + y, x, x, 2, 1)
(set-logic UFNIA)
