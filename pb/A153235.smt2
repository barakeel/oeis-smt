...
(assert (forall ((x Int)) (= (f0 x) (modf (+ (+ (ite (<= (- (modf (+ 1 (v1 x)) (+ 1 (+ x x))) 2) 0) 1 2) x) x) (ite (<= x 0) 1 (* 2 (+ 2 2)))))))
...
(assert (forall ((x Int)) (= (f4 x) (modf (+ (+ (ite (<= (- (modf (+ 1 (v5 x)) (+ 1 (+ x x))) 2) 0) 1 2) x) x) (ite (<= x 0) 1 (* 2 (+ 2 2)))))))
