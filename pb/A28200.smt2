;; sequence(s): A28200
;; terms: 1 30 565 8550 113701 1388310 15958405 175419750 1863406501 19269697590 195034120645 1939826329350 19018419228901 184245490086870 1767124523521285 16805853434269350 158682246543588901 1489103597614860150 13900428943759584325
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop(loop(loop2(((x + x) + x) + y, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (2 * (x + x))), x, 1), 1, y) + (((x + x) + x) * 2)) + x, x, 1)
(set-logic UFNIA)
