;; sequence(s): A13762
;; terms: 18 104976 612220032 3570467226624 20822964865671168 121439531096594251776 708235345355337676357632 4130428534112329328517709824 24088659210943104643915283693568
;; small program: loop(2 * loop((x + x) + x, 2, x), 1 + ((x + x) + x), 1)
