;; sequence(s): A94003
;; terms: 2 3 13 2380 32098914298781 34076243757937210559857502330309024747435410425446137941014310689706
;; small program: loop(loop2(1 + (x * y), y, y, 1, x), x, 2)
;; fast program: loop(1 + (loop2(1 + (x * y), y, y - 1, 1, x) * x), x, 2)
(set-logic UFNIA)
