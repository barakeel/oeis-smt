;; sequence(s): A97040
;; terms: 0 0 2 8 26 76 212 576 1542 4092 10802 28424 74648 195808 513242 1344672 3521994 9223284 24151052 63235040
;; small program: loop2(x + y, x, x + x, 1, 0) - loop2(x + y, x, x, 1, 1)
;; fast program: loop2(((x - y) + x) + x, x, x - 1, 2, 1) - loop2(x + y, x, x - 1, 2, 1)
(set-logic UFNIA)
