;; sequence(s): A2109
;; terms: 1 1 4 108 27648 86400000 4031078400000 3319766398771200000 55696437941726556979200000 21577941222941856209168026828800000 215779412229418562091680268288000000000000000 61564384586635053951550731889313964883968000000000000000
;; small program: loop(loop2(x * y, y, y, x, y), x, 1)
;; fast program: loop(loop2(x * y, y, y - 1, y, y) * x, x - 1, 1) * loop2(x * y, y, x, 1, x)
(set-logic UFNIA)
