;; sequence(s): A13912
;; terms: 13824 110075314176 876488338465357824 6979147079584381377970176 55572324035428505185378394701824 442501521100279865673218454734216626176 3523473231949594865126345424909586928788045824 28056092520079410863331801112675274709253984591282176
;; small program: loop(loop(x * y, 2 + 2, x), loop(1 + (x + x), 2, x) + x, 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 * (2 + (2 + 2))))) * loop2(x * y, y, 1 + x, 1, 2 * (2 * (2 + (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 * (2 * (2 + (2 + 2)))))
(set-logic UFNIA)
