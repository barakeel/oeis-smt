;; sequence(s): A167436
;; terms: 2 17 730 65537 9765626 2176782337 678223072850 281474976710657 150094635296999122 100000000000000000001 81402749386839761113322 79496847203390844133441537 91733330193268616658399616010
;; small program: 1 + loop2((x * y) + x, y, 2 + (x + x), 1, x)
;; fast program: 1 + loop(x * x, 1, loop2(x * y, y, x, 1 + x, 1 + x))
(set-logic UFNIA)
