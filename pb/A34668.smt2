;; sequence(s): A34668
;; terms: 10 124 3410 131068 5732210 264105844 12441770330 591961476748 28294099221410 1355321291969764 64989628053819050 3117943006504850428 149624153907514522610 7181073568202394620884 344670347564106497096570
;; small program: loop2(1 + loop(x + x, y, x), y, 2 + 2, 1, x) * (1 + loop((x + x) + x, x, 1))
;; fast program: (1 + loop((1 + (x * x)) * ((x * x) + x), 1, loop(x + x, x, 1))) * (1 + loop2(x * y, y, x, 1, 1 + 2))
(set-logic UFNIA)
