;; sequence(s): A135609
;; terms: 0 0 0 9 320 11275 471744 24578057 1608925184 131294473911 13158189440000 1593065610569389 229433616702111744 38775485168526047747 7600043344545171881984 1710011814830309043140625 437763118250650978834448384 126513545678306908298879235823
;; small program: loop((x * y) * y, x, 1) - loop2(x * y, y, x, 1, x)
;; fast program: loop(x * x, 1, loop(x * y, x - 1, x)) - ((x * x) * loop2(x * y, y, x - 2, 1, x))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (v2 x) (* (* x x) (w4 x))))))
