;; sequence(s): A53404
;; terms: 1 1 13 25 181 481 2653 8425 40261 141361 624493 2320825 9814741 37664641 155441533 607417225 2472715621 9761722321 39434309773 156574977625
;; small program: loop2(loop((2 + y) * x, 2, y) + x, x, x, 1, 0)
;; fast program: loop2((2 * ((y + y) + y)) + x, x + x, x - 1, 1, 2)
(set-logic UFNIA)
