;; sequence(s): A15259
;; terms: 1 57 3705 236665 15150201 969583737 62053592185 3971428035705 254171409198201 16266970069380217 1041086085394771065 66629509457629850745 4264288605349394427001 272914470741872571493497
;; small program: loop(loop(loop2(((y * y) * y) - x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 2 * (2 + 2)), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(((y * y) * y) - x, y + y, x, 1, 2) * loop((x * x) * x, 1, loop(x + x, x, 1)), 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (- (* (* y y) y) x))))
