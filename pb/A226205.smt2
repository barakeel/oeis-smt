;; sequence(s): A226205
;; terms: 1 0 3 5 16 39 105 272 715 1869 4896 12815 33553 87840 229971 602069 1576240 4126647 10803705 28284464
;; small program: loop(loop2(x + y, x, y + y, 0, 1) - x, x, 1)
;; fast program: loop2(y, x + y, x, loop2(x + y, x, x, 1, 1), 0)
(set-logic UFNIA)
