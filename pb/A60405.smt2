;; sequence(s): A60405
;; terms: 2 2 5 9 19 40 88 198 455 1061 2501 5940 14182 33982 81625 196389 473039 1140260 2749988 6634458
;; small program: loop2((x + x) + y, x, x, 0, 1) + loop2(y, x + y, x, 2, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then 1 else 2, 1) + loop2(x + y, x, x - 1, 1, 2)
(set-logic UFNIA)
