;; sequence(s): A13910
;; terms: 24 191102976 1521681143169024 12116574790945106558976 96479729228174488169059713024 768231807465763655682670928358014976 6117141027690268863066571918245810640257024
;; small program: loop(loop(x * y, 2 + 2, x), 1 + ((2 * (x + x)) + x), 1)
