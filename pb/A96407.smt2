;; sequence(s): A96407
;; terms: 5 17 197 33857 1133938277 1285739650972396817 1653126447166808571538254964938621797
;; small program: loop2(((x * y) + x) + y, x * y, 1 + x, 1, 2)
;; fast program: 1 + loop(x * x, 1, loop(2 + ((x * x) - x), x, 2))
(set-logic UFNIA)
