;; sequence(s): A214885
;; terms: 0 ~3 2 ~14 25 ~80 192 ~523 1346 ~3550 9265 ~24288 63552 ~166419 435650 ~1140590 2986057 ~7817648 20466816 ~53582875
;; small program: loop(loop2(1 - (((x + x) + x) + y), x, y, 1, 0) + x, x, 0) - x
;; fast program: loop(loop(loop2(x + y, x, x - 1, 2, 1) * loop2(y - x, x, x, 1, 0), 1, y) + x, x, 0) - x
(set-logic UFNIA)
