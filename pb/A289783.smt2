;; sequence(s): A289783
;; terms: 1 5 24 113 527 2446 11325 52369 242008 1117997 5163891 23849270 110142089 508652653 2349005592 10847859961 50095958215 231345247934 1068361195173 4933730638937
;; small program: loop2(((x + x) + x) + y, (2 * (y + y)) + x, x, 1, 2)
;; fast program: loop2(((2 * (x + x)) - y) + x, (x + y) + y, x - 1, (if x <= 0 then 0 else (2 + 2)) + 1, 1)
(set-logic UFNIA)
