;; sequence(s): A224454
;; terms: 27 180 567 1296 2475 4212 6615 9792 13851 18900 25047 32400 41067 51156 62775 76032 91035 107892 126711 147600
;; small program: (1 + x) * loop2(y, (x * y) + x, 2 + 2, 1 + x, 2)
;; fast program: (1 + (2 + (x + x))) * loop(x * x, 1, (1 + 2) * (1 + x))
(set-logic UFNIA)
