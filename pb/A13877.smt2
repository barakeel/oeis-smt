;; sequence(s): A13877
;; terms: 50625 38443359375 29192926025390625 22168378200531005859375 16834112196028232574462890625 12783403948858939111232757568359375 9707397373664756887592375278472900390625 7371554880626674761515459977090358734130859375
;; small program: loop((loop(x * x, 2, 2) * x) - x, (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1)) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, (2 * (2 * (2 + 2))) - 1))
(set-logic UFNIA)
