;; sequence(s): A187879
;; terms: 1 3 6561 7625597484987 3433683820292512484657849089281 436673502879206784130402698570834024654748577491697818855443
;; small program: loop((x + x) + x, (x * x) * x, 1)
;; fast program: loop2(x * y, y, x - 1, 1, loop2(x * y, y, x, 1, loop((x + x) + x, x, 1))) * loop2(x * y, y, x, 1, loop((x + x) + x, x, 1))
(set-logic UFNIA)
