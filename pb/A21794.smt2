;; sequence(s): A21794
;; terms: 1 22 335 4460 56061 686802 8317435 100210120 1204613321 14466168782 173649468135 2084076423780 25010353485781 300131513309962 3601614875036435 43219563508677440 518635692871953441
;; small program: loop((loop(loop(1 + (2 * (x + x)), y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
