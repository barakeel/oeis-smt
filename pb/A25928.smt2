;; sequence(s): A25928
;; terms: 1 20 275 3310 37761 421440 4662175 51395570 565817021 6225908260 68492850075 753453315030 8288115908281 91169797529480 1002869877293975 11031577111093690 121347382194479541
;; small program: loop((loop2(((2 * ((y * y) + x)) - y) + x, y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop2(((2 * ((y * y) + x)) - y) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
