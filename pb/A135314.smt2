;; sequence(s): A135314
;; terms: 1 42 63504 3456649728 6773484887801856 477827850919028491026432 1213481763117613016471583634489344 110942398014527364799038852663129544775958528
;; small program: loop(loop2((2 * ((x + x) + x)) + y, 0, y + y, x, x), x, 1)
;; fast program: (loop2(x * y, (y + y) + y, x, 1, 1 + 2) * loop2(x * y, (y + y) + y, x, 1, 1 + (2 + (2 + 2)))) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))
(set-logic UFNIA)
