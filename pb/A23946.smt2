;; sequence(s): A23946
;; terms: 1 27 488 7434 103215 1353681 17093182 210149568 2533379189 30086951895 353166486036 4106992533462 47398834914523 543607880403069 6201901277261450 70443098125125516 797096110863739617
;; small program: loop((loop((loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
