;; sequence(s): A163198
;; terms: 0 1 28 540 9801 176176 3162160 56744793 1018249596 18271762300 327873509425 5883451505856 105574253853888 1894453118539345 33994581881622076 610008020755286076 10946149791725643705 196420688230338021808 3524626238354441796016 63246851602149831726825
;; small program: loop(loop((x * x) * x, 1, loop2(x + y, x, y + y, 0, 1)) + x, x, 0)
;; fast program: loop(loop(loop((x * x) * x, 1, loop2(((x - y) + x) + x, x, x - 1, 1, 0)), 1, y) + x, x, 0)
(set-logic UFNIA)
...
(assert (= g5 1))
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (+ (- x y) x) x))))
