;; sequence(s): A192972
;; terms: 0 1 3 12 33 77 160 309 567 1004 1733 2937 4912 8137 13387 21916 35753 58181 94512 153341
;; small program: loop(loop(loop2(2 + (2 + (x + y)), x, y - 2, 1, 2) + x, y, x), x, 2) - 2
;; fast program: ((((((((loop(loop(((loop2(x + y, x, x, 1 + 2, 2) - 2) - x) - x, 1, y) + x, x, 1) + x) * 2) - 1) - x) - x) - x) - x) - 1) + loop2(x + y, x, x, 0, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (- (- (- (- (- (* (+ (v3 x) x) 2) 1) x) x) x) x) 1) (w6 x)))))
