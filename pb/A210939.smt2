...
(assert (forall ((x Int)) (= (f3 x) (ite (<= (modf (+ 1 (v4 x)) (+ 1 x)) 0) 1 0))))
(assert (= g3 1))
...
(assert (forall ((x Int)) (= (small x) (+ (+ (+ (modf (+ (* (v0 x) 2) 1) (+ 1 x)) 1) x) x))))
...
(assert (forall ((x Int)) (= (f6 x) (+ (+ (modf (modf (modf (- (* (+ (ite (<= (- (modf (* (+ 1 (modf x 2)) (v7 x)) (+ 1 x)) 1) 0) 1 2) (modf x 2)) 2) 1) (+ 1 x)) (+ 1 2)) 2) 1) x))))
(assert (= g6 2))
(assert (forall ((x Int)) (= (h6 x) x)))
(assert (forall ((x Int) (y Int)) (= (u6 x y) (ite (<= x 0) y (f6 (u6 (- x 1) y))))))
(assert (forall ((x Int)) (= (v6 x) (u6 g6 (h6 x)))))
(assert (forall ((x Int)) (= (f5 x) (modf (+ (+ (v6 x) 1) x) 2))))
...
(assert (forall ((x Int)) (= (fast x) (+ (divf (* (- (* (+ (divf (v5 x) 2) 1) 2) 1) (ite (<= x 0) 1 2)) 2) 1))))
