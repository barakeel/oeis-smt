;; sequence(s): A102714
;; terms: 2 5 14 36 95 248 650 1701 4454 11660 30527 79920 209234 547781 1434110 3754548 9829535 25734056 67372634 176383845
;; small program: loop(loop2(x + y, x, y + y, 2, 1 + 2) - x, x, 2)
;; fast program: loop2(x + y, x, x - 1, 1, 1) * loop2(x + y, x, x, 2, 1 + 2)
(set-logic UFNIA)
