;; sequence(s): A260614
;; terms: 1 1 4 186624 248907105618907424441185380787996852224
;; small program: loop(loop(loop2(x * y, y, x, 1, x), 1, loop(x * y, y, 1)) * x, x, 1)
;; fast program: loop(loop(loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 1, loop(x * y, x - 1, x)), 1, y) * x, x, 1)
(set-logic UFNIA)
