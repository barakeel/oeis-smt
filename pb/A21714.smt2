;; sequence(s): A21714
;; terms: 1 25 428 6278 84879 1092243 13601506 165488176 1979095877 23357343581 272803757304 3159571375194 36342586372795 415641464948839 4730786270092622 53625950549096132 605758471885400433
;; small program: loop(((loop((loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
