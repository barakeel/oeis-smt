;; sequence(s): A147816
;; terms: 1 1100 1110000 1111000000 1111100000000 1111110000000000 1111111000000000000 1111111100000000000000 1111111110000000000000000 1111111111000000000000000000 1111111111100000000000000000000
;; small program: loop(2 * ((2 * (x + x)) + x), x + x, loop(1 + (2 * ((2 * (x + x)) + x)), x, 1))
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) * loop2(1 + (x * y), y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
