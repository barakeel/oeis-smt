...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (divf (* (+ (divf (+ (+ x x) x) y) x) (+ 1 (+ 2 (+ 2 y)))) y))))
...
(assert (forall ((x Int)) (= (f1 x) (* (divf (v2 x) (+ 2 (+ 2 2))) (- (* (* x x) x) x)))))
(assert (= g1 1))
(assert (forall ((x Int)) (= (h1 x) (+ 2 x))))
(assert (forall ((x Int) (y Int)) (= (u1 x y) (ite (<= x 0) y (f1 (u1 (- x 1) y))))))
(assert (forall ((x Int)) (= (v1 x) (u1 g1 (h1 x)))))
(assert (forall ((x Int)) (= (fast x) (divf (* (divf (v1 x) (+ 2 (* 2 (+ 2 2)))) (+ 1 x)) (+ 1 2)))))
