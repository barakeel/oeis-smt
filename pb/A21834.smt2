;; sequence(s): A21834
;; terms: 1 22 329 4226 50469 580422 6541681 72922570 808020125 8923802030 98376704361 1083438632562 11925616635349 131228622530326 1443796242996449 15883448475593882 174728077773953421
;; small program: loop((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
