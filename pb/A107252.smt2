;; sequence(s): A107252
;; terms: 1 1 6 1440 36288000 184354652160000 309071606732292096000000 254046582743105184577722777600000000 142518177743863255019484504453155074867200000000000
;; small program: loop(loop2(((y * y) + y) * x, 1 + y, y - 1, x, y), x, 1)
;; fast program: loop(loop2((1 + y) * (x * y), 1 + y, y, 1, 1 + y) * x, x - 1, 1)
(set-logic UFNIA)
