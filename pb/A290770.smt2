;; sequence(s): A290770
;; terms: 1 1 16 11664 764411904 7464960000000000 16249593066946560000000000 11020848942410302096869949440000000000 3102093199396597590886754340698424229232640000000000 465607547420733489126893933985879279492195953053596584509440000000000
;; small program: loop(loop2((x * y) * y, y, y, x, y), x, 1)
;; fast program: loop(loop(loop2(x * y, y, x, 1, x * x), 1, y) * x, x - 1, 1) * loop2(x * y, y, x, 1, x * x)
(set-logic UFNIA)
