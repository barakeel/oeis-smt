;; sequence(s): A16031
;; terms: 1 1 2 16 2048 67108864 144115188075855872 1329227995784915872903807060280344576 226156424291633194186662080095093570025917938800079226639565593765455331328
;; small program: loop(loop2(x * y, 2, y, x, x), x, 1)
;; fast program: loop2((x * y) * x, y + y, x - 1, 1, 2)
(set-logic UFNIA)
