;; sequence(s): A286983
;; terms: 1 2 4 9 20 48 117 294 748 1925 4984 12960 33785 88218 230580 603057 1577836 4129232 10807885 28291230
;; small program: loop2(loop2(x + y, x, y, 1, x), y, 2, 0, x)
;; fast program: loop2(x + y, x, x, 1, loop2(x + y, x, x - 1, 1, 1))
(set-logic UFNIA)
