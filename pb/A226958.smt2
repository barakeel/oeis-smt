;; sequence(s): A226958
;; terms: 2 0 10 24 130 504 2210 9240 39338 166320 705058 2985840 12649570 53582256 226981610 961503816 4073004770 17253510120 73087065922 309601740360
;; small program: loop(loop2(x + y, x, y + y, 1, 0) - x, x, 2) * loop2(x + y, x, x, 1, 0)
;; fast program: loop((x * x) * x, 1, loop2(x + y, x, x - 1, 1, 1)) + loop2(y - x, x, x, 1, 0)
(set-logic UFNIA)
