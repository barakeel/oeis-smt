;; sequence(s): A276274
;; terms: 1 387420489 88817841970012523233890533447265625 66009724686219550843768321818371771650147004059278069406814190436565131829325062449
;; small program: loop(loop(loop2(x * y, y, x, 1, x), 1, x * x), 1, 1 + (x + x))
;; fast program: loop(loop(x * x, 1, loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, x))), 1, 1 + (x + x))
(set-logic UFNIA)
