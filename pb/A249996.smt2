;; sequence(s): A249996
;; terms: 1 ~1 15 ~5 191 99 2455 3515 33231 74899 474695 1371435 7071871 23520899 108399735 390617755 1691480111 6378762099 26676785575 103221406475
;; small program: loop((loop2(loop((2 + y) * x, 2, y) + x, x, y, 1, 0) - x) - x, x, 1)
;; fast program: loop((loop2(((x + y) + y) + y, 2 * (x + x), y, 1, 0) - x) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (+ x y) y) y))))
(assert (forall ((x Int)) (= (g4 x) (* 2 (+ x x)))))
