;; sequence(s): A26543
;; terms: 1 27 481 7191 98161 1272663 16005025 197611623 2412718033 29257382583 353312653057 4255864465671 51186427162417 615069092006487 7386770412718177 88683539390560935 1064502765417159313
;; small program: loop((loop((loop(loop(2 * ((x + x) + x), x, loop(x + x, x, 2) - 1), 1, y) + (2 * ((x + x) + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
