;; sequence(s): A16298
;; terms: 1 16 183 1850 17681 164316 1504843 13673710 123714261 1116683216 10066424303 90679197570 816519676441 7350711587716 66166576804563 595550053849430 5360204797752221 48243114745437816
;; small program: loop((loop((loop((x + x) + x, y + y, 1) + (2 * (x + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop2(((2 * (x + x)) + x) + y, y + y, y, 1, 2) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
