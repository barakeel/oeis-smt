;; sequence(s): A59723
;; terms: 1 2 10 410 1345210 28953440450810 26825654846035253786389446010 46055408506791340513753409614892651037805514032327504332410
;; small program: loop(x + loop2(x * y, 2, y, x, x), x, 1)
;; fast program: loop2((1 + (x * y)) * x, y + y, x - 1, if x <= 0 then 1 else 2, 2)
(set-logic UFNIA)
