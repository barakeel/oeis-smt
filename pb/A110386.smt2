;; sequence(s): A110386
;; terms: 1 2 7 400 25664160401 11133592066966265230223312802560009320400030085606006
;; small program: loop(loop2(1 + (x * y), y, y, 1, x), x, 1)
;; fast program: loop(1 + (loop2(1 + (x * y), y, y - 1, 1, x) * x), x, 1)
(set-logic UFNIA)
