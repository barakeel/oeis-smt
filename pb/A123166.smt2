;; sequence(s): A123166
;; terms: 1 2 5 17 65 257 1025 4097 16385 65537 262145 1048577 4194305 16777217 67108865 268435457 1073741825 4294967297 17179869185 68719476737
;; small program: 1 + loop2(y * y, y + y, x, 0, 1)
;; fast program: loop((x * x) + y, if x <= 0 then 0 else 1, loop(x + x, x - 1, 1))
(set-logic UFNIA)
