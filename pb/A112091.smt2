;; sequence(s): A112091
;; terms: 1 2 6 21 76 276 1001 3626 13126 47501 171876 621876 2250001 8140626 29453126 106562501 385546876 1394921876 5046875001 18259765626
;; small program: 1 + loop2((2 * (x + x)) + y, y - x, x, 0, 1)
;; fast program: 1 + loop2((2 * (x + x)) + y, y - x, x - 1, if x <= 0 then 0 else 1, 1)
(set-logic UFNIA)
