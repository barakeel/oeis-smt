;; sequence(s): A22455
;; terms: 1 24 386 5256 65667 781200 9024772 102391152 1148621573 12793511016 141851544198 1568288482488 17306928957319 190768033959072 2101198710944264 23132476329120864 254592463916330505
;; small program: loop((loop((loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((x + x) + x)) + x) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
