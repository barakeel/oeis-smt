;; sequence(s): A13876
;; terms: 3375 2562890625 1946195068359375 1477891880035400390625 1122274146401882171630859375 852226929923929274082183837890625 647159824910983792506158351898193359375 491436992041778317434363998472690582275390625
;; small program: loop((loop(x * x, 2, 2) * x) - x, loop(1 + (x + x), 2, x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + 2))) - 1)) * loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1))
(set-logic UFNIA)
