;; sequence(s): A137565
;; terms: 1 8 3072 141557760 1461147874099200 5429466527263925207040000 10652562037579218110269404217344000000 15215364593060190936848463156185060517032755200000000
;; small program: loop(loop(2 * (x * y), y + y, x), x, 1)
;; fast program: loop(loop(x * y, y + y, 1) * x, x, 1) * loop(x * x, 1, loop2(x * y, y + y, x, 1, 2))
(set-logic UFNIA)
