;; sequence(s): A53986
;; terms: 0 1 4 729 281474976710656 752316384526264005099991383822237233803945956334136013765601092018187046051025390625
;; small program: loop(loop2(x * y, y, y, 1, x), x, x)
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * ((x * x) * x), x - 2, x * x)
(set-logic UFNIA)
