;; sequence(s): A226638
;; terms: 0 1 6 20 84 319 1260 4901 19176 74860 292494 1142459 4462920 17433181 68099226 266014100 1039126224 4059116419 15856045380 61938144041
;; small program: loop2((x + x) + y, x, x, 0, 1) * loop2(y, x + y, x, 2, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1) * loop2(x + y, x, x - 1, 1, 2)
(set-logic UFNIA)
