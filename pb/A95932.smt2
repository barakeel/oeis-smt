;; sequence(s): A95932
;; terms: 1 5 22 93 385 1574 6385 25773 103702 416405 1669801 6690150 26789257 107232053 429124630 1717012749 6869397265 27481113638 109933682017 439758885885
;; small program: loop((x + loop2(y - x, x, y, 1, 0)) + x, (x + 1) + x, 1)
;; fast program: loop(loop2(((x - y) + x) + x, x, y - 1, 1, 1) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
