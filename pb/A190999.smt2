;; sequence(s): A190999
;; terms: 1 14 496 65024 33488896 68685922304 562881233944576 18446181123756130304 2417833192485184639860736 1267648182376590172238353793024 2658454723919231517578212623857483776 22300742540074631571703972465034240945291264
;; small program: loop(x + x, x * x, loop(2 * (x + x), x, 2) - 1)
;; fast program: (loop((2 * ((x * x) * x)) - x, 1, loop(x + x, x, 1)) * loop2(x * y, y + y, x - 1, 1, 2)) * loop2(x * y, y + y, x, 1, 1)
(set-logic UFNIA)
