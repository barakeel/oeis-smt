;; sequence(s): A152859
;; terms: 0 1 3 125 4337654948097993282537354757263188251697832994620405101744893017744569432720994168089672192211758909320807
;; small program: loop(loop2((2 * (x * y)) - x, y, x, 1, y), x, x)
;; fast program: loop2(loop2(x * y, y, x, 1, y), 2 + y, x, 0, 1)
(set-logic UFNIA)
