;; sequence(s): A52713
;; terms: 0 2 8 96 1920 53760 1935360 85155840 4428103680 265686220800 18066663014400 1373066389094400 115337576683929600 10611057054921523200 1061105705492152320000 114599416193152450560000
;; small program: loop2(2 * (x * y), 1 + y, x - 1, if x <= 0 then 0 else 2, x)
;; fast program: loop2(x * y, 1 + y, x - 2, 1, 1 + x) * loop(x + x, x, x)
(set-logic UFNIA)
