;; sequence(s): A15262
;; terms: 1 111 13542 1637362 198134223 23974093353 2900866919644 351004879413684 42471590605551405 5139062461110267955 621826557818118395106 75241013495730790109766 9104162632986302495960347 1101603678591310956191736717
;; small program: loop(loop(loop(loop(loop((2 + y) * x, 2, x) - x, y, 1) - x, x, 1) * loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))), 1, y) + x, x, 1)
;; fast program: loop(loop(loop(loop2(x * y, y, y, 1, 1 + (2 + (2 * (2 + 2)))) - x, x, 1) * loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))), 1, y) + x, x, 1)
(set-logic UFNIA)
