;; sequence(s): A335111
;; terms: 0 1 ~2 6 ~8 40 48 784 5248 49536 490240 5403904 64822272 842742784 11798284288 176974510080 2831591636992 48137058942976 866467058614272 16462874118651904
;; small program: loop((loop(0 - (x + x), y - 1, 1) + x) * y, x, 0)
;; fast program: loop(loop2(x * y, y, y, 1, 0 - 2) + (x * y), x - 1, 1) * x
(set-logic UFNIA)
