;; sequence(s): A81923
;; terms: 1 4 18 92 536 3552 26608 223456 2085504 21450752 241320704 2949474816 38933066752 552141672448 8374148696064 135274709700608 2318995023429632 42051109758173184 804227474125029376
;; small program: loop(loop((x * y) + loop(x + x, y, 1), y, 1) + (x * y), x, 1)
;; fast program: loop(loop(loop(x + x, y - 1, 2) + (x * y), y, 1) + (x * y), x, 1)
(set-logic UFNIA)
