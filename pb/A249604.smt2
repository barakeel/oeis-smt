;; sequence(s): A249604
;; terms: 1 11 211 3211 53211 853211 13853211 223853211 3623853211 58623853211 948623853211 15348623853211 248348623853211 4018348623853211 65018348623853211 1052018348623853211 17022018348623853211 275422018348623853211 4456422018348623853211
;; small program: loop(loop(loop(2 * ((2 * (x + x)) + x), x, 1) * loop2(x + y, x, x, 1, 0), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(x + y, x, x - 1, 1, 1) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))), 1, y) + x, x, 1)
(set-logic UFNIA)
