;; sequence(s): A99921
;; terms: 5 5 20 45 125 320 845 2205 5780 15125 39605 103680 271445 710645 1860500 4870845 12752045 33385280 87403805 228826125
;; small program: loop2(loop2(x + y, x, y, x, 0), y, 2, 1 + (2 + 2), x)
;; fast program: (1 + (2 + 2)) * loop(x * x, 1, loop2(x + y, x, x - 1, 1, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (+ 1 (+ 2 2)) (v2 x)))))
