;; sequence(s): A26006
;; terms: 1 27 483 7271 100083 1308831 16594651 206375367 2535071715 30892653935 374502469419 4524435989463 54536889623347 656393971978239 7892348208238587 94833193717469159 1138998700671586179
;; small program: loop((loop((loop2(loop((2 + y) * x, 2, x) + ((y * y) * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x, x, 1)
