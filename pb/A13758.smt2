;; sequence(s): A13758
;; terms: 16 65536 268435456 1099511627776 4503599627370496 18446744073709551616 75557863725914323419136 309485009821345068724781056 1267650600228229401496703205376 5192296858534827628530496329220096
;; small program: loop(x * x, 2, loop(x + x, (x + x) + x, 2))
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 2, 2 * (2 + 2))) * loop(x * x, 1, loop2(x * y, y, x, 2, 2 * (2 + 2)))
(set-logic UFNIA)
