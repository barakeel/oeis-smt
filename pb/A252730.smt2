;; sequence(s): A252730
;; terms: 1 3 17 871 4870849 483209576974811 36956045653220845240164417232897 8498748758632331927648392184620600167779995785955324343380396911247
;; small program: x + loop2((x + y) * x, y, x, 1, x)
;; fast program: loop2((x + y) * x, y, x - 1, 1 + x, x) + x
(set-logic UFNIA)
