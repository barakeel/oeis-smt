;; sequence(s): A120767
;; terms: 2 5 25 539 65617 33554675 68719477465 562949953423499 18446744073709558177 2417851639229258349432035 1267650600228229401496703264425 2658455991569831745807614120560866299
;; small program: loop((x + x) + x, x, 1) + loop(x + x, x * x, 1)
;; fast program: (loop2(x * y, y + y, x - 1, 1, 2) * loop2(x * y, y + y, x, 1, 2)) + loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
