;; sequence(s): A259926
;; terms: 0 8 486 49152 7812500 1813985280 581334062442 246290604621824 133417453597332552 90000000000000000000 74002499442581601012110 72872109936441607122321408 84676920178401799992368876316 114656931713301654695784797437952 178967655284025147557258605957031250
;; small program: loop2((x * y) + x, y, 1 + (x + x), x, x)
;; fast program: loop2(x * y, y, x, 1 + x, 1 + x) * loop2(x * y, y, x, x, 1 + x)
(set-logic UFNIA)
