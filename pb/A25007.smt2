;; sequence(s): A25007
;; terms: 1 31 635 10835 166851 2407971 33252835 445002595 5818890851 74768679011 947871169635 11890741318755 147930305201251 1828206048535651 22473922782504035 275081786101769315
;; small program: loop(loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop(loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + (2 * (2 * (y + y))), x, 1, 1 + (2 * (2 + 2))), 1, y) + loop((2 + y) * x, 2, x), x, 1)
(set-logic UFNIA)
