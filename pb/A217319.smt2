...
(assert (forall ((x Int)) (= (f0 x) (+ (+ (modf (divf (divf (w1 x) 2) 2) 2) 1) x))))
...
(assert (forall ((x Int) (y Int)) (= (g4 x y) (divf (divf y 2) 2))))
...
(assert (forall ((x Int)) (= (f3 x) (+ (+ (modf (+ (w4 x) x) 2) (modf x 2)) x))))
(assert (= g3 2))
(assert (forall ((x Int)) (= (h3 x) x)))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y))))))
(assert (forall ((x Int)) (= (v3 x) (u3 g3 (h3 x)))))
(assert (forall ((x Int)) (= (f2 x) (modf (+ (+ (modf (+ (v3 x) 1) 2) 1) x) 2))))
