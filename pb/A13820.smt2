;; sequence(s): A13820
;; terms: 24 7962624 2641807540224 876488338465357824 290797794982682557415424 96479729228174488169059713024 32009658644406818986777955348250624 10620036506406716776157242913621199028224 3523473231949594865126345424909586928788045824
;; small program: loop(loop(x * y, 2 + 2, x), 1 + (2 * (x + x)), 1)
;; fast program: (loop2(x * y, y, 1 + x, 1, 2 * (2 * (2 + (2 + 2)))) * loop2(x * y, y, x, 1, 2 * (2 * (2 + (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 * (2 + (2 + 2)))))
(set-logic UFNIA)
