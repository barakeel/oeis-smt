;; sequence(s): A64350
;; terms: 1 6 360 60480 19958400 10897286400 8892185702400 10137091700736000 15388105201717248000 30006805143348633600000 73096577329197271449600000 217535414131691079834009600000
;; small program: loop2((x * y) + x, 1 + y, x + x, 1, x)
;; fast program: loop2(x * y, 1 + y, x, 1, 1 + (x + x)) * loop2(x * y, 1 + y, x, 1, 1 + x)
(set-logic UFNIA)
