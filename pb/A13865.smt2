;; sequence(s): A13865
;; terms: 20736 5159780352 1283918464548864 319479999370622926848 79496847203390844133441536 19781359483314150527412524285952 4922235242952026704037113243122008064 1224809639974238708818962962512535510581248
;; small program: loop(loop((2 + y) * x, 2, x), (2 * (2 + (x + x))) + x, 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 + 2)))) * loop2(x * y, y, x, 1, 2 * (2 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 + 2))))
(set-logic UFNIA)
