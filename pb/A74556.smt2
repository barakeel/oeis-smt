;; sequence(s): A74556
;; terms: 3 17 109 755 5473 40787 309529 2379275 18463393 144315107 1134267049 8952908795 70896790513 562818102227 4476415458169 35654571422315 284296129664833 2268726602270147 18115958853570889 144724548978127835
;; small program: loop((x + x) + x, x, 1 + loop(x + x, x, 1)) + loop(x + x, (x + x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1 + loop(x + x, x, 1), 1 + 2)
(set-logic UFNIA)
