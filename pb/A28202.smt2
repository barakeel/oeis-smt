;; sequence(s): A28202
;; terms: 1 32 647 10582 153153 2049684 26010139 317905634 3781590725 44096537056 506668749951 5757875493006 64896612687817 726942456592748 8105282135259683 90059836210434298 998087763949942029
;; small program: loop((loop(loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
