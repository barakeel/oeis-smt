;; sequence(s): A178191
;; terms: 1 344 825945 13881657616 1633163136864785 1344980069223035633256 7753542448037025041629822057 312883404805904029979088478768109600 88381817680515537538446482833052972519290401
;; small program: loop(1 + loop((2 * ((x + x) + x)) + x, 2 + y, x), x, 1)
;; fast program: loop((loop(loop2(x * y, y, 2 + x, 1, 1 + (2 + (2 + 2))), 1, y) * x) + 1, x, 1)
(set-logic UFNIA)
