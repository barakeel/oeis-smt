;; sequence(s): A83282
;; terms: 1 64 19683 16777216 30517578125 101559956668416 558545864083284007 4722366482869645213696 58149737003040059690390169 1000000000000000000000000000000 23225154419887808141001767796309131
;; small program: loop2(loop2(x * y, y, y, x, x), 2, 2, 1 + x, x)
;; fast program: ((1 + ((2 + x) * x)) * loop2(x * y, y, x, 1 + x, 1 + x)) * loop(x * x, 1, loop2(x * y, y, x, 1, 1 + x))
(set-logic UFNIA)
