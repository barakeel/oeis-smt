;; sequence(s): A28091
;; terms: 1 29 542 8326 114639 1474683 18136084 216253052 2522916077 28975740937 329016750426 3704913244578 41464099463515 461955078856391 5129492632272368 56816621295693304 628178610574416153
;; small program: loop(((loop((loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop2(((((y * y) * y) + x) + x) + x, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
