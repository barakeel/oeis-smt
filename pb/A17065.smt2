;; sequence(s): A17065
;; terms: 1 18 235 2760 31141 345918 3819295 42071220 463025881 5094274218 56041033555 616467614880 6781209278221 74593565712918 820530282235015 9025837356505740 99284227972292161 1092126576027270018
;; small program: loop(((loop2((loop((2 + y) * x, 2, x) - x) + (y * y), y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop((loop2((((y * y) + x) + x) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (+ (* y y) x) x) x))))
