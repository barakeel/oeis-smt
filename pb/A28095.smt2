;; sequence(s): A28095
;; terms: 1 31 622 10294 153139 2133397 28467664 368853628 4681501957 58545953323 724357095826 8891996242402 108525576595255 1318871068893409 15976717061264308 193081291067943016
;; small program: loop(((loop((loop(loop((x + x) + x, y + y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
