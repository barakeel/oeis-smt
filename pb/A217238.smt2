;; sequence(s): A217238
;; terms: 0 1 6 54 792 18360 628560 29801520 1864114560 148458925440 14652778694400 1754531487878400 250496910657100800 42032247882174950400 8188505926902446745600 1832839841627736125184000 467088574163438830546944000
;; small program: loop((x * y) + loop((x * y) * y, y, 1), x, 0)
;; fast program: loop2(1 + (x * y), y - 1, x - 1, 1, x) * loop(x * y, x - 1, x)
(set-logic UFNIA)
