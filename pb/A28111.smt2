;; sequence(s): A28111
;; terms: 1 24 367 4578 50953 528612 5239459 50371926 474339085 4403719320 40486113031 369718215594 3360676724497 30451202305548 275320935296683 2485597397873982 22417376221672789 202042129817685696
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
