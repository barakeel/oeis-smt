;; sequence(s): A83697
;; terms: 1 2 24 2688 32342016 4677882957791232 97861912906883207538212742365184 42829440312913272520181533609472356498655100482256687829780267008
;; small program: loop2(y, 2 * ((x + x) + y), loop(x + x, x, 1), 0, 1)
;; fast program: loop2(loop2(x + y, x, y - 1, 1, 2) * x, y + y, x, 1, 1) * loop((2 * x) * x, x, 1)
(set-logic UFNIA)
