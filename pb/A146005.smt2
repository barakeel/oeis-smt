;; sequence(s): A146005
;; terms: 0 1 6 12 28 55 108 203 376 684 1230 2189 3864 6773 11802 20460 35312 60707 104004 177631
;; small program: x * loop2(y, x + y, x, 2, 1)
;; fast program: x * loop2(x + y, x, x - 1, 1, 2)
(set-logic UFNIA)
