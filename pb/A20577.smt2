;; sequence(s): A20577
;; terms: 1 25 427 6229 83779 1076341 13459699 165601573 2017494787 24431946517 294797887891 3549239159557 42674698231075 512696237681653 6156632228705203 73909998565124581 887135686636037443
;; small program: loop((loop(loop(2 * ((x + x) + x), x, loop(x + x, x, 2) - 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 2 + (2 + 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
