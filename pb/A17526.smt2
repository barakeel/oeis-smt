;; sequence(s): A17526
;; terms: 0 2985984 191102976 2176782336 12230590464 46656000000 139314069504 351298031616 782757789696 1586874322944 2985984000000 5289852801024 8916100448256 14412774445056 22483074023424
;; small program: loop(loop2(x * y, x, y, x, x), 2, loop((2 + y) * x, 2, x))
...
(assert (= g4 1))
(assert (forall ((x Int)) (= (h4 x) (* 2 (* 2 (+ (+ x x) x))))))
