;; sequence(s): A28206
;; terms: 1 34 733 12826 199213 2869258 39283021 519148762 6689833645 84640449322 1056561931789 13058296545658 160199367141997 1954490541959626 23747047106341837 287633422522201114
;; small program: loop((loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
