;; sequence(s): A193129
;; terms: 1 1 1 9 256 15625 1679616 282475249 68719476736 22876792454961 10000000000000000 5559917313492231481 3833759992447475122176 3211838877954855105157369 3214199700417740936751087616 3787675244106352329254150390625
;; small program: loop2((x * y) * y, y, x - 2, 1, x)
;; fast program: loop2(x * y, y, x - 2, 1, x) * loop2(x * y, y, x - 2, 1, x)
(set-logic UFNIA)
