;; sequence(s): A24346
;; terms: 1 27 484 7266 98959 1269177 15642586 187539120 2204181925 25529358855 292445725936 3321943348542 37489352241979 420930326166741 4707254688375814 52473555698990412 583456285162491601
;; small program: loop((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + loop((x + x) + x, 2, x), y, 1) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(loop2(((2 * (2 * (x + x))) + x) + y, 1 + (2 * ((y + y) + y)), x, 1, 1 + (2 + (2 + 2))), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
