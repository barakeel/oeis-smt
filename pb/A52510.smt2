;; sequence(s): A52510
;; terms: 1 6 240 25200 5080320 1676505600 821966745600 560992303872000 508633022177280000 591438478187741184000 858123464716031754240000 1519736656012092236759040000 3226517823533365056503808000000 8089341114715793820234547200000000
;; small program: loop2((1 + y) * ((2 + y) * x), 1 + y, x, 1, x)
;; fast program: loop2(x * y, 1 + y, x, 1, 1 + x) * loop2(x * y, 1 + y, x, 1, 2 + x)
(set-logic UFNIA)
