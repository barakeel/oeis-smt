;; sequence(s): A137500
;; terms: 0 0 1 5 17 51 149 439 1309 3927 11797 35423 106301 318903 956645 2869807 8609293 25827879 77483893 232452191
;; small program: loop(((loop2(x + y, y - x, y - 1, 0, 1) + x) + x) + x, x, 0)
;; fast program: loop(((loop2(x + y, y - x, y - 1, 1, 1) + x) + x) + x, x - 1, 0)
(set-logic UFNIA)
