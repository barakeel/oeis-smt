...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (divf (+ (divf y 2) y) 2) x))))
...
(assert (forall ((x Int)) (= (small x) (+ (modf (w0 x) 2) 1))))
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (divf (+ (divf y 2) y) 2) x))))
...
(assert (forall ((x Int)) (= (fast x) (+ (modf (w1 x) 2) 1))))
