;; sequence(s): A137232
;; terms: 0 0 1 ~1 8 ~12 65 ~125 544 ~1224 4657 ~11593 40520 ~107700 356561 ~988901 3161728 ~9014352 28179745 ~81795025
;; small program: loop(((loop2(y, (x + y) + y, y, 1, 0) - x) - x) - x, x, 0)
;; fast program: loop(((loop2((x + x) + y, x, y - 1, 0, 1) - x) - x) - x, x, 0)
(set-logic UFNIA)
