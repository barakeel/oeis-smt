;; sequence(s): A74319
;; terms: 2 144 2073600 17557585920000 192668014586363904000000 5116462645455544976110780416000000000 551096864092633744724294766310605805584384000000000000
;; small program: loop2(loop(x * y, 2 + y, x), 1 + y, 1 + x, 1, x)
;; fast program: loop2(loop(x * y, y - 1, y) * x, 1 + y, 1 + x, 1, 2 + x)
(set-logic UFNIA)
