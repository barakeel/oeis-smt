;; sequence(s): A191559
;; terms: 25 9765625 3814697265625 1490116119384765625 582076609134674072265625 227373675443232059478759765625 88817841970012523233890533447265625 34694469519536141888238489627838134765625 13552527156068805425093160010874271392822265625
;; small program: loop((2 * (x + x)) + x, 2 + (2 * (2 * (x + x))), 1)
;; fast program: loop((x * x) * x, 1, loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
