;; sequence(s): A16322
;; terms: 1 22 345 4730 60461 740982 8834065 103324210 1191912021 13609144142 154183593785 1736366607690 19463156373181 217362833310502 2420404185281505 26889163207923170 298163249815659941
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + (loop((2 + y) * x, 2, x) - x), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((y * y) + x) + x, (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (+ (* y y) x) x))))
