;; sequence(s): A168440
;; terms: 1 3 315 3274425 6637341335625 4345660353133020796875 1374246178519871776155872382421875 293343904920011883594420118662644304008056640625
;; small program: loop(loop((2 * (x * y)) - x, y + y, x), x, 1)
;; fast program: loop2(loop2(x * y, 2 + y, y, 1, 1 + 2) * x, 2 + y, x, 1, 1)
(set-logic UFNIA)
