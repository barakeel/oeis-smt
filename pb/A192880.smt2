;; sequence(s): A192880
;; terms: 1 0 3 7 34 123 495 1912 7501 29253 114342 446545 1744489 6814224 26618619 103979239 406172770 1586623227 6197795703 24210320296
;; small program: loop2((y - x) - x, x, x, 1, 1) * loop2(y - x, x, x, 1, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if x <= 0 then 1 else (1 + 2), 1) * loop2(y, x + y, x, 1, 0)
(set-logic UFNIA)
