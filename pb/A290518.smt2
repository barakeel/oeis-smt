;; sequence(s): A290518
;; terms: 1 1 2 2 6 12 12 48 144 288 288 1440 5760 17280 34560 34560 207360 1036800 4147200 12441600
;; small program: loop(loop(1 - loop(x - (if x <= 0 then 0 else (1 + y)), x, x - 1), 1, y) * x, x, 1)
;; fast program: loop(loop(1 - loop(x - (if x <= 0 then 0 else (1 + y)), x, x), 1, y) * x, x - 1, 1)
(set-logic UFNIA)
