;; sequence(s): A192253
;; terms: 0 1 3 15 87 687 6447 71967 918687 13256607 212840607 3765435807 72741666207 1523637512607 34389853295007 832071217775007 21482864837231007 589515687506543007 17133249343107695007 525731414152434287007
;; small program: loop(loop(x * y, y, loop2(x + y, x, y, 0, 1)) + x, x, 0)
;; fast program: loop2(loop2(x + y, x, y - 2, 1, 1) + ((1 + y) * x), y - 1, x, 0, x)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (w4 x y) (* (+ 1 y) x)))))
