;; sequence(s): A26738
;; terms: 1 28 516 7952 111440 1477056 18912832 236879104 2924469504 35764112384 434623874048 5259666886656 63472710995968 764545789837312 9197653087371264 110557371200503808 1328176959287263232 15950056940486000640 191496303058077614080
;; small program: loop(((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) + x) + x) + x, x, 1) * loop(x + x, x, 1)
;; fast program: loop(loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((x + x) + x)), x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
