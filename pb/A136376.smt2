;; sequence(s): A136376
;; terms: 1 3 8 18 37 73 139 259 474 856 1529 2707 4757 8307 14428 24942 42941 73661 125951 214739
;; small program: loop2(x + y, x, 1 + x, x, 1)
;; fast program: loop2(x + y, x, x, 1 + x, x)
(set-logic UFNIA)
