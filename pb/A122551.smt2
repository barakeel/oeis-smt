;; sequence(s): A122551
;; terms: 2 24 960 80640 11612160 2554675200 797058662400 334764638208000 182111963185152000 124564582818643968000 104634249567660933120000 105889860562472864317440000 127067832674967437180928000000
;; small program: loop((x * y) + x, x + x, loop(x + x, x, 2))
;; fast program: loop(2 * (x * y), x, 1 + x) * loop2(x * y, 1 + y, x, 2, 2 + x)
(set-logic UFNIA)
