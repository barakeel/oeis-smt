;; sequence(s): A209971
;; terms: 0 2 4 8 16 34 76 176 416 994 2388 5752 13872 33474 80796 195040 470848 1136706 2744228 6625128
;; small program: x + loop2((x + x) + y, x, x, 0, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1) + x
(set-logic UFNIA)
