;; sequence(s): A21503
;; terms: 1 18 217 2214 20701 183906 1582129 13325598 110626021 909165114 7418351161 60217256502 486961532461 3927035533842 31604351090113 253963231160526 2038476448492021 16348435376893290
;; small program: loop(((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((2 * ((x + x) + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
