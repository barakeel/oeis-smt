;; sequence(s): A116944
;; terms: 1 4 125 252047376 1017210679182495207444253709079169646680657
;; small program: loop(1 + loop2(x * y, y, y, x, x), x, 2) - 1
;; fast program: loop((1 + ((2 + x) * x)) * loop2(x * y, y, y - 1, 1, 1 + x), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* (+ 1 (* (+ 2 x) x)) (w3 x y)))))
