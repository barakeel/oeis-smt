;; sequence(s): A144838
;; terms: 18 33385282 1384619022984618483717737087933569992335566082
;; small program: loop2(x + y, x, loop(2 * ((x + x) + x), 1 + x, 1) - 1, 1, 2)
;; fast program: loop2(y - x, x, 2 * loop(2 * ((x + x) + x), x, 1 + 2), 2, 1)
(set-logic UFNIA)
