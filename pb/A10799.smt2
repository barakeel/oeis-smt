;; sequence(s): A10799
;; terms: 1 720 1814400 12192768000 184354652160000 5574884681318400000 309071606732292096000000 29374165503837040803840000000 4536546120412592581745049600000000
;; small program: loop(loop2((x * y) + x, 1 + y, 1 + (2 + 2), x, y), x, 1)
;; fast program: loop(loop((x - y) * x, 2, 2 + (2 + y)) * x, x, 1) * loop((1 + y) * x, x, 1)
(set-logic UFNIA)
...
(assert (= g3 2))
(assert (forall ((x Int) (y Int)) (= (h3 x y) (+ 2 (+ 2 y)))))
