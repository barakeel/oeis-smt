;; sequence(s): A28015
;; terms: 1 29 545 8425 116481 1498569 18339025 216366425 2482819361 27879546409 307689294705 3348390668025 36019012136641 383739078223049 4055195455949585 42559109119075225 444030782195892321
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)) * loop(x + x, x, 1), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
