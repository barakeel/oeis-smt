;; sequence(s): A76783
;; terms: 1 11 14641 2357947691 45949729863572161 108347059433883722041830251 30912680532870672635673352936887453361 1067189571633593786424240872639621090354383081702091 4457915684525902395869512133369841539490161434991526715513934826241
;; small program: loop(loop((2 + y) * x, 2, x) - x, x * x, 1)
;; fast program: loop(loop(x * x, 1, loop2(x * y, y, y, 1, 1 + (2 + (2 * (2 + 2))))) * x, x - 1, 1) * loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))
(set-logic UFNIA)
