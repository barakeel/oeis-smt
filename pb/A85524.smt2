;; sequence(s): A85524
;; terms: 0 1 8 243 16384 1953125 362797056 96889010407 35184372088832 16677181699666569 10000000000000000000 7400249944258160101211 6624737266949237011120128 7056410014866816666030739693 8819763977946281130444984418304 12783403948858939111232757568359375
;; small program: loop2((x * y) * y, y, x - 1, x, x)
;; fast program: (x * loop2(x * y, y, x - 2, x, x)) * loop2(x * y, y, x - 2, x, x)
(set-logic UFNIA)
