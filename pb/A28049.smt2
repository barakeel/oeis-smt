;; sequence(s): A28049
;; terms: 1 28 517 8008 113113 1513876 19589389 247937536 3091276705 38140546444 467097608341 5689887004984 69041150918377 835356636400132 10086046124610973 121588456137536752 1464064614481015729
;; small program: loop(((loop(loop(loop((x + x) + x, y + y, 1) + (2 * (x + x)), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
