;; sequence(s): A164367
;; terms: 101 10010 1000100 100001000 10000010000 1000000100000 100000001000000 10000000010000000 1000000000100000000 100000000001000000000
;; small program: loop2(loop2(x * y, y, y, 1, 2 + (2 * (2 + 2))) + x, (2 + y) + y, 2, 1, x) - 1
;; fast program: loop((1 + (loop(x * x, 1, 2 + (2 * (2 + 2))) * x)) * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
