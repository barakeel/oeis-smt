;; sequence(s): A307395
;; terms: 1 4 10 19 28 28 1 ~80 ~242 ~485 ~728 ~728 1 2188 6562 13123 19684 19684 1 ~59048
;; small program: 1 - loop2((1 + 2) * (x - y), x, x, 0, 1)
;; fast program: 1 + loop2((1 + 2) * (x - y), x, x - 1, if x <= 0 then 0 else (1 + 2), 0)
(set-logic UFNIA)
