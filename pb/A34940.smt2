;; sequence(s): A34940
;; terms: 1 3 75 5145 688905 152193195 50174679555 23089081640625 14140034726843025 11119632520038117075 10920803043967635894075 13100477280449146440878025 18849023772776126861572265625 32038907667175368299033846026875 63516199119599233704934379969701875
;; small program: loop((2 * (x * y)) - x, x, 1) * loop2((2 * (x * y)) + x, y, x, 1, x)
;; fast program: loop2(x * y, 2 + y, x, 1, 1 + 2) * loop2(x * y, y, x - 1, 1, 1 + (x + x))
(set-logic UFNIA)
