;; sequence(s): A28135
;; terms: 1 27 463 6447 79639 910959 9884071 103247199 1048457047 10419680271 101824958599 981887319231 9367184200375 88585292286063 831747262057447 7762970817850143 72093155775104023 666700494910153935
;; small program: loop(loop2((((((y - 1) + y) * (y * y)) + x) + (2 * (x + x))) + x, y + y, y, 1, 2) + loop((x + x) + x, 2, x), x, 1)
;; fast program: loop((loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop(x + x, x, 1), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
