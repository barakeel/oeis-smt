...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (divf (+ y y) (+ 1 2)) x))))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (divf (+ y y) (+ 1 2)) x))))
(assert (forall ((x Int) (y Int)) (= (g4 x y) (divf y (+ 1 2)))))
...
(assert (forall ((x Int)) (= (f3 x) (modf (+ (- (+ (+ (+ (divf (+ (+ (+ (+ (+ (+ (+ (modf (w4 x) 2) 1) x) x) x) x) x) x) 2) x) x) 2) x) x) 2))))
...
(assert (forall ((x Int)) (= (fast x) (divf (* (+ (v3 x) 1) 2) 2))))
