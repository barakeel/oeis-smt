;; sequence(s): A78186
;; terms: 1 16 65536 68719476736 18446744073709551616 1267650600228229401496703205376 22300745198530623141535718272648361505980416 100433627766186892221372630771322662657637687111424552206336
;; small program: loop(x + x, 2 * (2 * (x * x)), 1)
;; fast program: loop(x * x, 2, loop2(x * y, y + y, x - 1, 1, 2)) * loop(x * x, 2, loop2(x * y, y + y, x, 1, 2))
(set-logic UFNIA)
