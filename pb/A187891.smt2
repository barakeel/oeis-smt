;; sequence(s): A187891
;; terms: 0 5 4 8 11 18 28 45 72 116 187 302 488 789 1276 2064 3339 5402 8740 14141
;; small program: 1 + loop2(2 + y, x + y, x, 0 - 1, 2)
;; fast program: 1 + loop2(y, x + y, x, 0 - 1, 2 + 2)
(set-logic UFNIA)
