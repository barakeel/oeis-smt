;; sequence(s): A100680
;; terms: 2 2 16 134217728 115792089237316195423570985008687907853269984665640564039457584007913129639936
;; small program: loop(x + x, loop2(x * y, y, x, 1, x), 1)
;; fast program: loop2(loop2(x * y, y, y, 1, x) * x, y, x, 2, x - 1)
(set-logic UFNIA)
