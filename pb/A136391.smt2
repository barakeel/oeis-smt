;; sequence(s): A136391
;; terms: 1 1 4 6 13 23 43 77 138 244 429 749 1301 2249 3872 6642 11357 19363 32927 55861
;; small program: loop2(y, x + y, x, 1 + x, 1)
;; fast program: loop2(x + y, x, x - 1, 1, 1 + x)
(set-logic UFNIA)
