;; sequence(s): A14925
;; terms: 1 21 321 4321 54321 654321 7654321 87654321 987654321 10987654321 120987654321 1320987654321 14320987654321 154320987654321 1654320987654321 17654320987654321 187654320987654321
;; small program: loop(loop(2 * ((2 * (x + x)) + x), y, 1 + y) + x, x, 1)
;; fast program: loop2((2 * ((2 * (x + x)) + x)) + y, y - 1, x, 1 + x, x)
(set-logic UFNIA)
