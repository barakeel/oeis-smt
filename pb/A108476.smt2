;; sequence(s): A108476
;; terms: 1 2 24 160 1232 9120 68224 508928 3799296 28357120 211662848 1579868160 11792306176 88018952192 656982441984 4903783628800 36602339459072 273203580764160 2039219289063424 15220939987877888
;; small program: loop((loop2(y, 2 * (x + y), y + y, 1, 1) - x) - x, x, 1)
;; fast program: (if x <= 0 then 1 else loop2(2 * (x + y), x, x - 1, 2, 1)) * loop2(2 * (x + y), x, x - 1, 1, 1)
(set-logic UFNIA)
