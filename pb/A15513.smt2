;; sequence(s): A15513
;; terms: 1 1 13 1742 2552030 41102995180 7281683317103260 14189947350338830620680 304174136317707285574697584520 71722670512982436329410134761448960400 186030135925835196854820049614502274473787544400
;; small program: loop((loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) * x) + x, x - 1, 1)
;; fast program: loop((1 + loop2(1 + (x * y), y, y, 1, 1 + (2 + (2 * (2 + 2))))) * x, x - 1, 1)
(set-logic UFNIA)
