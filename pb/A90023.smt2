;; sequence(s): A90023
;; terms: 0 1 37 415 3745 31471 257257 2078455 16704865 133935391 1072633177 8585561095 68702163985 549687102511 4397773276297 35183283965335 281470638631105 2251782504544831 18014329402322617 144114912035163175
;; small program: (loop2(loop(x + x, y, x) - x, y + y, 2, 1, x) + 1) - loop((x + x) + x, x, 1)
;; fast program: (loop((((x * x) - x) * x) - x, 1, loop(x + x, x, 1)) - loop2(x * y, y, x, 1, 1 + 2)) + 2
(set-logic UFNIA)
