;; sequence(s): A323715
;; terms: 2 10 130 4550 441350 121371250 96247401250 222812733893750 1518914406953693750 30674476448429845281250 1842707823686526095580531250 330204028465507043697553297343750 176836474792332245660656600199579843750
;; small program: loop(loop2(((x - y) + x) + x, y + y, y, 2, 1) * x, x, 2)
;; fast program: loop((loop((x + x) + x, y, 1) + loop(x + x, y, 1)) * x, x, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (* (+ (v3 x y) (v4 x y)) x))))
