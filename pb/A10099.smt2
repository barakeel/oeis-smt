;; sequence(s): A10099
;; terms: 1 4 4 16 64 1024 65536 67108864 4398046511104 295147905179352825856 1298074214633706907132624082305024 383123885216472214589586756787577295904684780545900544
;; small program: loop2(y + y, x * y, x, 1, 2)
;; fast program: loop2(x * y, x, x - 2, if x <= 0 then 1 else 2, 2) * loop2(x * y, x, x - 2, if x <= 0 then 1 else 2, 2)
(set-logic UFNIA)
