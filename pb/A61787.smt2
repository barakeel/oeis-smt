;; sequence(s): A61787
;; terms: 1 28 3153 826696 388247185 285699917796 303160806510049 438197051187369424 827678458937524133601 1979247334119251113257580 5844566265720101772494382001 20886312566113632136127527292568
;; small program: loop2(loop2(x * y, y, y, 1, y) + x, 2 + y, x, 1, 1 + 2)
;; fast program: loop(loop(loop2(x * y, y, 1 + x, 1, 1 + (x + x)) * loop2(x * y, y, x, 1, 1 + (x + x)), 1, y) + x, x, 1)
(set-logic UFNIA)
