;; sequence(s): A308729
;; terms: 0 2 11 61 379 2668 21160 187388 1836396 19753416 231545016 2939000832 40172455296 588444153984 9197306248320 152803737342720 2689320607107840 49986863946616320 978529776749959680 20123805782225664000
;; small program: loop((loop((x * y) + loop(x * y, y - 1, 1), y, 1) + (x * y)) + x, x, 0)
;; fast program: loop(((loop((x * y) + loop(x * y, y - 1, 1), y - 1, 1) + x) * y) + x, x, 1) - loop(x * y, x, 1)
(set-logic UFNIA)
