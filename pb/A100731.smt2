;; sequence(s): A100731
;; terms: 3 3 9 729 282429536481 1797010299914431210413179829509605039731475627537851106401
;; small program: loop((x + x) + x, loop(x * y, x, 1), 1)
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 1, 1 + 2)
(set-logic UFNIA)
