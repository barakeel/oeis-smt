;; sequence(s): A111685
;; terms: 1 8 75 984 17045 366288 9374967 278095760 9375293169 353906211240 14785127222723 677150215857192 33734100501544365 1816008001717251104 105048613959883117935 6497985798745934394528 427999600108502895779657
;; small program: loop2(1 + ((x + y) * y), y - 1, x, 1, x + x) + x
;; fast program: loop2(1 + (x * y), y - 1, x, 1, 1 + (x + x)) * (1 + x)
(set-logic UFNIA)
