;; sequence(s): A135321
;; terms: 1 90 656100 387420489000 18530201888518410000 71789798769185258877024900000 22528399544939174411840147874772641000000
;; small program: loop(loop2(((2 * (2 + 2)) + y) * x, 1, y + y, x, 2), x, 1)
;; fast program: (loop2(x * y, y, x, 1, loop((x + x) + x, x - 1, 1 + 2)) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))) * loop2(x * y, y, x, 1, loop((x + x) + x, x, 1))
(set-logic UFNIA)
