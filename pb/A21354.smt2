;; sequence(s): A21354
;; terms: 1 14 129 994 6965 46158 295513 1850618 11423709 69851782 424437377 2568196722 15496267333 93328343486 561380193321 3373943212906 20266372059437 121689277194870 730500423652945
;; small program: loop(((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((x + x) + x)), x, 1)
(set-logic UFNIA)
