;; sequence(s): A52498
;; terms: 1 10 13200 2124276000 41393302251840000 97602635428252959312000000 27847155251069188894843979022720000000 961359275427083998992553051820498439890246400000000
;; small program: loop(loop((loop(loop((2 + y) * x, 2, x) - x, x, 1) - 1) * loop2(x * y, y, x - 1, 1, 1 + (2 + (2 * (2 + 2)))), 1, y) * x, x, 1)
