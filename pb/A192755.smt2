;; sequence(s): A192755
;; terms: 0 1 7 19 42 82 150 263 449 753 1248 2052 3356 5469 8891 14431 23398 37910 61394 99395
;; small program: loop(loop(loop2(y, x + y, y, 2 + 2, 1) + x, y, x), x, 0)
;; fast program: (((loop2(x + y, x, x, 1 + (2 + (2 * (2 + 2))), 2 + (2 + 2)) - 1) - 2) - (2 * (2 * (2 + x)))) - x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (- (- (w3 x) 1) 2) (* 2 (* 2 (+ 2 x)))) x))))
