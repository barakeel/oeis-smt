;; sequence(s): A81069
;; terms: 4 9 49 324 2209 15129 103684 710649 4870849 33385284 228826129 1568397609 10749957124 73681302249 505019158609 3461452808004 23725150497409 162614600673849 1114577054219524 7639424778862809
;; small program: 2 + loop2(y - x, x, 2 * (x + x), 2, 1)
;; fast program: loop(x * x, 1, loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2))
(set-logic UFNIA)
