;; sequence(s): A108196
;; terms: ~1 ~3 0 21 55 0 ~377 ~987 0 6765 17711 0 ~121393 ~317811 0 2178309 5702887 0 ~39088169 ~102334155
;; small program: loop2(x + y, x, x + x, 1, 1) * loop2(x - y, x, x + 1, 0, 1)
;; fast program: loop2(y - x, x, x + x, 0 - 1, 1) * loop2(x - y, x, x - 1, 1, 1)
(set-logic UFNIA)
