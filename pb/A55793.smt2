;; sequence(s): A55793
;; terms: 0 1 4 49 676 9409 131044 1825201 25421764 354079489 4931691076 68689595569 956722646884 13325427460801 185599261804324 2585064237799729 36005300067391876 501489136705686529 6984842613812219524 97286307456665386801
;; small program: loop(x * x, 1, loop2((2 * (x + x)) - y, x, x - 1, if x <= 0 then 0 else 1, 2))
;; fast program: loop(x * x, 1, loop2((2 * (x + x)) - y, x, x - 2, if (x - 1) <= 0 then x else 2, 1))
(set-logic UFNIA)
