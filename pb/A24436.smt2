;; sequence(s): A24436
;; terms: 1 30 601 10122 155029 2238894 31086721 419796498 5553887821 72338375382 930742000825 11858835825018 149897892005317 1882300860052734 23506492073507953 292186168385703522
;; small program: loop((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + loop((2 + y) * x, 2, x), y, 1) - x) + loop((2 + y) * x, 2, x), x, 1)
