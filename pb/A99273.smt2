;; sequence(s): A99273
;; terms: 0 1 15 256 4335 73441 1244160 21077281 357069615 6049106176 102477735375 1736072395201 29410752983040 498246728316481 8440783628397135 142995074954434816 2422475490596994735
;; small program: loop(loop2(y, ((2 * (2 * (2 * (y + y)))) - x) + y, y, 1, 1) - x, x, 0)
;; fast program: loop(loop2(((2 * (2 * (2 * (x + x)))) - y) + x, x, y - 1, 1, 1) - x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g1 x y) (+ (- (* 2 (* 2 (* 2 (+ y y)))) x) y))))
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (- (* 2 (* 2 (* 2 (+ x x)))) y) x))))
