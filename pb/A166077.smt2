;; sequence(s): A166077
;; terms: 1 2 32 4096 4194304 34359738368 2251799813685248 1180591620717411303424 4951760157141521099596496896 166153499473114484112975882535043072
;; small program: loop2(loop(x + x, y, x), 1 + y, x, 1, x)
;; fast program: loop(x * x, 1, loop2(x * y, y + y, x - 1, 1, 2)) * loop2(x * y, y + y, x, 1, 2)
(set-logic UFNIA)
