;; sequence(s): A91868
;; terms: 1 1 8 1296 7962624 2985984000000 100306130042880000000 416336312719673760153600000000 281633758444745849464726940024832000000000 39594086612242519324387557078266845776303882240000000000
;; small program: loop2(loop(x * y, y, x), y, 1 + x, 1, x)
;; fast program: (loop2(x * y, y, x - 2, 1, loop(x * y, x - 1, 1)) * loop2(x * y, y, x - 2, 1, x)) * loop((x * x) * x, 1, loop(x * y, x, 1))
(set-logic UFNIA)
