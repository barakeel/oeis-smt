;; sequence(s): A120838
;; terms: 2 8 706 1972808 152630937346 298024071165562568 14551915378461487103639746 17763568394241803976008724219043208 542101086242755650687546692947455513561979906
;; small program: loop2(((x + x) + x) + y, (2 * (y + y)) + y, x * x, 2, 2)
;; fast program: (loop2(x * y, (y + y) + y, x - 1, 1, 1 + 2) * loop2(x * y, (y + y) + y, x, 1, 1 + 2)) + loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
