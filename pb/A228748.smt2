;; sequence(s): A228748
;; terms: ~2 0 ~1 1 5 18 52 140 361 909 2255 5542 13538 32940 79939 193661 468625 1133118 2738432 6615760
;; small program: loop2((x + x) + y, x, x, 0, 1) - loop2(y, x + y, x, 2, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1) - loop2(y, x + y, x, 2, 1)
(set-logic UFNIA)
