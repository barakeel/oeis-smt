;; sequence(s): A279881
;; terms: 1 8 1056 5529600 2040024268800 82038030902231040000 512596445591262883479552000000 671373457257855830831011844849664000000000 238977230623673235057124486022413812190150656000000000000
;; small program: loop(((2 * (x * y)) + loop(x * y, y, 1)) + x, x, 1) * loop(loop(x * y, y + y, x), x, 1)
;; fast program: loop(((2 * (x * y)) + loop(x * y, y, 1)) + x, x, 1) * loop(loop(x * y, y + y, 1) * x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (* 2 (* x y)) (v5 x y)) x))))
