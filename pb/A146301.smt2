;; sequence(s): A146301
;; terms: 21 165 437 837 1365 2021 2805 3717 4757 5925 7221 8645 10197 11877 13685 15621 17685 19877 22197 24645
;; small program: loop(loop2(((x + y) + y) * x, 2, y, 1, x), 2, x + x)
;; fast program: (loop((2 + x) * x, 1, 2 * (2 + (2 * (x + x)))) - 1) - 2
(set-logic UFNIA)
