;; sequence(s): A86951
;; terms: 0 1 14 99 540 2565 11178 45927 180792 688905 2558790 9310059 33303636 117448461 409209570 1410975855 4821232752 16343405073 55013709438 184024732275
;; small program: loop2((2 * (2 * (x * y))) - x, 1, x - 1, x, x)
;; fast program: loop2((2 * (x * y)) - x, 2, x - 1, 1, x + x) * x
(set-logic UFNIA)
