;; sequence(s): A56788
;; terms: 2 5 31 283 3381 49781 870199 17600759 404197705 10387420489 295311670611 9201412118867 311791207040509 11414881932150269 449005897206417391 18884637964090410991 845687005960046315793
;; small program: loop2(loop2(x * y, y, y, 1, y) + x, 1 + y, 2, 0, x)
;; fast program: ((1 + ((2 + x) * x)) * loop2(x * y, y, x - 1, 1, 1 + x)) + loop2(x * y, y, x, 1, x)
(set-logic UFNIA)
