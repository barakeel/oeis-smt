;; sequence(s): A101093
;; terms: 1 66 860 5750 26265 93436 278256 725220 1703625 3682030 7431996 14167946 25730705 44823000 75305920 122566056 193963761 299373690 451829500 668285310
;; small program: loop(loop(((loop(x * x, 2, y) * y) * y) + x, 1 + y, x), x, 1)
;; fast program: loop(loop(loop((x * x) * x, 1, y * y) + x, y, x), 1 + x, 0)
(set-logic UFNIA)
