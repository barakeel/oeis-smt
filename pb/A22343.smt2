;; sequence(s): A22343
;; terms: 1 22 323 4004 45465 491106 5149327 53020528 539857109 5458923470 54963556011 551942523132 5533572185233 55422129454714 554747369555975 5550668292585416 55526041242871437 555377516005134438
;; small program: loop((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x))) + x, x, 1)
...
(assert (forall ((x Int) (y Int)) (= (g5 x y) (+ 1 (+ (* 2 (+ y y)) y)))))
