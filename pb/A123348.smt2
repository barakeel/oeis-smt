;; sequence(s): A123348
;; terms: 0 3 12 54 240 1068 4752 21144 94080 418608 1862592 8287584 36875520 164077248 730060032 3248394624 14453698560 64311583488 286153731072 1273238091264
;; small program: loop2(y, 2 * ((x + y) + y), x, 0, 1 + 2)
;; fast program: loop2(2 * ((x + x) + y), x, x - 2, if (x - 1) <= 0 then x else (2 + 2), 1) * (1 + 2)
(set-logic UFNIA)
