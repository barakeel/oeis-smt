;; sequence(s): A87751
;; terms: 0 1 7 56 538 6124 81048 1226112 20902992 396857376 8308373760 190212376320 4728556327680 126865966625280 3654264347274240 112484501485977600 3685202487258163200 128039255560187596800
;; small program: loop(loop(loop(2 * (x * y), y, 1) + (x * y), y - 1, 1) + (2 * (x * y)), x, 0)
;; fast program: loop(loop(loop(2 * (x * y), y, 1) + (x * y), y - 1, 1) + ((y + y) * x), x, 0)
(set-logic UFNIA)
