;; sequence(s): A88334
;; terms: 3 14 611 1346270 6557470319843 155576970220531065681649694 87571595343018854458033386304178158174356588264390371
;; small program: 1 + loop2(x + y, x, loop(2 + (x + x), x, 2), 1, 0)
;; fast program: loop(loop2(x + y, x, x - 1, 1, 0) * loop2(x + y, x, x - 2, 1, 2), 1, loop(x + x, x, 2)) + 2
(set-logic UFNIA)
