;; sequence(s): A135398
;; terms: 1 12 2304 7077888 347892350976 273593677362757632 3442605166011971360784384 693087965674784425268322477539328 2232592609368277258783200799359831235362816
;; small program: loop(loop2((2 + y) * x, 2, y + y, x, 1), x, 1)
;; fast program: loop(x * x, 1, loop2(x * y, y + y, x, 1, 2)) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 1 + 2))
(set-logic UFNIA)
