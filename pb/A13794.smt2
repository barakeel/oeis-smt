;; sequence(s): A13794
;; terms: 11 161051 2357947691 34522712143931 505447028499293771 7400249944258160101211 108347059433883722041830251 1586309297171491574414436704891 23225154419887808141001767796309131 340039485861577398992406882305761986971
;; small program: loop(loop((2 + y) * x, 2, x) - x, 1 + (2 * (x + x)), 1)
