;; sequence(s): A184163
;; terms: 1 1 2 3 10 1001 1010045120210252210120045010002
;; small program: loop2(1 + loop2(x * y, y, y, 1, x), x, x - 1, 1, 0)
;; fast program: loop2(1 + (loop2(x * y, y, y - 1, 1, x) * x), x, x - 2, if (x - 1) <= 0 then 1 else 2, 0)
(set-logic UFNIA)
