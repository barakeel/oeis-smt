;; sequence(s): A21894
;; terms: 1 24 393 5536 72513 914088 11282041 137597232 1666743345 20110305592 242090763369 2910464426688 34963222353697 419822302356936 5039713424985177 60489483108391504 725964257087306769
;; small program: loop((loop(loop(1 + (2 * (x + x)), y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * ((x + x) + x))) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
