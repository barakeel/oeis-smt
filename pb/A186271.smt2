;; sequence(s): A186271
;; terms: 1 1 3 21 357 14637 1449063 346326057 199830134889 278363377900377 936136039878967851 7600488507777339982269 148977175240943640992454669 7049748909576694035403947391749 805384464676770256686653161875581007
;; small program: loop(loop2(y, (x + y) + y, y, x, x), x, 1)
;; fast program: loop(loop2((x + x) + y, x, y - 1, 1 + 2, 1) * x, x - 1, 1)
(set-logic UFNIA)
