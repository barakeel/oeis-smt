;; sequence(s): A284122
;; terms: 0 2 4 8 12 18 26 38 56 84 128 198 310 490 780 1248 2004 3226 5202 8398
;; small program: loop2(loop2(x + y, x, y, x, 2), 1, x, 0, x)
;; fast program: ((x - 2) + x) + loop2(x + y, x, x - 2, 2, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (- x 2) x) (w2 x)))))
