;; sequence(s): A25930
;; terms: 1 16 165 1400 10661 75936 517525 3421000 22124421 140796656 885205685 5513890200 34098207781 209668346176 1283419890645 7827611393000 47601257612741 288785879108496 1748608103548405
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + x) + x, y, 1) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
