;; sequence(s): A20571
;; terms: 1 22 325 4030 45301 478702 4851925 47752510 460048501 4362445582 40876539925 379553364190 3499808594101 32098136255662 293160602826325 2668857246099070 24235419069434101 219645625266148942
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((x + x) + x) + y, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
