;; sequence(s): A21394
;; terms: 1 19 254 3014 34155 380073 4199368 46270588 509296469 5603570687 61644604242 678112219122 7459321497343 82052887210261 902583169445276 9928420525951016 109212648498243177 1201339224525513195
;; small program: loop(((loop((loop(1 + (2 * (x + x)), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
