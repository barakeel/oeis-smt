;; sequence(s): A88668
;; terms: 1 6 112 7680 2031616 2113929216 8727373545472 143552238122434560 9426286221665580875776 2473462226931531291448836096 2594880778667185584863751461404672 10886377285478460999082179823696022077440 182665403921164334152319068371262729095485587456
;; small program: loop(x + x, x * x, loop(x + x, x, 2) - 1)
;; fast program: (loop((2 * (x * x)) - x, 1, loop(x + x, x, 1)) * loop2(x * y, y + y, x - 1, 1, 2)) * loop2(x * y, y + y, x - 1, 1, 2)
(set-logic UFNIA)
