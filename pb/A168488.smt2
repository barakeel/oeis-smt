;; sequence(s): A168488
;; terms: 1 1 16 20736 6879707136 1426576071720960000 383375999244747512217600000000 247370021455402476126653493805056000000000000
;; small program: loop(x * x, 2, loop(loop(x * y, y, x), x, 1))
;; fast program: loop((x * x) * (x * x), 1, loop(loop(x * y, y, x), x, 1))
(set-logic UFNIA)
