;; sequence(s): A254641
;; terms: 1 131 2577 23723 141694 636426 2331462 7323954 20396871 51550213 120271151 262391493 540659756 1060489444 1992739932 3605846676 6310148349 10717864983 17722868317 28605158351
;; small program: loop(loop(loop((((loop(x * x, 2, y) * y) * y) * y) + x, y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop((loop((x * x) * x, 1, y * y) * y) + x, y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (* (* (* (v3 x y) y) y) y) x))))
...
(assert (= g7 1))
(assert (forall ((x Int) (y Int)) (= (h7 x y) (* y y))))
