;; sequence(s): A74579
;; terms: 3 23 181 1457 11953 99593 840241 7160057 61503553 531715913 4620992401 40333791257 353325795553 3104682336233 27353203130161 241545689168057 2137316275469953 18945908172796553 168210593763149521
;; small program: (loop((x + x) + x, x + x, 1) + loop(x + x, (x + x) + x, 1)) + loop(2 * ((x + x) + x), x, 1)
;; fast program: (loop((x * x) * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))) + loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
