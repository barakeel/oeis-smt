;; sequence(s): A27286
;; terms: 1 4 18 56 190 564 1722 4976 14454 40940 115698 322728 896558 2471588 6786090 18537184 50459366 136844892 370030434 997705240
;; small program: loop2(2 * (x + y), x - y, x, 1 + x, 0)
;; fast program: (1 + x) * loop2((x + y) + y, x + x, x - 1, if x <= 0 then 1 else 2, 2)
(set-logic UFNIA)
