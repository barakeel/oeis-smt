;; sequence(s): A17953
;; terms: 1 20 283 3518 41209 468608 5247271 58277666 644406997 7108612676 78315612739 862197157094 9488521761265 104399859167624 1148555174389087 12635047273900202 138991162189670413
;; small program: loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
