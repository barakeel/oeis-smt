;; sequence(s): A97334
;; terms: 1 3 3 7 19 31 59 135 259 495 1035 2071 4051 8191 16475 32679 65443 131343 262059 523831
;; small program: loop2(y - x, 0 - (x + x), x, 0, 1) + loop(x + x, x, 1)
;; fast program: loop2(0 - ((x + y) + y), x, x - 1, if x <= 0 then 0 else 1, 0) + loop(x + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (- 0 (+ (+ x y) y)))))
