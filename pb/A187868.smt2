;; sequence(s): A187868
;; terms: 9901 99990001 999999000001 9999999900000001
;; small program: loop((x * x) - x, 1, loop2((x * y) * y, y, 1 + x, 1, 2 + (2 * (2 + 2)))) + 1
;; fast program: loop((((x * x) * x) - x) * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2)))) + 1
(set-logic UFNIA)
