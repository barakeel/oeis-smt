;; sequence(s): A162558
;; terms: 1 6 38 248 1644 10984 73672 495072 3329936 22407776 150819168 1015220608 6834184384 46006990464 309717848192 2085024691712 14036454256896 94493999351296 636137999861248 4282512012883968
;; small program: loop2((2 * ((x + x) + x)) + y, 2 * ((x + y) + y), x, 1, 0)
;; fast program: loop2(2 * (((x + x) + x) + y), (2 * (y + y)) + x, x - 1, if x <= 0 then 1 else (2 + (2 + 2)), 1)
(set-logic UFNIA)
