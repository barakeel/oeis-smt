;; sequence(s): A52124
;; terms: 1 1 4 16 88 568 4288 36832 354688 3781504 44199424 561823744 7714272256 113769309184 1793341407232 30085661765632 535170830467072 10060645294440448 199287423535808512 4148644277780217856
;; small program: loop(loop(loop((x * y) + loop(0 - (x + x), y, 1), y, 1) + (x * y), y, 1) + (x * y), x, 1)
;; fast program: loop(loop(loop(loop2(x * y, y, y, 1, 0 - 2) + (x * y), y, 1) + (x * y), y, 1) + (x * y), x, 1)
(set-logic UFNIA)
