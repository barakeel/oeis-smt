...
(assert (forall ((x Int)) (= (f0 x) (+ (modf (+ (ite (<= (- (modf (v1 x) (+ 1 x)) 1) 0) 1 x) x) 2) (modf x 2)))))
(assert (= g0 1))
...
(assert (forall ((x Int)) (= (small x) (modf (* (divf (+ (* (- (v0 x) 1) x) 1) 2) x) 2))))
...
(assert (forall ((x Int)) (= (f7 x) (+ (modf (+ (ite (<= (- (modf (+ 1 (v8 x)) (+ 1 x)) 2) 0) 1 x) x) 2) (modf x 2)))))
(assert (= g7 1))
