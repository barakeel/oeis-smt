;; sequence(s): A81077
;; terms: 6 21 126 846 5781 39606 271446 1860501 12752046 87403806 599074581 4106118246 28143753126 192900153621 1322157322206 9062201101806 62113250390421 425730551631126 2918000611027446 20000273725560981
;; small program: 1 + (2 + loop2(x + y, x, 1 + (2 * (x + x)), 1, 2))
;; fast program: 1 + ((1 + (2 + 2)) * loop(x * x, 1, loop2(((x - y) + x) + x, x, x - 1, if x <= 0 then 1 else 2, 1)))
(set-logic UFNIA)
