;; sequence(s): A13888
;; terms: 5832 11019960576 20822964865671168 39346408075296537575424 74347713614021927913318776832 140485060518220186283313934500888576 265456074833292280954988944586975024775168 501597304410594428739556550045321223614364647424
;; small program: loop(2 * loop((x + x) + x, 2, x), loop(1 + (x + x), 2, x) + x, 1)
