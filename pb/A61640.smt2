;; sequence(s): A61640
;; terms: 0 1 4 24 240 4080 110880 4404960 238452480 16777393920 1484592883200 161180605555200 21054378333542400 3256459844769331200 588451470437627596800 122827588904844375552000
;; small program: loop(loop((x * y) * y, y - 1, y) + (x * y), x, 0)
;; fast program: loop2(1 + (x * y), y - 1, x - 1, 1, x - 1) * loop(x * y, x - 1, x)
(set-logic UFNIA)
