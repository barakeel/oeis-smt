;; sequence(s): A20595
;; terms: 1 25 421 5965 76741 929005 10791061 121699645 1342777381 14569879885 156038219701 1653799781725 17380932862021 181408804717165 1882561696208341 19442349988398205 199976918230722661
;; small program: loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: loop(loop(loop2(((x + x) + x) + y, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
