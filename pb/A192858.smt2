;; sequence(s): A192858
;; terms: 2 10 36 120 382 1178 3550 10514 30720 88788 254342 723190 2043386 5742490 16062492 44744688 124192270 343594514 947857750 2608015778
;; small program: 2 * loop2(x + y, x, 1 + (x + x), 1, x)
;; fast program: 2 * loop2(((x - y) + x) + x, x, x, 1 + x, x)
(set-logic UFNIA)
