;; sequence(s): A84637
;; terms: 1 1 2 4 8 16 32 65 136 293 642 1410 3072 6606 14004 29295 60592 124187 252742 511672
;; small program: loop(loop(loop(loop(loop(x + y, y, x) - y, y - 2, x), y - 2, x), y, x) + x, x - 1, 1)
;; fast program: loop(loop(loop(loop(loop(x + y, y, x), y, x), y - 2, x), (y - 1) - 2, x) + x, x - 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g6 x y) (- (- y 1) 2))))
