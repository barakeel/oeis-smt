;; sequence(s): A178635
;; terms: 72 8712 887112 88871112 8888711112 888887111112 88888871111112 8888888711111112 888888887111111112 88888888871111111112 8888888888711111111112 888888888887111111111112
;; small program: 2 * loop(x * x, 1, loop(2 * (loop(1 + (x + x), 2, x) + x), 1 + x, 0))
;; fast program: loop(x * x, 1, loop2(1 + (x * y), y, x, 1, 2 + (2 * (2 + 2)))) * ((((1 + (2 * (2 + 2))) * 2) * 2) * 2)
(set-logic UFNIA)
