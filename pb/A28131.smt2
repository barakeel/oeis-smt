;; sequence(s): A28131
;; terms: 1 26 429 5746 68285 751842 7859293 79189682 776807229 7469674498 70755237917 662574315858 6150105857533 56698559685794 519954841569501 4748676612377074 43230125518942397 392566127341918530
;; small program: loop((loop(loop(loop((x + x) + x, y + y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (* 2 (+ (+ x x) x)) (* y y)))))
