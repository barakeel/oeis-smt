;; sequence(s): A253604
;; terms: 2 9 1000 17850625 96132816409376 221244556300694143783489 311992044873796240380263281250000000 374145846406785831860102174312003089603054492712961 507528892168086660506357001295247426244187377081938096246553087918592
;; small program: loop2(loop2(x * y, y, y, 1, 1 + x), 1 + x, 2, x, x)
;; fast program: loop2(x * y, y, 1 + x, 1, 1 + loop2(x * y, y, x, 1, 1 + x))
(set-logic UFNIA)
