;; sequence(s): A13852
;; terms: 729 43046721 2541865828329 150094635296999121 8862938119652501095929 523347633027360537213511521 30903154382632612361920641803529 1824800363140073127359051977856583921 107752636643058178097424660240453423951129
;; small program: loop((x + x) + x, 2 * (loop(1 + (x + x), 2, x) + x), 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1 + 2, 1 + (2 * (2 + 2))))
(set-logic UFNIA)
