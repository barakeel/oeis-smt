;; sequence(s): A13816
;; terms: 22 5153632 1207269217792 282810057883082752 66249952919459433152512 15519448971100888972574851072 3635524038174209847159494312722432 851643319086537701956194499721106030592 199502557355935975909450298726667414302359552
;; small program: loop((loop(x * y, 2 + 2, x) - x) - x, 1 + (2 * (x + x)), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))) * loop2(x * y, y, 1 + (x + x), 1, 1 + (2 + (2 * (2 + 2))))) * loop2(x * y, y, x, 2, 2 * (2 * (2 + 2)))
(set-logic UFNIA)
