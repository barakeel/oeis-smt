;; sequence(s): A24778
;; terms: 1 30 595 9840 147061 2063010 27740215 362136180 4628090521 58232585190 724277646235 8930528438520 109397647960381 1333481828166570 16193198750646655 196081347032548860
;; small program: loop(loop(loop(1 + (2 * (2 * (x + x))), y, 1) + loop((x + x) + x, 2, x), y, 1) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(loop(loop2(1 + (x * y), y, y, 1, 2 * (2 + (2 + 2))) + (((x + x) * 2) * 2), x, 1), 1, y) + x) + (((x + x) * 2) * 2), x, 1)
(set-logic UFNIA)
