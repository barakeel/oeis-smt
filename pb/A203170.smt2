;; sequence(s): A203170
;; terms: 0 1 17 642 29203 1365539 64107780 3011403301 141469813301 6646055880582 312223061019703 14667837157106759 689076118833981960 32371909717271872585 1520790680382055836761 71444790066793903279242
;; small program: loop(loop(loop(x * x, 2, loop2(((x - y) + x) + x, x, x, 1, 2)), 1, y) + x, x, 0)
;; fast program: loop(loop(loop(x * x, 2, loop2(((x - y) + x) + x, x, x - 1, 1, 1)), 1, y) + x, x, 0)
(set-logic UFNIA)
