;; sequence(s): A56573
;; terms: 0 1 1 64 729 15625 262144 4826809 85766121 1544804416 27680640625 496981290961 8916100448256 160005726539569 2871098559212689 51520374361000000 924491486192068809 16589354847268067929
;; small program: loop(loop2(x * y, x, y, x, x), 2, loop2(x + y, x, x, 0, 1))
;; fast program: loop((x * x) * x, 1, loop(x * x, 1, if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h4 x) (ite (<= x 0) 0 (w5 x)))))
