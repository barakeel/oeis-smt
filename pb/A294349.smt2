;; sequence(s): A294349
;; terms: 2 6 42 756 35532 4370436 1407280392 1186337370456 2618246576596392 15128228719573952976 228844715840995186667952 9062937281450932377610903056 939663463215395570775453650652192 255065069445576619918001465293982953056
;; small program: loop(x * loop2(y - x, x, y + y, 2, 1), x, 2)
;; fast program: loop(loop2(((x - y) + x) + x, x, y - 1, 1 + 2, 2) * x, x, 2)
(set-logic UFNIA)
