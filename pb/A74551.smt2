;; sequence(s): A74551
;; terms: 3 16 106 820 6898 60316 536266 4801540 43118818 387702316 3487892026 31385431060 282446845138 2541934531516 22877065673386 205892220185380 1853024526865858 16677199008675916 150094704403896346
;; small program: loop((x * x) + x, 1, loop((x + x) + x, x, 1)) + loop(x + x, x + x, 1)
;; fast program: loop((x * x) + x, 1, loop2(x * y, y, x, 1, 1 + 2)) + loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
