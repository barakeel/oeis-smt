;; sequence(s): A21524
;; terms: 1 21 304 3822 45031 513639 5760910 64038576 708445573 7817058249 86132670988 948329828082 10436851589347 114836710756971 1263391885146058 13898439159046260 152889601348716673
;; small program: loop(((loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((x + x) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
