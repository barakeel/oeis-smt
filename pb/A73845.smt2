;; sequence(s): A73845
;; terms: 1 1 0 5 ~3 18 ~17 65 ~80 241 ~351 914 ~1485 3525 ~6152 13757 ~25163 54130 ~102105 214169
;; small program: loop((loop2(1 + y, x + y, y, 1 - 2, 2) - x) - x, x, 1)
;; fast program: loop((loop2(y, x + y, y, 1 + 2, 2) - x) - x, x - 1, 1)
(set-logic UFNIA)
