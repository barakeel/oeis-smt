;; sequence(s): A7861
;; terms: 1 2 48 127401984 4027747178726102955105561756869669557370880
;; small program: loop(loop((x * y) + x, y, loop2(x * y, y, y, 1, x)) * x, x, 1)
;; fast program: loop((loop2(x * y, y, y - 1, 1, x) * (x * x)) * loop(x * y, 1 + y, 1), x, 1)
(set-logic UFNIA)
