;; sequence(s): A258384
;; terms: 2 18 576 40000 4860000 914838624 246727835648 90275517038592 43046721000000000 25937424601000000000 19271723592631858495488 17310672267004940730236928 18492034350245752657180811264 23170856660867919150000000000000
;; small program: loop2((1 + y) * ((2 + y) * x), y, x, 2 + x, x)
;; fast program: loop2(x * y, y, x, 1, 1 + x) * loop2(x * y, y, x, 2 + x, 2 + x)
(set-logic UFNIA)
