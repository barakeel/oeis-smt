;; sequence(s): A192475
;; terms: 2 5 11 26 63 157 398 1021 2639 6854 17855 46601 121770 318421 833027 2179906 5705471 14934533 39094934 102345101
;; small program: loop2(loop2(x + y, x, y, 1, x), 1 + y, 2, 2, x)
;; fast program: loop2(x + y, x, x, 1 + loop2(x + y, x, x, 1, 2), 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i2 x) (+ 1 (w3 x)))))
(assert (= j2 1))
