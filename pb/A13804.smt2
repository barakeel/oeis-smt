;; sequence(s): A13804
;; terms: 16 1048576 68719476736 4503599627370496 295147905179352825856 19342813113834066795298816 1267650600228229401496703205376 83076749736557242056487941267521536 5444517870735015415413993718908291383296
;; small program: loop(x * x, 2, loop(x + x, 2 * (x + x), 2))
;; fast program: loop(x * x, 1 + 2, loop(x + x, x, 1)) * loop(x * x, 2, loop2(x * y, y, x, 2, 2 + 2))
(set-logic UFNIA)
