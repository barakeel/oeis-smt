;; sequence(s): A8791
;; terms: 0 1 128 6561 262144 9765625 362797056 13841287201 549755813888 22876792454961 1000000000000000 45949729863572161 2218611106740436992 112455406951957393129 5976303958948914397184 332525673007965087890625
;; small program: loop2(x * y, y, 2 + (2 + x), x, x)
;; fast program: loop((x * x) * x, 1, x * x) * loop2(x * y, y, x - 2, x, x)
(set-logic UFNIA)
