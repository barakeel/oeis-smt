;; sequence(s): A275002
;; terms: 0 2 2048 6973568802 590295810358705651712 4440892098500626161694526672363281250 7659889842507589786155370254176860349292085605349868961792 6468953019249515982689295538200433621714406397809250801867790662783382919273856120002
;; small program: loop2(loop2(x * y, y, x, x, y), y, 2, 2, x)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, x))) * (2 * (x * x))
(set-logic UFNIA)
