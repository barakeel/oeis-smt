;; sequence(s): A25938
;; terms: 1 19 237 2471 23429 210063 1818349 15380167 128060757 1054660607 8618507261 70035919863 566816115685 4573706232751 36824728021773 296008336113959 2376529889559413 19063018707520095
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + x) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop(((loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + x) + x) + x, x, 1)
(set-logic UFNIA)
