;; sequence(s): A153
;; terms: 0 1 2 7 32 181 1214 9403 82508 808393 8743994 103459471 1328953592 18414450877 273749755382 4345634192131 73362643649444 1312349454922513 24796092486996338 493435697986613143
;; small program: loop((loop(loop((x * y) + loop(0 - x, y, 1), y, 1) + (x * y), y, 1) - (x * y)) + x, x, 0)
;; fast program: loop(loop(loop((x * y) + loop(0 - x, y, 1), y, 1) + (x * y), y, 0) + (x * y), x - 1, x)
(set-logic UFNIA)
