;; sequence(s): A123866
;; terms: 0 63 728 4095 15624 46655 117648 262143 531440 999999 1771560 2985983 4826808 7529535 11390624 16777215 24137568 34012223 47045880 63999999
;; small program: loop(loop2(x * y, x, y, x, x), 2, 1 + x) - 1
;; fast program: loop((x * x) * x, 1, 1 + ((2 + x) * x)) - 1
(set-logic UFNIA)
