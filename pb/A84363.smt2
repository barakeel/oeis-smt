;; sequence(s): A84363
;; terms: 1 7 73 943 14601 264311 5484865 128452927 3352566673 96513215599 3038428376721 103854777002351 3830383180320217 151630719172112935 6412840260155078401 288579496823639935231 13767936546888372165153
;; small program: loop2((x * y) + x, y, 2 + x, 1, x) - loop2(x * y, y, x, x, x)
;; fast program: (loop((x * x) * x, 1, 1 + x) * loop2(x * y, y, x - 1, 1, 1 + x)) - (loop2(x * y, y, x, 1, x) * x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (v2 x) (w3 x)) (* (w4 x) x)))))
