;; sequence(s): A111648
;; terms: 3 83 2811 95483 3243603 110187011 3743114763 127155714923 4319551192611 146737584833843 4984758333158043 169335045742539611 5752406796913188723 195412496049305876963
;; small program: 2 + loop(x * x, 1, loop2((x + x) + y, x, x + x, 1, 2))
;; fast program: 2 + loop(x * x, 1, loop2((2 * ((x + x) + x)) - y, x, x - 1, (if x <= 0 then 0 else (2 * (2 + 2))) + 1, 1))
(set-logic UFNIA)
