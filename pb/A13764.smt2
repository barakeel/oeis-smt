;; sequence(s): A13764
;; terms: 19 130321 893871739 6131066257801 42052983462257059 288441413567621167681 1978419655660313589123979 13569980418174090907801371961 93076495688256089536609610280499
;; small program: loop((2 * loop((x + x) + x, 2, x)) + x, 1 + ((x + x) + x), 1)
