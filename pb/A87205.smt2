;; sequence(s): A87205
;; terms: 1 2 0 8 ~16 64 ~192 640 ~2048 6656 ~21504 69632 ~225280 729088 ~2359296 7634944 ~24707072 79953920 ~258736128 837287936
;; small program: loop2(y + y, 2 * (x - y), x, 1, 1)
;; fast program: loop(x + x, x, loop2(y - x, x, x - 1, 1, 1))
(set-logic UFNIA)
