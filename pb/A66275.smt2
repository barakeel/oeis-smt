;; sequence(s): A66275
;; terms: 0 1 10 111 1476 23255 425958 8915263 210156040 5513215599 159374246010 5034663700847 172583816090700 6380915666604583 253132868797656526 10725414213389814015 483431164831317069840
;; small program: loop2((x * y) + x, y, x, x, x) - loop2(x * y, y, x, x, x)
;; fast program: ((loop2(x * y, y, x - 1, 1, 1 + x) * (1 + x)) - (loop2(x * y, y, x - 2, x, x) * x)) * x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (- (* (w2 x) (+ 1 x)) (* (w3 x) x)) x))))
