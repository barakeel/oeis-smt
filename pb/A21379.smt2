;; sequence(s): A21379
;; terms: 1 17 198 2002 19019 175539 1598416 14463284 130489557 1175715541 10586766554 95302471446 857809330015 7720634709623 69487122519012 625389764724088 5628530595298793 50656866402527385
;; small program: loop(((loop(loop(1 + (2 * (x + x)), y, 1) + loop((x + x) + x, 2, x), y, 1) + x) + x) + x, x, 1)
