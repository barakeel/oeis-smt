;; sequence(s): A23955
;; terms: 1 25 413 5693 70989 831693 9347341 102052621 1091175437 11489041421 119581270029 1233774903309 12644058796045 128906738896909 1308890633457677 13248056512466957 133757151879680013
;; small program: loop(loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (2 * (x + x))), x, 1)
