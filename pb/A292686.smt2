;; sequence(s): A292686
;; terms: 1 101 101000101 101000101000000000101000101 101000101000000000101000101000000000000000000000000000101000101000000000101000101
;; small program: loop2(loop(2 * ((2 * (x + x)) + x), y, x) + x, (y + y) + y, x, 1, 2)
;; fast program: loop2((loop(x * x, 1, loop2(x * y, y, y, 1, 2 + (2 * (2 + 2)))) * x) + x, (y + y) + y, x, 1, 1)
(set-logic UFNIA)
