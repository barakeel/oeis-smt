;; sequence(s): A74577
;; terms: 3 21 149 1071 7793 57351 426449 3200631 24221633 184649031 1416683249 10930058391 84737546273 659705518311 5154633748049 40402118583351 317529017187713 2501356987117191 19744372064060849 156123443001239511
;; small program: loop2((2 * ((x + x) + x)) + y, (2 * ((y + y) + y)) + y, x, 2, 1) + loop(x + x, (x + x) + x, 1)
