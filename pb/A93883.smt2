;; sequence(s): A93883
;; terms: 1 3 60 12600 38102400 2112397056000 2609908810629120000 84645606509847871488000000 82967862872337478796810649600000000 2781259372192376861719959017613164544000000000
;; small program: loop(loop2((2 + y) * x, 1 + y, y, x, y), x, 1)
;; fast program: loop(loop2(x * y, 1 + y, y, 1, 2 + y) * x, x, 1)
(set-logic UFNIA)
