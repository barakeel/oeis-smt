;; sequence(s): A28207
;; terms: 1 34 731 12716 195657 2781030 37422967 484054192 6078887573 74632686986 900223323363 10706758727028 125901196014049 1466781515230702 16957557634824719 194793155476604024
;; small program: loop((loop(loop(loop(loop((2 + y) * x, 2, x) - x, y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop((loop(loop2(((2 * (x + x)) + x) + y, (y + y) + y, x, 1, 1 + 2) * loop(x + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1), 1, y) + ((((x + x) * 2) + x) * 2)) + x, x, 1)
(set-logic UFNIA)
