;; sequence(s): A108898
;; terms: ~1 1 3 11 31 87 239 655 1791 4895 13375 36543 99839 272767 745215 2035967 5562367 15196671 41518079 113429503
;; small program: loop2(2 * (x + y), x, x, 0, 1) - 1
;; fast program: (2 * loop2(2 * (x + y), x, x - 2, if (x - 1) <= 0 then x else 2, 1)) - 1
(set-logic UFNIA)
