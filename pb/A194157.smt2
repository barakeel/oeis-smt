;; sequence(s): A194157
;; terms: 1 3 24 504 27720 3991680 1504863360 1485300136320 3838015552250880 25964175210977203200 459851507161617245875200 21322394684069868456741273600 2588389457883293541569193426124800 822618641999347403739646931950148812800
;; small program: loop(loop2(x + y, x, y + y, x, x), x, 1)
;; fast program: loop(loop2(((x - y) + x) + x, x, y - 1, 1 + 2, 1) * x, x, 1)
(set-logic UFNIA)
