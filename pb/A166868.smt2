;; sequence(s): A166868
;; terms: 1 5 16 48 133 357 932 2392 6057 15189 37800 93520 230301 565045 1382236 3373208 8216033 19980037 48525632 117730352
;; small program: loop((loop(loop2((x + x) + y, x, y, 1, 2) - x, y, 1) + x) + x, x, 1)
;; fast program: loop(loop(loop2((x + x) + y, x, x, 1, 2) - loop(x + x, x, 2), 1, 2 + y) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (+ x x) y))))
