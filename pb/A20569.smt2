;; sequence(s): A20569
;; terms: 1 28 537 8780 131681 1872828 25708777 344166700 4522666161 58593270428 750663052217 9530987332620 120125429898241 1504795780456828 18753752307454857 232703290568738540
;; small program: loop((loop(loop(loop((2 + y) * x, 2, x) - x, y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
