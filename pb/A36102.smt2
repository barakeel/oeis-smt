;; sequence(s): A36102
;; terms: 1 16777217 282446313697 281757406247137 59886119752101281 4797985983097007521 196319612718888031297 4913947714250211628097 84488809559742155077057 1079766443076872509863361
;; small program: loop2(loop(x * x, 2, ((((y * y) * y) * y) * y) * y) + x, 1 + y, 2, 2, x) - 2
...
(assert (= g1 2))
(assert (forall ((x Int) (y Int)) (= (h1 x y) (* (* (* (* (* y y) y) y) y) y))))
