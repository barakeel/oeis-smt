;; sequence(s): A13775
;; terms: 576 7962624 110075314176 1521681143169024 21035720123168587776 290797794982682557415424 4019988717840603673710821376 55572324035428505185378394701824
;; small program: loop(loop(x * y, 2 + 2, x), 2 + ((x + x) + x), 1)
