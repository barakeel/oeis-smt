;; sequence(s): A245306
;; terms: 1 2 2 5 10 26 65 170 442 1157 3026 7922 20737 54290 142130 372101 974170 2550410 6677057 17480762
;; small program: 1 + loop(x * x, 1, loop2(x + y, x, x, 0, 1))
;; fast program: 1 + loop(x * x, 1, if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
