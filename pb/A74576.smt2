;; sequence(s): A74576
;; terms: 3 22 170 1366 11282 94942 809210 6958246 60214562 523591342 4570291850 40019822326 351393153842 3092842345342 27280942481690 241106021761606 2134647753453122 18929744452804942 168112848503746730
;; small program: loop2((2 * (2 * (x + x))) + (y * y), (y + y) + y, x, 2, 1) + loop((2 * (x + x)) + x, x, 1)
