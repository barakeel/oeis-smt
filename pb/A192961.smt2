;; sequence(s): A192961
;; terms: 0 1 4 11 26 55 108 201 360 627 1070 1799 2992 4937 8100 13235 21562 35055 56908 92289
;; small program: loop(loop((loop2(x + y, x, y, 2, 0) - 2) + x, y, x), x, x)
;; fast program: (((loop2(x + y, x, x, 1 + (2 + 2), 1 + 2) - (2 * (2 + x))) * 2) - 2) - (x * x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (* (- (w3 x) (* 2 (+ 2 x))) 2) 2) (* x x)))))
