;; sequence(s): A13802
;; terms: 15 759375 38443359375 1946195068359375 98526125335693359375 4987885095119476318359375 252511682940423488616943359375 12783403948858939111232757568359375 647159824910983792506158351898193359375
;; small program: loop((loop(x * x, 2, 2) * x) - x, 1 + (2 * (x + x)), 1)
;; fast program: (loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + 2))) - 1) * loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1)) * loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1))
(set-logic UFNIA)
