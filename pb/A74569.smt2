;; sequence(s): A74569
;; terms: 3 20 146 1136 9218 76880 653186 5622896 48877058 428036240 3770308226 33362580656 296287600898 2638821947600 23555283963266 210639767346416 1886257414388738 16909829393522960 151723117614386306
;; small program: loop2(((x - y) + x) + x, y + y, x + x, 2, 1) + loop((2 * ((x + x) + x)) + x, x, 1)
;; fast program: (loop(x * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) + loop2(x * y, y, x, 1, 1 + (2 * (2 + 2)))
(set-logic UFNIA)
