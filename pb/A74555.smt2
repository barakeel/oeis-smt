;; sequence(s): A74555
;; terms: 3 16 94 586 3778 24826 165034 1105666 7450978 50450986 343000474 2340300946 16018600978 109951298746 756592019914 5217760843426 36054083523778 249557302572106 1729973941999354 12008256087645106
;; small program: loop((x + x) + x, x, 1 + loop(x + x, x, 1)) + loop((2 * ((x + x) + x)) + x, x, 1)
;; fast program: loop2(x * y, y, x, 1, 1 + (2 + (2 + 2))) + loop2(x * y, y, x, 1 + loop(x + x, x, 1), 1 + 2)
(set-logic UFNIA)
