;; sequence(s): A97039
;; terms: 0 1 7 19 47 102 210 413 789 1473 2703 4892 8756 15529 27331 47791 83103 143810 247814 425445
;; small program: loop((y * loop2(y, x + y, y, 2, 1)) + x, x, 0)
;; fast program: loop((loop2(x + y, x, y - 1, 1, 2) * y) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (* y (w1 x y)) x))))
