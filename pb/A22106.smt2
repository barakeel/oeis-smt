;; sequence(s): A22106
;; terms: 1 16 17 33 50 83 133 216 349 565 914 1479 2393 3872 6265 10137 16402 26539 42941 69480
;; small program: loop2(y, x + y, x, 1, loop(x * x, 2, 2))
;; fast program: loop2(y, x + y, x, 1, 2 * (2 * (2 + 2)))
(set-logic UFNIA)
