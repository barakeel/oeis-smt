;; sequence(s): A16314
;; terms: 1 20 287 3634 43329 500136 5666179 63480878 706360277 7826457892 86486501751 954119775882 10514695335145 115797293297888 1274719738572203 14028563710395046 154360726917116733
;; small program: loop((loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop2(((2 * ((x + x) + x)) + x) + y, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (* 2 (+ (+ x x) x)) x) y))))
