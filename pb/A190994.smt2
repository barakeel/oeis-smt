;; sequence(s): A190994
;; terms: 27 2 29 31 60 91 151 242 393 635 1028 1663 2691 4354 7045 11399 18444 29843 48287 78130
;; small program: loop2(y, x + y, x, loop((x + x) + x, 1 + 2, 1), 2)
;; fast program: loop2(y, x + y, x, loop((x * x) * x, 1, 1 + 2), 2)
(set-logic UFNIA)
