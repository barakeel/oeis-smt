;; sequence(s): A93969
;; terms: 0 1 0 3 8 25 72 203 560 1521 4080 10835 28536 74633 194040 501915 1292512 3315425 8474976 21597091
;; small program: loop2(y, (x + y) + y, x - 1, x, 0)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 0, x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i1 x) (ite (<= (- x 1) 0) x 0))))
