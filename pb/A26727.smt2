;; sequence(s): A26727
;; terms: 1 27 477 7007 93093 1163799 13989949 163814559 1883880405 21393162791 240779316141 2692752875631 29976989988037 332620147754103 3681925234618653 40686711732853823 449042333942609589
;; small program: loop((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
