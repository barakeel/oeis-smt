;; sequence(s): A26028
;; terms: 1 27 480 7130 96111 1221537 14941750 178032960 2082076821 24019528247 274281235020 3107772782790 35002020287131 392372934746157 4382268859012290 48800507502984620 542165787330583041
;; small program: loop((loop((loop(loop((x + x) + x, y + y, 1) + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop((loop2(((2 * (x + x)) + x) + y, y + y, y, 1, 2) + (2 * (2 * (x + x)))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
