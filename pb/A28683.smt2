;; sequence(s): A28683
;; terms: 1 420 81496800 6988909668048000 264339188251171547754240000 4409145118315866486641282521305984000000 32432910584848683243891703579686352553931989191680000000
;; small program: loop(loop((x * x) - x, 1, loop((2 * (2 * ((2 * (x + x)) + x))) + x, y, 1)) * x, x, 1)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, 1 + (2 * (2 + (2 * (2 + 2)))))) * x, x, 1)
(set-logic UFNIA)
