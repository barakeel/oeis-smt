;; sequence(s): A259317
;; terms: 0 2 70 588 2772 9438 26026 61880 131784 257754 471086 814660 1345500 2137590 3284946 4904944 7141904 10170930 14202006 19484348
;; small program: loop(loop(loop(loop((y * y) + x, y, x), y, x), y, x), (x - 1) + x, 0) * 2
;; fast program: loop(loop((loop(loop(x + y, y, x), y - 1, 0) * y) + x, y, x), x + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (* (v6 x y) y) x))))
