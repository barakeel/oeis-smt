;; sequence(s): A25951
;; terms: 1 25 423 6125 82103 1054725 13214671 163046125 1992333255 24194295125 292622085119 3529789897725 42504079369207 511221761969125 6144043634254767 73803583579040525 886243482821361959
;; small program: loop(((loop((loop2(loop((2 + y) * x, 2, x) + ((y * y) * y), y + y, y, 1, 2) + x) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop(((loop(loop2((2 * ((x + x) + x)) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)) * loop(x + x, x, 1), 1, y) + x) + x) + x, x, 1)
(set-logic UFNIA)
