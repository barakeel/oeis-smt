;; sequence(s): A25957
;; terms: 1 28 531 8582 127505 1800456 24581887 327729514 4292988909 55478507084 709331302043 8991457539246 113171793119113 1416078851325712 17631136903084599 218593740438932978
;; small program: loop(((loop(loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
