;; sequence(s): A139744
;; terms: 0 5 85 1115 13345 153275 1724905 19207235 212679265 2347869995 25876958425 284948873555 3136251594385 34509651449915 379671469419145 4176777984431075 45946908753664705 505430101839849035 5559815753535563065 61158481088674535795
;; small program: loop(loop((2 + y) * x, 2, x) - x, x, 1) - loop(2 * ((x + x) + x), x, 1)
;; fast program: loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))) - loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
