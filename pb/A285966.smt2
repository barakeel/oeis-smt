...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (modf (+ 2 x) y))))
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (divf y 2) x))))
(assert (forall ((x Int) (y Int)) (= (g6 x y) (divf y 2))))
...
(assert (forall ((x Int)) (= (f5 x) (+ (modf (+ (w6 x) x) 2) x))))
(assert (= g5 2))
(assert (forall ((x Int)) (= (h5 x) x)))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y))))))
(assert (forall ((x Int)) (= (v5 x) (u5 g5 (h5 x)))))
(assert (forall ((x Int)) (= (f4 x) (modf (divf (+ (divf (* (- (+ (v5 x) 1) x) 2) 2) 1) (+ 2 2)) 2))))
...
(assert (forall ((x Int)) (= (fast x) (modf (+ (divf (* (+ (v4 x) 1) 2) 2) 1) 2))))
