;; sequence(s): A24772
;; terms: 1 29 554 8794 125715 1681143 21476668 265496948 3202922789 37927649617 442690769742 5108795150862 58428053357623 663418639575851 7489021847982176 84142202352592936 941752569789292617
;; small program: loop((loop(loop(1 + (2 * (2 * (x + x))), y, 1) + loop((x + x) + x, 2, x), y, 1) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(loop((loop2(1 + (x * y), y, y, 1, 2 * (2 + 2)) + (((x + x) * 2) * 2)) + x, x, 1), 1, y) + x) + ((((x + x) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
