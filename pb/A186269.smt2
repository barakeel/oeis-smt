;; sequence(s): A186269
;; terms: 1 1 6 96 5376 946176 544997376 1011515129856 6085275021213696 118395110812733669376 7456050498542715562622976 1519364146391040406489059557376 1001953802522449942301649259468947456 2138185445843748536070796346094885374263296 14766000790292725890315725371457440731168428261376
;; small program: loop(loop2(y, 2 * ((x + x) + y), y, x, x), x, 1)
;; fast program: loop(loop2(x + y, x, y, 1, 2) * x, x - 1, 1) * loop2(x * y, y + y, x - 1, 1, 2)
(set-logic UFNIA)
