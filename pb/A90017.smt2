;; sequence(s): A90017
;; terms: 0 1 4 18 80 356 1584 7048 31360 139536 620864 2762528 12291840 54692416 243353344 1082798208 4817899520 21437194496 95384577024 424412697088
;; small program: loop2(y, 2 * ((x + y) + y), x, 0, 1)
;; fast program: loop2(2 * ((x + x) + y), x, x - 2, if (x - 1) <= 0 then x else (2 + 2), 1)
(set-logic UFNIA)
