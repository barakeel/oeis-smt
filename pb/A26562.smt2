;; sequence(s): A26562
;; terms: 1 26 440 6160 77616 915936 10347520 113400320 1215923456 12829712896 133751654400 1381696942080 14173677776896 144610035654656 1469203965870080 14877573810749440 150264242988711936
;; small program: loop(((loop((loop(1 + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1) * loop(x + x, x, 1)
