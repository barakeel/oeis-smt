;; sequence(s): A20758
;; terms: 1 28 532 8560 125776 1747648 23401792 305401600 3912299776 49432480768 618099069952 7666644643840 94496470552576 1158938055589888 14157139120832512 172384964172513280
;; small program: loop(loop(loop(2 * ((x + x) + x), x, loop(x + x, x, 2) - 1), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
