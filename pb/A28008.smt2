;; sequence(s): A28008
;; terms: 1 29 551 8713 124719 1681449 21820639 276146585 3436220975 42270842185 515935095039 6263469307641 75758994829519 914022487668137 11008535762024351 132431203010446681 1591851153157367151
;; small program: loop((loop((loop2(loop((2 + y) * x, 2, x) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)) * loop(x + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
