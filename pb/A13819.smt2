;; sequence(s): A13819
;; terms: 12167 3404825447 952809757913927 266635235464391245607 74615470927590710561908487 20880467999847912034355032910567 5843211045545439551605946764725979847 1635170022196481349560959748587682926364327
;; small program: loop(loop(x * y, 2 + 2, x) - x, loop(1 + (x + x), 2, x), 1)
;; fast program: (loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + (2 + 2)))) - 1) * loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1)) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + (2 + 2)))) - 1))
(set-logic UFNIA)
