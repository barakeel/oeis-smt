;; sequence(s): A262458
;; terms: 1 1 256 14348907 281474976710656 2910383045673370361328125 22452257707354557240087211123792674816 174251498233690814305510551794710260107945042018748343 1766847064778384329583297500742918515827483896875618958121606201292619776
;; small program: loop2(x * y, y, (2 + x) * x, 1, x)
;; fast program: loop2(x * y, y, x - 2, 1, loop2(x * y, y, x, 1, x)) * loop(x * x, 1, loop2(x * y, y, x, 1, x * x))
(set-logic UFNIA)
