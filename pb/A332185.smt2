;; sequence(s): A332185
;; terms: 5 858 88588 8885888 888858888 88888588888 8888885888888 888888858888888 88888888588888888 8888888885888888888 888888888858888888888 88888888888588888888888 8888888888885888888888888 888888888888858888888888888 88888888888888588888888888888 8888888888888885888888888888888
;; small program: (((loop(2 + (2 * ((2 * (x + x)) + x)), x + x, 2) - loop(2 * ((2 * (x + x)) + x), x, 1)) * 2) * 2) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
;; fast program: ((((2 * (2 * loop2(x * y, y, x, 2, 2 + (2 * (2 + 2))))) - 1) * loop2(1 + (x * y), y, x, 1, 2 + (2 * (2 + 2)))) - 1) - loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
