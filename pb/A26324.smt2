;; sequence(s): A26324
;; terms: 1 23 341 4147 45045 455091 4373797 40541699 365712149 3230463379 28067769093 240654781731 2041291828213 17162300683187 143239714105829 1188212150789443 9805989936743637 80575358596047315
;; small program: loop((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
