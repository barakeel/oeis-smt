;; sequence(s): A82471
;; terms: 1 1 2 6 24 144 1296 18144 399168 13970880 782369280 70413235200 10209919104000 2389121070336000 903087764587008000 551786624162661888000 545165184672709945344000 871173965106990492659712000 2251984699801570423525355520000
;; small program: loop(x + loop2(x + y, x, y, x, 0), x - 1, 1)
;; fast program: loop((1 + loop2(x + y, x, y - 1, 1, 1)) * x, x - 1, 1)
(set-logic UFNIA)
