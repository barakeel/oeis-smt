;; sequence(s): A321581
;; terms: 0 1 9 46656 1000000000000000000000000
;; small program: loop(loop2(x * y, y, y, 1, x), x, loop(x + y, x, 0))
;; fast program: loop(loop2(x * y, y, y - 1, x, x) * x, x - 1, loop(x + y, x - 1, x))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (w4 x y) (u4 (h4 x y) (i4 x) (j4 x)))))
