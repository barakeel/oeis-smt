;; sequence(s): A166334
;; terms: 1 3 90 7560 1247400 340540200 138940401600 79196028912000 60109785944208000 58607041295602800000 71383376298044210400000 106218463931489785075200000 189599958117709266359232000000
;; small program: loop2((loop(x + y, y, 1) + y) * x, 2 + y, x, 1, x)
;; fast program: loop2(x * y, 1 + y, x - 1, 1, 2 + (x + x)) * loop2(x * y, 2 + y, x, 1, 1 + 2)
(set-logic UFNIA)
