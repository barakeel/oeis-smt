;; sequence(s): A204245
;; terms: 1 1 4 84 9792 7015680 35334144000 1424547274752000 516934658477260800000 1875850653748811739955200000 74877948716953984356707205120000000 35866656974348638336845775173058560000000000
;; small program: loop(((x * y) - 1) + x, x, 1) * loop(loop(x * y, y, x), x, 1)
;; fast program: (loop(loop(x * y, y, 1) * x, x - 1, 1) * loop(x * y, x, 1)) * loop((x * y) + (x - 1), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (* x y) (- x 1)))))
