;; sequence(s): A343445
;; terms: ~1 1 3 24 315 5760 135135 3870720 130945815 5109350400 225881530875 11158821273600 609202488769875 36422392637030400 2366751668870964375 166086110424858624000 12517749576658530579375
;; small program: loop2((x * y) + x, 2 + y, x - 1, 1, x) - loop(0, x, 2)
;; fast program: loop2(x * y, 2 + y, x - 1, if x <= 0 then (1 - 2) else 1, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i2 x) (ite (<= x 0) (- 1 2) 1))))
