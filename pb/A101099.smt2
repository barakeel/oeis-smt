;; sequence(s): A101099
;; terms: 1 35 345 1955 7990 26226 73470 182490 412335 863005 1695551 3158805 5624060 9629140 15933420 25585476 40005165 61082055 91292245 133835735
;; small program: loop(loop(loop((loop(x * x, 2, y) * y) + x, y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(((((y * y) * y) * y) * y) + x, y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (* (* (* (* y y) y) y) y) x))))
