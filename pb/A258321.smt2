;; sequence(s): A258321
;; terms: 0 2 7 14 31 60 116 216 397 718 1285 2278 4008 7006 12179 21070 36299 62304 106588 181812
;; small program: loop2(1 + y, x + y, x, x + x, x)
;; fast program: loop2(x + y, x, x, x + x, 1 - x)
(set-logic UFNIA)
