;; sequence(s): A135425
;; terms: 1 42 86436 8716379112 43069878018202896 10428149586506991068675232 123719154344427992379322114891976256 71922158596935138096613542488243622890285377152
;; small program: loop(loop2((2 + (2 + (2 + y))) * x, 1, y + y, x, 0), x, 1)
;; fast program: loop2(x * y, y, x - 1, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) * loop2(x * y, y, x, 1, loop((x * x) + x, 2, 2))
(set-logic UFNIA)
