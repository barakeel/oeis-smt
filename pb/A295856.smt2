;; sequence(s): A295856
;; terms: 0 0 3 1 10 7 29 28 81 93 222 283 601 820 1613 2305 4302 6351 11421 17260
;; small program: loop2(2 + y, x + y, x, 1, 2) - loop2(y + y, x, x, 1, 2)
;; fast program: loop2(x + y, x, x, 1, 1 + 2) - loop2(y + y, x, x, 1, 2)
(set-logic UFNIA)
