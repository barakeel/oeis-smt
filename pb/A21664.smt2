;; sequence(s): A21664
;; terms: 1 23 362 4894 61251 733461 8546764 97847228 1106991941 12422320339 138608884206 1540404875802 17070111627271 188776494239057 2084583574516688 22994756444303416 253457017948866441
;; small program: loop(((loop((loop(1 + (2 * (2 * (x + x))), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
