;; sequence(s): A13905
;; terms: 234256 1207269217792 6221821273427820544 32064977213018365645815808 165251092644282265779977014214656 851643319086537701956194499721106030592 4389056261830591470007906571986683114651910144 22619580800770514778759787562400873673529752979243008
;; small program: loop((loop(x * y, 2 + 2, x) - x) - x, (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 * (2 + 2)))))) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, 2 + (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
