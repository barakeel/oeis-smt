;; sequence(s): A112685
;; terms: 1 1 1 7 7 37 49 199 319 1093 1993 6103 12151 34501 72961 196807 433807 1129957 2562649 6517399
;; small program: loop((loop2((x + y) + y, x + y, y - 1, 1 + 2, 0) - x) - x, x, 1)
;; fast program: loop((loop2(y, (x + y) + y, y - 1, 1 + 2, 1 + 2) - x) - x, x, 1)
(set-logic UFNIA)
