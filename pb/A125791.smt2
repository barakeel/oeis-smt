;; sequence(s): A125791
;; terms: 1 1 2 16 1024 1048576 34359738368 72057594037927936 19342813113834066795298816 1329227995784915872903807060280344576 46768052394588893382517914646921056628989841375232
;; small program: loop(loop2(x * y, y + y, y, x, 1), x, 1)
;; fast program: loop(loop2(x * y, y + y, y, 1, 2) * x, x - 2, 1) * loop2(x * y, y + y, x - 1, 1, 2)
(set-logic UFNIA)
