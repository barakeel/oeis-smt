;; sequence(s): A141609
;; terms: 1 1 1 2 6 48 1296 290304 1763596800 2400297571123200 19846204885558066176000000 223334408639880528216369404299444224000000 20780031060559302184531906881808103844643569442380668928000000000000
;; small program: loop(x * loop2(y, (x * y) + x, y - 1, 1, 1), x, 1)
;; fast program: loop(loop2((1 + x) * y, x, y, 1, 1) * x, x - 2, 1)
(set-logic UFNIA)
