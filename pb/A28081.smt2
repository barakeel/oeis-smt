;; sequence(s): A28081
;; terms: 1 28 507 7574 101801 1283016 15511399 182368858 2103357861 23935475564 269799417251 3020592495102 33653261722081 373625952944272 4137562797943263 45735549657446306 504875559449240861
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (2 * (x + x))), y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
