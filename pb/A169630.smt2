;; sequence(s): A169630
;; terms: 0 1 2 12 36 125 384 1183 3528 10404 30250 87131 248832 705757 1989806 5581500 15586704 43356953 120187008 332134459
;; small program: loop2(loop2(x + y, x, y, 0, x), x, 2, x, x)
;; fast program: loop(x * x, 1, loop2(x + y, x, x - 2, 1, 1)) * x
(set-logic UFNIA)
