;; sequence(s): A21954
;; terms: 1 24 387 5278 65793 776412 8835919 98027226 1067371965 11457966520 121639285131 1279935023094 13371252146617 138859728185748 1434922500247623 14766153399643282 151413895297559349
;; small program: loop(loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), y, 1) + loop((x + x) + x, 2, x), x, 1)
