;; sequence(s): A250491
;; terms: 0 1 2178309 271964099255182923543922814194423915162591622175362
;; small program: loop2(x + y, x, loop(x * x, 2, x) * x, 0, 1)
;; fast program: loop2(x + y, x, (((x * x) * x) * x) * x, 0, 1)
(set-logic UFNIA)
