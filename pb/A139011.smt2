;; sequence(s): A139011
;; terms: 1 2 3 2 ~7 ~38 ~117 ~278 ~527 ~718 ~237 2642 11753 33802 76443 136762 164833 ~24478 ~922077 ~3565918
;; small program: loop2((x + x) + y, (y - x) + y, x, 1, 0)
;; fast program: if x <= 0 then 1 else loop2((x - y) + x, (x + y) + y, x - 1, 2, 1)
(set-logic UFNIA)
