...
(assert (forall ((x Int)) (= (small x) (+ (+ (ite (<= (modf (+ (- (v0 x) (modf x 2)) 1) (+ 1 x)) 0) (+ 1 x) 0) 1) x))))
...
(assert (forall ((x Int)) (= (f3 x) (modf (+ (modf (ite (<= (modf (- (modf (v4 x) (+ 1 x)) 1) (+ 1 x)) 0) 1 0) (+ 1 x)) x) (+ 1 x)))))
(assert (forall ((x Int)) (= (g3 x) (modf x 2))))
(assert (forall ((x Int)) (= (h3 x) x)))
(assert (forall ((x Int) (y Int)) (= (u3 x y) (ite (<= x 0) y (f3 (u3 (- x 1) y))))))
(assert (forall ((x Int)) (= (v3 x) (u3 (g3 x) (h3 x)))))
(assert (forall ((x Int)) (= (fast x) (+ (+ (ite (<= (modf (- (modf (modf (+ (v3 x) x) 2) (+ 1 x)) 1) (+ 1 x)) 0) (+ 1 x) 0) 1) x))))
