;; sequence(s): A15511
;; terms: 1 1 11 1012 830852 6133349464 407444538242984 243599680968409330048 1310771150941736627904810368 63477451180042308935531134194562816 27666523379269090447091129488519658150671616
;; small program: loop((loop(1 + loop((x + x) + x, 2, x), y, 1) * x) + x, x - 1, 1)
;; fast program: loop((1 + loop2(1 + (x * y), y, y, 1, 1 + (2 * (2 + 2)))) * x, x - 1, 1)
(set-logic UFNIA)
