;; sequence(s): A245490
;; terms: 1 1 256 7625597484987 340282366920938463463374607431768211456
;; small program: loop2(x * y, y, (x * x) * x, 1, x)
;; fast program: loop2(x * y, y, x - 1, 1, loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, x))) * loop2(x * y, y, x, 1, loop2(x * y, y, x, 1, x))
(set-logic UFNIA)
