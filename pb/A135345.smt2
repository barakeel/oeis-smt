;; sequence(s): A135345
;; terms: 1 4 13 51 204 819 3277 13108 52429 209715 838860 3355443 13421773 53687092 214748365 858993459 3435973836 13743895347 54975581389 219902325556
;; small program: loop(loop(loop2(x - y, x, x - 2, 1, 1) + loop(x + x, x + x, 1), 1, y) - x, x, 1)
;; fast program: loop(loop(loop2(x - y, x, x - 2, 1, 1) + loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) - x, x, 1)
(set-logic UFNIA)
