;; sequence(s): A92236
;; terms: 1 2 4 9 24 72 225 702 2160 6561 19764 59292 177633 532170 1595052 4782969 14346720 43040160 129127041 387400806
;; small program: loop2((x - y) + x, x + y, x - 1, if x <= 0 then 0 else 1, 1) + loop2(x * y, y, x - 1, 1, 1 + 2)
;; fast program: loop2((x - y) + x, x + y, x - 2, if x <= 0 then 0 else 1, 2) + loop2(x * y, y, x - 1, 1, 1 + 2)
(set-logic UFNIA)
