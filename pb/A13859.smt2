;; sequence(s): A13859
;; terms: 121 19487171 3138428376721 505447028499293771 81402749386839761113321 13109994191499930367061460371 2111377674535255285545615254209921 340039485861577398992406882305761986971 54763699237492901685126120802225273763666521
;; small program: loop(loop((2 + y) * x, 2, x) - x, 2 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))) * loop2(x * y, y, 2 + x, 1, 1 + (2 + (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
