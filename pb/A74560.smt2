;; sequence(s): A74560
;; terms: 3 20 154 1268 10738 92060 794314 6882308 59830498 521657900 4560585274 39971171348 351149544658 3091623236540 27274843749034 241075518532388 2134495208609218 18928981642491980 168109034193901594 1494966906911109428
;; small program: loop((x * x) + x, 1, loop((x + x) + x, x, 1)) + loop(x + x, (x + x) + x, 1)
;; fast program: loop((1 + x) * x, 1, loop2(x * y, y, x, 1, 1 + 2)) + loop((x * x) * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
