;; sequence(s): A20969
;; terms: 1 27 493 7611 107293 1432011 18457741 232505307 2883927805 35398400235 431393410669 5231599117563 63232056214237 762504498009099 9180490786688077 110414131486397979 1326988747136473789
;; small program: loop((loop2(loop((2 + y) * x, 2, x) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((x + x) + x) + y, y + y, x, 1, 2) * loop(x * x, 1, loop(x + x, x - 1, 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
