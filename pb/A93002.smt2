;; sequence(s): A93002
;; terms: 1 2 144 2073600 17557585920000 192668014586363904000000 5116462645455544976110780416000000000
;; small program: loop2(loop((x * y) + x, y, x), 1 + y, x, 1, x)
;; fast program: loop2(loop(x * y, y, 1 + y) * x, 1 + y, x, 1, x)
(set-logic UFNIA)
