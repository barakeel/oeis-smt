;; sequence(s): A67667
;; terms: 1 1 3 315 638512875 122529844256906551386796875 13757108753595648665519665029568345104465749222289382342659100341796875
;; small program: loop2(loop((2 * (x * y)) - x, y, x), y + y, x, 1, 1)
;; fast program: loop2(loop2(x * y, 2 + y, y - 1, 1, 1 + 2) * x, y + y, x, 1, 1)
(set-logic UFNIA)
