;; sequence(s): A28692
;; terms: 1 22 11616 141320256 39547060439040 254538406080331591680 37680818974206486508802211840 128296611269497862923425473853914480640 10047034036599529256387830050150921763777884979200
;; small program: loop(loop(loop(x * y, 2 + 2, x) - x, y, x) - x, x, 1)
;; fast program: loop((loop(loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1), 1, y) - 1) * x, x, 1)
(set-logic UFNIA)
