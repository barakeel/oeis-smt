;; sequence(s): A290124
;; terms: 1 2 14 38 206 662 3134 11078 48686 181622 765854 2945318 12135566 47479382 193106174 762858758 3080132846 12234437942 49196032094 196009287398
;; small program: loop2(x + y, loop((2 + y) * x, 2, x), x, 1, 1)
;; fast program: if x <= 0 then 1 else loop2((2 * ((y + y) + y)) + x, x + x, x - 1, 2, 2)
(set-logic UFNIA)
