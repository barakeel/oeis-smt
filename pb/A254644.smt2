;; sequence(s): A254644
;; terms: 1 36 381 2336 10326 36552 110022 292512 704847 1567852 3263403 6422208 12046268 21675408 37608828 63194304 103199469 164281524 255573769 389409504
;; small program: loop(loop(loop(loop((loop(x * x, 2, y) * y) + x, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop(((((y * y) * y) * y) * y) + x, y, x), y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f8 x y) (+ (* (* (* (* y y) y) y) y) x))))
