;; sequence(s): A21964
;; terms: 1 25 422 6050 79563 993675 12002224 141692500 1645717205 18887136125 214818117306 2426541462150 27263857999327 305049644712175 3401871310224068 37837512809631800 419965002207076329
;; small program: loop((loop(loop(1 + (2 * (x + x)), y, 1) + loop((x + x) + x, 2, x), y, 1) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop(loop2(((2 * (2 * (x + x))) + x) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
