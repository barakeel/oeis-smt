;; sequence(s): A316777
;; terms: 1 33 7809 7970433 24891170433 193516654370433 3252209580756770433 106565314598088199970433 6292489787293574101716770433 629244614687684894925781716770433 101340090272908294280184341461716770433 25216602106682627624613336066827221716770433
;; small program: loop(loop((loop(x * x, 2, y) * y) * x, 1 + y, 1) + x, x, 1)
;; fast program: loop(loop((x * x) * ((x * x) * x), 1, loop((x * y) + x, y, 1)) + x, x, 1)
(set-logic UFNIA)
