;; sequence(s): A13849
;; terms: 4096 134217728 4398046511104 144115188075855872 4722366482869645213696 154742504910672534362390528 5070602400912917605986812821504 166153499473114484112975882535043072 5444517870735015415413993718908291383296
;; small program: loop(x + x, loop(2 + ((2 * (x * y)) + x), 2, x), 1)
;; fast program: loop((x * x) * x, 2, loop(x + x, x, 1)) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, 2 * (2 + 2)))
(set-logic UFNIA)
