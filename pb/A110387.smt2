;; sequence(s): A110387
;; terms: 1 2 6 222 2428912878 84539502447168140812774402430429967456348471246
;; small program: loop(x + loop2(x * y, y, y, 1, x), x, 1)
;; fast program: loop((loop2(x * y, y, y - 1, 1, x) * (x * x)) + x, x - 1, if x <= 0 then 1 else 2)
(set-logic UFNIA)
