;; sequence(s): A28674
;; terms: 1 132 2718144 8111637540864 3487687464241924669440 215947547174699123561887936020480 1925409377348197859035291587889453626619330560
;; small program: loop(loop((x * x) - x, 1, loop(2 * (2 * ((x + x) + x)), y, 1)) * x, x, 1)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, 2 * (2 + (2 + 2)))) * x, x, 1)
(set-logic UFNIA)
