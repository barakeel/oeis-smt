;; sequence(s): A135446
;; terms: ~1 ~1 3 10 19 33 62 125 255 514 1027 2049 4094 8189 16383 32770 65539 131073 262142 524285
;; small program: loop(x + x, x, 1) + loop2(x - y, x, x, 0 - 2, 1)
;; fast program: loop(x + x, x - 1, 2) - loop2(x - y, x, x - 1, 1 + 2, 2)
(set-logic UFNIA)
