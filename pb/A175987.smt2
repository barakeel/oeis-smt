;; sequence(s): A175987
;; terms: 1 ~1 ~9 9999 99900039992000799967
;; small program: 1 + loop(loop2(x * y, y, y, x, x) - 2, x, 0)
;; fast program: loop((loop2(x * y, y, y, 1, x) * x) - 2, x, 0) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (- (w1 x y) 2))))
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (- (* (w3 x y) x) 2))))
