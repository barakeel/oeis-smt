;; sequence(s): A21994
;; terms: 1 27 495 7735 111111 1517607 20059495 259217895 3295741671 41400518887 515323813095 6369067214055 78280643507431 957886180955367 11679819118040295 142009680313898215 1722634678467548391
;; small program: loop(loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), y, 1) + loop((2 + y) * x, 2, x), x, 1)
