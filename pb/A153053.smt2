...
(assert (forall ((x Int)) (= (f1 x) (modf (v2 x) (+ 1 (* 2 (+ 2 x)))))))
...
(assert (forall ((x Int)) (= (f5 x) (modf (+ (ite (<= (- (modf (+ 1 (v6 x)) (+ 1 x)) 2) 0) 1 0) x) 2))))
(assert (forall ((x Int)) (= (g5 x) (modf x 2))))
(assert (forall ((x Int)) (= (h5 x) (+ 1 x))))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y))))))
(assert (forall ((x Int)) (= (v5 x) (u5 (g5 x) (h5 x)))))
(assert (forall ((x Int)) (= (f4 x) (+ (- (modf (modf (+ (v5 x) x) 2) (+ 1 x)) (modf x 2)) 1))))
(assert (= g4 2))
