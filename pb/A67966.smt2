;; sequence(s): A67966
;; terms: 1 2 9 125 4096 371293 85766121 52523350144 83733937890625 350356403707485209 3833759992447475122176 109879109551310452512114617 8243206936713178643875538610721 1619152874321527556575810000000000000
;; small program: loop2(loop2(x + y, x, y, x, x), y, x, 1, x)
;; fast program: loop2(x * y, y, x, 1, loop2(x + y, x, x - 1, 2, 1))
(set-logic UFNIA)
