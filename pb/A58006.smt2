;; sequence(s): A58006
;; terms: 1 0 2 ~4 20 ~100 620 ~4420 35900 ~326980 3301820 ~36614980 442386620 ~5784634180 81393657020 ~1226280710980 19696509177020 ~335990918918980 6066382786809020 ~115578717622022980
;; small program: loop2(1 - (x * y), y - 1, x, 1, x)
;; fast program: loop2((1 - x) * y, y - 1, x, 1, 1 + x)
(set-logic UFNIA)
