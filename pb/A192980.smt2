;; sequence(s): A192980
;; terms: 0 1 2 6 15 34 70 135 248 440 761 1292 2164 3589 5910 9682 15803 25726 41802 67835
;; small program: loop(loop(loop2(2 + (x + y), x, y - 2, 0, 1) + x, y, x), x, x)
;; fast program: (((loop2(x + y, x, x, 1 + (2 + (2 + 2)), 1 + (2 + 2)) - 1) - 2) - ((2 + x) * (2 + x))) + x
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (- (- (- (w3 x) 1) 2) (* (+ 2 x) (+ 2 x))) x))))
