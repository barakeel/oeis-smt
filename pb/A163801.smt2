...
(assert (forall ((x Int)) (= (g2 x) (divf (+ 1 x) 2))))
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (+ 1 (divf (* y y) (+ x y))))))
...
(assert (forall ((x Int)) (= (f6 x) (+ (+ (modf (+ (v7 x) x) 2) (modf x 2)) x))))
(assert (= g6 2))
(assert (forall ((x Int)) (= (h6 x) x)))
(assert (forall ((x Int) (y Int)) (= (u6 x y) (ite (<= x 0) y (f6 (u6 (- x 1) y))))))
(assert (forall ((x Int)) (= (v6 x) (u6 g6 (h6 x)))))
(assert (forall ((x Int)) (= (f5 x) (+ (+ (modf (+ (v6 x) x) 2) (modf x 2)) x))))
(assert (= g5 2))
