;; sequence(s): A28183
;; terms: 1 32 653 10876 161673 2240376 29659621 380803412 4787944865 59338124560 728084033469 8872019284908 107592152638777 1300465261202984 15682817092702997 188828216949912964
;; small program: loop((loop((loop2(loop((2 + y) * x, 2, x) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop((loop(loop2(((x + x) + x) + y, y + y, x, 1, 2) * loop(x * x, 1, loop(x + x, x, 1)), 1, y) + (2 * (x + x))) + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
