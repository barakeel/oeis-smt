;; sequence(s): A138119
;; terms: 10 11000 11100000 11110000000 11111000000000 11111100000000000 11111110000000000000 11111111000000000000000 11111111100000000000000000 11111111110000000000000000000
;; small program: loop(2 * ((2 * (x + x)) + x), 1 + (x + x), 1) * loop(1 + (2 * ((2 * (x + x)) + x)), x, 1)
;; fast program: (loop2(1 + (x * y), y, 1 + x, 1, 2 + (2 * (2 + 2))) - 1) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
