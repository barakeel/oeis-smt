;; sequence(s): A135320
;; terms: 1 72 331776 97844723712 1846757322198614016 2230808147575757441788280832 172462464674787958108367218731066064896 853310183691766528293183623126485287871181154680832
;; small program: loop(loop2((2 * (2 * (x + x))) + y, 0, y + y, x, x), x, 1)
;; fast program: (loop2(x * y, y, x, 1, loop(x + x, x, 1 + 2)) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 1 + 2))) * loop2(x * y, y, x, 1, loop(x + x, x, 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (w2 x) (w4 x)) (w6 x)))))
