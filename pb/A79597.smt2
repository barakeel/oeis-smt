;; sequence(s): A79597
;; terms: 1 1 8 16384 35184372088832 21267647932558653966460912964485513216 66749594872528440074844428317798503581334516323645399060845050244444366430645017188217565216768
;; small program: loop2(loop2(x * y, 2, y, x, x), y, x, 1, x)
;; fast program: loop2((x * y) * x, y, x, 1, loop(x + x, x - 1, 1))
(set-logic UFNIA)
