;; sequence(s): A217473
;; terms: 1 4 44 1276 96976 19298224 10054374704 13714167096256 48973290700730176 457851294761126415424 11206368290573330143917824 718092873691648422292110244096 120467978583384630972146706659789056
;; small program: loop(x * loop2(x + y, x, y + y, 1, 2), x, 1)
;; fast program: loop(loop2(((x - y) + x) + x, x, y - 1, 2 + 2, 1) * x, x, 1)
(set-logic UFNIA)
