;; sequence(s): A60226
;; terms: 1 0 2 15 148 1845 27906 496951 10188872 236425545 6125795110 175311670611 5492360400924 186965800764925 6871755333266474 271213787997489135 11440441827615801616 513645612633274386705
;; small program: loop2(x * y, y, x, 1, x) - loop2(x * (y - 1), y, x - 1, x, x)
;; fast program: loop2(x * y, y, x, 1, x) - (loop2(x * y, y, x - 1, 1, 1 + (x - 2)) * x)
(set-logic UFNIA)
