;; sequence(s): A13798
;; terms: 13 371293 10604499373 302875106592253 8650415919381337933 247064529073450392704413 7056410014866816666030739693 201538126434611150798503956371773 5756130429098929077956071497934208653
;; small program: loop(loop((2 + y) * x, 2, x) + x, 1 + (2 * (x + x)), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 + 2))))) * loop2(x * y, y, 1 + (x + x), 1, 1 + (2 * (2 + (2 + 2))))
(set-logic UFNIA)
