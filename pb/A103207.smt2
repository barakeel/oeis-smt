;; sequence(s): A103207
;; terms: 1 2 144 1036800 1463132160000 668986161758208000000 148045794139338685651353600000000 22147346968743318573346465338485637120000000000
;; small program: loop(loop2((x * y) * y, 1 + y, y, 2, y) * x, x, 1)
;; fast program: loop(x * x, 1, loop(loop((2 * (x * y)) - x, y, x), x, 1)) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))
(set-logic UFNIA)
