;; sequence(s): A24347
;; terms: 1 28 523 8218 117649 1592416 20790631 264958246 3320750557 41132364364 505211150899 6167574174034 74958865496425 908053837462072 10973667150086527 132377759927894782 1594780291608334453
;; small program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + x, x, 1)
;; fast program: loop(loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + x, x, 1)
(set-logic UFNIA)
