;; sequence(s): A28013
;; terms: 1 31 629 10595 160965 2293347 31302517 414606643 5373114725 68512221635 862890573909 10764894286419 133300183232581 1640952361357795 20105879474257205 245421711656823923
;; small program: loop((loop(loop2((2 * ((2 * (x + x)) + x)) + y, y + y, y, 1, 2) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)) * loop(x + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
