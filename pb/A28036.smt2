;; sequence(s): A28036
;; terms: 1 24 379 5034 61345 713988 8103223 90690558 1007169229 11137289592 122864771107 1353656241522 14903146727353 164012446077036 1804604958697231 19853467108689126 218405030624426917
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (x + x)), y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h7 x) (- (v8 x) 1))))
