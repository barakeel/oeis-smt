;; sequence(s): A298678
;; terms: 1 0 7 12 73 216 919 3204 12409 45408 171271 635580 2379241 8865000 33113527 123523572 461111833 1720661616 6422058919 23966525484
;; small program: loop((loop2((2 * (x + x)) - y, x, y, 1, 2) - x) - x, x, 1)
;; fast program: loop((loop2((2 * (x + x)) - y, x, y - 1, 2, 1) - x) - x, x, 1)
(set-logic UFNIA)
