;; sequence(s): A24134
;; terms: 1 10 ~7 ~856 ~1743 82926 1491625 18663628 212261729 2353164722 25927424601 285292183440 3138392544913 34522649395414 379749728169737 4177247998556276 45949729595136705 505447028088955098
;; small program: loop(loop((2 + y) * x, 2, x) - x, x, 1) - loop2((x * x) * y, x, 2, x, x)
;; fast program: loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2)))) - (loop((x * x) * x, 1, x * x) * x)
(set-logic UFNIA)
