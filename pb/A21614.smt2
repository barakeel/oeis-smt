;; sequence(s): A21614
;; terms: 1 22 332 4322 52353 609924 6948544 78112924 871004585 9663416906 106874239836 1179653481006 13004446987897 143246730136168 1577098731557408 17357778969071768 191003419177941489
;; small program: loop(((loop((loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((x + x) + x)) + x) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
