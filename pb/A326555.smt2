;; sequence(s): A326555
;; terms: 1 5 169 42875 88529281 1572763671875 248679006649044049 356333757516508153671875 4663869092837765297703279248641 558720643076358108093837582958513671875 612058887069969285456490153219530731912451357649 6117651922857367443605981033627635368555142419249951171875 556511030566224080586773690363350894350192064787062589546222802473281
;; small program: loop2(loop(loop2((x + x) + y, (y + y) + y, x, 2, 1), 1, y) * x, y, x, 1, x)
;; fast program: loop2(x * y, y, x, 1, loop(x + x, x, 1) + loop2(x * y, y, x, 1, 1 + 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j3 x) (+ (v4 x) (w5 x)))))
