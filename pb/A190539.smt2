;; sequence(s): A190539
;; terms: 1 2 256 134217728 18446744073709551616 42535295865117307932921825928971026432 105312291668557186697918027683670432318895095400549111254310977536
;; small program: loop(x + x, (x * x) * x, 1)
;; fast program: loop2(x * y, y, x - 1, 1, loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (w1 x) (w4 x)))))
