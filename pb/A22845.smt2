;; sequence(s): A22845
;; terms: 1 25 416 5810 73731 881895 10139746 113382280 1242174461 13399350965 142804173876 1507398751950 15788505813991 164317248669235 1701069830850806 17531812552906820 180008344463520321
;; small program: loop((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + loop((x + x) + x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
