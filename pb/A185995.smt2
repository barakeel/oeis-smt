;; sequence(s): A185995
;; terms: 1 2 32 16384 1073741824 36028797018963968 2475880078570760549798248448 1393796574908163946345982392040522594123776 25711008708143844408671393477458601640355247900524685364822016
;; small program: loop(loop(x + x, y * y, x), x, 1)
;; fast program: loop(loop(loop2(x * y, y, x, 1, loop(x + x, x - 1, 2)), 1, y) * x, x - 1, 1) * loop2(x * y, y, x, 1, loop(x + x, x - 1, 2))
(set-logic UFNIA)
