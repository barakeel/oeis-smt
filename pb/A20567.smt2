;; sequence(s): A20567
;; terms: 1 26 461 6946 95781 1250466 15739501 193056386 2323229621 27553572706 323079534141 3753826047426 43291842381061 496209045488546 5658293396858381 64241196847864066 726653012738614101
;; small program: loop(loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
