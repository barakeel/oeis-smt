;; sequence(s): A55797
;; terms: 1 6 22 64 162 372 792 1584 3003 5434 9438 15808 25636 40392 62016 93024 136629 196878 278806 388608
;; small program: loop(loop(loop(loop(loop(loop(x + y, y - 2, x), y, x) + y, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop(loop(loop(x + y, y, x), y - 1, x) + y, y, x) + y, y, x) + y, y, x) + y, x, 1) + x
(set-logic UFNIA)
