;; sequence(s): A28032
;; terms: 1 20 255 2650 24521 210840 1725235 13631750 104995341 793395460 5908353815 43502236050 317443722961 2299938136880 16567618807995 118785894675550 848393691575381 6040178746163100 42890062369599775 303884399490790250
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (x + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
