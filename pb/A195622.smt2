;; sequence(s): A195622
;; terms: 20 2020 206040 21014040 2143226060 218588044060 22293837268080 2273752813300080 231900493119340100 23651576545359390100 2412228907133538450120 246023696951075562522120 25092004860102573838806140 2559138472033511455995704140
;; small program: loop2(loop2((2 * ((2 * (x + x)) + x)) + y, x, y, x, 0), 1 + y, 2, 2, x)
;; fast program: loop2(loop2((2 * ((2 * (x + x)) + x)) + y, x, y, 1, 0) * x, 1 + y, 2, 2, x)
(set-logic UFNIA)
