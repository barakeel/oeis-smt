;; sequence(s): A25964
;; terms: 1 23 359 4843 61287 753315 9137263 110167211 1324737623 15911030707 191005360767 2292437677179 27511152416359 330143464656899 3961770291040271 47541489215721547 570499107794719095
;; small program: loop(loop2(((2 * (((y * y) + x) + x)) - y) + x, y + y, y, 1, 2) + loop((2 + y) * x, 2, x), x, 1)
