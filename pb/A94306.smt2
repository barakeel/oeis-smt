;; sequence(s): A94306
;; terms: 1 3 10 30 88 252 712 1992 5536 15312 42208 116064 318592 873408 2392192 6547584 17912320 48985344 133926400 366085632
;; small program: loop((x + loop2(y, 2 * (x + y), y, 1, 1)) + x, x, 1)
;; fast program: loop2(2 * (x + y), x, x - 1, (if x <= 0 then 0 else (1 + 2)) + 2, 2) - loop(x + x, x, 1)
(set-logic UFNIA)
