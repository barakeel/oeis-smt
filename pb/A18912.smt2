;; sequence(s): A18912
;; terms: 1 19 251 2879 30891 320439 3266131 32986399 331554971 3324266759 33287301411 333100377519 3332157369451 33327408774679 333303531583091 3333183608754239 33332581847126331 333329564449052199
;; small program: loop(loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (x + x)), x, 1)
;; fast program: loop(loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + (2 + 2)), 1, y) + (2 * (x + x)), x, 1)
(set-logic UFNIA)
