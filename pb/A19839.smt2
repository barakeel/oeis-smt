;; sequence(s): A19839
;; terms: 1 21 301 3681 41461 445641 4658221 47871201 486836581 4919066361 49504632541 496978967121 4981629662101 49888557269481 499325240101261 4995920923029441 49975372950286021 499851474762263001 4999105033876312381 49994611129771546161
;; small program: loop(loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * ((x + x) + x)), x, 1)
;; fast program: loop(loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + (2 + 2)), 1, y) + (2 * ((x + x) + x)), x, 1)
(set-logic UFNIA)
