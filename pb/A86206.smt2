;; sequence(s): A86206
;; terms: 0 1 27 2401 759375 887503681 3938980639167 67675234241018881 4558916353692287109375 1213972926354344043087129601 1284197945649659948122178573052927 5412701932445852698371002894178179850241 91054366938067173656011584805755385081787109375
;; small program: loop2(loop(x + x, y, x) - x, y, 1 + x, 1, x)
;; fast program: loop2(loop2(x * y, y, y - 1, 1, x) * (x * x), x, 1, loop(1 + (x + x), x, 0), x)
(set-logic UFNIA)
