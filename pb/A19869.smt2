;; sequence(s): A19869
;; terms: 1 23 367 5075 65551 817643 10013527 121451315 1465540351 17637184763 211960186087 2545454874755 30557298487951 366759842503883 4401557777453047 52821361851453395 633872505937432351
;; small program: loop((loop(loop(2 * ((x + x) + x), x, loop(x + x, x, 2) - 1), 1, y) + (2 * (x + x))) + x, x, 1)
;; fast program: loop(loop((loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 2 + (2 + 2)), 1, y) + (2 * (x + x))) + x, x, 1), 1, x)
(set-logic UFNIA)
