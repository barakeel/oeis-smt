;; sequence(s): A13873
;; terms: 38416 20661046784 11112006825558016 5976303958948914397184 3214199700417740936751087616 1728673739677471101567216945987584 929722225368296217729286886758826377216 500026926136478545004035990584179037499817984
;; small program: loop((loop(x * x, 2, 2) - 2) * x, (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, 2 + (2 * (2 + (2 + 2)))))
(set-logic UFNIA)
