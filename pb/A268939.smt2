;; sequence(s): A268939
;; terms: 4 16 60 220 788 2780 9684 33404 114292 388444 1312788 4415548 14790836 49369628 164279892 545170172 1804855540 5962578652 19661140116 64722276796
;; small program: loop(((loop2(((x + x) + x) + y, x - y, y - 1, 1, 1) + x) + x) + x, 1 + x, 1)
;; fast program: (loop(((loop2(((x + x) + x) + y, x - y, y - 1, 1, 0) + x) + x) + x, x, 1) * 2) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (+ (+ (w3 x y) x) x) x))))
