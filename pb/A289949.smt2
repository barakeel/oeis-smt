;; sequence(s): A289949
;; terms: 1 2 18 1314 333090 207693090 268946253090 645510228813090 2643553803594573090 17342764866576345933090 173418555892594089945933090 2538940579958951120707545933090 52646414799433780559063261145933090 1503614384819523432725006336630745933090
;; small program: loop(loop(loop(x * x, 2, y) * x, y, 1) + x, x, 1)
;; fast program: loop(loop(x * x, 2, loop(x * y, y - 1, y)) + x, x, 1)
(set-logic UFNIA)
