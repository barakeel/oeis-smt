;; sequence(s): A84595
;; terms: 1 2 16 896 2781184 26794772135936 2487085750646543836443049984 21427531469765285263614058238314319540132878612321796096
;; small program: loop2(y, 2 * (x + y), loop(x + x, x, 1), 0, 1)
;; fast program: loop2(2 * (x + y), x, loop(x + x, x, 1) - 1, 1, 0)
(set-logic UFNIA)
