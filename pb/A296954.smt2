;; sequence(s): A296954
;; terms: 0 1 2 8 20 44 92 188 380 764 1532 3068 6140 12284 24572 49148 98300 196604 393212 786428
;; small program: loop2(y, 2 * (2 + y), x - 1, x, 2)
;; fast program: (loop(x + x, x - 2, 1 + 2) - 2) * loop(x - 1, 2 - x, 2)
(set-logic UFNIA)
