;; sequence(s): A99858
;; terms: 1 6 17 42 109 288 755 1974 5167 13530 35423 92736 242785 635622 1664081 4356618 11405773 29860704 78176339 204668310
;; small program: loop2(x + y, x, x + x, 2, 2) - loop2(0 - y, x, x, 1, 0)
;; fast program: loop2(((x - y) + x) + x, x, x, 2, 0) - loop2(0 - y, x, x, 1, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (- 0 y))))
