;; sequence(s): A332181
;; terms: 1 818 88188 8881888 888818888 88888188888 8888881888888 888888818888888 88888888188888888 8888888881888888888 888888888818888888888 88888888888188888888888 8888888888881888888888888 888888888888818888888888888 88888888888888188888888888888 8888888888888881888888888888888
;; small program: (((loop(2 + (2 * ((2 * (x + x)) + x)), x + x, 2) - loop(2 * ((2 * (x + x)) + x), x, 2)) * 2) * 2) + loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
;; fast program: ((((2 * (2 * loop2(x * y, y, x, 2, 2 + (2 * (2 + 2))))) - 1) * loop2(1 + (x * y), y, x, 1, 2 + (2 * (2 + 2)))) - 1) - loop2(x * y, y, x, 1 + (2 + 2), 2 + (2 * (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (* (- (* 2 (* 2 (w3 x))) 1) (w4 x)) 1) (w5 x)))))
