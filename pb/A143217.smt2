;; sequence(s): A143217
;; terms: 1 2 8 60 816 18480 629280 29806560 1864154880 148459288320 14652782323200 1754531527795200 250496911136102400 42032247888401971200 8188505926989625036800 1832839841629043799552000 467088574163459753336832000 134454052266325985991942144000
;; small program: loop((x * y) + loop((x * y) * y, y, 1), x, 1)
;; fast program: loop2(1 + (x * y), y - 1, x - 1, 1 + x, x - 1) * loop(x * y, x, 1)
(set-logic UFNIA)
