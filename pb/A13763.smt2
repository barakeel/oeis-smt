;; sequence(s): A13763
;; terms: 324 1889568 11019960576 64268410079232 374813367582081024 2185911559738696531968 12748236216396078174437376 74347713614021927913318776832 433595865796975883590475106484224
;; small program: loop(2 * loop((x + x) + x, 2, x), 2 + ((x + x) + x), 1)
