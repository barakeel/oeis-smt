;; sequence(s): A269684
;; terms: 3 9 27 75 201 525 1347 3411 8553 21285 52659 129675 318153 778269 1899267 4625955 11249481 27321525 66285747 160679451
;; small program: (1 + 2) * loop((x + loop2(y, (x + y) + y, y, 1, 1)) + x, x, 1)
;; fast program: (1 + 2) * (loop2((x + x) + y, x, x, 1 + 2, 1) - loop(x + x, x, 2))
(set-logic UFNIA)
