;; sequence(s): A19854
;; terms: 1 22 333 4334 52325 606606 6874477 76908238 854115189 9445967630 104219612861 1148348383182 12643672205893 139152654913294 1531118871452685 16844976107996366 185310900907951637 2038517655246870798 22424284493969261149 246670690224670294990
;; small program: loop((loop(loop(loop((2 + y) * x, 2, x) - x, y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, 2 * ((y + y) + y), x, 1, 2 + (2 + 2)), 1, y) + x) + ((((x * 2) * 2) + x) * 2), x, 1)
(set-logic UFNIA)
