;; sequence(s): A28669
;; terms: 1 42 98784 11587955904 66774437101209600 18861003469034659931443200 261058346935768909875766027257446400 177055579258883302762565632026325003745732198400
;; small program: loop(loop((x * x) - x, 1, loop((2 * ((x + x) + x)) + x, y, 1)) * x, x, 1)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, 1 + (2 + (2 + 2)))) * x, x, 1)
(set-logic UFNIA)
