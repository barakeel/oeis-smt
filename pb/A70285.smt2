;; sequence(s): A70285
;; terms: 1 12 432 32000 4050000 784147392 215886856192 80244904034304 38742048900000000 23579476910000000000 17665746626579203620864 15979082092619945289449472 17171174753799627467382181888 21626132883476724540000000000000 31553580184752881664000000000000000
;; small program: loop2((1 + y) * ((2 + y) * x), y, x, 1 + x, x)
;; fast program: loop2(x * y, y, x, 1, 1 + x) * loop2(x * y, y, x, 1 + x, 2 + x)
(set-logic UFNIA)
