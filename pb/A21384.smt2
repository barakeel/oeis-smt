;; sequence(s): A21384
;; terms: 1 18 225 2470 25701 261378 2632345 26400990 264329901 2644608538 26451412065 264535693110 2645444018101 26454790920498 264549319337385 2645498855426830 26455011267050301 264550203715341258
;; small program: loop(((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
