...
(assert (forall ((x Int)) (= (f3 x) (ite (<= (modf (+ 1 x) (* 2 (+ 2 2))) 0) 1 0))))
(assert (= g3 1))
...
(assert (forall ((x Int)) (= (f7 x) (ite (<= (modf (+ 1 x) (* 2 (+ 2 2))) 0) 1 0))))
(assert (= g7 1))
...
(assert (forall ((x Int)) (= (g4 x) (- 2 (modf x 2)))))
(assert (forall ((x Int)) (= (h4 x) x)))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int)) (= (v4 x) (u4 (g4 x) (h4 x)))))
(assert (forall ((x Int)) (= (fast x) (modf (+ (- (v4 x) x) 1) 2))))
