;; sequence(s): A20572
;; terms: 1 23 357 4675 55781 628803 6831637 72401555 754291461 7764923683 79263766517 804302170035 8126850016741 81868359076163 822960967286997 8260021493532115 82815918789863621 829686041539878243
;; small program: loop((loop(loop(2 * ((x + x) + x), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, (y + y) + y, x, 1, 1 + 2) * loop(x + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
