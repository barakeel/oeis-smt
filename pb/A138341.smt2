;; sequence(s): A138341
;; terms: 1 ~2 ~7 ~7 2 13 13 ~2 ~19 ~19 2 25 25 ~2 ~31 ~31 2 37 37 ~2
;; small program: loop2(0 - y, x + y, x, 1 + (x + x), 2)
;; fast program: loop2(y, y - x, x, (x + x) + 1, 0 - 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (i1 x) (+ (+ x x) 1))))
(assert (= j1 (- 0 2)))
