;; sequence(s): A65236
;; terms: 1 24 10080 15966720 62270208000 482718652416000 6528287055273984000 141011000393918054400000 4563680016748763912601600000 210842016773792892762193920000000
;; small program: loop((x * y) + x, x, 1) * loop(2 * ((2 * (x * y)) - x), x + x, 1)
;; fast program: (loop2(x * y, 1 + y, x, 1, 1 + ((x + x) + x)) * loop(x * y, x, 1 + x)) * loop2(x * y, 1 + y, x, 1, 1 + (x + x))
(set-logic UFNIA)
