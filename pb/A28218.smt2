;; sequence(s): A28218
;; terms: 1 38 913 17738 304549 4824806 72271081 1039149506 14486436877 197162419454 2632865400529 34623882428954 449653998040885 5779288950415382 73637791767193657 931419802216938482
;; small program: loop((loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop((x + x) + x, x, 1), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((y * y) + x)) - y) + x, y + y, x, 1, 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
