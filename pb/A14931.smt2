;; sequence(s): A14931
;; terms: 1 33 801 17185 344865 6636321 124076833 2271560481 40926266145 728121033505 12822748939041 223928981472033 3883103678710561 66933498461897505 1147797409030816545 19594541482740368161
;; small program: loop(loop(2 * (x + x), y + y, 1 + y) + x, x, 1)
;; fast program: loop2(((2 * (2 * (2 + 2))) * x) + y, y - 1, x, 1 + x, x)
(set-logic UFNIA)
