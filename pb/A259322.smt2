;; sequence(s): A259322
;; terms: 1 730 16355 134004 665445 2437006 7263815 18654440 42792009 89837890 175604011 323639900 567780525 955201014 1550024335 2437528016 3728995985 5567261610 8132988019 11651731780
;; small program: loop(loop(loop2(x * y, x, y, x, x), 2, 1 + (y + y)) + x, x, 1)
;; fast program: loop2(loop((x * x) * x, 1, y * y) + x, 2 + y, x, 1, 1 + 2)
(set-logic UFNIA)
