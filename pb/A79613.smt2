;; sequence(s): A79613
;; terms: 2 8 144 46368 4807526976 51680708854858323072 5972304273877744135569338397692020533504 79757008057644623350300078764807923712509139103039448418553259155159833079730688
;; small program: loop2(x + y, x, loop(1 + (x + x), x, 2), 1, 0)
;; fast program: loop2(loop2(x + y, x, y, 1 + 2, 1) * x, (2 + y) + y, x, 2, 1)
(set-logic UFNIA)
