;; sequence(s): A99276
;; terms: 0 1 18 361 7200 143641 2865618 57168721 1140508800 22753007281 453919636818 9055639729081 180658874944800 3604121859166921 71901778308393618 1434431444308705441 28616727107865715200
;; small program: loop(loop2(y, (2 * (2 * ((2 * (y + y)) + y))) - x, y, 1, 1) - x, x, 0)
;; fast program: loop(loop2(((2 + (2 * (2 + 2))) * (x + x)) - y, x, y - 1, 1, 1) - x, x, 0)
(set-logic UFNIA)
