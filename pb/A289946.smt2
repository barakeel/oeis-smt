;; sequence(s): A289946
;; terms: 1 65 46721 191149697 2986175149697 139317055679149697 16390300280131775149697 4296598745804900241599149697 2283384320190476620685217983149697 2283382306976051006261597069217983149697
;; small program: loop(loop(((loop(x * x, 2, y) * y) * y) * x, 1 + y, 1) + x, x, 1)
;; fast program: loop(loop((x * x) * x, 1, loop(x * x, 1, loop(x * y, y, 1 + y))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (v6 x y) (u6 (g6 x y) (h6 x y)))))
(assert (forall ((x Int) (y Int)) (= (h5 x y) (v6 x y))))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y))))))
(assert (forall ((x Int) (y Int)) (= (v5 x y) (u5 g5 (h5 x y)))))
(assert (forall ((x Int) (y Int)) (= (h4 x y) (v5 x y))))
