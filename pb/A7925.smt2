;; sequence(s): A7925
;; terms: ~1 ~1 ~1 17 399 7849 162287 3667649 91171007 2486784401 74062575399 2395420006033 83695120256591 3143661612445145 126375169532421599 5415486851106043649 246486713303685957375 11877172892329028459041
;; small program: loop2(x * y, y, x, x, x) - loop2((x * y) + x, y, x, 1, x)
;; fast program: (((x * x) * x) * loop2(x * y, y, x - 2, 1, x)) - loop2(x * y, y, x, 1, 1 + x)
(set-logic UFNIA)
