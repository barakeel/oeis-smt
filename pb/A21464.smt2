;; sequence(s): A21464
;; terms: 1 19 248 2810 29871 307929 3126478 31504000 316245941 3168518639 31715571108 317307900390 3173840747611 31742218586149 317441248586138 3174507821007980 31745554950382881 317457933399054459
;; small program: loop(((loop((loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
