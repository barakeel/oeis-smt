;; sequence(s): A128534
;; terms: 0 2 1 6 12 35 88 234 609 1598 4180 10947 28656 75026 196417 514230 1346268 3524579 9227464 24157818
;; small program: loop2(y - x, x, x + x, 1, 1) - loop(0 - x, x, 1)
;; fast program: (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(y, x + y, x - 1, 2, 1)
(set-logic UFNIA)
