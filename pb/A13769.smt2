;; sequence(s): A13769
;; terms: 441 4084101 37822859361 350277500542221 3243919932521508681 30041942495081691894741 278218429446951548637196401 2576580875108218291929075869661 23861715484377209601555171628930521 220983347100817338120002444455525554981
;; small program: loop((loop(2 * (2 + x), 2, 2) * x) + x, 2 + ((x + x) + x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))) * loop2(x * y, y, 2 + x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
