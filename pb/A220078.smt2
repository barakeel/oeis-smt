;; sequence(s): A220078
;; terms: 5 5 25 15625 59604644775390625 752316384526264005099991383822237233803945956334136013765601092018187046051025390625
;; small program: loop((2 * (x + x)) + x, loop(x * y, x, 1), 1)
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 1, 1 + (2 + 2))
(set-logic UFNIA)
