;; sequence(s): A13860
;; terms: 1331 214358881 34522712143931 5559917313492231481 895430243255237372246531 144209936106499234037676064081 23225154419887808141001767796309131 3740434344477351388916475705363381856681 602400691612421918536387328824478011400331731
;; small program: loop(loop((2 + y) * x, 2, x) - x, loop(1 + (x + x), 2, x) + x, 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))) * loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
