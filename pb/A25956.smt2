;; sequence(s): A25956
;; terms: 1 27 493 7671 109813 1496031 19737181 254700567 3234969925 40605328335 505121007469 6240023291463 76665993102037 937849058035839 11432760118860157 138978835693603959 1685603171125077349
;; small program: loop(((loop(loop2((2 * ((2 * (x + x)) + x)) + y, y + y, y, 1, 2) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(((loop(loop2((2 * ((x + x) + x)) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)) * loop(x + x, x, 1), 1, y) + x) + x) + x, x, 1)
(set-logic UFNIA)
