;; sequence(s): A1870
;; terms: 1 5 19 65 210 654 1985 5911 17345 50305 144516 411900 1166209 3283145 9197455 25655489 71293590 197452746 545222465 1501460635
;; small program: loop(loop2(x + y, x, y + y, 0, y) - x, 1 + x, 0)
;; fast program: loop(loop2(((x - y) + x) + x, x, y, 1 + y, 0) - x, x, 1)
(set-logic UFNIA)
