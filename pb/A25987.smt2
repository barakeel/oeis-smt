;; sequence(s): A25987
;; terms: 1 21 285 3185 31941 299481 2685565 23352945 198684981 1663903241 13774041645 113050606305 921961387621 7483064823801 60518933442525 488128819261265 3929148977523861 31579173926461161
;; small program: loop((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop(x + x, x, 1), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
