;; sequence(s): A185968
;; terms: 0 1 32 2304 524288 419430400 1236950581248 13792273858822144 590295810358705651712 97922991388784963151200256 63382530011411470074835160268800
;; small program: loop2(x * y, 2, x * x, x, x)
;; fast program: loop2(x * y, y + y, x - 1, x, 2 + 2) * loop2(x * y, y + y, x - 1, x, 2)
(set-logic UFNIA)
