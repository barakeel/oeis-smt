;; sequence(s): A24439
;; terms: 1 27 482 7182 96843 1227609 14939644 176784444 2050941365 23457934071 265547461686 2983410454986 33332770184767 370895550650613 4114522946353808 45542666345230008 503271413032566249
;; small program: loop((loop((loop(1 + (2 * (2 * (x + x))), y, 1) - x) + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((2 * ((y + y) + y)) + y), x, 1, 2 * (2 + 2)), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
