;; sequence(s): A14943
;; terms: 1 51 1926 64426 2017551 60611301 1769595676 50597720676 1423888736301 39570861392551 1088612609439426 29698842101626926 804559224181705051 21666184895568423801 580459729664855533176
;; small program: loop(loop((2 * (x + x)) + x, y + y, 1 + y) + x, x, 1)
;; fast program: loop2((loop(x * x, 1, 1 + (2 + 2)) * x) + y, y - 1, x, 1 + x, x)
(set-logic UFNIA)
