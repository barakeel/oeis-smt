;; sequence(s): A302612
;; terms: 1 2 6 20 65 186 462 1016 2025 3730 6446 10572 16601 25130 36870 52656 73457 100386 134710 177860
;; small program: (loop(loop((y * y) + x, y - 2, x) + y, x, 1) - x) * (1 + x)
;; fast program: loop(loop((y * y) + x, y - 1, x) + y, x - 1, 1) * (x + 1)
(set-logic UFNIA)
