;; sequence(s): A21604
;; terms: 1 21 300 3670 41511 449151 4730890 48987840 501640821 5098774681 51564400680 519680849610 5225067192931 52448485198611 525869552045670 5268388442396980 52751734942121841 527992303241992941
;; small program: loop(((loop((loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
