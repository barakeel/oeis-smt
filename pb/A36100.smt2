;; sequence(s): A36100
;; terms: 1 4194305 31385253913 17623567104025 2401777977060041 134005889633282761 4041442752425255185 77696797343421194513 1058557878478449439345 10984770902183611232881
;; small program: loop2(loop2(x * y, y, 2 + (2 * (2 + (2 * (2 + 2)))), 1, y) + x, 1 + y, 2, 0, x)
;; fast program: loop2(loop(loop2(loop(loop2(x * y, y, 1 + (2 + (2 * (2 + 2))), 1, x), 1, y) * x, y, 2, 1, x), 1, y) + x, 1 + y, 2, 0, x)
(set-logic UFNIA)
