;; sequence(s): A134833
;; terms: 1 ~1 1 0 ~2 12 ~16 144 368 4768 39488 412288 4577280 55671808 731390976 10335518720 156303439872 2518984822784 43099089166336 780268880543744
;; small program: loop((loop((x * y) + loop(0 - (x + x), y, 1), y - 1, 1) - x) - x, x, 1)
;; fast program: loop((loop(loop2(x * y, y, y, 1, 0 - 2) + (x * y), y - 1, 1) - x) - x, x, 1)
(set-logic UFNIA)
