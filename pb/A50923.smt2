;; sequence(s): A50923
;; terms: 2 2 4 64 16777216 1329227995784915872903807060280344576
;; small program: loop(x + x, loop(x * y, x, 1), 1)
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 2, loop(x + x, x - 1, 2))
(set-logic UFNIA)
