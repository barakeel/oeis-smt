;; sequence(s): A167423
;; terms: 1 ~1 ~11 ~50 ~186 ~631 ~2029 ~6299 ~19075 ~56704 ~166164 ~481391 ~1381691 ~3935125 ~11134331 ~31328366 ~87721614 ~244588519 ~679429225 ~1881102959
;; small program: loop2(y - x, x, 1 + (x + x), x, 1)
;; fast program: loop2(((x - y) + x) + x, x, x, 1 - x, 1)
(set-logic UFNIA)
