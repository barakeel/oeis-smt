;; sequence(s): A37451
;; terms: 0 1 3 16 63 275 1152 4901 20727 87856 372075 1576279 6676992 28284569 119814747 507544400 2149990983 9107510539 38580029568 163427634589
;; small program: loop2(x + y, x, x + x, 0, loop2(x + y, x, x, 0, 1))
;; fast program: loop(x * x, 1, if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(x + y, x, x - 1, 1, 2)
(set-logic UFNIA)
