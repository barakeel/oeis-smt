;; sequence(s): A7704
;; terms: 2 3 4 9 28 225 6076 1361025 8268226876 11253255215681025 93044467205527772332546876 1047053135870867396062743192203958743681025
;; small program: 1 + loop2((x * y) + y, x, x, 1, 1)
;; fast program: 1 + loop2((1 + x) * y, x, x - 1, if x <= 0 then 1 else 2, 1)
(set-logic UFNIA)
