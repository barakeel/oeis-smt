;; sequence(s): A22565
;; terms: 1 24 383 5130 62481 718164 7948003 85708590 907402661 9479002104 98042032023 1006497443250 10273896592441 104411869082844 1057509545490443 10682260439173110 107680115000743821
;; small program: loop((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + (2 * (x + x))) + x, x, 1)
