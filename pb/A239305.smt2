;; sequence(s): A239305
;; terms: 1 1 2 6 13 31 69 153 332 712 1509 3169 6603 13669 28142 57674 117741 239587 486193 984353
;; small program: loop(x + x, x, 2) - loop2(1 + y, x + y, x, 1 + x, 2)
;; fast program: loop(x + x, x, 2) - loop2(y, x + y, x, 1 + x, 1 + 2)
(set-logic UFNIA)
