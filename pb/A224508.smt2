;; sequence(s): A224508
;; terms: 0 1 2 1 7 0 23 ~9 78 ~59 275 ~296 1003 ~1341 3758 ~5775 14367 ~24176 55727 ~99521
;; small program: loop((loop2(y, x + y, y, 1 + 2, 1) - x) - x, x, 0)
;; fast program: loop((loop2(x + y, x, y - 1, 1, 1 + 2) - x) - x, x, 0)
(set-logic UFNIA)
