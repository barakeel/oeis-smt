;; sequence(s): A18092
;; terms: 1 24 405 5940 81081 1061424 13533885 169579980 2099526561 25775439624 314535422565 3821496571620 46281602898441 559192032726624 6744619579010445 81244271639092860 977710789930868721
;; small program: loop((x + x) + x, x, loop(((loop(1 + (2 * (x + x)), y, 1) + x) + x) + x, x, 1))
;; fast program: loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
