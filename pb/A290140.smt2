;; sequence(s): A290140
;; terms: 1 2 5 9 13 19 27 39 57 85 129 199 311 491 781 1249 2005 3227 5203 8399
;; small program: loop(loop2(x + y, x, y, 2, 0) + y, x - 1, 1) + x
;; fast program: ((loop(1 - x, 2 - x, x) - 1) + x) + loop2(x + y, x, x - 2, 2, 2)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (+ (- (v2 x) 1) x) (w3 x)))))
