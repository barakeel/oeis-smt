;; sequence(s): A13836
;; terms: 125 390625 1220703125 3814697265625 11920928955078125 37252902984619140625 116415321826934814453125 363797880709171295166015625 1136868377216160297393798828125 3552713678800500929355621337890625
;; small program: loop((2 * (x + x)) + x, loop(1 + (x + x), 2, x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 + 2))) * loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 + 2)))
(set-logic UFNIA)
