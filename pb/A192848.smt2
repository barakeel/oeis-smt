;; sequence(s): A192848
;; terms: 12 96 300 672 1260 2112 3276 4800 6732 9120 12012 15456 19500 24192 29580 35712 42636 50400 59052 68640
;; small program: 2 * loop2((x * y) + x, x, 2, 1 + (x + x), 2 + x)
;; fast program: loop((2 + (2 + x)) * ((x * x) - x), 1, 2 + (x + x))
(set-logic UFNIA)
