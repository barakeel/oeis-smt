...
(assert (forall ((x Int)) (= (f1 x) (divf (+ (v2 x) (v3 x)) 2))))
(assert (= g1 1))
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (* 2 (+ (- x (divf x y)) x)))))
...
(assert (forall ((x Int)) (= (f5 x) (divf (+ (+ (- (v6 x) x) 1) (v8 x)) 2))))
(assert (= g5 1))
...
(assert (forall ((x Int)) (= (fast x) (divf (- (- (- (* (v4 x) 2) 1) x) x) 2))))
