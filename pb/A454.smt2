;; sequence(s): A454
;; terms: 1 10 85 735 6769 67284 723680 8409500 105258076 1414014888 20313753096 310989260400 5056995703824 87077748875904 1583313975727488 30321254007719424 610116075740491776
;; small program: loop((loop(loop(((x * y) + loop(x * y, y, 1)) + x, y, 1) + ((2 + y) * x), y, 1) + ((2 + y) * x)) + x, x, 1)
;; fast program: loop((loop(loop((loop(x * y, y - 1, y) + (x * y)) + x, y, 1) + ((2 + y) * x), y, 1) + ((2 + y) * x)) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (v5 x y) (* (+ 2 y) x)) x))))
