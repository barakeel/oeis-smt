;; sequence(s): A233481
;; terms: 0 1 4 21 144 1245 13140 164745 2399040 39834585 742940100 15374360925 349484058000 8654336615925 231842662751700 6679510641428625 205916703920928000 6762863294018456625 235719416966063530500 8689887736412502745125
;; small program: loop(loop(((x + x) * y) - x, y - 1, y) + (x * y), x, 0)
;; fast program: loop(loop2(x * y, 2 + y, y - 1, 1, 1 + 2) + (x * y), x - 1, 1) * x
(set-logic UFNIA)
