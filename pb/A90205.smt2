;; sequence(s): A90205
;; terms: 4 108 6912 800000 145800000 38423222208 13816758796288 6499837226778624 3874204890000000000 2853116706110000000000 2543867514227405321404416 2700464873652770753916960768
;; small program: loop2((1 + y) * ((2 + y) * x), y, 1 + x, 2 + x, x)
;; fast program: loop(loop2(x * y, y, x - 2, x, x) * x, 1, 2 + x) * loop2(x * y, y, x, 1 + x, 1 + x)
(set-logic UFNIA)
