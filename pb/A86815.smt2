;; sequence(s): A86815
;; terms: 0 16 1458 196608 39062500 10883911680 4069338437094 1970324836974592 1200757082375992968 900000000000000000000 814027493868397611133210 874465319237299285467856896 1100799962319223399900795392108
;; small program: loop2((x * y) + x, y, 2 + (x + x), x, x)
;; fast program: (x * loop2(x * y, y, x, 1 + x, 1 + x)) * loop2(x * y, y, x, 1 + x, 1 + x)
(set-logic UFNIA)
