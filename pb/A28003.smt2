;; sequence(s): A28003
;; terms: 1 30 592 9744 145264 2038176 27478144 360357888 4633015552 58698511872 735496093696 9137636831232 112771744215040 1384481544019968 16926102208872448 206237168590258176
;; small program: loop(((loop((loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1) * loop(x + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
