;; sequence(s): A117263
;; terms: 1 2 7 64 1729 140050 34032151 24809438080 54258241080961 355988319732185122 7006918097288599756327 413751506726794527011353024 73294838162131470076480154142529
;; small program: loop2(1 + (x * y), (y + y) + y, x, 1, 1)
;; fast program: loop2((x * y) + 1, (y + y) + y, x - 1, if x <= 0 then 1 else 2, 1 + 2)
(set-logic UFNIA)
