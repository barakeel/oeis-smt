;; sequence(s): A158218
;; terms: 167 672 1515 2696 4215 6072 8267 10800 13671 16880 20427 24312 28535 33096 37995 43232 48807 54720 60971 67560
;; small program: (1 + x) * (loop(loop((2 + y) * x, 2, 1 + x) + x, 2, x) - 1)
