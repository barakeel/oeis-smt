;; sequence(s): A106230
;; terms: 3 8 3 8 15 24 35 48 63 80 99 120 143 168 195 224 255 288 323 360
;; small program: (1 + x) * loop(y, x - 1, 1 + (2 + x))
;; fast program: (loop(loop(x * y, 2 + x, 1) - y, 2 - x, x) - 1) * (1 + x)
(set-logic UFNIA)
