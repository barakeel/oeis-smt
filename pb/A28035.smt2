;; sequence(s): A28035
;; terms: 1 23 345 4315 49121 530403 5553385 57088955 580462641 5863054483 58985130425 591995063595 5932878706561 59406619141763 594534243267465 5948154995694235 59498442385788881 595085846763024243
;; small program: loop(((loop(loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (x + x)), y, 1) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h6 x) (- (v7 x) 1))))
