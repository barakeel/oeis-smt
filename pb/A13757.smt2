;; sequence(s): A13757
;; terms: 225 759375 2562890625 8649755859375 29192926025390625 98526125335693359375 332525673007965087890625 1122274146401882171630859375 3787675244106352329254150390625 12783403948858939111232757568359375
;; small program: loop((loop(x * x, 2, 2) * x) - x, 2 + ((x + x) + x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1)) * loop2(x * y, y, 2 + x, 1, (2 * (2 * (2 + 2))) - 1)
(set-logic UFNIA)
