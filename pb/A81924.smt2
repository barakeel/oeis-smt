;; sequence(s): A81924
;; terms: 1 5 27 159 1029 7353 58095 506691 4860297 51023277 583097859 7215769575 96210083853 1375803720801 21012273704151 341449444105227 5883436565417745 107162594556721749 2057521815411573483
;; small program: loop(loop((x * y) + loop((x + x) + x, y, 1), y, 1) + (x * y), x, 1)
;; fast program: loop(loop((x * y) + loop2(x * y, y, y, 1, 1 + 2), y, 1) + (x * y), x, 1)
(set-logic UFNIA)
