;; sequence(s): A2605
;; terms: 0 1 2 6 16 44 120 328 896 2448 6688 18272 49920 136384 372608 1017984 2781184 7598336 20759040 56714752
;; small program: loop2(y, 2 * (x + y), x, 0, 1)
;; fast program: loop2(2 * (x + y), x, x - 2, if (x - 1) <= 0 then x else 2, 1)
(set-logic UFNIA)
