;; sequence(s): A101090
;; terms: 1 19 135 605 2054 5778 14178 31350 63855 121693 219505 378027 625820 1001300 1555092 2352732 3477741 5035095 7155115 9997801
;; small program: loop(loop(loop(loop(x * x, 2, y) + x, y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop((((y * y) * y) * y) + x, y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (* (* (* y y) y) y) x))))
