;; sequence(s): A13750
;; terms: 12 20736 35831808 61917364224 106993205379072 184884258895036416 319479999370622926848 552061438912436417593344 953962166440690129601298432 1648446623609512543951043690496
;; small program: loop(loop((2 + y) * x, 2, x), 1 + ((x + x) + x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2)))) * loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 + 2)))
(set-logic UFNIA)
