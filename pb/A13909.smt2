;; sequence(s): A13909
;; terms: 279841 1801152661463 11592836324538749809 74615470927590710561908487 480250763996501976790165756943041 3091058643093537522799545838540043339063 19895113660064588580108197261066338165074766609 128051775540161094255459334683883498184411818540470887
;; small program: loop(loop(x * y, 2 + 2, x) - x, (2 * (2 + (x + x))) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1)) * loop(x * x, 1, loop2(x * y, y, 2 + x, 1, (2 * (2 * (2 + (2 + 2)))) - 1))
(set-logic UFNIA)
