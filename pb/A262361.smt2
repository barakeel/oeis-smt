;; sequence(s): A262361
;; terms: 4 1 7 29 1149851 387739824812222466915538827541705412334749
;; small program: loop(loop2(y, x + y, x, 2, 1), 1 + 2, x)
;; fast program: loop(loop2(x + y, x, x, 2, 0 - 1), 1 + 2, x)
(set-logic UFNIA)
