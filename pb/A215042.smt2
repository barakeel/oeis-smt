;; sequence(s): A215042
;; terms: 0 7 141 2576 46347 831985 14930208 267913919 4807525989 86267568688 1548008749155 27777890017577 498454011832896 8944394323670071 160500643816049277 2880067194369984080 51680708854856144763 927372692193073296289
;; small program: loop2(y - x, x, 2 * (x + x), 2, 1) * loop2(x + y, x, x + x, 0, 1)
;; fast program: loop2(((2 * ((x + x) + x)) - y) + x, x, x - 1, (if x <= 0 then 0 else (1 + (2 + 2))) + 2, 2) * loop2(x + y, x, x + x, 0, 1)
(set-logic UFNIA)
