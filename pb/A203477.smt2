;; sequence(s): A203477
;; terms: 1 3 90 97200 14276736000 1107198567383040000 178601637561927097909248000000 237856509917156074017606774172522905600000000 10420480393274493153643458442091600404477248333907230720000000000
;; small program: loop(loop2(loop(x + y, y, 0) * x, y + y, y, 1, 2) * x, x, 1)
;; fast program: loop(loop2((1 + (y + y)) * (x * y), y + y, y, 1, 1) * x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (* (+ 1 (+ y y)) (* x y)))))
