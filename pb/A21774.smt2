;; sequence(s): A21774
;; terms: 1 20 271 3150 34041 354480 3620611 36607010 368161981 3692428740 36979730151 370080107670 3702237477121 37029646251800 370333177834891 3703516786589130 37036098633715461 370365663082767660
;; small program: loop((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, x, 1)
