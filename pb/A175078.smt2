...
(assert (forall ((x Int)) (= (small x) (divf (+ (+ (- (v0 x) (ite (<= x 0) 1 2)) x) x) (+ 2 x)))))
(assert (forall ((x Int)) (= (f6 x) (+ x x))))
(assert (forall ((x Int)) (= (g6 x) (divf x 2))))
(assert (= h6 1))
(assert (forall ((x Int) (y Int)) (= (u6 x y) (ite (<= x 0) y (f6 (u6 (- x 1) y))))))
(assert (forall ((x Int)) (= (v6 x) (u6 (g6 x) h6))))
(assert (forall ((x Int)) (= (f5 x) (ite (<= (- (modf (+ 1 (v6 x)) (+ 1 x)) 2) 0) 1 2))))
(assert (= g5 1))
...
(assert (forall ((x Int)) (= (fast x) (modf (v3 x) (w7 x)))))
