;; sequence(s): A13896
;; terms: 8000 25600000000 81920000000000000 262144000000000000000000 838860800000000000000000000000 2684354560000000000000000000000000000 8589934592000000000000000000000000000000000 27487790694400000000000000000000000000000000000000
;; small program: loop(loop(2 * (2 + x), 2, 2) * x, loop(1 + (x + x), 2, x) + x, 1)
