;; sequence(s): A13840
;; terms: 216 1679616 13060694016 101559956668416 789730223053602816 6140942214464815497216 47751966659678405306351616 371319292745659279662190166016 2887378820390246558653190730940416 22452257707354557240087211123792674816
;; small program: loop(2 * ((x + x) + x), loop(1 + (x + x), 2, x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 + 2))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 + 2)))
(set-logic UFNIA)
