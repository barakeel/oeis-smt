;; sequence(s): A122883
;; terms: 1 3 23 123 739 4263 24935 145155 846379 4932351 28749263 167560155 976617811 5692134423 33176213303 193365096243 1127014462459 6568721481903 38285314822175 223143166664715
;; small program: loop((loop2((x + x) + y, x, y + y, 1, 0) - x) - x, x, 1)
;; fast program: loop((loop2((2 * ((x + x) + x)) - y, x, y - 1, 1 + (2 + 2), 1) - x) - x, x, 1)
(set-logic UFNIA)
