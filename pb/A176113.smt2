;; sequence(s): A176113
;; terms: 1 ~1 ~8 1296 7962624 ~2985984000000 ~100306130042880000000 416336312719673760153600000000 281633758444745849464726940024832000000000
;; small program: loop2(x * y, 0 - y, 1 + x, 1, loop(x * y, x, 1))
;; fast program: (loop2(x * y, y, x - 1, 1, loop(x * y, x, 1)) * loop(x * x, 1, loop(x * y, x, 1))) * loop2(0 - y, x, x, 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (- 0 y))))
