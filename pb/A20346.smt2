;; sequence(s): A20346
;; terms: 1 23 359 4747 57351 655683 7229839 77760587 821694071 8571599443 88563029919 908455411227 9267399149191 94137972490403 953097676407599 9624750893682667 96997854561570711 975982073553112563
;; small program: loop(loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (2 * (x + x))), x, 1)
;; fast program: loop(loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + (2 + 2)), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
