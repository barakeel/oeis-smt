;; sequence(s): A74565
;; terms: 3 17 101 623 3953 25607 168401 1119863 7509953 50693447 343990001 2344318103 16034846753 110016813287 756855672401 5218820236343 36058335444353 249574353301127 1730042274055601 12008529803290583
;; small program: loop2((2 * ((x + x) + x)) + y, (2 * ((y + y) + y)) + y, x, 2, 1) + loop(x + x, x + x, 1)
;; fast program: (loop(x * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))) + loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
