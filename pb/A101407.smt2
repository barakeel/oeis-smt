;; sequence(s): A101407
;; terms: 4 4 16 4096 281474976710656 1766847064778384329583297500742918515827483896875618958121606201292619776
;; small program: loop(x + x, loop(x * y, x, 2), 1)
;; fast program: loop(loop2(x * y, y, y - 1, 1, x) * (x * x), x - 2, loop(x * x, 1, loop(x + x, x - 1, 2)))
(set-logic UFNIA)
