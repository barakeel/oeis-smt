;; sequence(s): A121366
;; terms: 1 16 2048 2097152 17179869184 1125899906842624 590295810358705651712 2475880078570760549798248448 83076749736557242056487941267521536 22300745198530623141535718272648361505980416
;; small program: loop(x + x, loop((2 + x) + y, x, x * x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y + y, x - 1, 1, 2)) * loop2(x * y, y + y, x, 1, 2 * (2 * (2 + 2)))
(set-logic UFNIA)
