;; sequence(s): A238846
;; terms: 1 4 13 40 120 354 1031 2972 8495 24110 68016 190884 533293 1484020 4115185 11375764 31358376 86223942 236540915 647556620
;; small program: loop(loop2(x + y, x, y + y, 1, 2 + y) - x, x, 1)
;; fast program: loop(loop2((x + x) + y, x + y, y, 1, 2 + y) - x, x, 1)
(set-logic UFNIA)
...
(assert (= i1 1))
(assert (forall ((x Int) (y Int)) (= (j1 x y) (+ 2 y))))
