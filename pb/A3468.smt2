;; sequence(s): A3468
;; terms: 1 22 305 3410 33621 305382 2619625 21554170 171870941 1337764142 10216988145 76862115330 571247591461 4203844925302 30687029023865 222518183370890 1604626924403181 11518132293452862
;; small program: loop((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((x + x) + x)) + (y * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (+ (* 2 (+ (+ x x) x)) (* y y)))))
