;; sequence(s): A128533
;; terms: 0 4 7 22 54 145 376 988 2583 6766 17710 46369 121392 317812 832039 2178310 5702886 14930353 39088168 102334156
;; small program: loop(loop2(x + y, x, y + y, 1, 2) - x, x, 0)
;; fast program: (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(x + y, x, x, 1 + 2, 1)
(set-logic UFNIA)
