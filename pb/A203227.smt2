;; sequence(s): A203227
;; terms: 1 2 5 32 780 93888 67633920 340899840000 13745206960128000 4987865758275993600000 18099969098565397826764800000 722492853172221856076141690880000000 346075232923849611911833538569175040000000000
;; small program: loop(loop(x * y, y, x), x - 1, loop(1 + (x * y), x, 1))
;; fast program: (loop(loop(x * y, y - 1, y) * x, x - 2, 1) * loop(x * y, x - 1, 1)) * loop(1 + (x * y), x, 1)
(set-logic UFNIA)
