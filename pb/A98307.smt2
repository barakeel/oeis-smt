;; sequence(s): A98307
;; terms: 0 1 7 64 567 5041 44800 398161 3538647 31449664 279508327 2484125281 22077619200 196214447521 1743852408487 15498457228864 137742262651287 1224181906632721 10879894897043200 96694872166756081
;; small program: loop(loop2(y, ((2 * (2 * (y + y))) - x) + y, y, 1, 1) - x, x, 0)
;; fast program: loop(loop2(((2 * (2 * (x + x))) - y) + x, x, y - 1, 1, 1) - x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g1 x y) (+ (- (* 2 (* 2 (+ y y))) x) y))))
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (- (* 2 (* 2 (+ x x))) y) x))))
