;; sequence(s): A28066
;; terms: 1 27 474 6902 90867 1126545 13446028 156530604 1791797733 20274317063 227558149182 2539586737506 28227640438999 312844584806781 3460030004311536 38210322891344408 421513875961285065
;; small program: loop(((loop((loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop2(((((y * y) * y) + x) + x) + x, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
