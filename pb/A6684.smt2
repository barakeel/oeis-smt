;; sequence(s): A6684
;; terms: 0 0 1 3 9 24 62 156 387 951 2323 5652 13716 33228 80405 194415 469845 1135092 2741626 6620928
;; small program: loop2((x + x) + y, x, x, 0, 1) - loop2(x + y, x, x, 0, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then 1 else 2, 1) - loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
