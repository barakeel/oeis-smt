;; sequence(s): A24114
;; terms: 1 27 487 7407 102943 1357119 17315839 216369279 2667080575 32582253951 395677903231 4786097041791 57739474264447 695339842109823 8363901349806463 100525966375567743 1207588183261823359
;; small program: loop(loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + loop((2 + y) * x, 2, x), x, 1)
