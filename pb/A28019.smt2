;; sequence(s): A28019
;; terms: 1 32 668 11536 179088 2599296 36043456 483836672 6341561600 81632911360 1036368313344 13015606775808 162070777434112 2004417298202624 24654551330373632 301916965980012544
;; small program: loop((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)), 1, y) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1)
(set-logic UFNIA)
