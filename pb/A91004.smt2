;; sequence(s): A91004
;; terms: 0 1 ~2 8 ~20 68 ~188 596 ~1724 5300 ~15644 47444 ~141308 425972 ~1273820 3829652 ~11472572 34450484 ~103285916 309988820
;; small program: loop(((loop(x + x, y - 2, 1) - x) - x) - x, x, 0)
;; fast program: loop2(2 * ((y + y) - x), x + y, x - 1, if x <= 0 then 0 else 1, 0)
(set-logic UFNIA)
