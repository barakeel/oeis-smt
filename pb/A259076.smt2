;; sequence(s): A259076
;; terms: 1 80 6400 512000 40960000 3276800000 262144000000 20971520000000 1677721600000000 134217728000000000 10737418240000000000 858993459200000000000 68719476736000000000000
;; small program: loop(loop((2 + x) * x, 2, 2) * x, x, 1)
;; fast program: loop(x * x, 2, loop(x + x, x, 1)) * loop2(x * y, y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
