;; sequence(s): A13913
;; terms: 331776 2641807540224 21035720123168587776 167499529910025153071284224 1333735776850284124449081472843776 10620036506406716776157242913621199028224 84563357566790276763032290197830086290913099776 673346220481905860719963226704206593022095630190772224
;; small program: loop(loop(x * y, 2 + 2, x), (2 * (2 + (x + x))) + x, 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 * (2 + (2 + 2))))) * loop2(x * y, y, 2 + x, 1, 2 * (2 * (2 + (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 * (2 * (2 + (2 + 2)))))
(set-logic UFNIA)
