;; sequence(s): A22000
;; terms: 1 28 533 8648 128889 1824276 24950461 333078016 4367420897 56484732044 722650676709 9164986526904 115404823162825 1444532800672132 17990818115880077 223110488408176112
;; small program: loop(loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * (x + x)), y, 1) + loop((2 + y) * x, 2, x), x, 1)
