;; sequence(s): A13796
;; terms: 12 248832 5159780352 106993205379072 2218611106740436992 46005119909369701466112 953962166440690129601298432 19781359483314150527412524285952 410186270246002225336426103593500672 8505622499821102144576131684114829934592
;; small program: loop(loop((2 + y) * x, 2, x), 1 + (2 * (x + x)), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2)))) * (2 * (2 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (v2 x) (* 2 (+ 2 (+ 2 2)))) (v4 x)))))
