;; sequence(s): A330016
;; terms: 0 1 2 9 41 233 1531 11537 98047 928529 9700111 110843729 1375599151 18427159889 265038487471 4074124514129 66660157879471 1156745432699729 21220242625821871 410344904191816529
;; small program: loop(loop((x * y) + loop(x * y, y - 1, 1), y, 0) - x, x, 0)
;; fast program: loop(loop(((loop(x * y, y - 1, 1) + x) * y) + x, y - 1, 1) - x, x, 0)
(set-logic UFNIA)
