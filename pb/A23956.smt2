;; sequence(s): A23956
;; terms: 1 26 449 6502 85581 1063194 12725545 148560206 1704811493 19330213474 217323204033 2428517447382 27020001684157 299686169462186 3316371108572633 36639232372189150 404308142849091093
;; small program: loop(loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + (2 * ((x + x) + x)), y, 1) + (2 * (2 * (x + x))), x, 1)
;; fast program: loop((loop(loop2((2 * ((x + x) + x)) + y, 1 + (2 * (2 * (y + y))), x, 1, 1 + (2 * (2 + 2))), 1, y) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
