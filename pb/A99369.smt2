;; sequence(s): A99369
;; terms: 0 1 64 4225 278784 18395521 1213825600 80094094081 5284996383744 348729667233025 23010873040995904 1518368891038496641 100189335935499782400 6610977802851947141761 436224345652293011573824
;; small program: loop(x * x, 1, loop2((2 * (2 * (x + x))) + y, x, x, 0, 1))
;; fast program: loop(x * x, 1, loop2((2 * (2 * (x + x))) + y, x, x - 1, if x <= 0 then 0 else 1, 0))
(set-logic UFNIA)
