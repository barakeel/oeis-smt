;; sequence(s): A13903
;; terms: 484 2494357888 12855002631049216 66249952919459433152512 341427877364219557396646723584 1759593634476317566025195247357657088 9068298061633453450429559033030337013743616 46734671075972137972644189178514201804813539213312
;; small program: loop((loop(x * y, 2 + 2, x) - x) - x, 2 + ((2 * (x + x)) + x), 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 * (2 + 2)))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
