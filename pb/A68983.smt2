;; sequence(s): A68983
;; terms: 0 2 23 255 3260 49196 867699 17604595 404662204 10401033404 295672787215 9211294233871 312080173805324 11423999821072140 449316582527563515 18896039733447227131 846135945932355895308 40192537618855187742732 2018612071634068368034711
;; small program: loop(loop(loop2(x * y, y, x, 1, x) - loop(x * y, x, 1), 1, 1 + y) + x, x, 0)
;; fast program: loop(loop(((loop2(x * y, y, x - 1, 1, 1 + x) * (1 + x)) - loop(x * y, x, 1)) * (1 + x), 1, y) + x, x, 0)
(set-logic UFNIA)
