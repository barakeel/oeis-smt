;; sequence(s): A103845
;; terms: 1 2 4 13 85 925 16633 482329 22669417 1722875617 211913700769 42170826452833 13579006117811905 7074662187380001985 5963940223961341672513 8134814465483270041306369
;; small program: loop(x * loop2(y, x + y, y, 2, 1), x, 1) + (if x <= 0 then 0 else 1)
;; fast program: loop(loop2(x + y, x, y, 1, 2) * x, x - 1, 1) + (if x <= 0 then 0 else 1)
(set-logic UFNIA)
