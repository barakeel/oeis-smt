;; sequence(s): A19623
;; terms: 1 22 335 4400 53661 628122 7178395 80862100 902846921 10025125022 110934086055 1224883116600 13505988249781 148791855626722 1638292574483315 18032294531183900 198432777621062241
;; small program: loop((loop2((loop((2 + y) * x, 2, x) - x) + (y * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop2(((2 * ((x + x) + x)) + (y * y)) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (+ (* 2 (+ (+ x x) x)) (* y y)) x))))
