;; sequence(s): A291547
;; terms: 1 9 3375 121550625 753631499840625 1261673443947253805015625 822952789790387281855874669859609375 285018362247755338974104595257347347998199462890625 68512882179510153729154120317673085873841328059500855014801025390625
;; small program: loop2(loop((2 * (x * y)) + x, y, x), y, 1 + x, 1, x)
;; fast program: loop2(loop2(x * y, y, y - 1, 1, x) * (x * x), x, 1, loop2(x * y, 2 + y, x, 1, 1 + 2), x)
(set-logic UFNIA)
