;; sequence(s): A258385
;; terms: 0 8 648 82944 16000000 4374000000 1613775332736 773738492592128 467988280328060928 348678440100000000000 313842837672100000000000 335790511878017502425382912 421272520289832237611045879808 612530145817540311016457192308736
;; small program: loop2((1 + y) * (x * y), y, 1 + x, 1 + x, x)
;; fast program: (((x * x) * x) * loop2(x * y, y, x - 2, 1 + x, x)) * loop2(x * y, y, x, 1 + x, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (* (* x x) x) (w1 x)) (w2 x)))))
