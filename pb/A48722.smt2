;; sequence(s): A48722
;; terms: 0 1 3 7 29 233 7457 1908993 15638470657 32796250015268865 563435284988077103288156161 20299895516157546089301785397257605216206849 12565026726380593749379544715414757684521993402717913413208480665305089
;; small program: loop((x * loop2(y, x * y, y, 2, 1)) + 1, x, 0)
;; fast program: loop(1 + (loop2(x * y, x, y - 1, 1, 2) * x), x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (* x (w1 x y)) 1))))
