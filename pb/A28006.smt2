;; sequence(s): A28006
;; terms: 1 27 473 6831 88473 1069551 12338761 137686527 1499327225 16029462735 168979616169 1762044328863 18217806426457 187092613978479 1911192049791497 19440694364069439 197083660672701369 1992576025702599183 20101955387867645545
;; small program: loop((loop((loop2((2 * ((2 * (x + x)) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)) * loop(x + x, x, 1), 1, y) + x) + (((x + x) + x) * 2), x, 1)
(set-logic UFNIA)
