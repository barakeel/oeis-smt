;; sequence(s): A81714
;; terms: 0 3 4 14 33 90 232 611 1596 4182 10945 28658 75024 196419 514228 1346270 3524577 9227466 24157816 63245987
;; small program: loop(loop2(y - x, x, y + y, 2, 1) - x, x, 0)
;; fast program: (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(x + y, x, x, 1, 2)
(set-logic UFNIA)
