;; sequence(s): A306651
;; terms: 1 288 36118462464000 240498631970530185123135341199360000000000
;; small program: loop(loop(loop((x * y) + x, y, x), (y + y) + y, x), x, 1)
;; fast program: loop(loop(loop(x * y, y, 1 + y) * x, (y + y) + y, 1) * x, x, 1)
(set-logic UFNIA)
