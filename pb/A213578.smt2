;; sequence(s): A213578
;; terms: 1 4 13 34 80 174 359 712 1371 2580 4768 8684 15629 27852 49225 86390 150704 261530 451795 777360
;; small program: loop(loop(loop2(x + y, x, y, 0, y) + x, 1 + y, x), x, 1)
;; fast program: loop(loop((loop2(x + y, x, y - 2, 1, 1) * y) + x, y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ (* (w5 x y) y) x))))
