...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (* (* (ite (<= (modf x (+ 1 (+ 2 2))) 0) (+ 2 (+ 2 2)) 1) 2) x) y))))
...
(assert (forall ((x Int) (y Int)) (= (f1 x y) (+ (* (* (ite (<= (modf x (+ 1 (+ 2 2))) 0) (+ 2 (+ 2 2)) 1) 2) x) y))))
...
(assert (forall ((x Int)) (= (fast x) (divf (* (w1 x) (- 2 (modf x 2))) 2))))
