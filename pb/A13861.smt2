;; sequence(s): A13861
;; terms: 14641 2357947691 379749833583241 61159090448414546291 9849732675807611094711841 1586309297171491574414436704891 255476698618765889551019445759400441 41144777789250865278081232758997200423491
;; small program: loop(loop((2 + y) * x, 2, x) - x, (2 * (2 + (x + x))) + x, 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2))))) * loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
