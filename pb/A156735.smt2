;; sequence(s): A156735
;; terms: 9801 114243 332929 665859 1113033 1674451 2350113 3140019 4044169 5062563 6195201 7442083 8803209 10278579 11868193 13572051 15390153 17322499 19369089 21529923
;; small program: (loop(x * x, 1, loop2((x + x) + y, x, 2 + (2 + 2), x, 1)) * 2) + 1
;; fast program: (2 * loop(x * x, 1, loop2((2 * ((x + x) + x)) - y, x, 2, 2 + ((2 * (x + x)) + x), x))) + 1
(set-logic UFNIA)
...
(assert (= h3 2))
(assert (forall ((x Int)) (= (i3 x) (+ 2 (+ (* 2 (+ x x)) x)))))
