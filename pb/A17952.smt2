;; sequence(s): A17952
;; terms: 1 19 253 2935 31861 333919 3431773 34875415 352106821 3541203919 35532912493 356054541895 3564898452181 35675104315519 356907766700413 3570018022624375 35705822403011941 357092077219868719 3571123891724603533 35712457635563794855
;; small program: loop(((loop2(2 * (2 * ((x + x) + y)), (2 * (2 * (y + y))) + x, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop(loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * ((2 * (x + x)) + x)), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f3 x) (* (- (v4 x) 1) (w5 x)))))
(assert (= g3 1))
