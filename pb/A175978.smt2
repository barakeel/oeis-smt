;; sequence(s): A175978
;; terms: 1 2 5 126 252047377 1017210679182495207444253709079169646680658
;; small program: loop(1 + loop2(x * y, y, y, 1, x), x, 1)
;; fast program: loop((loop2(x * y, y, y - 1, 1, x) * (x * x)) + 1, x - 1, if x <= 0 then 1 else 2)
(set-logic UFNIA)
