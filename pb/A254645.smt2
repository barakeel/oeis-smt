;; sequence(s): A254645
;; terms: 1 68 995 7672 40614 166992 571626 1701480 4534959 11050468 24997973 53113424 106959580 205628736 379603812 676144944 1166649837 1956528420 3198236503 5108229896
;; small program: loop(loop(loop(loop(((loop(x * x, 2, y) * y) * y) + x, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop(loop((x * x) * x, 1, y * y) + x, y, x), y, x), 1 + y, x), x, 1)
(set-logic UFNIA)
...
(assert (= g9 1))
(assert (forall ((x Int) (y Int)) (= (h9 x y) (* y y))))
