;; sequence(s): A21844
;; terms: 1 23 363 4963 63539 787731 9609811 116281811 1401253587 16850623699 202422366419 2430363281619 29172151056595 350112652220627 4201633221810387 50421288464357587 605065606114711763
;; small program: loop(loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * (x + x)), y, 1) + loop((2 + y) * x, 2, x), x, 1)
