;; sequence(s): A13765
;; terms: 361 2476099 16983563041 116490258898219 799006685782884121 5480386857784802185939 37589973457545958193355601 257829627945307727248226067259 1768453418076865701195582595329481
;; small program: loop((2 * loop((x + x) + x, 2, x)) + x, 2 + ((x + x) + x), 1)
