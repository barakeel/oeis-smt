;; sequence(s): A21054
;; terms: 1 17 212 2422 26943 297339 3273754 36020624 396255365 4358895541 47948112576 527430027306 5801732675467 63819066571823 702009753747878 7722107355665668 84943181105770449 934374992744081385
;; small program: loop(loop2(((2 * (x + y)) - 1) + x, y + y, y, 1, 2) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop2(((2 * (x + y)) - 1) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
