;; sequence(s): A28685
;; terms: 1 506 141331872 20920469730667584 1638296742744745305180456960 67868907839960050279986415163868117749760 1487321615877089920298398794877451264100990832314711736320
;; small program: loop(loop((x * x) - x, 1, loop((2 * (2 * (2 * ((x + x) + x)))) - x, y, 1)) * x, x, 1)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, (2 * (2 * (2 + (2 + 2)))) - 1)) * x, x, 1)
(set-logic UFNIA)
