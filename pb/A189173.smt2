;; sequence(s): A189173
;; terms: 0 1 47 2161 99359 4568353 210044879 9657496081 444034774847 20415942146881 938689303981679 43159292041010353 1984388744582494559 91238722958753739361 4194996867358089516047 192878617175513363998801 8868221393206256654428799 407745305470312292739725953 18747415830241159209372965039
;; small program: loop2(((loop((x + y) * x, 2, 2) - 2) * x) - y, x, x - 1, if x <= 0 then 0 else 1, 0 - 1)
;; fast program: loop2((((2 * (2 * (2 * (2 + (2 + 2))))) - 2) * x) - y, x, x - 1, if x <= 0 then 0 else 1, 0 - 1)
(set-logic UFNIA)
