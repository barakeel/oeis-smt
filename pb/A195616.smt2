;; sequence(s): A195616
;; terms: 12 444 16872 640680 24328980 923860548 35082371856 1332206269968 50588755886940 1921040517433740 72948950906595192 2770139093933183544 105192336618554379492 3994538652411133237140 151687276455004508631840
;; small program: loop2(loop2((2 * ((x + x) + x)) + y, x, y, x, 0), 1 + y, 2, 2, x)
;; fast program: loop2(loop2((2 * ((x + x) + x)) + y, x, y, 1, 0) * x, 1 + y, 2, 2, x)
(set-logic UFNIA)
