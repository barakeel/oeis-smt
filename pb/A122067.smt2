;; sequence(s): A122067
;; terms: 1 8 1024 2097152 68719476736 36028797018963968 302231454903657293676544 40564819207303340847894502572032 87112285931760246646623899502532662132736 2993155353253689176481146537402947624255349848014848
;; small program: loop(loop(x + x, y, x), x + x, 1)
;; fast program: (loop2(x * y, y + y, x, 1, 2) * loop2(x * y, y + y, x, 1, 2 + 2)) * loop(x * x, 1, loop2(x * y, y + y, x - 1, 1, 2))
(set-logic UFNIA)
