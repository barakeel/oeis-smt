;; sequence(s): A76453
;; terms: 1 0 ~1 1 2 1 ~1 0 1 1 0 ~1 1 2 1 ~1 0 1 1 0
;; small program: loop2((loop(1, x, x) * x) - y, x, x, 1, 1)
;; fast program: loop2(loop(1, 0 - x, x) - y, x, x, 1, 1)
(set-logic UFNIA)
(declare-fun f1 () Int)
