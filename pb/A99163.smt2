;; sequence(s): A99163
;; terms: 1 1 2 3 7 12 27 49 106 199 419 804 1663 3237 6618 13003 26383 52156 105299 209001
;; small program: loop((x - loop2(y - x, x, y, 1, 2)) + x, x, 1)
;; fast program: loop((x - loop2(y - x, x, y - 1, 0, 1)) + x, x - 1, 1)
(set-logic UFNIA)
