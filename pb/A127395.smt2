;; sequence(s): A127395
;; terms: 0 0 12 20736 1186099200 4863092981760000 2405722022408355840000000 210982363040448544794759659520000000 4417663598633083951292726052200194139750400000000 28285349218442861392592006529041874362190858603724800000000000000 68815738101453790475316164980880834884596607113691790965601206272000000000000000000
;; small program: loop(loop(x * y, y + y, x), x, 1) - loop2(x * y, y, x, 1, loop((x * y) + x, x, 1))
;; fast program: loop(loop(x * y, y + y, 1) * x, x, 1) - loop2(x * y, y, x, 1, loop(x * y, x, 1 + x))
(set-logic UFNIA)
