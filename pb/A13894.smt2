;; sequence(s): A13894
;; terms: 20 64000000 204800000000000 655360000000000000000 2097152000000000000000000000 6710886400000000000000000000000000 21474836480000000000000000000000000000000 68719476736000000000000000000000000000000000000 219902325555200000000000000000000000000000000000000000
;; small program: loop(loop(2 * (2 + x), 2, 2) * x, 1 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 * (2 + 2))))) * loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
