...
(assert (forall ((x Int)) (= (f0 x) (modf (+ (modf (w1 x) (+ 1 2)) 1) 2))))
(assert (forall ((x Int)) (= (g0 x) x)))
(assert (forall ((x Int)) (= (t0 x) (ite (<= (f0 x) 0) x (t0 (+ x 1))))))
(assert (forall ((x Int)) (= (u0 x) (ite (<= x 0) (t0 0) (t0 (+ (u0 (- x 1)) 1))))))
(assert (forall ((x Int)) (= (v0 x) (u0 (g0 x)))))
(assert (forall ((x Int)) (= (small x) (divf (v0 x) 1))))
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ (modf (+ x y) 2) x))))
...
(assert (forall ((x Int)) (= (f2 x) (modf (- (- (modf (- (divf (- (w3 x) 1) 2) 1) (+ 1 2)) (modf x 2)) 1) (+ 1 x)))))
