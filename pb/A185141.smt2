;; sequence(s): A185141
;; terms: 1 1 16 46656 110075314176 619173642240000000000 19408409961765342806016000000000000 6823819180249038753817675898369448345600000000000000 48789725533845219197010193096946682961355723304326670581760000000000000000
;; small program: loop2(loop((x * y) * y, y, x), y, x, 1, x)
;; fast program: (loop2(x * y, y, x - 2, 1, loop(x * y, x - 1, x)) * loop((x * x) * x, 1, loop(x * y, x, 1))) * loop2(x * y, y, x - 1, 1, loop(x * y, x - 1, x))
(set-logic UFNIA)
