;; sequence(s): A57528
;; terms: 1 1 2 96 31850496 2524286414780230533120 1189172215782988266980141580906985588465965465600000
;; small program: loop(loop(loop(loop(loop(x * y, y, x), y, x), y, x), y, x), x, 1)
;; fast program: loop(loop(loop(loop(loop((x * y) + x, y, x), y, x), y, 1) * x, y, 1) * x, x - 1, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f9 x y) (+ (* x y) x))))
