;; sequence(s): A13891
;; terms: 361 893871739 2213314919066161 5480386857784802185939 13569980418174090907801371961 33600614943460448322716069311260139 83198449060887472631428936505541918917761 206007596521214410095208558252435839890349094339
;; small program: loop((2 * loop((x + x) + x, 2, x)) + x, 2 + ((2 * (x + x)) + x), 1)
