;; sequence(s): A197189
;; terms: 1 2 11 43 184 767 3221 13498 56599 237287 994856 4171003 17487289 73316882 307387091 1288745683 5403172504 22653245927 94975600301 398193030538
;; small program: loop2((2 * (x + x)) + y, x - y, x, 1, 0 - 2)
;; fast program: loop2((2 * (x + x)) + y, x - y, x - 1, if x <= 0 then 1 else 2, 1 + 2)
(set-logic UFNIA)
