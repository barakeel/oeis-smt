;; sequence(s): A101855
;; terms: 6 30 91 216 441 812 1386 2232 3432 5082 7293 10192 13923 18648 24548 31824 40698 51414 64239 79464
;; small program: loop(loop(loop(loop(2 + (2 + (x + y)), y, x), y, x) + y, y, x), 1 + x, 0)
;; fast program: loop(loop(loop(((loop(x + y, 1 + y, x) + y) + y) + y, y, x), y, x), 1 + x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ 2 (+ 2 (+ x y))))))
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (+ (+ (v7 x y) y) y) y))))
