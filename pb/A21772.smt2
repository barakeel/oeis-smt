;; sequence(s): A21772
;; terms: 1 19 242 2618 26103 248997 2316784 21251956 193359485 1751044295 15814841406 142616378814 1284983809747 11572125768313 104185847231708 937857633325592 8441649467754489 75979521955403451
;; small program: loop((loop(loop(1 + (2 * (x + x)), y, 1) + loop((x + x) + x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
