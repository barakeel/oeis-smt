;; sequence(s): A178949
;; terms: 1 2 36 1920 210000 39191040 11181360960 4534378168320 2481970620729600 1764322560000000000 1580868516481859404800 1743505552795995891302400 2321376488366363008816435200 3671767205084150828189614080000
;; small program: loop(2 * ((2 * (x * y)) - x), x, 1) * loop2((1 + y) * x, y, x - 1, 1, x)
;; fast program: loop2(x * y, 1 + y, x - 1, 1, 2 + x) * loop2(x * y, y, x, 1, 1 + x)
(set-logic UFNIA)
