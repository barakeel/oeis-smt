;; sequence(s): A16281
;; terms: 1 17 223 2741 33103 397901 4776871 57328757 687964255 8255629085 99067724119 1188813216773 14265760187407 171189127015469 2054269538501767 24651234505002389 295814814189037759
;; small program: loop(((loop2(loop((2 + y) * x, 2, x) + y, y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop2(2 * ((2 * ((x + x) + x)) - y), y + y, x, 2, 2) - loop2(x * y, y, x, 1, 1 + 2)
(set-logic UFNIA)
