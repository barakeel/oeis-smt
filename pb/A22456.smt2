;; sequence(s): A22456
;; terms: 1 25 422 6074 80739 1027731 12764344 156290788 1897808357 22932373997 276311410986 3323658428142 39939656787655 479667696880423 5758762699959548 69124442908248536 829628539194983433
;; small program: loop((loop((loop(1 + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * ((x + x) + x))) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
