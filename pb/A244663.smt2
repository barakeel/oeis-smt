;; sequence(s): A244663
;; terms: 111 10111 1001111 100011111 10000111111 1000001111111 100000011111111 10000000111111111 1000000001111111111 100000000011111111111 10000000000111111111111 1000000000001111111111111 100000000000011111111111111 10000000000000111111111111111
;; small program: loop(1 + (2 * ((2 * (x + x)) + x)), 2 + x, loop(2 * ((2 * (x + x)) + x), x, 1))
;; fast program: loop2(1 + (x * y), y, 1 + x, 1, 2 + (2 * (2 + 2))) + loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2))))
(set-logic UFNIA)
