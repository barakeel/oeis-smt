;; sequence(s): A28172
;; terms: 1 30 573 8918 123669 1595958 19642141 234045366 2726478117 31257792566 354281953389 3982604010294 44504504288245 495188689219254 5492628385206717 60786003189650102 671598926425152453
;; small program: loop((loop(loop2((loop((2 + y) * x, 2, x) - x) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
