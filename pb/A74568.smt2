;; sequence(s): A74568
;; terms: 3 19 129 919 6753 50599 383889 2937079 22607553 174833479 1357265649 10571455639 82577541153 646711933159 5076538019409 39933007340599 314712202247553 2484447507541639 19642880826869169 155514358139135959
;; small program: loop((2 * ((x + x) + x)) + x, x, 1) + loop(2 * (x + x), x, 1 + loop(x + x, x, 1))
;; fast program: loop((1 + x) * (x * x), 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + (2 + 2)))
(set-logic UFNIA)
