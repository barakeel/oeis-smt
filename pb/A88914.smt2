;; sequence(s): A88914
;; terms: 1 32 605 10933 196384 3524489 63245753 1134902560 20365009477 365435291981 6557470308896 117669030432337 2111485077903025 37889062372947488 679891637638098029 12200160415120530469
;; small program: loop2(x + y, x, x + x, 1, 2) * loop2(x + y, x, 2 * (x + x), 1, 1)
;; fast program: (if x <= 0 then 1 else loop2(((x - y) + x) + x, x, x - 1, 2, 1)) * loop(x * x, 1, loop2(x + y, x, x + x, 1, 2))
(set-logic UFNIA)
