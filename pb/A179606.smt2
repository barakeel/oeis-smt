;; sequence(s): A179606
;; terms: 1 4 17 71 298 1249 5237 21956 92053 385939 1618082 6783941 28442233 119246404 499950377 2096083151 8788001338 36844419769 154473265997 647641896836
;; small program: loop2((2 * (x + x)) + y, x - y, x, 1, 0)
;; fast program: loop2((2 * (x + x)) + y, x - y, x - 1, if x <= 0 then 1 else (2 + 2), 1)
(set-logic UFNIA)
