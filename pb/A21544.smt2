;; sequence(s): A21544
;; terms: 1 19 242 2606 25659 239313 2153884 18910012 163042517 1386706607 11670306726 97399296618 807453069775 6657437827501 54644202679568 446846543376824 3642622865166633 29615936742107595
;; small program: loop(((loop((loop(1 + (2 * (2 * (x + x))), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
