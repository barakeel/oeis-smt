;; sequence(s): A292612
;; terms: 4 ~3 5 0 13 21 68 165 445 1152 3029 7917 20740 54285 142133 372096 974173 2550405 6677060 17480757
;; small program: loop(loop2(y, x + y, y + y, 1, 0) - x, x, 2 + 2)
;; fast program: (2 * loop(0 - x, x, 2)) + loop(x * x, 1, loop2(x + y, x, x, 0, 1))
(set-logic UFNIA)
