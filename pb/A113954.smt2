;; sequence(s): A113954
;; terms: 1 0 1 2 3 8 13 30 55 116 225 458 907 1824 3637 7286 14559 29132 58249 116514
;; small program: loop(loop2(x + y, x + x, y, 0, 1) - x, x, 1)
;; fast program: loop2(((y - 1) - x) + y, x, x, 1, 1) * loop(0 - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (- (- y 1) x) y))))
