;; sequence(s): A27991
;; terms: 1 3 12 40 130 404 1227 3653 10720 31090 89316 254568 720757 2029095 5684340 15855964 44061862 122032508 336966015 927953705
;; small program: loop(loop2(x + y, x, y + y, 1 + y, 0) - x, x, 1)
;; fast program: loop(loop(loop2(((x - y) + x) + x, x, x - 1, 2, 1) * (1 + x), 1, y) - x, x, 1)
(set-logic UFNIA)
