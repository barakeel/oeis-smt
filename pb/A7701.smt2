;; sequence(s): A7701
;; terms: 0 1 8 432 131072 204800000 1565515579392 56593444029595648 9444732965739290427392 7146646609494406531041460224 24178516392292583494123520000000000
;; small program: loop2(2 * (x * y), 2 * (y + y), x - 1, x, x)
;; fast program: loop2(x * y, y + y, x - 1, 1, x) * loop2(x * y, y + y, x - 1, x, 2)
(set-logic UFNIA)
