;; sequence(s): A163271
;; terms: 0 2 4 10 24 58 140 338 816 1970 4756 11482 27720 66922 161564 390050 941664 2273378 5488420 13250218
;; small program: loop2((x + x) + y, x, x, 0, 2)
;; fast program: 2 * loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1)
(set-logic UFNIA)
