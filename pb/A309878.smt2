;; sequence(s): A309878
;; terms: 0 1 2 1 ~4 ~13 ~22 ~23 ~8 23 54 53 ~12 ~141 ~270 ~271 ~16 495 1006 1005
;; small program: loop2(x + y, y - x, x, 0, 2) - x
;; fast program: (2 * loop2(2 * (x - y), x, x - 2, if (x - 1) <= 0 then x else 2, 1)) - x
(set-logic UFNIA)
