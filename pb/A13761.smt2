;; sequence(s): A13761
;; terms: 289 1419857 6975757441 34271896307633 168377826559400929 827240261886336764177 4064231406647572522401601 19967568900859523802559065713 98100666009922840441972689847969 481968572106750915091411825223071697
;; small program: loop((loop(x * x, 2, 2) * x) + x, 2 + ((x + x) + x), 1)
