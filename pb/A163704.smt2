;; sequence(s): A163704
;; terms: 1 5 11 21 38 66 112 187 309 507 828 1348 2190 3553 5759 9329 15106 24454 39580 64055
;; small program: loop(loop(loop2(1 + (x + y), x, y, 2, 0) + x, y, 2), x, 1)
;; fast program: (((loop2(x + y, x, x, 1 + (2 + (2 + 2)), 2 + 2) - 1) - 2) - 2) - (if x <= 0 then 1 else x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (- (- (- (w3 x) 1) 2) 2) (ite (<= x 0) 1 x)))))
