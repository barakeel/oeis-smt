;; sequence(s): A203422
;; terms: 1 ~6 ~288 144000 933120000 ~94097687040000 ~172670008499896320000 6607002383077924814192640000 5946302144770132332773376000000000000 ~140210694122490812598274255654748160000000000000
;; small program: loop(loop(loop2(0 - (x * y), y, x, 1, 2 + x) * (1 + x), 1, y) * x, x, 1)
;; fast program: loop(loop(loop2(0 - (x * y), y, x, 1, 1 + x), 1, y) * x, x, 1) * loop2(x * y, y, x, 1, 2 + x)
(set-logic UFNIA)
