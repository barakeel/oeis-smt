;; sequence(s): A195529
;; terms: 1 256 1333735776850284124449081472843776
;; small program: loop(loop2(x * y, y, x, 1, x), 1, 2 * (((x * x) + x) * x))
;; fast program: loop2(loop(x * x, 1, loop2(x * y, y, x, 1, x + x)), x * x, 1, ((x * x) + x) * x, x)
(set-logic UFNIA)
