;; sequence(s): A17106
;; terms: 729 1771561 47045881 387420489 1838265625 6321363049 17596287801 42180533641 90458382169 177978515625 326940373369 567869252041 941480149401 1500730351849 2313060765625 3462825991689
;; small program: loop(loop2(x * y, x, y, x, x), 2, loop(1 + (x + x), 2, x + x))
;; fast program: loop((x * x) * x, 1, loop(x * x, 1, 1 + (2 + (2 * (2 * (x + x))))))
(set-logic UFNIA)
...
(assert (= g4 1))
(assert (forall ((x Int)) (= (h4 x) (+ 1 (+ 2 (* 2 (* 2 (+ x x))))))))
