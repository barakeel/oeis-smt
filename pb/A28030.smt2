;; sequence(s): A28030
;; terms: 1 23 350 4510 53691 614373 6891160 76527020 845660981 9322579123 102653929170 1129737260730 12429895581871 136743043622273 1504245500346380 16547064858237640 182019552263480361
;; small program: loop(((loop((loop2((loop((2 + y) * x, 2, x) - x) + (y * y), y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop2((((y * y) + x) + x) + x, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
