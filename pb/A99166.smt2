;; sequence(s): A99166
;; terms: 1 3 9 22 51 113 244 517 1081 2238 4599 9397 19116 38753 78349 158062 318331 640233 1286244 2581837
;; small program: loop((x + x) + loop2(y, x + y, y, 2, 1), x, 1)
;; fast program: loop(x + x, x, 1 + (2 + 2)) - loop2(x + y, x, x, 2 + 2, 1 + 2)
(set-logic UFNIA)
