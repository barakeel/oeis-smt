...
(assert (forall ((x Int) (y Int)) (= (f0 x y) (+ (ite (<= (modf (v1 x) (* y y)) 0) 1 2) x))))
...
(assert (forall ((x Int)) (= (f3 x) (ite (<= (- (modf (+ 1 (v4 x)) (+ 1 (+ x x))) 2) 0) 1 0))))
(assert (= g3 1))
...
(assert (forall ((x Int)) (= (fast x) (+ (modf (v2 x) (v5 x)) (+ 1 x)))))
