;; sequence(s): A89210
;; terms: 1 4 19683 340282366920938463463374607431768211456
;; small program: loop2(loop2((x * y) + x, y, x, 1, y), x, 2, x, x)
;; fast program: loop2(loop2(x * y, y, y - 1, 1, x) * (x * x), y, x, 1 + x, x)
(set-logic UFNIA)
