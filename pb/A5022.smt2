;; sequence(s): A5022
;; terms: 6 26 100 364 1288 4488 15504 53296 182688 625184 2137408 7303360 24946816 85196928 290926848 993379072 3391793664 11580678656 39539651584 134998297600
;; small program: loop((loop2(2 * ((x - y) + x), x, y, 1, 0) + x) + x, 1 + x, 1)
;; fast program: loop(loop2(2 * ((x - y) + x), x, x - 1, 1 + 2, 1) - loop(x + x, x, 1), 1, 2 + x)
(set-logic UFNIA)
