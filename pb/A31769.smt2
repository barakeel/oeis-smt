;; sequence(s): A31769
;; terms: 8283 33128 74535 132504 207035 298128 405783 530000 670779 828120 1002023 1192488 1399515 1623104 1863255 2119968 2393243 2683080 2989479 3312440
;; small program: (1 + x) * (loop((loop(2 * (2 + x), 2 + 2, 2) * x) - x, 2, 1 + x) + 2)
;; fast program: 2 + ((loop(x * x, 1, (1 + loop((x * x) - x, 1, 2 + (2 * (2 + 2)))) * (1 + x)) + x) + x)
(set-logic UFNIA)
