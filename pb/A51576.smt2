;; sequence(s): A51576
;; terms: 1 3 27 2187 4782969 847288609443 36472996377170786403 1144561273430837494885949696427 78551672112789411833022577315290546060373041 35370553733215749514562618584237555997034634776827523327290883
;; small program: loop(loop2(x * y, (y + y) + y, y, 1 + 2, 1) * x, x, 1)
;; fast program: loop(loop(loop2(x * y, (y + y) + y, x - 1, 1, 1 + 2), 1, y) * x, x - 1, 1) * loop2(x * y, (y + y) + y, x, 1, 1 + 2)
(set-logic UFNIA)
