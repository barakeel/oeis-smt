;; sequence(s): A28668
;; terms: 1 30 37800 1755432000 2946176634240000 178121125423535616000000 387722609071165087097978880000000 30383449623465746081582327522446540800000000
;; small program: loop(loop((x * x) - x, 1, loop(2 * ((x + x) + x), y, 1)) * x, x, 1)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, 2 + (2 + 2))) * x, x, 1)
(set-logic UFNIA)
