;; sequence(s): A120940
;; terms: 0 1 3 6 14 26 52 95 177 318 572 1012 1784 3117 5423 9382 16170 27758 47500 81035
;; small program: loop(loop2(x + y, x, y, y, 0) - x, x, 0)
;; fast program: loop(loop2(x + y, x, y - 1, y, y) - x, x, 0)
(set-logic UFNIA)
