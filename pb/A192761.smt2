;; sequence(s): A192761
;; terms: 0 1 5 11 22 40 70 119 199 329 540 882 1436 2333 3785 6135 9938 16092 26050 42163
;; small program: loop(x + loop2(y, 1 + (x + y), y, 2, 1), x, 0)
;; fast program: (((loop2(x + y, x, x, 1 + (2 + 2), 2) - 1) - 2) - 2) - x
(set-logic UFNIA)
