;; sequence(s): A156087
;; terms: 0 1 50 2354 110595 5195620 244083556 11466731525 538692298134 25307071280790 1188893657899015 55852694849972936 2623887764290829000 123266872226818990089 5790919106896201705210 272049931151894661154810
;; small program: loop(loop(x * x, 1, loop2(((2 * ((x + x) + x)) + x) - y, x, y, 0, 1)) + x, x, 0)
;; fast program: loop(loop(x * x, 1, loop2(((2 * ((x + x) + x)) + x) - y, x, y - 1, 1, 0)) + x, x, 0)
(set-logic UFNIA)
...
(assert (= g4 1))
(assert (forall ((x Int) (y Int)) (= (f5 x y) (- (+ (* 2 (+ (+ x x) x)) x) y))))
