;; sequence(s): A13883
;; terms: 289 410338673 582622237229761 827240261886336764177 1174562876521148458974062689 1667711322168688287513535727415473 2367911594760467245844106297320951247361 3362095853201812742282475234995233875224247377 4773695331839566234818968439734627784374274207965089
;; small program: loop((loop(x * x, 2, 2) * x) + x, 2 + ((2 * (x + x)) + x), 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 * (2 * (2 + 2)))))
(set-logic UFNIA)
