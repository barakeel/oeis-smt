;; sequence(s): A192917
;; terms: 0 5 6 22 51 140 360 949 2478 6494 16995 44500 116496 304997 798486 2090470 5472915 14328284 37511928 98207509
;; small program: loop(loop2(y, x + y, y + y, 2 + 2, 1) - x, x, 0)
;; fast program: (if x <= 0 then 0 else loop2(x + y, x, x - 2, 1, 1)) * loop2(x + y, x, x, 1, 2 + 2)
(set-logic UFNIA)
