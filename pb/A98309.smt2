;; sequence(s): A98309
;; terms: 0 1 10 121 1440 17161 204490 2436721 29036160 345997201 4122930250 49129165801 585427059360 6975995546521 83126519498890 990542238440161 11803380341783040 140650021862956321 1675996882013692810 19971312562301357401
;; small program: loop(loop2(y, (2 * (2 * ((y + y) + y))) - x, y, 1, 1) - x, x, 0)
;; fast program: loop(loop2(((2 * (2 + (2 + 2))) * x) - y, x, y - 1, 1, 1) - x, x, 0)
(set-logic UFNIA)
