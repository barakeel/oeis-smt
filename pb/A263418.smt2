;; sequence(s): A263418
;; terms: 1 6 21 51 106 201 361 626 1061 1771 2926 4801 7841 12766 20741 33651 54546 88361 143081 231626
;; small program: loop(loop(loop2(x + y, x, y, 1 + (2 + 2), 0) + x, y, x), x, 1)
;; fast program: (((loop2(x + y, x, x, 1 + (2 + 2), 1 + 2) - 1) - (2 * (2 + x))) * (1 + (2 + 2))) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (+ (* (- (- (w3 x) 1) (* 2 (+ 2 x))) (+ 1 (+ 2 2))) 1))))
