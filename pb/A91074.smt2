;; sequence(s): A91074
;; terms: 12 67 79 146 225 371 596 967 1563 2530 4093 6623 10716 17339 28055 45394 73449 118843 192292 311135
;; small program: (loop2(y, x + y, x, 1, 2 + (2 + 2)) * loop(1 + (x + x), 2, 2)) + loop2(x + y, x, x, 1, 0)
;; fast program: loop2(x + y, x, x, 2 + (2 + (2 * (2 + 2))), (1 + (2 + (2 * (2 + 2)))) * (1 + (2 + 2)))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (small x) (+ (* (w0 x) v1) (w2 x)))))
(assert (forall ((x Int) (y Int)) (= (f3 x y) (+ x y))))
(assert (forall ((x Int)) (= (g3 x) x)))
(assert (forall ((x Int)) (= (h3 x) x)))
(assert (= i3 (+ 2 (+ 2 (* 2 (+ 2 2))))))
(assert (= j3 (* (+ 1 (+ 2 (* 2 (+ 2 2)))) (+ 1 (+ 2 2)))))
