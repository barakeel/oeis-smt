;; sequence(s): A20568
;; terms: 1 27 499 7863 113731 1561647 20724139 268611543 3422947891 43073421567 536871293179 6642406690023 81708636139651 1000502412972687 12206022852156619 148472243708301303
;; small program: loop(loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + loop((2 + y) * x, 2, x), x, 1)
