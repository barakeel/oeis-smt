;; sequence(s): A87131
;; terms: 2 2 12 32 112 352 1152 3712 12032 38912 125952 407552 1318912 4268032 13811712 44695552 144637952 468058112 1514668032 4901568512
;; small program: loop2(y + y, 2 * (x + y), x, 2, 1)
;; fast program: 2 * loop(x + x, x - 1, loop2(x + y, x, x - 1, 1, 2))
(set-logic UFNIA)
