;; sequence(s): A61714
;; terms: 1 0 1 4 25 208 2121 25828 365457 5895104 106794993 2147006948 47436635753 1142570789072 29797622256377 836527783016196 25153234375160993 806519154686509056 27470342073410272609
;; small program: loop(loop((2 * (x * y)) + loop(0 - x, y, 1), y - 1, 1) - x, x, 1)
;; fast program: loop(loop(loop(0 - x, y, 1) + ((y + y) * x), y - 1, 1) - x, x, 1)
(set-logic UFNIA)
