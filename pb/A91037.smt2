;; sequence(s): A91037
;; terms: 1 144 17856 2156544 259117056 31102009344 3732432224256 447896453382144 53747684481171456 6449724779548114944 773967036949154758656 92876045955579714207744
;; small program: loop(loop(x * y, 2 + 2, x), x, loop(1 + ((2 * (x + x)) + x), x, 1))
;; fast program: loop2(1 + (x * y), y, x, 1, 1 + (2 + 2)) * loop2(x * y, y, x, 1, 2 * (2 * (2 + (2 + 2))))
(set-logic UFNIA)
