;; sequence(s): A154570
;; terms: 1 3 ~4 2 ~6 ~2 ~14 ~18 ~46 ~82 ~174 ~338 ~686 ~1362 ~2734 ~5458 ~10926 ~21842 ~43694 ~87378
;; small program: loop(loop2(y + y, x + y, y - 1, 1 + 2, 0 - 2), x, 1)
;; fast program: loop2(y + y, x + y, x - 1, (if x <= 0 then 0 else 2) + 1, 0 - 2)
(set-logic UFNIA)
