;; sequence(s): A21629
;; terms: 1 23 366 5062 65555 820701 10087792 122732444 1484551749 17896987459 215340503378 2588122883346 31085733296983 373226612833097 4480104054056724 53770941570620968 645319149365603657
;; small program: loop(((loop((loop(1 + loop((2 + y) * x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * ((x + x) + x))) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
