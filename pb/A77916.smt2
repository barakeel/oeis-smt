;; sequence(s): A77916
;; terms: 1 ~1 5 ~10 30 ~74 199 ~515 1355 ~3540 9276 ~24276 63565 ~166405 435665 ~1140574 2986074 ~7817630 20466835 ~53582855
;; small program: loop(x + loop2(1 - (((x + x) + x) + y), x, y, 1, 0), x, 1)
;; fast program: loop(loop(loop2(x + y, x, x - 1, 2, 1) * loop2(y - x, x, x, 1, 0), 1, y) + x, x, 1)
(set-logic UFNIA)
