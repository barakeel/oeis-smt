;; sequence(s): A92698
;; terms: 0 2 40 310 1520 5628
;; small program: loop(loop(loop(loop(loop(x * x, 2, y) + x, y, x), y, x), y, x), x, 0) * 2
;; fast program: loop(loop(loop(loop((((y * y) * y) * y) + x, y, x), y, x), y, x), x, 0) * 2
(set-logic UFNIA)
