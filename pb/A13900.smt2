;; sequence(s): A13900
;; terms: 9261 37822859361 154472377739119461 630880792396715529789561 2576580875108218291929075869661 10523016528610349434285830688358359761 42977062327514056734916195400155065458259861 175522663228862486625127968549968702993144556569961
;; small program: loop((loop(2 * (2 + x), 2, 2) * x) + x, loop(1 + (x + x), 2, x) + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 * (2 + (2 * (2 + 2)))))) * loop(x * x, 1, loop2(x * y, y, x, 1, 1 + (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
