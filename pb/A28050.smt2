;; sequence(s): A28050
;; terms: 1 28 515 7910 110241 1448328 18302575 225096970 2713995581 32234230028 378383333835 4400300953230 50784218810521 582435753818128 6644887820416295 75474715560668690 854031383578979061
;; small program: loop(((loop((loop2((2 * ((2 * (x + x)) + x)) + (y * y), y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((((y * y) + x) + x) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
