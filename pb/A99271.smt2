;; sequence(s): A99271
;; terms: 0 1 13 196 2925 43681 652288 9740641 145457325 2172119236 32436331213 484372848961 7233156403200 108012973199041 1612961441582413 24086408650537156 359683168316474925 5371161116096586721
;; small program: loop(loop2(y, ((1 + 2) * ((2 * (y + y)) + y)) - x, y, 1, 1) - x, x, 0)
;; fast program: loop(loop2(((1 + 2) * ((2 * (x + x)) + x)) - y, x, y - 1, 1, 1) - x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g1 x y) (- (* (+ 1 2) (+ (* 2 (+ y y)) y)) x))))
...
(assert (forall ((x Int) (y Int)) (= (f3 x y) (- (* (+ 1 2) (+ (* 2 (+ x x)) x)) y))))
