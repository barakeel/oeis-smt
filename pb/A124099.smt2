;; sequence(s): A124099
;; terms: 1 30 619 10920 177061 2726130 40547359 588485820 8387148121 117876868230 1638536364499 22574666496720 308755233696781 4197234089634330 56765041887676039 764357559726523620
;; small program: loop((loop((loop(loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, y, 1) + loop((2 + y) * x, 2, x)) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * ((x + x) + x))) + y, (2 * (y + y)) + y, x, 1, 1 + (2 + 2)), 1, y) + (2 * (2 * ((x + x) + x)))) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (g7 x y) (+ (* 2 (+ y y)) y))))
