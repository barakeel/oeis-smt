;; sequence(s): A347017
;; terms: 1 1 2 4 7 12 22 44 93 200 428 904 1883 3876 7906 16020 32313 64976 130392 261328
;; small program: loop(loop(loop((x - 2) + y, y - 2, x), y, x) + x, x - 1, 1)
;; fast program: loop(x + x, x - 1, 1) - loop(loop(x + y, y - 2, x), x - 1, 0)
(set-logic UFNIA)
