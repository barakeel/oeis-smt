;; sequence(s): A108400
;; terms: 1 2 16 768 294912 1132462080 52183852646400 33664847019245568000 347485857744891213250560000 64560982045934655213753964953600000 239901585047846581083822477336190648320000000
;; small program: loop(loop(2 * (x * y), y, x), x, 1)
;; fast program: (loop(loop(x * y, y, 1 + y) * x, x - 2, 1) * loop(x * y, x, 1)) * loop2(x * y, y + y, x, 1, 2)
(set-logic UFNIA)
