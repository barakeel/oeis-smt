;; sequence(s): A14921
;; terms: 1 17 209 2257 22737 219345 2054353 18831569 169826513 1512003793 13323163857 116402378961 1009755576529 8706336970961 74677034637521 637626988058833 5422701592139985 45955098238474449
;; small program: loop(loop(x + x, (y + y) + y, 1 + y) + x, x, 1)
;; fast program: loop2((2 * (2 * (x + x))) + y, y - 1, x, 1 + x, x)
(set-logic UFNIA)
