...
(assert (forall ((x Int)) (= (f2 x) (divf x (+ 1 (modf x 2))))))
(assert (forall ((x Int)) (= (g2 x) x)))
(assert (forall ((x Int)) (= (h2 x) x)))
(assert (forall ((x Int) (y Int)) (= (u2 x y) (ite (<= x 0) y (f2 (u2 (- x 1) y))))))
(assert (forall ((x Int)) (= (v2 x) (u2 (g2 x) (h2 x)))))
(assert (forall ((x Int)) (= (f1 x) (modf (- (divf (v2 x) 2) x) (+ 1 2)))))
...
(assert (forall ((x Int)) (= (f6 x) (divf (ite (<= (modf x 2) 0) 2 x) 2))))
(assert (= g6 (+ 1 2)))
...
(assert (forall ((x Int)) (= (f3 x) (modf (- (modf (- (modf (+ (modf (+ (modf (+ (- (v4 x) x) 1) 2) x) (+ 1 x)) 1) (+ 1 2)) 1) (+ 1 2)) 1) (+ 1 x)))))
