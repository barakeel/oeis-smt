;; sequence(s): A202946
;; terms: 3 18 1080 181440 59875200 32691859200 26676557107200 30411275102208000 46164315605151744000 90020415430045900800000 219289731987591814348800000 652606242395073239502028800000
;; small program: loop2((x * y) + x, 1 + y, x + x, 1 + 2, x)
;; fast program: loop2(x * y, y - 1, x, 1 + 2, x + x) * loop2(x * y, 1 + y, x, 1, 1 + (x + x))
(set-logic UFNIA)
