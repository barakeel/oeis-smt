;; sequence(s): A225686
;; terms: 1 21 2584 2178309 12586269025 498454011879264 135301852344706746049 251728825683549488150424261 3210056809456107725247980776292056 280571172992510140037611932413038677189525
;; small program: loop2(x + y, x, 2 * ((2 + x) * x), 1, 1)
;; fast program: loop(loop2(x + y, x, x - 1, 1, 1) * loop2(x + y, x, x, 1, 2), 1, (2 + x) * x)
(set-logic UFNIA)
