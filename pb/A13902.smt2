;; sequence(s): A13902
;; terms: 22 113379904 584318301411328 3011361496339065143296 15519448971100888972574851072 79981528839832616637508874879893504 412195366437884247746798137865015318806528 2124303230726006271483826780841554627491524509696 10947877107572929152919737180202022857988400441953615872
;; small program: loop((loop(x * y, 2 + 2, x) - x) - x, 1 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 * (2 + 2)))))) * loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + (2 * (2 + 2)))))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
