;; sequence(s): A13723
;; terms: 18 5832 1889568 612220032 198359290368 64268410079232 20822964865671168 6746640616477458432 2185911559738696531968 708235345355337676357632 229468251895129407139872768
;; small program: loop(2 * loop((x + x) + x, 2, x), 1 + (x + x), 1)
;; fast program: loop2(x * y, y, 1 + x, 2, 1 + (2 * (2 + 2))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 + 2)))
(set-logic UFNIA)
