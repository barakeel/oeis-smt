;; sequence(s): A45889
;; terms: 1 7 30 102 303 825 2116 5200 12381 28779 65658 147594 327835 721069 1573056 3408084 7340265 15728895 33554710 71303470
;; small program: loop(loop(loop((x - 1) + x, y, y) + x, 1 + y, x), x, 1)
;; fast program: loop(loop((((((x - 1) * loop(x + x, x, 2)) + 2) * 2) + 1) + x, 1, y) + x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f4 x) (+ (+ (* (+ (* (- x 1) (v5 x)) 2) 2) 1) x))))
(assert (= g4 1))
