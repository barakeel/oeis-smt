;; sequence(s): A13807
;; terms: 4913 410338673 34271896307633 2862423051509815793 239072435685151324847153 19967568900859523802559065713 1667711322168688287513535727415473 139288917338851014461418017489467720433 11633549665058175578832094238737833478284593
;; small program: loop((loop(x * x, 2, 2) * x) + x, loop(1 + (x + x), 2, x), 1)
;; fast program: loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 1 + (2 * (2 * (2 + 2))))) * loop2(x * y, y, 1 + (x + x), 1, 1 + (2 * (2 * (2 + 2))))
(set-logic UFNIA)
