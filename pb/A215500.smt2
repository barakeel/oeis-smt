;; sequence(s): A215500
;; terms: 4 2 10 14 54 112 340 814 2254 5702 15250 39404 104004 270922 711490 1859134 4873054 12748472 33391060 87394454
;; small program: loop2(loop2(y - x, x, y, 2, 1) + x, y + y, 2, 0, x)
;; fast program: loop2(((x - y) + x) + x, x, x - 1, (if x <= 0 then 0 else 1) + 2, 2) + loop2(y - x, x, x, 2, 1)
(set-logic UFNIA)
