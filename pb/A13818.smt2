;; sequence(s): A13818
;; terms: 23 6436343 1801152661463 504036361936467383 141050039560662968926103 39471584120695485887249589623 11045767571919545466173812409689943 3091058643093537522799545838540043339063 865004941741938633917747707002884268046728983
;; small program: loop(loop(x * y, 2 + 2, x) - x, 1 + (2 * (x + x)), 1)
;; fast program: (loop2(x * y, y, 1 + x, 1, (2 * (2 * (2 + (2 + 2)))) - 1) * loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1)) * loop(x * x, 1, loop2(x * y, y, x, 1, (2 * (2 * (2 + (2 + 2)))) - 1))
(set-logic UFNIA)
