;; sequence(s): A21434
;; terms: 1 17 194 1882 16827 143835 1197868 9822164 79783253 644325253 5184986742 41632083246 333818409679 2674358387471 21413929824416 171406773741928 1371730930238505 10976231337133689 87821770754328490
;; small program: loop(((loop((loop(1 + (2 * (2 * (x + x))), y, 1) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop2((2 * (2 * (x + x))) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
