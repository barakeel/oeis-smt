;; sequence(s): A28680
;; terms: 1 306 32023512 1089004102288704 12000667955029147591142400 42847968954950283704312619696092774400 49567873660106321460531697392097352394556112948428800
;; small program: loop(loop((x * x) - x, 1, loop(2 * loop((x + x) + x, 2, x), y, 1)) * x, x, 1)
