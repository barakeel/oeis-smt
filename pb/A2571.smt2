;; sequence(s): A2571
;; terms: 1 5 10 30 74 199 515 1355 3540 9276 24276 63565 166405 435665 1140574 2986074 7817630 20466835 53582855 140281751
;; small program: loop(loop(loop2(x + y, x, y + y, 1, 1) - x, 1 + y, 1) - x, x, 1)
;; fast program: loop(loop(loop2(x + y, x, x - 1, 2, 1) * loop2(x + y, x, x, 2, 1), 1, y) - x, x, 1)
(set-logic UFNIA)
