;; sequence(s): A55869
;; terms: 1 5 37 369 4651 70993 1273609 26269505 612579511 15937424601 457696700077 14381984674225 490839666661891 18080919199832609 715027614225987601 30214447801957316865 1358671297852359767791 64780942222614703957417 3264460344339686410876021
;; small program: loop(loop2((x * y) + x, y, x, 1, x) - loop2(x * y, y, x, 1, x), 1, 1 + x)
;; fast program: (loop2(x * y, y, x, 1, 2 + x) * (2 + x)) - loop2(x * y, y, x, 1 + x, 1 + x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (w3 x) (+ 2 x)) (w4 x)))))
