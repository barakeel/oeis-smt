;; sequence(s): A34941
;; terms: 1 1 15 735 76545 13835745 3859590735 1539272109375 831766748637825 585243816844111425 520038240188935042575 569585968715180280038175 753960950911045074462890625 1186626209895384011075327630625 2190213762744801162239116550679375
;; small program: loop((2 * (x * y)) - x, x, 1) * loop2((2 * (x * y)) + x, y, x - 1, 1, x)
;; fast program: loop2(x * y, 2 + y, x - 1, 1, 1 + 2) * loop2(x * y, y, x - 1, 1, 1 + (x + x))
(set-logic UFNIA)
