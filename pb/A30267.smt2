;; sequence(s): A30267
;; terms: 1 4 14 46 145 444 1331 3926 11434 32960 94211 267384 754309 2116936 5914310 16458034 45638101 126159156 347769719 956238170
;; small program: loop(loop2(x + y, x, (y + y) + 1, 1, y) - x, x, 1)
;; fast program: loop(loop2((x + x) + y, x + y, y, 1 + y, 1) - x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (h1 x y) (+ (+ y y) 1))))
(assert (= i1 1))
...
(assert (forall ((x Int) (y Int)) (= (i3 x y) (+ 1 y))))
(assert (= j3 1))
(assert (forall ((x Int) (y Int) (z Int)) (= (u3 x y z) (ite (<= x 0) y (f3 (u3 (- x 1) y z) (v3 (- x 1) y z))))))
(assert (forall ((x Int) (y Int) (z Int)) (= (v3 x y z) (ite (<= x 0) z (g3 (u3 (- x 1) y z) (v3 (- x 1) y z))))))
(assert (forall ((x Int) (y Int)) (= (w3 x y) (u3 (h3 x y) (i3 x y) j3))))
