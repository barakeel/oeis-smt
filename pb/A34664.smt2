;; sequence(s): A34664
;; terms: 8 60 850 16380 358258 8253300 194402650 4624699020 110523825058 2647111898340 63466433646250 1522433108644860 36529334450076658 876595894555956180 21037008518317046650 504872725633265889900
;; small program: loop2(1 + loop(x + x, y, x), y, 1 + 2, 1, x) * (1 + loop((x + x) + x, x, 1))
;; fast program: loop((1 + (x * x)) * (1 + x), 1, loop(x + x, x, 1)) * (1 + loop2(x * y, y, x, 1, 1 + 2))
(set-logic UFNIA)
