;; sequence(s): A25935
;; terms: 1 21 300 3710 43071 485751 5405170 59772720 659098341 7258131881 79879876440 878881296930 9668709132811 106360879560411 1169995084978110 12870073026808340 141571438884146481
;; small program: loop(((loop((loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop2(((x + x) + x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
