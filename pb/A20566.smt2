;; sequence(s): A20566
;; terms: 1 26 463 7040 98461 1310486 16902043 213488540 2658229321 32768006546 401049136423 4883135986040 59232793113781 716511189600206 8649599428831603 104258410046219540 1255270025244687841 15100763008086187466 181546864258080915583
;; small program: loop((loop(loop((x + x) + x, y + y, 1) + loop((2 + y) * x, 2, x), y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop(loop(loop2(((2 * (x + x)) + (y * y)) + x, (y + y) + y, x, 1, 1 + 2), 1, y) + (2 * (2 * ((x + x) + x))), x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f6 x y) (+ (+ (* 2 (+ x x)) (* y y)) x))))
