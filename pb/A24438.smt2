;; sequence(s): A24438
;; terms: 1 26 445 6330 81141 973746 11173405 124182410 1348136581 14378944866 151299635565 1575384732090 16269102500821 166926103626386 1703932925460925 17322243189947370 175524515134509861
;; small program: loop((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * (2 * (x + x))), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
