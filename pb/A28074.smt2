;; sequence(s): A28074
;; terms: 1 24 367 4566 50449 516348 5012659 46832082 425124997 3774414072 32930084551 283309497198 2409910756345 20309449295796 169843460626843 1411263104458314 11663354948539693 95953443568179120
;; small program: loop(((loop((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop(loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (2 * (x + x))), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
