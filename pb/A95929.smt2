;; sequence(s): A95929
;; terms: 1 2 6 20 70 254 948 3614 13990 54740 215766 854702 3396916 13530350 53971350 215492564 860941798 3441074654 13757249460 55010542910
;; small program: loop((x - loop2(y - x, x, y, 0, 2)) + x, x + x, 1)
;; fast program: loop(2 * ((x - loop2(((x - y) + x) + x, x, y - 2, 1, 1)) + x), x, 1)
(set-logic UFNIA)
