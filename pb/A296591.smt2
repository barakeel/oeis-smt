;; sequence(s): A296591
;; terms: 1 2 288 12441600 421382062080000 23120161750363668480000000 3683853104727992382799761899520000000000 2777528195026874073410445622205453260145295360000000000000
;; small program: loop2(loop(x * y, y, x), 1 + y, 1 + x, 1, x)
;; fast program: (loop(loop((2 * (x * y)) + x, y, 1) * x, x - 1, 1) * loop2(x * y, y + y, x - 1, 1, 2)) * loop(loop(x * y, y + y, 1) * x, x, 1)
(set-logic UFNIA)
