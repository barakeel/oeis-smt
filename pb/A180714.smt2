...
(assert (forall ((x Int) (y Int)) (= (f2 x y) (+ (divf (- (- y 1) x) (* x x)) x))))
...
(assert (forall ((x Int) (y Int)) (= (f5 x y) (divf (v6 x y) (+ 1 x)))))
(assert (forall ((x Int) (y Int)) (= (g5 x y) y)))
(assert (= h5 (+ 1 2)))
(assert (= i5 (+ 2 2)))
(assert (forall ((x Int)) (= (j5 x) (divf (- x 1) 2))))
...
(assert (forall ((x Int)) (= (f4 x) (modf (+ (w5 x) 1) 2))))
(assert (= g4 1))
