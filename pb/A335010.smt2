;; sequence(s): A335010
;; terms: 1 9 3087 156279375 4474145825060625 279739266376566114746420625 149066302192479440045478394157489352699375 2665022756273454714861436593121414601862237540654765380859375
;; small program: loop(loop(loop2(loop(x + x, y, x) - x, y, x, 1, x), 1, 1 + y) * x, x, 1)
;; fast program: loop(loop(loop2(x * y, y, 1 + x, 1, loop(x + x, x, 2) - 1), 1, y) * x, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (j6 x) (- (v7 x) 1))))
