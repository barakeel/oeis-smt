;; sequence(s): A16237
;; terms: 1 16 191 2066 21441 218316 2202691 22124566 221733941 2219780816 22210015191 222161187066 2221917046441 22220696343316 222214592827691 2222184075249566 22222031487358941 222221268547905816 2222217453850640191 22222198380364312066
;; small program: loop(loop((2 * (x + x)) + x, y, loop(1 + (x + x), y, 1)) + x, x, 1)
;; fast program: loop2(2 + (x * y), y, x, 2, 2 + (2 * (2 + 2))) - loop2(1 + (x * y), y, x, 1, 1 + (2 + 2))
(set-logic UFNIA)
