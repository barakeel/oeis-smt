...
(assert (forall ((x Int)) (= (f1 x) (modf (+ (+ (ite (<= (- (modf (+ 1 (v2 x)) (+ 1 (+ x x))) 2) 0) 1 2) x) x) 2))))
(assert (= g1 1))
(assert (forall ((x Int)) (= (h1 x) (+ (+ x x) x))))
(assert (forall ((x Int) (y Int)) (= (u1 x y) (ite (<= x 0) y (f1 (u1 (- x 1) y))))))
(assert (forall ((x Int)) (= (v1 x) (u1 g1 (h1 x)))))
(assert (forall ((x Int)) (= (f0 x) (modf (modf (v1 x) 2) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (f4 x) (ite (<= (- (modf (+ 1 (v5 x)) (+ 1 (+ x x))) 2) 0) 1 0))))
(assert (= g4 1))
(assert (forall ((x Int)) (= (h4 x) (+ (+ x x) x))))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y))))))
(assert (forall ((x Int)) (= (v4 x) (u4 g4 (h4 x)))))
(assert (forall ((x Int)) (= (f3 x) (modf (v4 x) (+ 1 x)))))
