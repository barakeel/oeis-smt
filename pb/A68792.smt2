;; sequence(s): A68792
;; terms: 1 16 441 24336 2418025 384473664 89755965649 28953439105600 12345678987654321 6727499948806851600 4562491230669011577289 3769449794266138309731600 3727710895159027432980276121
;; small program: loop(x * x, 1, loop2(1 + ((2 + y) * x), y, x, 1, x))
;; fast program: loop(x * x, 1, loop2(1 + (x * y), y, x, 1, 2 + x))
(set-logic UFNIA)
