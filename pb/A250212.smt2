;; sequence(s): A250212
;; terms: 1 130 2446 21146 117971 494732 1695036 4992492 13072917 31153342 68720938 142120342 278268263 519829688 932250488 1613106744 2704301673 4407716634 7005003334 10882290034
;; small program: loop(loop((((loop(x * x, 2, y) * y) * y) * y) + x, 1 + y, x), x, 1)
;; fast program: loop(loop((loop((x * x) * x, 1, y * y) * y) + x, y, x), 1 + x, 0)
(set-logic UFNIA)
