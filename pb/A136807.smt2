;; sequence(s): A136807
;; terms: 1 4 256 589824 86973087744 1282470362637926400 2723154477021188283432960000 1133321924829207204666583887642624000000 120746421332702772771144114237731253721340313600000000
;; small program: loop(loop(2 * (2 * ((x * y) * y)), y, x), x, 1)
;; fast program: loop(x * x, 1, loop2(x * y, y + y, x, 1, 2)) * loop(x * x, 1, loop(loop(x * y, y, x), x, 1))
(set-logic UFNIA)
