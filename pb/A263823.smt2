;; sequence(s): A263823
;; terms: 1 1 3 10 42 213 1283 8989 71925 647346 6473494 71208489 854501957 11108525585 155519358423 2332790376722 37324646028162 634518982479741 11421341684636935 217005492008104349
;; small program: loop((x * y) + loop2(y, x + y, y, 1, 0), x, 1)
;; fast program: loop(loop2(x + y, x, y - 2, 1, 1) + ((1 + y) * x), x - 1, 1)
(set-logic UFNIA)
