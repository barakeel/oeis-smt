;; sequence(s): A263394
;; terms: 1 5 95 6175 1302925 866445125 1784010512375 11248186280524375 215638979183932793125 12512451767147700321078125 2190917791975795178520458609375 1155369543009475708416871245360859375 1832567448623162714866960405275465241328125
;; small program: loop(loop2(((x + x) + x) + y, y + y, y, 1, 2) * x, x, 1)
;; fast program: loop(loop(loop2(x * y, y, x, 1 + 2, 1 + 2) - loop(x + x, x, 2), 1, y) * x, x, 1)
(set-logic UFNIA)
