;; sequence(s): A234483
;; terms: 62 242 944 3686 14402 56312 220334 862706 3380192 13252982 51996674 204137576 801957182 3152502002 12400248464 48805735046 192207885122 757400598872 2986264405454 11780750826866
;; small program: loop(loop2((2 * (x + x)) - y, x - y, x, 1, 0) + loop2(x * y, y, x, 1, 2 + 2), 1, 2 + x) * 2
;; fast program: loop(loop2((2 * (x + x)) - y, x - y, x, 1, 0) + loop(x * x, 1, loop(x + x, x, 1)), 1, 2 + x) * 2
(set-logic UFNIA)
