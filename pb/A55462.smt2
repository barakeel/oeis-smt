;; sequence(s): A55462
;; terms: 1 1 2 24 6912 238878720 5944066965504000 745453331864786829312000000 3769447945987085350501386572267520000000000 6916686207999802072984424331678589933649915805696000000000000000
;; small program: loop(loop(loop(x * y, y, x), y, x), x, 1)
;; fast program: loop(loop(loop(x * y, y, x), y, 1) * x, x - 1, 1) * loop(loop(x * y, y - 1, y) * x, x, 1)
(set-logic UFNIA)
