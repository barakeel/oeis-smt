...
(assert (forall ((x Int)) (= (small x) (* (* (divf (+ (divf (v0 x) 2) 1) 2) 2) (+ 2 1)))))
(assert (forall ((x Int)) (= (f9 x) (ite (<= (modf x 2) 0) (divf x (+ 1 2)) 1))))
(assert (forall ((x Int)) (= (g9 x) (divf (divf x 2) 2))))
...
(assert (forall ((x Int)) (= (f7 x) (- (- (+ (* (divf (v8 x) 2) (+ 1 2)) 1) x) x))))
(assert (= g7 1))
...
(assert (forall ((x Int)) (= (fast x) (* (divf (+ (* (+ (v2 x) x) (+ 1 2)) 1) 2) (+ 2 (+ 2 2))))))
