;; sequence(s): A169657
;; terms: 12 4320 87091200 158018273280000 37845502865178624000000 1649653134695488211543654400000000 17257672962657131355854388575443353600000000000
;; small program: loop(loop((2 + y) * x, y + y, x), 1 + x, 1)
;; fast program: loop(loop(loop(x * y, 1 + (x + x), 1 + x), 1, y) * x, 1 + x, 1)
(set-logic UFNIA)
