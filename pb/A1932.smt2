;; sequence(s): A1932
;; terms: 0 2 3 7 15 34 78 182 429 1019 2433 5830 14004 33694 81159 195635 471819 1138286 2746794 6629290
;; small program: loop2((x + x) + y, x, x, 0, 1) + loop2(x + y, x, x, 0, 1)
;; fast program: loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1) + loop2(x + y, x, x, 0, 1)
(set-logic UFNIA)
