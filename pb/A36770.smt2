;; sequence(s): A36770
;; terms: 1 3 60 3150 317520 52390800 12843230400 4382752374000 1986847742880000 1155153277710432000 838011196011749760000 742058914068404412480000 787724078011075453248000000 987468397792455300321600000000 1443283810213452666950050560000000
;; small program: loop2((loop(x + y, y, 1) + y) * x, 1 + y, x, 1, x)
;; fast program: loop2(x * y, 1 + y, x - 1, 1, 2 + x) * loop2(x * y, 2 + y, x, 1, 1 + 2)
(set-logic UFNIA)
