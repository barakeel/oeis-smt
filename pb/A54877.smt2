;; sequence(s): A54877
;; terms: 1 0 2 0 6 2 20 14 70 72 254 330 948 1430 3614 6008 13990 24786 54740 101118
;; small program: loop((x - loop2(y - x, x, y, 0, 2)) + x, x, 1)
;; fast program: loop((x - loop2(y - x, x, y - 1, 2, 0)) + x, x, 1)
(set-logic UFNIA)
