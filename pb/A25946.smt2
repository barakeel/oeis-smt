;; sequence(s): A25946
;; terms: 1 23 356 4702 57435 672441 7683502 86531384 965954429 10724321179 118659465288 1310098171746 14444989850383 159132262849037 1752116527119314 19284913291752988 212215466792375697
;; small program: loop(((loop((loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop2(((x + x) + x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x))) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
