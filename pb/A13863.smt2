;; sequence(s): A13863
;; terms: 144 35831808 8916100448256 2218611106740436992 552061438912436417593344 137370551967459378662586974208 34182189187166852111368841966125056 8505622499821102144576131684114829934592 2116471057875484488839167999221661362284396544
;; small program: loop(loop((2 + y) * x, 2, x), 2 + ((2 * (x + x)) + x), 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2)))) * loop2(x * y, y, 2 + x, 1, 2 * (2 + (2 + 2)))) * loop(x * x, 1, loop2(x * y, y, x, 1, 2 * (2 + (2 + 2))))
(set-logic UFNIA)
