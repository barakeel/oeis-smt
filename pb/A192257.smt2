;; sequence(s): A192257
;; terms: 0 8 35 163 538 1618 4362 11018 26327 60327 133532 287324 603692 1243044 2515419 5013979 9863110 19176814 36900470 70348470
;; small program: loop(loop((loop2(x + y, x, x, 0, 1 + x) * (1 + x)) * (1 + x), 1, y) + x, x, 0)
;; fast program: loop(loop(loop2(x + y, x, x - 2, 1, 1) * loop((x * x) * x, 1, 1 + x), 1, y) + x, x, 0)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (f1 x) (* (* (w2 x) (+ 1 x)) (+ 1 x)))))
(assert (= g1 1))
