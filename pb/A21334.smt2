;; sequence(s): A21334
;; terms: 1 26 473 7462 109221 1527162 20707681 274691534 3584491901 46184032258 589079813049 7452543446166 93649963947541 1170213435915914 14553113785023377 180253443514702558
;; small program: loop((loop(loop(1 + (loop((2 + y) * x, 2, x) - x), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x, x, 1)
;; fast program: loop((loop2((2 * ((2 * ((x + x) + x)) + y)) - 1, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
