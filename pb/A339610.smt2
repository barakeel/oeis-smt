;; sequence(s): A339610
;; terms: 2 3 7 11 21 36 64 111 193 333 573 982 1678 2859 4859 8239 13941 23544 39692 66807
;; small program: 2 + loop2(y, 2 + (x + y), x, x, 1)
;; fast program: loop2(x + y, x, x, 2 + x, 1 - x)
(set-logic UFNIA)
