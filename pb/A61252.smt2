;; sequence(s): A61252
;; terms: 0 1 31 721 14911 289201 5386591 97576081 1732076671 30276117361 522861237151 8942430185041 151728638820031 2557404559011121 42864668012537311 715027614225987601 11878335717996660991
;; small program: loop(loop(x * x, 2, 2) * x, x, 1) - loop((loop(x * x, 2, 2) * x) - x, x, 1)
;; fast program: loop(x * x, 2, loop(x + x, x, 1)) - loop2(x * y, y, x, 1, (2 * (2 * (2 + 2))) - 1)
(set-logic UFNIA)
