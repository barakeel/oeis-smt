;; sequence(s): A225786
;; terms: 0 48 15552 5007792 1612493568 519217921200 167186558132928 53833552500881712 17334236718725778432 5581570389877199773488 1797248331303739601284800 578708381109414274413932208 186342301468900092621684886272
;; small program: (1 + 2) * loop(x * x, 1, loop2((2 * (x + x)) + y, x, x + x, 0, 1))
;; fast program: loop(x * x, 1, loop2((2 * ((2 * (2 * (x + x))) + x)) - y, x, x - 1, if x <= 0 then 0 else (2 + 2), 0)) * (1 + 2)
(set-logic UFNIA)
