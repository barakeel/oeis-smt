...
(assert (forall ((x Int)) (= (f1 x) (modf (+ (v2 x) x) (+ 1 2)))))
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (divf (* y y) (- x y)))))
(assert (forall ((x Int)) (= (g4 x) x)))
(assert (= h4 0))
(assert (forall ((x Int) (y Int)) (= (u4 x y) (ite (<= x 0) y (f4 (u4 (- x 1) y) x)))))
(assert (forall ((x Int)) (= (v4 x) (u4 (g4 x) h4))))
(assert (forall ((x Int)) (= (f3 x) (modf (- (modf (- (- (- (- (+ (- (* (+ (v4 x) x) 2) (ite (<= x 0) 1 2)) 1) x) x) 1) x) (+ 1 2)) 1) (+ 1 x)))))
