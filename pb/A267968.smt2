;; sequence(s): A267968
;; terms: 1 1 8 648 663552 10368000000 2902376448000000 16731622649806848000000 2245680377810414777401344000000 7830203310981140781182893575634944000000 783020331098114078118289357563494400000000000000000 2457453226667794121573260254679367673480373862400000000000000000
;; small program: loop(x * loop2(x * y, y, y, y, y), x, 1)
;; fast program: (loop(loop2(x * y, y, y - 1, y, y) * x, x - 1, 1) * loop2(x * y, y, x, 1, x)) * loop(x * y, x, 1)
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (i3 x y) y)))
(assert (forall ((x Int) (y Int)) (= (j3 x y) y)))
(assert (forall ((x Int) (y Int) (z Int)) (= (u3 x y z) (ite (<= x 0) y (f3 (u3 (- x 1) y z) (v3 (- x 1) y z))))))
(assert (forall ((x Int) (y Int) (z Int)) (= (v3 x y z) (ite (<= x 0) z (g3 (u3 (- x 1) y z) (v3 (- x 1) y z))))))
(assert (forall ((x Int) (y Int)) (= (w3 x y) (u3 (h3 x y) (i3 x y) (j3 x y)))))
