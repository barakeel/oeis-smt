;; sequence(s): A151881
;; terms: 1 5 23 120 724 5012 39332 345832 3371976 36135792 422379792 5349561984 72996193152 1067779243008 16670798231040 276718772067840 4866610479828480 90401487246167040 1768784607499944960 36360467544043008000
;; small program: loop((loop((x * y) + loop(x * y, y - 1, 2), y, 1) + (x * y)) + x, x, 1)
;; fast program: loop(loop((x * y) + loop(x * y, y - 1, 2), y, 1) + ((1 + y) * x), x, 1)
(set-logic UFNIA)
