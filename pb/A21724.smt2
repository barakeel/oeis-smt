;; sequence(s): A21724
;; terms: 1 26 465 7150 101621 1378026 18123145 233349350 2958918141 37094306626 461004657425 5690785933950 69876732453061 854393804284826 10411455807073305 126524771262956950 1534170271000826381
;; small program: loop(((loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((2 * ((2 * (x + x)) + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2), 1, y) + (2 * (2 * ((x + x) + x))), x, 1)
(set-logic UFNIA)
