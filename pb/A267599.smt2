;; sequence(s): A267599
;; terms: 1 1 1001 101001 10101001 1010101001 101010101001 10101010101001 1010101010101001 101010101010101001 10101010101010101001 1010101010101010101001 101010101010101010101001 10101010101010101010101001 1010101010101010101010101001
;; small program: loop(loop(loop(2 * ((2 * (x + x)) + x), 1 + (x + x), 1), 1, y) + x, x - 1, 1)
;; fast program: loop(loop(loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + 2))) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2))), 1, y) + x, x - 1, 1)
(set-logic UFNIA)
