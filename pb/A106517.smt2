;; sequence(s): A106517
;; terms: 1 3 10 31 95 288 869 2615 7858 23595 70819 212512 637625 1913019 5739290 17218247 51655351 154967040 464902717 1394710735
;; small program: loop(((x + x) + x) + loop2(y, x + y, y, 1, 0), x, 1)
;; fast program: loop(((x + loop2(x + y, x, y - 1, 0, 1)) + x) + x, x, 1)
(set-logic UFNIA)
