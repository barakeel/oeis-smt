;; sequence(s): A103312
;; terms: 0 1 1 1 0 ~3 ~9 ~18 ~27 ~27 0 81 243 486 729 729 0 ~2187 ~6561 ~13122
;; small program: if x <= 0 then 0 else loop2((x - y) + x, x + y, x - 2, 1, 1)
;; fast program: loop2((x - y) + x, x + y, (x - 1) - 2, if x <= 0 then 0 else 1, 2)
(set-logic UFNIA)
