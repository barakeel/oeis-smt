...
(assert (forall ((x Int)) (= (f1 x) (modf (- (w2 x) 1) (+ 2 x)))))
(assert (forall ((x Int)) (= (g1 x) (modf (divf (* (+ 2 x) x) 2) 2))))
(assert (forall ((x Int)) (= (h1 x) x)))
(assert (forall ((x Int) (y Int)) (= (u1 x y) (ite (<= x 0) y (f1 (u1 (- x 1) y))))))
(assert (forall ((x Int)) (= (v1 x) (u1 (g1 x) (h1 x)))))
(assert (forall ((x Int)) (= (f0 x) (modf (modf (v1 x) (+ 1 x)) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (f5 x) (+ (modf (ite (<= (- (modf (+ 1 (w6 x)) (+ 1 x)) 2) 0) 1 2) 2) x))))
