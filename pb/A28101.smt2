;; sequence(s): A28101
;; terms: 1 32 661 11228 170905 2428664 32963197 433285556 5565811009 70301927696 876950844133 10837103324684 132978429495913 1623019468693928 19728775328561869 239074474267587812
;; small program: loop(((loop(loop(loop((x + x) + x, y + y, 1) + (2 * (2 * (x + x))), y, 1) + loop((2 + y) * x, 2, x), y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop(loop2((2 * (x + x)) + y, 1 + ((y + y) + y), x, 1, 2 + 2) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
