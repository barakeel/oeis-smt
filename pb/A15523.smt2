;; sequence(s): A15523
;; terms: 0 1 3 14 57 241 1008 4229 17727 74326 311613 1306469 5477472 22964761 96281643 403668734 1692414417 7095586921 29748832848 124724433149
;; small program: loop2((2 * (x + x)) + y, x - y, x, 0, 1)
;; fast program: loop2(y - x, (2 * (y + y)) + x, x - 1, if x <= 0 then 0 else 1, 2 + 2)
(set-logic UFNIA)
