;; sequence(s): A23951
;; terms: 1 24 381 5056 60837 689640 7521277 79922832 834214293 8599137976 87862904493 892165074528 9019015091269 90887374167432 913848341454429 9173869834986544 91989788624850165 921675830164728408
;; small program: loop((loop(loop(1 + (2 * ((x + x) + x)), y, 1) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
...
(assert (forall ((x Int) (y Int)) (= (g5 x y) (+ 1 (+ (* 2 (+ (+ y y) y)) y)))))
