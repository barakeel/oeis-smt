;; sequence(s): A17142
;; terms: 46656 7529536 113379904 729000000 3010936384 9474296896 24794911296 56800235584 117649000000 225199600704 404567235136 689869781056 1126162419264 1771561000000 2699554153024
;; small program: loop(loop2(x * y, x, y, x, x), 2, 2 * loop(1 + (x + x), 2, x))
;; fast program: loop((x * x) * x, 1, loop(x * x, 1, 2 + (2 * (2 + (2 * (x + x))))))
(set-logic UFNIA)
...
(assert (= g4 1))
(assert (forall ((x Int)) (= (h4 x) (+ 2 (* 2 (+ 2 (* 2 (+ x x))))))))
