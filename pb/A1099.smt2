;; sequence(s): A1099
;; terms: 1 3 24 232 2893 43763 779780 15997436 371423053 9628576947 275683093664 8640417354592 294234689237661 10817772136320355 427076118244539020 18019667955465012596 809220593930871751581 38537187481365665823843 1939882468178947923300136
;; small program: loop(loop2(x * y, y, y, 1, y) - x, 1 + x, 0)
;; fast program: loop(loop(loop2(x * y, y, x - 2, 1, x) * (x * x), 1, y) - x, 1 + x, 0)
(set-logic UFNIA)
