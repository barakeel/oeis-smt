;; sequence(s): A134367
;; terms: 1 1 1 6 576 1728000 268738560000 3252016064102400000 4296582355504620109824000000 828592942960967278432052230225920000000 30067980714167580599742311330438184960000000000000000
;; small program: loop2(loop(x * y, y, x), y, x - 2, 1, x)
;; fast program: (loop2(x * y, y, (x - 1) - 2, 1, loop(x * y, x - 1, 1)) * loop2(x * y, y, x - 2, 1, x)) * loop(x * y, x - 1, 1)
(set-logic UFNIA)
