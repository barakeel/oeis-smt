;; sequence(s): A342573
;; terms: 1 2 24 5184 39813120 17915904000000 702142910300160000000 3330690501757390081228800000000 2534703826002712645182542460223488000000000 395940866122425193243875570782668457763038822400000000000
;; small program: loop2(loop(x * y, y, x), y, 1 + x, 1 + x, x)
;; fast program: loop2(x * y, y, x - 2, 1, loop(x * y, x - 1, x)) * (loop((x * x) * x, 1, loop(x * y, x, 1)) * (1 + x))
(set-logic UFNIA)
