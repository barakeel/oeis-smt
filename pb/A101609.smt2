;; sequence(s): A101609
;; terms: 0 2 6 36 180 1320 9240 84000 756000 8285760 91143360 1173553920 15256200960 226040855040 3390612825600 56865153945600 966707617075200 18112111963545600 344130127307366400 7125892746964992000
;; small program: loop((loop(loop(x * y, y, 1) - (x * y), y, 0) + (x * y)) + x, x, 0) * 2
;; fast program: loop(((loop(loop(x * y, y - 1, y) - (x * y), y - 1, 1) + x) * y) + x, x, 0) * 2
(set-logic UFNIA)
