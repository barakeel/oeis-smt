;; sequence(s): A33813
;; terms: 4 15 37 77 146 262 454 769 1283 2119 3476 5676 9240 15011 24353 39473 63942 103538 167610 271285
;; small program: loop(loop(loop2(x + y, x, y + 1, 1, 2) + x, y, x), 1 + x, 0)
;; fast program: loop(((((loop2(x + y, x, x, 1 + (2 + (2 * (2 + 2))), 1 + (2 + (2 + 2))) - 2) - (2 * (2 * (2 + x)))) - x) - x) - x, 1, 2 + x) - 1
(set-logic UFNIA)
