;; sequence(s): A165812
;; terms: 1 4 46656 205891132094649000000000000000000000000000000
;; small program: loop2(loop2(x * y, y, x, 1, x) + y, x, 2, x, x) - x
;; fast program: loop(loop2(x * y, y, x - 2, 1, x) * (x * x), 1, x + loop2(x * y, y, x, 1, x))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (h2 x) (+ x (w4 x)))))
