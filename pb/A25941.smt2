;; sequence(s): A25941
;; terms: 1 22 327 4172 49553 567714 6382699 71043064 786493125 8681598926 95678810591 1053554778276 11595631317817 127591121803258 1403737417995603 15442522109891408 169876206409453229
;; small program: loop(((loop(loop2((loop((2 + y) * x, 2, x) - x) + y, y + y, y, 1, 2) + (2 * ((x + x) + x)), y, 1) + x) + x) + x, x, 1)
;; fast program: loop((loop((loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + x) + x, y, 1) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
