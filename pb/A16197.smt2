;; sequence(s): A16197
;; terms: 0 1 23 397 6095 87781 1214423 16344637 215622815 2801832661 35979939623 457696700077 5777672071535 72470493235141 904168630965623 11229773405170717 138934529031464255 1713164078241143221
;; small program: loop(loop((2 + y) * x, 2, x), x, 1) - loop(loop((2 + y) * x, 2, x) - x, x, 1)
;; fast program: loop2(x * y, y, x, 1, 2 * (2 + (2 + 2))) - loop2(x * y, y, x, 1, 1 + (2 + (2 * (2 + 2))))
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (w4 x) (w5 x)))))
