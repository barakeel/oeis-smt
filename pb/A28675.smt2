;; sequence(s): A28675
;; terms: 1 156 4429152 21368939889024 17430690424387037091840 2402962221899462961810522363863040 55984406793280086114756507719510983331312762880
;; small program: loop(loop((x * x) - x, 1, loop(loop((2 + y) * x, 2, x) + x, y, 1)) * x, x, 1)
