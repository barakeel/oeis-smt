;; sequence(s): A76113
;; terms: 1 2 27 4096 9765625 470184984576 558545864083284007 19342813113834066795298816 22528399544939174411840147874772641 1000000000000000000000000000000000000000000000
;; small program: loop2((x * y) + x, y, loop(x + y, x, 0), 1, x)
;; fast program: loop2(x * y, y, x - 1, 1, 1 + x) * loop2(x * y, y, loop(x + y, x - 1, 1), 1, 1 + x)
(set-logic UFNIA)
