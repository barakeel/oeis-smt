;; sequence(s): A88211
;; terms: 1 2 7 22 65 186 519 1422 3841 10258 27143 71270 185921 482314 1245191 3201182 8199169 20931234 53276679 135246390
;; small program: loop2((x + x) + y, x, x, 1, x - 1)
;; fast program: loop2((x + x) + y, x, x - 1, 1 + x, 1)
(set-logic UFNIA)
