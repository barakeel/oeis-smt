;; sequence(s): A96313
;; terms: 1 2 6 48 1440 207360 174182400 1003290624000 45509262704640000 18349334722510848000000 73244672425152101744640000000 3189483207556703361731395584000000000
;; small program: loop(loop(x * y, y, x), x, 1 + x)
;; fast program: loop(loop(x * y, y - 1, y) * x, x - 2, 1) * loop(x * y, x - 1, loop((1 + y) * x, x, 1))
(set-logic UFNIA)
