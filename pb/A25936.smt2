;; sequence(s): A25936
;; terms: 1 22 333 4406 55133 673566 8144701 98052262 1178225565 14146756910 169801508669 2037820760118 24454863987997 293463446955454 3521586773279037 42259168371397574 507110656046025629
;; small program: loop(((loop((loop2(loop((2 + y) * x, 2, x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + x) + x) + x, x, 1)
;; fast program: loop(loop((loop2(((x + x) + x) + y, y + y, y, 1, 2) + (2 * (x + x))) + x, y, 1) + (2 * (2 * ((x + x) + x))), x, 1)
(set-logic UFNIA)
