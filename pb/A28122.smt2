;; sequence(s): A28122
;; terms: 1 28 505 7500 100161 1254588 15084745 176531500 2028331921 23012251548 258784204185 2892049106700 32177076653281 356869970102908 3948976130302825 43626137399621100 481387456885736241
;; small program: loop(loop2(((((y - 1) + y) * (y * y)) + x) + (2 * (x + x)), y + y, y, 1, 2) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop2(((((y - 1) + y) * (y * y)) + x) + (2 * (x + x)), y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
