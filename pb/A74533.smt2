;; sequence(s): A74533
;; terms: 3 12 56 288 1568 8832 50816 296448 1745408 10340352 61515776 366993408 2193563648 13127811072 78632615936 471258759168 2825404940288 16943839444992 101628676407296 609634618441728
;; small program: loop(x + x, x, 1 + (loop((x + x) + x, x, 1) + loop(x + x, x, 1)))
;; fast program: loop((x * x) + x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
