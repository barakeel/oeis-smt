;; sequence(s): A28208
;; terms: 1 35 777 13999 223769 3314031 46600009 631601663 8333511417 107767060687 1372468494761 17273924107167 215413939302745 2666835630709103 32824988535796233 402159883923086911
;; small program: loop((loop(loop(loop(2 * ((x + x) + x), x, loop(x + x, x, 2) - 1), 1, y) + (2 * ((2 * (x + x)) + x)), y, 1) + (2 * ((x + x) + x))) + x, x, 1)
;; fast program: loop((loop(loop((loop(loop((x + x) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (x + x))) + x, x, 1) * loop(x + x, x, 1), 1, y) + (2 * ((x + x) + x))) + x, x, 1)
(set-logic UFNIA)
