;; sequence(s): A13808
;; terms: 18 1889568 198359290368 20822964865671168 2185911559738696531968 229468251895129407139872768 24088659210943104643915283693568 2528731089327963353099650821015994368 265456074833292280954988944586975024775168
;; small program: loop(2 * loop((x + x) + x, 2, x), 1 + (2 * (x + x)), 1)
