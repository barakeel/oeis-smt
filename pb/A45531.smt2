;; sequence(s): A45531
;; terms: 1 3 19 175 2101 31031 543607 11012415 253202761 6513215599 185311670611 5777672071535 195881901213181 7174630439858727 282325794823047151 11878335717996660991 532092356706983938321 25283323623228812584415 1270184310304975912766347
;; small program: loop2((x * y) + x, y, 1 + x, 1, x) - loop2(x * y, y, x, x, x)
;; fast program: (loop2(x * y, y, x - 1, 1, 1 + x) * (((2 + x) * x) + 1)) - ((loop2(x * y, y, x - 2, x, x) * x) * x)
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (- (* (w2 x) (+ (* (+ 2 x) x) 1)) (* (* (w3 x) x) x)))))
