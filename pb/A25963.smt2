;; sequence(s): A25963
;; terms: 1 22 325 4110 48381 550062 6148165 68149870 752379661 8290355502 91266902805 1004309278830 11049302357341 121551961591342 1337120292662245 14708568942522990 161795495573813421
;; small program: loop((loop2(((2 * (((y * y) + x) + x)) - y) + x, y + y, y, 1, 2) - x) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop((loop2(((2 * (((y * y) + x) + x)) - y) + x, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
