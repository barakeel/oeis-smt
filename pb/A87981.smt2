;; sequence(s): A87981
;; terms: 1 0 2 4 24 128 880 6816 60032 589312 6384384 75630080 972387328 13483769856 200571078656 3185540657152 53800242216960 962741176500224 18195808235880448 362183230599856128
;; small program: loop(loop((x * y) + loop(0 - (x + x), y, 1), y, 1) + (x * y), x, 1)
;; fast program: loop(loop(loop2(x * y, y, y, 1, 0 - 2) + (x * y), y, 1) + (x * y), x, 1)
(set-logic UFNIA)
