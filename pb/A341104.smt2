;; sequence(s): A341104
;; terms: 1 1 4 11 30 81 217 578 1533 4053 10690 28145 74001 194370 510133 1338077 3508194 9194697 24092281 63114914
;; small program: loop2(x + y, x, (x - 2) + x, 2, 1) - loop(x + x, x - 2, 1)
;; fast program: loop2(((x - y) + x) + x, x, x - 1, 2, 1) - loop(x + x, x - 2, 1)
(set-logic UFNIA)
