;; sequence(s): A16267
;; terms: 1 23 387 5755 80171 1073163 13989067 178979915 2258870091 28217552203 349721737547 4307771961675 52804374651211 644763606925643 7848274394218827 95290403841737035 1154595957211955531
;; small program: loop(loop(1 + (2 * ((2 * (x + x)) + x)), y, 1) + loop((2 + y) * x, 2, x), x, 1)
;; fast program: loop(loop2(1 + (x * y), y, y, 1, 2 + (2 * (2 + 2))) + (2 * (2 * ((x + x) + x))), x, 1)
(set-logic UFNIA)
