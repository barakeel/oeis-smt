;; sequence(s): A21274
;; terms: 1 22 337 4482 55533 660774 7667929 87542794 988535845 11078416206 123498755601 1371575734386 15192048468637 167950256294518 1854154604388553 20449314929530458 225371378475017109
;; small program: loop(loop2((2 * ((2 * (x + x)) + y)) - 1, y + y, y, 1, 2) + (loop((2 + y) * x, 2, x) - x), x, 1)
;; fast program: loop((loop2((2 * ((2 * (x + x)) + y)) - 1, y + y, y, 1, 2) + (2 * ((2 * (x + x)) + x))) + x, x, 1)
(set-logic UFNIA)
