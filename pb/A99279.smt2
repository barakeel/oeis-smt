;; sequence(s): A99279
;; terms: 0 1 16 289 5184 93025 1669264 29953729 537497856 9645007681 173072640400 3105662519521 55728852710976 1000013686278049 17944517500293904 322001301319012225 5778078906241926144
;; small program: loop(x * x, 1, loop2((2 * (x + x)) + y, x, x, 0, 1))
;; fast program: loop(x * x, 1, loop2((2 * (x + x)) + y, x, x - 1, if x <= 0 then 0 else 1, 0))
(set-logic UFNIA)
