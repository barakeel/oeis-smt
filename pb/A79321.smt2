;; sequence(s): A79321
;; terms: 27649 86400001 4031078400001 3319766398771200001 55696437941726556979200001 21577941222941856209168026828800001 215779412229418562091680268288000000000000001
;; small program: loop(loop2(x * y, y, y, x, y), 2 + (2 + x), 1) + 1
;; fast program: loop(loop(loop2(x * y, y, x, 1 + x, 1 + x), 1, y) * x, 2 + (1 + x), 1) + 1
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (g2 x) (+ 2 (+ 1 x)))))
(assert (= h2 1))
