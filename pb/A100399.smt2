;; sequence(s): A100399
;; terms: 1 1 1 8 81 3125 262144 62748517 37822859361 60716992766464 253295162119140625 2775173073766990340489 79496847203390844133441536 5965226978431093156430190442313 1171598758708107367475386427203165009 602486784535040403801858901000000000000000
;; small program: loop2(loop2(x + y, x, y, 0, x), y, x, 1, x)
;; fast program: loop2(x * y, y, x - 2, 1, loop2(x + y, x, x - 2, 1, 1)) * loop(x * x, 1, loop2(x + y, x, x - 2, 1, 1))
(set-logic UFNIA)
