;; sequence(s): A87124
;; terms: 1 3 6 15 37 94 241 623 1618 4215 11001 28746 75169 196651 514606 1346879 3525565 9229062 24160401 63250167
;; small program: loop2(x + y, x, x + x, 1, 0) + loop2(x + y, x, x, 0, 1)
;; fast program: (if x <= 0 then 0 else loop2(((x - y) + x) + x, x, x - 1, 2, 1)) + loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
