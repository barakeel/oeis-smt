;; sequence(s): A74561
;; terms: 3 15 77 405 2177 11925 66377 374445 2135777 12292965 71280377 415819485 2437700177 14348506005 84736115177 501776304525 2977992765377 17706778767045 105443373410777 628708104245565
;; small program: loop2(((2 * (x + x)) + x) + y, 2 * ((y + y) + y), x, 2, 1) + loop(x + x, x + x, 1)
;; fast program: (loop(x * x, 1, loop(x + x, x, 1)) + loop2(x * y, y, x, 1, 1 + (2 + 2))) + loop2(x * y, y, x, 1, 2 + (2 + 2))
(set-logic UFNIA)
