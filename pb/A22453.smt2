;; sequence(s): A22453
;; terms: 1 22 320 3890 42861 444612 4433080 43016380 409466321 3843870602 35717758440 329381322270 3020187550381 27573503381992 250911867832400 2277497319225560 20632700169031041 186641825267602782
;; small program: loop((loop((loop(1 + loop((x + x) + x, 2, x), y, 1) + (2 * ((x + x) + x))) + x, y, 1) + (2 * (x + x))) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * ((x + x) + x)) + x) + y, 1 + ((2 * (y + y)) + y), x, 1, 2 + (2 + 2)), 1, y) + (2 * (2 * (x + x)))) + x, x, 1)
(set-logic UFNIA)
