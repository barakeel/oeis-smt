;; sequence(s): A14936
;; terms: 1 39 1122 28558 680163 15536757 344857924 7495831836 160347899205 3387224876995 70828953712806 1468712060491434 30241806008351527 618983574479950353 12604083861223212168 255502116339219984952
;; small program: loop(loop((2 * loop((x + x) + x, 2, x)) + x, y, 1 + y) + x, x, 1)
