;; sequence(s): A248099
;; terms: 1 4 216 2428912656 84539502447168140812774402430429967453919558368
;; small program: loop2(loop(x + loop2(x * y, y, y, 1, x), y, 1) * x, y, 1 + x, 1, x)
;; fast program: loop2(x * y, y, 1 + x, 1, loop(x + loop2(x * y, y, y, 1, x), x, 1))
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (+ x (w5 x y)))))
