;; sequence(s): A208148
;; terms: 1 16 2187 1048576 1220703125 2821109907456 11398895185373143 73786976294838206464 717897987691852588770249 10000000000000000000000000000 191943424957750480504146841291811 4922235242952026704037113243122008064
;; small program: loop2((x * y) + x, y, 1 + ((x + x) + x), 1, x)
;; fast program: loop(x * x, 1, loop2(x * y, y, x, 1, 1 + x)) * loop2(x * y, y, x, 1 + x, 1 + x)
(set-logic UFNIA)
