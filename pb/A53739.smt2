;; sequence(s): A53739
;; terms: 1 6 22 63 155 344 709 1383 2587 4685 8273 14323 24416 41119 68595 113590 187030 306605 500950 816410
;; small program: loop(loop(loop(loop((loop2(x + y, x, y, 1, 1) - 1) + x, y, x), y, x), 1 + y, x), x, 1)
;; fast program: loop(loop(loop(loop((loop2(x + y, x, y, 2, 1) - 1) + x, y, x), y, x) + y, y, x) + y, x, 1) + x
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f8 x y) (+ (- (w9 x y) 1) x))))
