;; sequence(s): A13813
;; terms: 8000 1280000000 204800000000000 32768000000000000000 5242880000000000000000000 838860800000000000000000000000 134217728000000000000000000000000000 21474836480000000000000000000000000000000 3435973836800000000000000000000000000000000000
;; small program: loop(loop(2 * (2 + x), 2, 2) * x, loop(1 + (x + x), 2, x), 1)
;; fast program: (loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 * (2 + 2)))) * loop2(x * y, y, x, 1, 2 * (2 + (2 * (2 + 2))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 * (2 + (2 * (2 + 2)))))
(set-logic UFNIA)
