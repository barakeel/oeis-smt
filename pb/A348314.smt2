;; sequence(s): A348314
;; terms: 0 1 10 78 568 4120 30864 244720 2088832 19389312 196514560 2173194496 26128665600 339890756608 4759410116608 71395178280960 1142340032364544 19419853564641280 349557673401188352 6641597100292636672
;; small program: loop(loop(2 * (x + x), y - 1, y) + (x * y), x, 0)
;; fast program: loop(loop(x * x, 1, loop(x + x, y, 1)) + (x * y), x - 1, 1) * x
(set-logic UFNIA)
