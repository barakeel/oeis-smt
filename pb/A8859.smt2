;; sequence(s): A8859
;; terms: 1 2 4 8 16 32 64 127 247 466 848 1486 2510 4096 6476 9949 14893 21778 31180 43796
;; small program: loop(loop(loop(loop(loop(x + y, y - 2, x), y, x) + y, y - 2, x), y, x) + y, x, 1)
;; fast program: loop(loop(loop(loop(loop(x + y, y, x), y - 1, x) + y, y - 1, x) + y, y - 2, x) + y, x, 1)
(set-logic UFNIA)
