...
(assert (forall ((x Int)) (= (f1 x) (modf (ite (<= (v2 x) 0) 1 0) (+ 1 x)))))
...
(assert (forall ((x Int) (y Int)) (= (f7 x y) (+ 2 (modf x y)))))
...
(assert (forall ((x Int)) (= (f4 x) (- (divf (* (modf (divf (divf (- (+ (v5 x) 2) x) 2) 2) 2) (+ 1 x)) 2) 1))))
