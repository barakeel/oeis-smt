;; sequence(s): A306948
;; terms: 0 1 3 5 8 9 19 ~15 216 ~1407 11803 ~108483 1106192 ~12363703 150381243 ~1977666743 27965386320 ~423158076351 6822782712723 ~116781368777867
;; small program: loop(loop(loop(1 - (x * y), y - 2, 1) + x, y, x), x, 0)
;; fast program: loop(loop(loop(1 - (x * y), y - 1, 1) + x, y - 1, 1) + x, x, 0)
(set-logic UFNIA)
