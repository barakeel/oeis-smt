;; sequence(s): A43699
;; terms: 0 2 24 350 4896 68962 970200 13652158 192099456 2703046850 38034749784 535189557278 7530688519200 105964828904482 1491038292992664 20980500931258750 295218051329511936 4154033219547089282 58451683124982331800 822477596969315258078
;; small program: loop2(loop2((x + x) + y, x, y, 1, 0) - x, 2 + y, x, 0, x)
;; fast program: (loop(x * x, 1, loop2((x + x) + y, x, x, 0, 1)) * loop2(y, (x + y) + y, x, 1, 1)) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int)) (= (fast x) (* (* (v2 x) (w4 x)) 2))))
