...
(assert (forall ((x Int)) (= (small x) (* (+ (v0 x) 1) (+ 1 (divf (+ 1 x) 2))))))
(assert (forall ((x Int)) (= (f5 x) (+ x x))))
(assert (forall ((x Int)) (= (g5 x) (divf x 2))))
(assert (= h5 1))
(assert (forall ((x Int) (y Int)) (= (u5 x y) (ite (<= x 0) y (f5 (u5 (- x 1) y))))))
(assert (forall ((x Int)) (= (v5 x) (u5 (g5 x) h5))))
(assert (forall ((x Int)) (= (f4 x) (modf (- (modf (- (modf (+ (modf (ite (<= (- (modf (+ 1 (v5 x)) (+ 1 x)) 2) 0) 1 x) 2) 1) (+ 1 2)) 1) (+ 1 2)) 1) (+ 1 x)))))
...
(assert (forall ((x Int)) (= (fast x) (* (+ (v3 x) 1) (+ 1 (- x (divf x 2)))))))
