;; sequence(s): A137864
;; terms: 1 3 5 7 33 131 373 855 1697 3043 5061 7943 11905 17187 24053 32791 43713 57155 73477 93063
;; small program: 1 + ((loop((x - y) * x, 2, 2 - x) + x) + x)
;; fast program: 1 + ((2 + loop(((x * x) * x) - x, 1, x - 2)) * x)
(set-logic UFNIA)
