;; sequence(s): A25998
;; terms: 1 25 409 5565 68481 792645 8815129 95390845 1012475761 10596550965 109756131849 1127967674925 11523334499041 117184641488485 1187466959384569 11999684812451805 120997224186474321
;; small program: loop((loop(loop(loop((2 * (x + x)) + x, x, loop(x + x, x, 2) - 1), 1, y) + (2 * (2 * (x + x))), y, 1) + x) + x, x, 1)
;; fast program: loop((loop(loop2(((2 * (x + x)) + x) + y, 1 + (2 * (y + y)), x, 1, 1 + (2 + 2)) * loop(x + x, x, 1), 1, y) + (2 * (x + x))) + x, x, 1)
(set-logic UFNIA)
