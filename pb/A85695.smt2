;; sequence(s): A85695
;; terms: 0 1 4 34 216 1525 10336 71149 486864 3339106 22881100 156843721 1074985344 7368157369 50501844796 346145466850 2372514562656 16261461342589 111457702083424 763942486626661
;; small program: loop2((2 * (x + x)) + y, x, x, 0, loop2(x + y, x, x, 0, 1))
;; fast program: loop2((2 * (x + x)) + y, x, x - 2, if (x - 1) <= 0 then x else (2 + 2), 1) * loop2(x + y, x, x - 2, 1, 1)
(set-logic UFNIA)
