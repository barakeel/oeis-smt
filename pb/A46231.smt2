;; sequence(s): A46231
;; terms: 0 1 5 17 65 257 1025 4097 16385 65537 262145 1048577 4194305 16777217 67108865 268435457 1073741825 4294967297
;; small program: loop2(1 + (y * y), y + y, x - 1, x, 2)
;; fast program: loop(x * x, 1, loop(x + x, x - 1, 1)) + loop(x - 1, 2 - x, 1)
(set-logic UFNIA)
