;; sequence(s): A28677
;; terms: 1 210 10584000 120522654000000 308880278577360000000000 178115698742031918598500000000000000 23109857603759312583902403410250000000000000000000
;; small program: loop(loop((x * x) - x, 1, loop((2 * (2 * (2 * (x + x)))) - x, y, 1)) * x, x, 1)
;; fast program: loop(loop((x * x) - x, 1, loop2(x * y, y, y, 1, (2 * (2 * (2 + 2))) - 1)) * x, x, 1)
(set-logic UFNIA)
