;; sequence(s): A74570
;; terms: 3 21 161 1305 10913 92841 797681 6896505 59889473 521900361 4561574801 39975188505 351165790433 3091688751081 27275107401521 241076577925305 2134499460529793 18928998693221001 168109102525957841
;; small program: loop((x + x) + x, x + x, 1) + loop(x + x, x + x, 1 + loop(x + x, x, 1))
