;; sequence(s): A259323
;; terms: 2 1460 32710 268008 1330890 4874012 14527630 37308880 85584018 179675780 351208022 647279800 1135561050 1910402028 3100048670 4875056032 7457991970 11134523220 16265976038 23303463560
;; small program: loop(loop(loop2(x * y, x, y, x, x), 2, 1 + (y + y)) + x, x, 1) * 2
;; fast program: loop2(loop((x * x) * x, 1, y * y) + x, 2 + y, x, 1, 1 + 2) * 2
(set-logic UFNIA)
