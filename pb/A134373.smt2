;; sequence(s): A134373
;; terms: 1 8 13824 373248000 65548320768000 47784725839872000000 109903340320478724096000000 662559760549147780765974528000000 9159226129831418921308831875072000000000
;; small program: loop(((x * y) * y) * y, x + x, 1)
;; fast program: loop((x * x) * x, 1, loop2(x * y, 1 + y, x, 1, 1 + x)) * loop((x * x) * x, 1, loop(x * y, x, 1))
(set-logic UFNIA)
