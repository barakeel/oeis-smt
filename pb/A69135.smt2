;; sequence(s): A69135
;; terms: 1 4 144 20736 8294400 7464960000 13168189440000 41295442083840000 214075571762626560000 1734012131277275136000000 20981546788455029145600000000 365582471242040427832934400000000
;; small program: loop(loop((2 + (x - y)) * x, 2, y) * x, x, 1)
;; fast program: loop(x * x, 1, loop(x * y, x, 1)) * loop(x * x, 1, loop(x * y, x, 1 + x))
(set-logic UFNIA)
