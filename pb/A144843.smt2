;; sequence(s): A144843
;; terms: 1 64 2704 102400 3748096 135675904 4893282304 176265625600 6346852335616 228502162898944 8226263614357504 296147719133593600 10661344637077159936 383808727914259677184 13817118056668205154304 497416296261117961830400 17906987220053014721069056
;; small program: loop(x * x, 1, loop(x + x, x, loop(1 + ((x + x) + x), x, 1)))
;; fast program: loop(x * x, 1, loop2(1 + (x * y), y, x, 1, 1 + 2)) * loop(x * x, 1, loop(x + x, x, 1))
(set-logic UFNIA)
