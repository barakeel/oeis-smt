;; sequence(s): A174191
;; terms: 1 2 3 6 13 30 71 170 409 986 2379 5742 13861 33462 80783 195026 470833 1136690 2744211 6625110
;; small program: 1 + loop2((x + x) + y, x, x, 0, 1)
;; fast program: 1 + loop2((x + x) + y, x, x - 2, if (x - 1) <= 0 then x else 2, 1)
(set-logic UFNIA)
