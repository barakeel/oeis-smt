;; sequence(s): A13904
;; terms: 10648 54875873536 282810057883082752 1457498964228107529355264 7511413302012830262726227918848 38711059958478986452554295441868455936 199502557355935975909450298726667414302359552 1028162763671387035398172161927312439705897862692864
;; small program: loop((loop(x * y, 2 + 2, x) - x) - x, loop(1 + (x + x), 2, x) + x, 1)
;; fast program: (loop(x * x, 1, loop2(x * y, y, x, 1, 2 + (2 * (2 + (2 * (2 + 2)))))) * loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + (2 * (2 + 2)))))) * loop(x * x, 1, loop2(x * y, y, 1 + x, 1, 2 + (2 * (2 + (2 * (2 + 2))))))
(set-logic UFNIA)
