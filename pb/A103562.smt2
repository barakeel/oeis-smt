;; sequence(s): A103562
;; terms: 2 9 262144 542101086242752217003726400434970855712890625
;; small program: loop2(loop2(x * y, y, y, x, x), y, x, 2 + x, x)
;; fast program: loop2(loop2(x * y, y, y - 1, 1, x) * (x * x), y, x, 2 + x, x)
(set-logic UFNIA)
