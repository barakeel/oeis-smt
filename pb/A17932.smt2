;; sequence(s): A17932
;; terms: 1 17 199 1997 18487 163205 1398223 11743469 97300423 798539093 6509186047 52798905341 426744275959 3440074001381 27677315556271 222358880070413 1784513217331495 14309958928401269 114682790953126495
;; small program: loop(((loop2((2 * ((x + x) + x)) + ((y * y) * y), y + y, y, 1, 2) + x) + x) + x, x, 1)
;; fast program: loop(loop((loop(x + x, x, 2) - 1) * loop2(x * y, y, x, 1, 1 + 2), 1, y) + (2 * (2 * (x + x))), x, 1)
(set-logic UFNIA)
