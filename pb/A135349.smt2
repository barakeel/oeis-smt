;; sequence(s): A135349
;; terms: 1 30 22500 421875000 197753906250000 2317428588867187500000 678934156894683837890625000000 4972662281943485140800476074218750000000
;; small program: loop(loop2((2 + (2 + y)) * x, 1, y + y, x, 2), x, 1)
;; fast program: loop2(((1 + 2) * (y * y)) * x, (2 * (y + y)) + y, x, 1, 1) * loop2(x * y, y, x, 1, 2 + (2 * (2 + 2)))
(set-logic UFNIA)
