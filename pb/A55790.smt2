;; sequence(s): A55790
;; terms: 0 2 4 14 64 362 2428 18806 165016 1616786 17487988 206918942 2657907184 36828901754 547499510764 8691268384262 146725287298888 2624698909845026 49592184973992676 986871395973226286
;; small program: loop((loop(loop((x * y) + loop(0 - x, y, 1), y, 1) + (x * y), y, 1) - (x * y)) + x, x, 0) * 2
;; fast program: loop(loop(loop((x * y) + loop(0 - x, y, 1), y, 1) + (x * y), y, 1) - (x * (y - 1)), x, 0) * 2
(set-logic UFNIA)
...
(assert (forall ((x Int) (y Int)) (= (f4 x y) (- (v5 x y) (* x (- y 1))))))
